...
class ListTransactionsByAddressResponseItemBlockchainSpecificLitecoinScriptSig(ModelNormal):
    ...
    def __init__(self, asm, hex, type, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressResponseItemBlockchainSpecificLitecoinScriptSig - a model defined in OpenAPI
