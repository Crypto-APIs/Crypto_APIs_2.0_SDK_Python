...
class AddressTokensTransactionConfirmedEachConfirmationDataItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'token': (AddressTokensTransactionConfirmedEachConfirmationToken,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, network, address, mined_in_block, transaction_id, current_confirmations, target_confirmations, token_type, token, direction, *args, **kwargs):  # noqa: E501
        """AddressTokensTransactionConfirmedEachConfirmationDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, network, address, mined_in_block, transaction_id, current_confirmations, target_confirmations, token_type, token, direction, *args, **kwargs):  # noqa: E501
        """AddressTokensTransactionConfirmedEachConfirmationDataItem - a model defined in OpenAPI
