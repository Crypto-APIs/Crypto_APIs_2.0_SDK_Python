...
class ListLatestMinedBlocksRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hash, height, previous_block_hash, timestamp, transactions_count, total_coins, total_fees, blockchain_specific, *args, **kwargs):  # noqa: E501
        """ListLatestMinedBlocksRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, hash, height, previous_block_hash, timestamp, transactions_count, total_coins, total_fees, blockchain_specific, *args, **kwargs):  # noqa: E501
        """ListLatestMinedBlocksRI - a model defined in OpenAPI
