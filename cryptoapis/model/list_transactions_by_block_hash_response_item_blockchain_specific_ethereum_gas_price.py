...
class ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumGasPrice(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumGasPrice - a model defined in OpenAPI
