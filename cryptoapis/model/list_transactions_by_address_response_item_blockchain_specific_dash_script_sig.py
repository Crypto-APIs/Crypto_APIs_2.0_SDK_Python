...
class ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig(ModelNormal):
    ...
    def __init__(self, asm, hex, type, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptSig - a model defined in OpenAPI
