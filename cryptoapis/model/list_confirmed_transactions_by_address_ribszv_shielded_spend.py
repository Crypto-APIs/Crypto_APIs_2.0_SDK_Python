...
class ListConfirmedTransactionsByAddressRIBSZVShieldedSpend(ModelNormal):
    ...
    def _from_openapi_data(cls, anchor, cv, nullifier, proof, rk, spend_auth_sig, *args, **kwargs):  # noqa: E501
        """ListConfirmedTransactionsByAddressRIBSZVShieldedSpend - a model defined in OpenAPI
