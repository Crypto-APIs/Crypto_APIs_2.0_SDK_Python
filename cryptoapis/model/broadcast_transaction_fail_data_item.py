...
class BroadcastTransactionFailDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, network, transaction_id, error_message, *args, **kwargs):  # noqa: E501
        """BroadcastTransactionFailDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, network, transaction_id, error_message, *args, **kwargs):  # noqa: E501
        """BroadcastTransactionFailDataItem - a model defined in OpenAPI
