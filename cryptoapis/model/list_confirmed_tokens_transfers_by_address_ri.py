...
class ListConfirmedTokensTransfersByAddressRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, contract_address, mined_in_block_height, recipient_address, sender_address, token_decimals, token_name, token_symbol, token_type, transaction_hash, transaction_timestamp, transaction_fee, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, contract_address, mined_in_block_height, recipient_address, sender_address, token_decimals, token_name, token_symbol, token_type, transaction_hash, transaction_timestamp, transaction_fee, *args, **kwargs):  # noqa: E501
        """ListConfirmedTokensTransfersByAddressRI - a model defined in OpenAPI
