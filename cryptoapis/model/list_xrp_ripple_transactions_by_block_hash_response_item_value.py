...
class ListXRPRippleTransactionsByBlockHashResponseItemValue(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """ListXRPRippleTransactionsByBlockHashResponseItemValue - a model defined in OpenAPI
