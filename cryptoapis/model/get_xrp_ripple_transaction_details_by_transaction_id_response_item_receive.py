...
class GetXRPRippleTransactionDetailsByTransactionIDResponseItemReceive(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """GetXRPRippleTransactionDetailsByTransactionIDResponseItemReceive - a model defined in OpenAPI
