...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC(ModelNormal):
    ...
    def _from_openapi_data(cls, gas_limit, gas_price, gas_used, input_data, nonce, transaction_status, *args, **kwargs):  # noqa: E501
        """ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC - a model defined in OpenAPI
