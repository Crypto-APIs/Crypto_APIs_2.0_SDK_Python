...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSZ(ModelNormal):
    ...
    def _from_openapi_data(cls, binding_sig, expiry_height, join_split_pub_key, join_split_sig, locktime, overwintered, size, v_join_split, v_shielded_output, v_shielded_spend, value_balance, version, version_group_id, vin, vout, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            v_join_split ([GetTransactionDetailsByTransactionIDRIBSZVJoinSplit]): Represents a sequence of JoinSplit descriptions using BCTV14 proofs.
            ...
            vin ([GetTransactionDetailsByTransactionIDRIBSZVin]): Object Array representation of transaction inputs
