...
class ListConfirmedTransactionsByAddressRIBSBSC(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, gas_limit, gas_price, gas_used, input_data, internal_transactions_count, nonce, token_transfers_count, transaction_status, *args, **kwargs):  # noqa: E501
        """ListConfirmedTransactionsByAddressRIBSBSC - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, gas_limit, gas_price, gas_used, input_data, internal_transactions_count, nonce, token_transfers_count, transaction_status, *args, **kwargs):  # noqa: E501
        """ListConfirmedTransactionsByAddressRIBSBSC - a model defined in OpenAPI
