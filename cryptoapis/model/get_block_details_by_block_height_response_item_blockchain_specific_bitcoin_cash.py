...
class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash(ModelNormal):
    ...
    def __init__(self, difficulty, nonce, size, bits, chainwork, merkle_root, version, version_hex, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash - a model defined in OpenAPI
