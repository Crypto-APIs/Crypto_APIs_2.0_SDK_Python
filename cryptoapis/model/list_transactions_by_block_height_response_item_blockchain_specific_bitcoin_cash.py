...
class ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinCash(ModelNormal):
    ...
    def __init__(self, locktime, size, version, vin, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightResponseItemBlockchainSpecificBitcoinCash - a model defined in OpenAPI

        Args:
            locktime (int): Represents the time at which a particular transaction can be added to the blockchain.
            size (int): Represents the total size of this transaction.
            version (int): Represents the total size of this transaction.
            vin ([ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin]): Represents the transaction inputs.
            vout ([ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout]): Represents the transaction outputs.
