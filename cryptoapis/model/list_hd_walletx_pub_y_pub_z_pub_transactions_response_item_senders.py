...
class ListHDWalletxPubYPubZPubTransactionsResponseItemSenders(ModelNormal):
    ...
    def __init__(self, address, amount, is_member, *args, **kwargs):  # noqa: E501
        """ListHDWalletxPubYPubZPubTransactionsResponseItemSenders - a model defined in OpenAPI
