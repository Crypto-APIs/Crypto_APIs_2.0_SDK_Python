...
class GetInternalTransactionByTransactionHashAndOperationIdE401(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetInternalTransactionByTransactionHashAndOperationIdE401 - a model defined in OpenAPI
