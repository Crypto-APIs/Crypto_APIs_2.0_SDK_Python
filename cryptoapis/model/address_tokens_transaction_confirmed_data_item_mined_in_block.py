...
class AddressTokensTransactionConfirmedDataItemMinedInBlock(ModelNormal):
    ...
    def _from_openapi_data(cls, height, hash, timestamp, *args, **kwargs):  # noqa: E501
        """AddressTokensTransactionConfirmedDataItemMinedInBlock - a model defined in OpenAPI
