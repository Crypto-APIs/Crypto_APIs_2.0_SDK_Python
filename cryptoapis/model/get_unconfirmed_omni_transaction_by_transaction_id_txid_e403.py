...
class GetUnconfirmedOmniTransactionByTransactionIDTxidE403(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetUnconfirmedOmniTransactionByTransactionIDTxidE403 - a model defined in OpenAPI
