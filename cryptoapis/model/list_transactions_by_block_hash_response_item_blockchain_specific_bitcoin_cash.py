...
class ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCash(ModelNormal):
    ...
    def __init__(self, locktime, size, version, vin, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCash - a model defined in OpenAPI
