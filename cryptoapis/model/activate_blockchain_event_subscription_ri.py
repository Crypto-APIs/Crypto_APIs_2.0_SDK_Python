...
class ActivateBlockchainEventSubscriptionRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, blockchain, callback_secret_key, callback_url, confirmations_count, created_timestamp, event_type, is_active, network, reference_id, transaction_id, *args, **kwargs):  # noqa: E501
        """ActivateBlockchainEventSubscriptionRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, blockchain, callback_secret_key, callback_url, confirmations_count, created_timestamp, event_type, is_active, network, reference_id, transaction_id, *args, **kwargs):  # noqa: E501
        """ActivateBlockchainEventSubscriptionRI - a model defined in OpenAPI
