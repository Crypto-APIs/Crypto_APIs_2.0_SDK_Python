...
class GetXRPRippleTransactionDetailsByTransactionIDRIReceive(ModelNormal):
    ...
    def _from_openapi_data(cls, amount, unit, *args, **kwargs):  # noqa: E501
        """GetXRPRippleTransactionDetailsByTransactionIDRIReceive - a model defined in OpenAPI
