...
class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightResponseItemBlockchainSpecific - a model defined in OpenAPI
