...
class GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders - a model defined in OpenAPI
