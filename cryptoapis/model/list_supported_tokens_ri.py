...
class ListSupportedTokensRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, decimals, identifier, name, symbol, type, *args, **kwargs):  # noqa: E501
        """ListSupportedTokensRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, decimals, identifier, name, symbol, type, *args, **kwargs):  # noqa: E501
        """ListSupportedTokensRI - a model defined in OpenAPI
