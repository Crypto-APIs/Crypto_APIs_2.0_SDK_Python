...
class GetWalletTransactionDetailsByTransactionIDRIRecipientsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetWalletTransactionDetailsByTransactionIDRIRecipientsInner - a model defined in OpenAPI
