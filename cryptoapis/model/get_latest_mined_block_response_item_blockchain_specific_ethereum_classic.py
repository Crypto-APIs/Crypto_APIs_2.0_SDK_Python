...
class GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic(ModelNormal):
    ...
    def __init__(self, difficulty, nonce, size, extra_data, gas_limit, gas_used, mined_in_seconds, sha3_uncles, total_difficulty, *args, **kwargs):  # noqa: E501
        """GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic - a model defined in OpenAPI
