...
class CreateFungibleTokensTransactionRequestFromAddressRBDataItem(ModelNormal):
    ...
    def _from_openapi_data(cls, amount, fee_priority, recipient_address, token_identifier, *args, **kwargs):  # noqa: E501
        """CreateFungibleTokensTransactionRequestFromAddressRBDataItem - a model defined in OpenAPI
