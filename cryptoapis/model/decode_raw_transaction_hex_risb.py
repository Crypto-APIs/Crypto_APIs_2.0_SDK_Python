...
class DecodeRawTransactionHexRISB(ModelNormal):
    ...
    def _from_openapi_data(cls, locktime, transaction_hash, v_size, version, vin, vout, *args, **kwargs):  # noqa: E501
        """DecodeRawTransactionHexRISB - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            weight (int): Represents the size of Bitcoin block, measured in weight units and including the segwit discount.. [optional]  # noqa: E501
        """
