...
def lazy_import():
    ...
    globals()['TransactionRequestFailData'] = TransactionRequestFailData


class TransactionRequestFail(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (TransactionRequestFailData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, api_version, reference_id, idempotency_key, data, *args, **kwargs):  # noqa: E501
        """TransactionRequestFail - a model defined in OpenAPI
        ...
        Args:
            ...
            data (TransactionRequestFailData):
