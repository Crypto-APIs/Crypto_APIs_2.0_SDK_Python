...
class GetBlockchainEventSubscriptionDetailsByReferenceIDRI(ModelNormal):
    ...
    attribute_map = {
        ...
        'deactivation_reasons': 'deactivationReasons',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, callback_url, created_timestamp, event_type, is_active, network, reference_id, *args, **kwargs):  # noqa: E501
        """GetBlockchainEventSubscriptionDetailsByReferenceIDRI - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            address (str): Represents the address of the transaction.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, callback_url, created_timestamp, event_type, is_active, network, reference_id, *args, **kwargs):  # noqa: E501
        """GetBlockchainEventSubscriptionDetailsByReferenceIDRI - a model defined in OpenAPI
