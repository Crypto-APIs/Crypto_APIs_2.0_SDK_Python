...
def lazy_import():
    ...
    globals()['TransactionMinedData'] = TransactionMinedData


class TransactionMined(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (TransactionMinedData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, api_version, reference_id, idempotency_key, data, *args, **kwargs):  # noqa: E501
        """TransactionMined - a model defined in OpenAPI
