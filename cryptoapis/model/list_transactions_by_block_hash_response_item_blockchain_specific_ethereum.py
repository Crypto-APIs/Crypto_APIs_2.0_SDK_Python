...
class ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum(ModelNormal):
    ...
    def __init__(self, contract, gas_limit, gas_price, gas_used, input_data, nonce, transaction_status, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum - a model defined in OpenAPI
