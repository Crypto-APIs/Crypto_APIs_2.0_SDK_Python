...
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey(ModelNormal):
    ...
    def __init__(self, addresses, asm, hex, req_sigs, type, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey - a model defined in OpenAPI
