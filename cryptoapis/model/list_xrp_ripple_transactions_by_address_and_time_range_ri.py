...
class ListXRPRippleTransactionsByAddressAndTimeRangeRI(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (str,),  # noqa: E501
            'fee': (ListXRPRippleTransactionsByAddressRIFee,),  # noqa: E501
    ...
    def _from_openapi_data(cls, index, mined_in_block_hash, mined_in_block_height, recipients, senders, sequence, status, timestamp, transaction_hash, type, fee, offer, receive, value, *args, **kwargs):  # noqa: E501
        """ListXRPRippleTransactionsByAddressAndTimeRangeRI - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            destination_tag (int): A destination tag is a value used to discern the holder of the Ripple (XRP) being deposited or withdrawn.. [optional]  # noqa: E501
        """
