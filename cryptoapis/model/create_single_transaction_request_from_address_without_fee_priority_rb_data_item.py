...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, recipient_address, *args, **kwargs):  # noqa: E501
        """CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, recipient_address, *args, **kwargs):  # noqa: E501
        """CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem - a model defined in OpenAPI
