...
def lazy_import():
    ...
    globals()['TokensForwardingFailData'] = TokensForwardingFailData


class TokensForwardingFail(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (TokensForwardingFailData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, api_version, reference_id, idempotency_key, data, *args, **kwargs):  # noqa: E501
        """TokensForwardingFail - a model defined in OpenAPI
