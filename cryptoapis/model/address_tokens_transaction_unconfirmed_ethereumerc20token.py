...
class AddressTokensTransactionUnconfirmedEthereumerc20token(ModelNormal):
    ...
    def _from_openapi_data(cls, name, symbol, amount, contract_address, *args, **kwargs):  # noqa: E501
        """AddressTokensTransactionUnconfirmedEthereumerc20token - a model defined in OpenAPI
