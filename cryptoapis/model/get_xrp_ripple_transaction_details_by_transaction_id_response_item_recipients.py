...
class GetXRPRippleTransactionDetailsByTransactionIDResponseItemRecipients(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """GetXRPRippleTransactionDetailsByTransactionIDResponseItemRecipients - a model defined in OpenAPI
