...
class ListWalletTransactionsRIValue(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, converted_amount, exchange_rate_unit, symbol, *args, **kwargs):  # noqa: E501
        """ListWalletTransactionsRIValue - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, converted_amount, exchange_rate_unit, symbol, *args, **kwargs):  # noqa: E501
        """ListWalletTransactionsRIValue - a model defined in OpenAPI
