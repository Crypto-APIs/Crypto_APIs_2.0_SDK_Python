...
class ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig(ModelNormal):
    ...
    def __init__(self, asm, hex, type, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig - a model defined in OpenAPI
