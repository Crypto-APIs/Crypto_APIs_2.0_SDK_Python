...
class GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalCoins(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalCoins - a model defined in OpenAPI
