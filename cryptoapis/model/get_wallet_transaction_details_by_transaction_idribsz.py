...
class GetWalletTransactionDetailsByTransactionIDRIBSZ(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, binding_sig, expiry_height, join_split_pub_key, join_split_sig, locktime, overwintered, size, value_balance, version, version_group_id, vin, vout, *args, **kwargs):  # noqa: E501
        """GetWalletTransactionDetailsByTransactionIDRIBSZ - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, binding_sig, expiry_height, join_split_pub_key, join_split_sig, locktime, overwintered, size, value_balance, version, version_group_id, vin, vout, *args, **kwargs):  # noqa: E501
        """GetWalletTransactionDetailsByTransactionIDRIBSZ - a model defined in OpenAPI
