...
def lazy_import():
    ...
    globals()['BlockHeightReachedData'] = BlockHeightReachedData


class BlockHeightReached(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (BlockHeightReachedData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, api_version, reference_id, idempotency_key, data, *args, **kwargs):  # noqa: E501
        """BlockHeightReached - a model defined in OpenAPI
