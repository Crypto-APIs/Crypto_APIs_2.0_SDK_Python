...
class ListInternalTransactionDetailsByTransactionHashRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, block_hash, block_height, operation_id, operation_type, parent_hash, recipient, sender, timestamp, *args, **kwargs):  # noqa: E501
        """ListInternalTransactionDetailsByTransactionHashRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, block_hash, block_height, operation_id, operation_type, parent_hash, recipient, sender, timestamp, *args, **kwargs):  # noqa: E501
        """ListInternalTransactionDetailsByTransactionHashRI - a model defined in OpenAPI
