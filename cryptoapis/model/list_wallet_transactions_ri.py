...
class ListWalletTransactionsRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, direction, fee, recipients, senders, status, timestamp, transaction_id, value, *args, **kwargs):  # noqa: E501
        """ListWalletTransactionsRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, direction, fee, recipients, senders, status, timestamp, transaction_id, value, *args, **kwargs):  # noqa: E501
        """ListWalletTransactionsRI - a model defined in OpenAPI
