...
class BlockHeightReachedDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, network, height, hash, timestamp, *args, **kwargs):  # noqa: E501
        """BlockHeightReachedDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, network, height, hash, timestamp, *args, **kwargs):  # noqa: E501
        """BlockHeightReachedDataItem - a model defined in OpenAPI
