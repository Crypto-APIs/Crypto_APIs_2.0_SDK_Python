...
class ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassicGasPrice(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassicGasPrice - a model defined in OpenAPI
