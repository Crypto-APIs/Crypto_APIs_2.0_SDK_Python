...
class ListUnconfirmedOmniTransactionsByAddressRISendersInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """ListUnconfirmedOmniTransactionsByAddressRISendersInner - a model defined in OpenAPI
