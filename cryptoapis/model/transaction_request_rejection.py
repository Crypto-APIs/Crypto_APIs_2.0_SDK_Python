...
def lazy_import():
    ...
    globals()['TransactionRequestRejectionData'] = TransactionRequestRejectionData


class TransactionRequestRejection(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (TransactionRequestRejectionData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, api_version, reference_id, idempotency_key, data, *args, **kwargs):  # noqa: E501
        """TransactionRequestRejection - a model defined in OpenAPI
