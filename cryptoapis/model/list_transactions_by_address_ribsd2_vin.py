...
def lazy_import():
    ...
    globals()['ListTransactionsByAddressRIBSD2ScriptSig'] = ListTransactionsByAddressRIBSD2ScriptSig


class ListTransactionsByAddressRIBSD2Vin(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'script_sig': (ListTransactionsByAddressRIBSD2ScriptSig,),  # noqa: E501
    ...
    def _from_openapi_data(cls, addresses, script_sig, sequence, txinwitness, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressRIBSD2Vin - a model defined in OpenAPI

        Args:
            addresses ([str]):
            script_sig (ListTransactionsByAddressRIBSD2ScriptSig):
