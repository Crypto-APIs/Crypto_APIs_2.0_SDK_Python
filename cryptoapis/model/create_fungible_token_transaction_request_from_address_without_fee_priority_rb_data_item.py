...
class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRBDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, fee_limit, recipient_address, token_identifier, *args, **kwargs):  # noqa: E501
        """CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRBDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, fee_limit, recipient_address, token_identifier, *args, **kwargs):  # noqa: E501
        """CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRBDataItem - a model defined in OpenAPI
