...
class ListZilliqaTransactionsByAddressRI(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'fee': (GetZilliqaTransactionDetailsByTransactionIDRIFee,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fee, gas_limit, gas_price, gas_used, mined_in_block_hash, mined_in_block_height, nonce, recipients, senders, timestamp, transaction_hash, transaction_index, transaction_status, *args, **kwargs):  # noqa: E501
        """ListZilliqaTransactionsByAddressRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fee, gas_limit, gas_price, gas_used, mined_in_block_hash, mined_in_block_height, nonce, recipients, senders, timestamp, transaction_hash, transaction_index, transaction_status, *args, **kwargs):  # noqa: E501
        """ListZilliqaTransactionsByAddressRI - a model defined in OpenAPI
