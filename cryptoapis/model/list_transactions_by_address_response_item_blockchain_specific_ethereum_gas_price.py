...
class ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressResponseItemBlockchainSpecificEthereumGasPrice - a model defined in OpenAPI
