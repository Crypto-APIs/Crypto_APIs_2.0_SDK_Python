...
def lazy_import():
    ...
    globals()['ListTransactionsByBlockHeightRIBSLScriptSig'] = ListTransactionsByBlockHeightRIBSLScriptSig


class ListTransactionsByBlockHeightRIBSLVin(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'script_sig': (ListTransactionsByBlockHeightRIBSLScriptSig,),  # noqa: E501
    ...
    def _from_openapi_data(cls, addresses, script_sig, sequence, txid, txinwitness, value, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightRIBSLVin - a model defined in OpenAPI

        Args:
            addresses ([str]):
            script_sig (ListTransactionsByBlockHeightRIBSLScriptSig):
