...
class GetTransactionDetailsByTransactionIDFromCallbackRIRecipientsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIRecipientsInner - a model defined in OpenAPI
