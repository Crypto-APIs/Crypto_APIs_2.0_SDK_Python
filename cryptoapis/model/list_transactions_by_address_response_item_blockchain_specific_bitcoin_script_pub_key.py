...
class ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinScriptPubKey(ModelNormal):
    ...
    def __init__(self, addresses, asm, hex, req_sigs, type, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinScriptPubKey - a model defined in OpenAPI
