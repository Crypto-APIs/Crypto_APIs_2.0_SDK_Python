...
class ListUnconfirmedTransactionsByAddressRIBSBSC(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, gas_limit, gas_price, input_data, nonce, transaction_status, *args, **kwargs):  # noqa: E501
        """ListUnconfirmedTransactionsByAddressRIBSBSC - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, gas_limit, gas_price, input_data, nonce, transaction_status, *args, **kwargs):  # noqa: E501
        """ListUnconfirmedTransactionsByAddressRIBSBSC - a model defined in OpenAPI
