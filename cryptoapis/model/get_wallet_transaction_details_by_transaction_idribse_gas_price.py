...
class GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice(ModelNormal):
    ...
    def _from_openapi_data(cls, amount, unit, *args, **kwargs):  # noqa: E501
        """GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice - a model defined in OpenAPI
