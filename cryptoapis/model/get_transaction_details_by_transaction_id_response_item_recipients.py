...
class GetTransactionDetailsByTransactionIDResponseItemRecipients(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDResponseItemRecipients - a model defined in OpenAPI
