...
class GetBlockDetailsByBlockHashResponseItemBlockchainSpecific(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHashResponseItemBlockchainSpecific - a model defined in OpenAPI
