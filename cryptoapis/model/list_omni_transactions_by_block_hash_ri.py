...
class ListOmniTransactionsByBlockHashRI(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'fee': (ListOmniTransactionsByBlockHashRIFee,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, amount, divisible, mined_in_block_hash, mined_in_block_height, position_in_block, property_id, recipients, senders, timestamp, transaction_id, type, type_int, valid, version, fee, *args, **kwargs):  # noqa: E501
        """ListOmniTransactionsByBlockHashRI - a model defined in OpenAPI
        ...
        Args:
            ...
            fee (ListOmniTransactionsByBlockHashRIFee):
