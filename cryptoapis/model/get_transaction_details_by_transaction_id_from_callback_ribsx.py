...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSX(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, additional_data, offer, receive, sequence, status, type, value, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSX - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, additional_data, offer, receive, sequence, status, type, value, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSX - a model defined in OpenAPI
