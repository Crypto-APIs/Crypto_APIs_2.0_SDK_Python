...
class ListBlockchainEventsSubscriptionsRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, callback_url, confirmations_count, created_timestamp, event_type, is_active, reference_id, *args, **kwargs):  # noqa: E501
        """ListBlockchainEventsSubscriptionsRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, callback_url, confirmations_count, created_timestamp, event_type, is_active, reference_id, *args, **kwargs):  # noqa: E501
        """ListBlockchainEventsSubscriptionsRI - a model defined in OpenAPI
