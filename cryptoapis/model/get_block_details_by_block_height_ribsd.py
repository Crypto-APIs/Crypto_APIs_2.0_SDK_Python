...
class GetBlockDetailsByBlockHeightRIBSD(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, difficulty, bits, chainwork, merkle_root, nonce, size, stripped_size, version, weight, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, difficulty, bits, chainwork, merkle_root, nonce, size, stripped_size, version, weight, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightRIBSD - a model defined in OpenAPI
