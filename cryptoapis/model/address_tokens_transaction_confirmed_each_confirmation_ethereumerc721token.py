...
class AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, symbol, token_id, contract_address, *args, **kwargs):  # noqa: E501
        """AddressTokensTransactionConfirmedEachConfirmationEthereumerc721token - a model defined in OpenAPI
