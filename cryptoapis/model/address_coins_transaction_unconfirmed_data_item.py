...
class AddressCoinsTransactionUnconfirmedDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, network, address, transaction_id, amount, unit, direction, first_seen_in_mempool_timestamp, *args, **kwargs):  # noqa: E501
        """AddressCoinsTransactionUnconfirmedDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, network, address, transaction_id, amount, unit, direction, first_seen_in_mempool_timestamp, *args, **kwargs):  # noqa: E501
        """AddressCoinsTransactionUnconfirmedDataItem - a model defined in OpenAPI
