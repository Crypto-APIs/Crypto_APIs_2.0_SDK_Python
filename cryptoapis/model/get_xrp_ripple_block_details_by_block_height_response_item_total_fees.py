...
class GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalFees(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """GetXRPRippleBlockDetailsByBlockHeightResponseItemTotalFees - a model defined in OpenAPI
