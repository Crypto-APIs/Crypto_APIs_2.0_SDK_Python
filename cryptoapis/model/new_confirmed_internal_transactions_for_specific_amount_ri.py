...
class NewConfirmedInternalTransactionsForSpecificAmountRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount_higher_than, callback_url, created_timestamp, event_type, is_active, reference_id, *args, **kwargs):  # noqa: E501
        """NewConfirmedInternalTransactionsForSpecificAmountRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount_higher_than, callback_url, created_timestamp, event_type, is_active, reference_id, *args, **kwargs):  # noqa: E501
        """NewConfirmedInternalTransactionsForSpecificAmountRI - a model defined in OpenAPI
