...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSTEnergyUsed(ModelNormal):
    ...
    def _from_openapi_data(cls, amount, unit, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSTEnergyUsed - a model defined in OpenAPI
