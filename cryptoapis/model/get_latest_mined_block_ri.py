...
def lazy_import():
    ...
    globals()['GetLatestMinedBlockRIBS'] = GetLatestMinedBlockRIBS


class GetLatestMinedBlockRI(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'blockchain_specific': (GetLatestMinedBlockRIBS,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, hash, height, previous_block_hash, timestamp, transactions_count, blockchain_specific, *args, **kwargs):  # noqa: E501
        """GetLatestMinedBlockRI - a model defined in OpenAPI
        ...
        Args:
            ...
            blockchain_specific (GetLatestMinedBlockRIBS):
