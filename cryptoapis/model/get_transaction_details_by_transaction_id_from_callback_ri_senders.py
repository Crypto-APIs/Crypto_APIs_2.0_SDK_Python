...
class GetTransactionDetailsByTransactionIDFromCallbackRISenders(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRISenders - a model defined in OpenAPI
