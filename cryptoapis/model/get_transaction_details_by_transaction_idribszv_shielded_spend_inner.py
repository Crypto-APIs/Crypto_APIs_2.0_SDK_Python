...
class GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner(ModelNormal):
    ...
    def _from_openapi_data(cls, anchor, cv, nullifier, proof, rk, spend_auth_sig, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner - a model defined in OpenAPI
