...
class ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig(ModelNormal):
    ...
    def __init__(self, asm, hex, type, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptSig - a model defined in OpenAPI
