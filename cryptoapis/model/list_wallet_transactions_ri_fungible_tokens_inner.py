...
class ListWalletTransactionsRIFungibleTokensInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, converted_amount, exchange_rate_unit, name, recipient, sender, symbol, token_decimals, type, *args, **kwargs):  # noqa: E501
        """ListWalletTransactionsRIFungibleTokensInner - a model defined in OpenAPI
        ...
        self.exchange_rate_unit = exchange_rate_unit
        self.name = name
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, converted_amount, exchange_rate_unit, name, recipient, sender, symbol, token_decimals, type, *args, **kwargs):  # noqa: E501
        """ListWalletTransactionsRIFungibleTokensInner - a model defined in OpenAPI
