...
class ListXRPRippleTransactionsByBlockHashResponseItemOffer(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """ListXRPRippleTransactionsByBlockHashResponseItemOffer - a model defined in OpenAPI
