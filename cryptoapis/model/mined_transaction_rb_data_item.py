...
class MinedTransactionRBDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, callback_url, transaction_id, *args, **kwargs):  # noqa: E501
        """MinedTransactionRBDataItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            allow_duplicates (bool): Specifies a flag that permits or denies the creation of duplicate addresses.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, callback_url, transaction_id, *args, **kwargs):  # noqa: E501
        """MinedTransactionRBDataItem - a model defined in OpenAPI
