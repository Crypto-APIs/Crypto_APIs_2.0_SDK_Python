...
class NewBlockRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, callback_secret_key, callback_url, created_timestamp, is_active, reference_id, *args, **kwargs):  # noqa: E501
        """NewBlockRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, callback_secret_key, callback_url, created_timestamp, is_active, reference_id, *args, **kwargs):  # noqa: E501
        """NewBlockRI - a model defined in OpenAPI
