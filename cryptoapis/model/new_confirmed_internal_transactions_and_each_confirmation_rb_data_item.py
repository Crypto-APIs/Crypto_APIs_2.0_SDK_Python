...
class NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, callback_secret_key, callback_url, confirmations_count, *args, **kwargs):  # noqa: E501
        """NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem - a model defined in OpenAPI
        ...
        Keyword Args:
            allow_duplicates (bool): Specifies a flag that permits or denies the creation of duplicate addresses.. defaults to False  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, callback_secret_key, callback_url, confirmations_count, *args, **kwargs):  # noqa: E501
        """NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem - a model defined in OpenAPI
