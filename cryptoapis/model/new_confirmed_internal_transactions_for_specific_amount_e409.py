...
class NewConfirmedInternalTransactionsForSpecificAmountE409(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NewConfirmedInternalTransactionsForSpecificAmountE409 - a model defined in OpenAPI
