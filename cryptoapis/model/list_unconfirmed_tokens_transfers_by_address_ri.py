...
class ListUnconfirmedTokensTransfersByAddressRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, contract_address, recipient_address, sender_address, token_decimals, token_name, token_symbol, token_type, transaction_hash, transaction_timestamp, *args, **kwargs):  # noqa: E501
        """ListUnconfirmedTokensTransfersByAddressRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, contract_address, recipient_address, sender_address, token_decimals, token_name, token_symbol, token_type, transaction_hash, transaction_timestamp, *args, **kwargs):  # noqa: E501
        """ListUnconfirmedTokensTransfersByAddressRI - a model defined in OpenAPI
