...
class ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig(ModelNormal):
    ...
    def __init__(self, asm, hex, type, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig - a model defined in OpenAPI
