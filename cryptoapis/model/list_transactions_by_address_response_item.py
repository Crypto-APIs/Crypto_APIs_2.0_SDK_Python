...
class ListTransactionsByAddressResponseItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'fee': (GetTransactionDetailsByTransactionIDResponseItemFee,),  # noqa: E501
            'blockchain_specific': (ListTransactionsByAddressResponseItemBlockchainSpecific,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, index, recipients, senders, timestamp, transaction_hash, transaction_id, fee, blockchain_specific, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressResponseItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            mined_in_block_hash (str): Represents the hash of the block where this transaction was mined/confirmed for first time. The hash is defined as a cryptographic digital fingerprint made by hashing the block header twice through the SHA256 algorithm.. [optional]  # noqa: E501
            mined_in_block_height (int): Represents the hight of the block where this transaction was mined/confirmed for first time. The height is defined as the number of blocks in the blockchain preceding this specific block.. [optional]  # noqa: E501
        """
