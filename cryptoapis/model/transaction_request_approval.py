...
def lazy_import():
    ...
    globals()['TransactionRequestApprovalData'] = TransactionRequestApprovalData


class TransactionRequestApproval(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (TransactionRequestApprovalData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, api_version, reference_id, idempotency_key, data, *args, **kwargs):  # noqa: E501
        """TransactionRequestApproval - a model defined in OpenAPI
