...
class TransactionRequestApproveDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, network, required_approves, required_rejects, current_approves, current_rejects, *args, **kwargs):  # noqa: E501
        """TransactionRequestApproveDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, network, required_approves, required_rejects, current_approves, current_rejects, *args, **kwargs):  # noqa: E501
        """TransactionRequestApproveDataItem - a model defined in OpenAPI
