...
class CreateFungibleTokensTransactionRequestFromAddressE409(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CreateFungibleTokensTransactionRequestFromAddressE409 - a model defined in OpenAPI
