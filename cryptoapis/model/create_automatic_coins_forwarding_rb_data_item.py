...
class CreateAutomaticCoinsForwardingRBDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, callback_secret_key, callback_url, confirmations_count, fee_priority, minimum_transfer_amount, to_address, *args, **kwargs):  # noqa: E501
        """CreateAutomaticCoinsForwardingRBDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, callback_secret_key, callback_url, confirmations_count, fee_priority, minimum_transfer_amount, to_address, *args, **kwargs):  # noqa: E501
        """CreateAutomaticCoinsForwardingRBDataItem - a model defined in OpenAPI
