...
class ListLatestMinedBlocksRData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'limit': (int,),  # noqa: E501
            'total': (int,),  # noqa: E501
            'items': ([ListLatestMinedBlocksRI],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, offset, limit, total, items, *args, **kwargs):  # noqa: E501
        """ListLatestMinedBlocksRData - a model defined in OpenAPI

        Args:
            offset (int): The starting index of the response items, i.e. where the response should start listing the returned items.
            limit (int): Defines how many items should be returned in the response per page basis.
            total (int): Defines the total number of items returned in the response.
            items ([ListLatestMinedBlocksRI]):
