...
class GenerateAddressRIAddresses(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, format, *args, **kwargs):  # noqa: E501
        """GenerateAddressRIAddresses - a model defined in OpenAPI

        Args:
            address (str): Represents the specific address that will be generated.
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, format, *args, **kwargs):  # noqa: E501
        """GenerateAddressRIAddresses - a model defined in OpenAPI
