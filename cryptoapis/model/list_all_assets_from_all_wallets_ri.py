...
class ListAllAssetsFromAllWalletsRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, coins, fungible_tokens, non_fungible_tokens, wallet_id, wallet_name, *args, **kwargs):  # noqa: E501
        """ListAllAssetsFromAllWalletsRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, coins, fungible_tokens, non_fungible_tokens, wallet_id, wallet_name, *args, **kwargs):  # noqa: E501
        """ListAllAssetsFromAllWalletsRI - a model defined in OpenAPI
