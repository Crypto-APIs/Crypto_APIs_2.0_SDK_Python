...
class GetOmniTransactionDetailsByTransactionIDTxidResponseItemSenders(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """GetOmniTransactionDetailsByTransactionIDTxidResponseItemSenders - a model defined in OpenAPI
