...
class ListXRPRippleTransactionsByBlockHashResponseItemReceive(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """ListXRPRippleTransactionsByBlockHashResponseItemReceive - a model defined in OpenAPI
