...
class CreateCoinsTransactionFromAddressForWholeAmountRBDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fee_priority, recipient_address, *args, **kwargs):  # noqa: E501
        """CreateCoinsTransactionFromAddressForWholeAmountRBDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fee_priority, recipient_address, *args, **kwargs):  # noqa: E501
        """CreateCoinsTransactionFromAddressForWholeAmountRBDataItem - a model defined in OpenAPI
