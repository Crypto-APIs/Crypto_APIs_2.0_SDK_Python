...
class ListTransactionsByAddressResponseItemBlockchainSpecificDash(ModelNormal):
    ...
    def __init__(self, locktime, size, version, vin, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressResponseItemBlockchainSpecificDash - a model defined in OpenAPI

        Args:
            locktime (int): Represents the locktime on the transaction on the specific blockchain, i.e. the blockheight at which the transaction is valid.
            size (int): Represents the total size of this transaction.
            version (int): Represents the transaction's version number.
            vin ([ListTransactionsByAddressResponseItemBlockchainSpecificDashVin]): Represents the transaction inputs.
            vout ([ListTransactionsByAddressResponseItemBlockchainSpecificDashVout]): Represents the transaction outputs.
