...
class ListUnconfirmedOmniTransactionsByAddressResponseItemSenders(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """ListUnconfirmedOmniTransactionsByAddressResponseItemSenders - a model defined in OpenAPI
