...
class ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, amount, is_member, *args, **kwargs):  # noqa: E501
        """ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, amount, is_member, *args, **kwargs):  # noqa: E501
        """ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner - a model defined in OpenAPI
