...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSP(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, contract, gas, gas_price, gas_used, input, nonce, recipients, senders, transaction_status, txid, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSP - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, contract, gas, gas_price, gas_used, input, nonce, recipients, senders, transaction_status, txid, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSP - a model defined in OpenAPI
