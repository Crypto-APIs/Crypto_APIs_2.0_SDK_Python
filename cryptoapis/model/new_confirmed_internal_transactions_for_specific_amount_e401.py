...
class NewConfirmedInternalTransactionsForSpecificAmountE401(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NewConfirmedInternalTransactionsForSpecificAmountE401 - a model defined in OpenAPI
