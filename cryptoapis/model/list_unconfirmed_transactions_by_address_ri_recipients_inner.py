...
class ListUnconfirmedTransactionsByAddressRIRecipientsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """ListUnconfirmedTransactionsByAddressRIRecipientsInner - a model defined in OpenAPI
