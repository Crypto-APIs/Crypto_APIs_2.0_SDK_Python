...
class GetWalletTransactionDetailsByTransactionIDRISendersInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetWalletTransactionDetailsByTransactionIDRISendersInner - a model defined in OpenAPI
