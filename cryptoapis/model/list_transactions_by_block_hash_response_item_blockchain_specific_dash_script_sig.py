...
class ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptSig(ModelNormal):
    ...
    def __init__(self, asm, hex, type, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptSig - a model defined in OpenAPI
