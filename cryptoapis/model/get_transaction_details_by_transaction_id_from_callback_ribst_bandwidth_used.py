...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSTBandwidthUsed(ModelNormal):
    ...
    def _from_openapi_data(cls, amount, unit, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSTBandwidthUsed - a model defined in OpenAPI
