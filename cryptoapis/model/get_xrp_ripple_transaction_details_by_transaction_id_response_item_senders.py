...
class GetXRPRippleTransactionDetailsByTransactionIDResponseItemSenders(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """GetXRPRippleTransactionDetailsByTransactionIDResponseItemSenders - a model defined in OpenAPI
