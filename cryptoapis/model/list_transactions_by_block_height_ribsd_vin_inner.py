...
class ListTransactionsByBlockHeightRIBSDVinInner(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'script_sig': (ListTransactionsByBlockHeightRIBSDVinInnerScriptSig,),  # noqa: E501
    ...
    def _from_openapi_data(cls, addresses, coinbase, script_sig, sequence, txinwitness, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightRIBSDVinInner - a model defined in OpenAPI

        Args:
            addresses ([str]):
            coinbase (str): Represents the coinbase hex.
            script_sig (ListTransactionsByBlockHeightRIBSDVinInnerScriptSig):
