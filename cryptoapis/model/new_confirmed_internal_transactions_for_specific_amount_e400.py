...
class NewConfirmedInternalTransactionsForSpecificAmountE400(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NewConfirmedInternalTransactionsForSpecificAmountE400 - a model defined in OpenAPI
