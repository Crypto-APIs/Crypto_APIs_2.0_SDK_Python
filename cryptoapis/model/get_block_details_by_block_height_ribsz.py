...
class GetBlockDetailsByBlockHeightRIBSZ(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, difficulty, bits, chainwork, merkle_root, nonce, size, version, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightRIBSZ - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, difficulty, bits, chainwork, merkle_root, nonce, size, version, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightRIBSZ - a model defined in OpenAPI
