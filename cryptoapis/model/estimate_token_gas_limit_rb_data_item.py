...
class EstimateTokenGasLimitRBDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, contract, contract_type, recipient, sender, *args, **kwargs):  # noqa: E501
        """EstimateTokenGasLimitRBDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, contract, contract_type, recipient, sender, *args, **kwargs):  # noqa: E501
        """EstimateTokenGasLimitRBDataItem - a model defined in OpenAPI
