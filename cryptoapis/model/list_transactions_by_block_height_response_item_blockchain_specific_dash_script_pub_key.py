...
class ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey(ModelNormal):
    ...
    def __init__(self, addresses, asm, hex, req_sigs, type, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashScriptPubKey - a model defined in OpenAPI
