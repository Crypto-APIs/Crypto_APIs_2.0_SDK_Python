...
class GetHDWalletXPubYPubZPubAssetsRIFungibleTokensInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, identifier, symbol, type, *args, **kwargs):  # noqa: E501
        """GetHDWalletXPubYPubZPubAssetsRIFungibleTokensInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, identifier, symbol, type, *args, **kwargs):  # noqa: E501
        """GetHDWalletXPubYPubZPubAssetsRIFungibleTokensInner - a model defined in OpenAPI
