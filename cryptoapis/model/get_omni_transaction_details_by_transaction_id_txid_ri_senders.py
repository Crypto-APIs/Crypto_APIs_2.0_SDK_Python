...
class GetOmniTransactionDetailsByTransactionIDTxidRISenders(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetOmniTransactionDetailsByTransactionIDTxidRISenders - a model defined in OpenAPI
