...
class GetTransactionDetailsByTransactionIDFromCallbackRIFee(ModelNormal):
    ...
    def _from_openapi_data(cls, amount, unit, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIFee - a model defined in OpenAPI
