...
class ListUnspentTransactionOutputsByAddressRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address, amount, index, is_confirmed, timestamp, transaction_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, address, amount, index, is_confirmed, timestamp, transaction_id, *args, **kwargs):  # noqa: E501
        """ListUnspentTransactionOutputsByAddressRI - a model defined in OpenAPI
