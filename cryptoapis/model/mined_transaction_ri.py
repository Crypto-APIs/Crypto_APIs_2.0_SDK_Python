...
class MinedTransactionRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, callback_secret_key, callback_url, created_timestamp, event_type, is_active, reference_id, transaction_id, *args, **kwargs):  # noqa: E501
        """MinedTransactionRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, callback_secret_key, callback_url, created_timestamp, event_type, is_active, reference_id, transaction_id, *args, **kwargs):  # noqa: E501
        """MinedTransactionRI - a model defined in OpenAPI
