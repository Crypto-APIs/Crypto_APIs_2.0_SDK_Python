...
class TransactionRequestFailDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, network, required_approvals, required_rejections, current_approvals, current_rejections, error_message, *args, **kwargs):  # noqa: E501
        """TransactionRequestFailDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, network, required_approvals, required_rejections, current_approvals, current_rejections, error_message, *args, **kwargs):  # noqa: E501
        """TransactionRequestFailDataItem - a model defined in OpenAPI
