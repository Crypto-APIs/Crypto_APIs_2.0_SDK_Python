...
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey(ModelNormal):
    ...
    def __init__(self, addresses, asm, hex, req_sigs, type, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashScriptPubKey - a model defined in OpenAPI
