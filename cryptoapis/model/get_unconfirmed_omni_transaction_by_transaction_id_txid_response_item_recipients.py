...
class GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemRecipients - a model defined in OpenAPI
