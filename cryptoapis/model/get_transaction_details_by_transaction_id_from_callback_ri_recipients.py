...
class GetTransactionDetailsByTransactionIDFromCallbackRIRecipients(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIRecipients - a model defined in OpenAPI
