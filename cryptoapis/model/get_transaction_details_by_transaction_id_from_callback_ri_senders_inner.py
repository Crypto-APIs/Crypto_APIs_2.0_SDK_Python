...
class GetTransactionDetailsByTransactionIDFromCallbackRISendersInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRISendersInner - a model defined in OpenAPI
