...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, unit, *args, **kwargs):  # noqa: E501
        """CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner - a model defined in OpenAPI
