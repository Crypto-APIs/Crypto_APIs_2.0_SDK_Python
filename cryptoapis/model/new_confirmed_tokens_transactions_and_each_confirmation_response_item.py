...
class NewConfirmedTokensTransactionsAndEachConfirmationResponseItem(ModelNormal):
    ...
    def __init__(self, address, callback_url, created_timestamp, event_type, reference_id, *args, **kwargs):  # noqa: E501
        """NewConfirmedTokensTransactionsAndEachConfirmationResponseItem - a model defined in OpenAPI
