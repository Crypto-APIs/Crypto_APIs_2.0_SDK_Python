...
class ListTransactionsByBlockHashResponseItemBlockchainSpecificDash(ModelNormal):
    ...
    def __init__(self, locktime, size, version, vin, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHashResponseItemBlockchainSpecificDash - a model defined in OpenAPI

        Args:
            locktime (int): Represents the time at which a particular transaction can be added to the blockchain.
            size (int): Represents the total size of this transaction.
            version (int): Represents transaction version number.
            vin ([ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVin]): Represents the transaction inputs.
            vout ([ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVout]): Represents the transaction outputs.
