...
class GetLatestMinedXRPRippleBlockRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, block_hash, block_height, previous_block_hash, timestamp, transactions_count, total_coins, total_fees, *args, **kwargs):  # noqa: E501
        """GetLatestMinedXRPRippleBlockRI - a model defined in OpenAPI
