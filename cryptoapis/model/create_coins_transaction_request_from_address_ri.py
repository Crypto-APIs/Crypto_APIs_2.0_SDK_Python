...
class CreateCoinsTransactionRequestFromAddressRI(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'recipients': ([CreateCoinsTransactionRequestFromAddressRIRecipientsInner],),  # noqa: E501
    ...
    def _from_openapi_data(cls, fee_priority, recipients, senders, transaction_request_id, transaction_request_status, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            recipients ([CreateCoinsTransactionRequestFromAddressRIRecipientsInner]): Defines the destination for the transaction, i.e. the recipient(s).
