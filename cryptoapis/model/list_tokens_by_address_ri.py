...
class ListTokensByAddressRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, confirmed_balance, contract_address, name, symbol, type, *args, **kwargs):  # noqa: E501
        """ListTokensByAddressRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, confirmed_balance, contract_address, name, symbol, type, *args, **kwargs):  # noqa: E501
        """ListTokensByAddressRI - a model defined in OpenAPI
