...
class ListTransactionsByBlockHeight400Response(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'error': (ListTransactionsByBlockHeightE400,),  # noqa: E501
    ...
    def _from_openapi_data(cls, api_version, request_id, error, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeight400Response - a model defined in OpenAPI

        Args:
            api_version (str): Specifies the version of the API that incorporates this endpoint.
            request_id (str): Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
            error (ListTransactionsByBlockHeightE400):
