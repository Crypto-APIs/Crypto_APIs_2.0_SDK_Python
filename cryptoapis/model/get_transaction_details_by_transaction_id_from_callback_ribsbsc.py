...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC(ModelNormal):
    ...
    def _from_openapi_data(cls, contract, gas_limit, gas_price, gas_used, input_data, nonce, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC - a model defined in OpenAPI
