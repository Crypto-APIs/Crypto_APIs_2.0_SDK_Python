...
class NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem(ModelNormal):
    ...
    def __init__(self, address, callback_url, confirmations_count, *args, **kwargs):  # noqa: E501
        """NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem - a model defined in OpenAPI
