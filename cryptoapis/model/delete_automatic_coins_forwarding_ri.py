...
class DeleteAutomaticCoinsForwardingRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, callback_url, confirmations_count, created_timestamp, fee_priority, from_address, minimum_transfer_amount, reference_id, to_address, *args, **kwargs):  # noqa: E501
        """DeleteAutomaticCoinsForwardingRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, callback_url, confirmations_count, created_timestamp, fee_priority, from_address, minimum_transfer_amount, reference_id, to_address, *args, **kwargs):  # noqa: E501
        """DeleteAutomaticCoinsForwardingRI - a model defined in OpenAPI
