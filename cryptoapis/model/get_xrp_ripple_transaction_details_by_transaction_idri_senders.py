...
class GetXRPRippleTransactionDetailsByTransactionIDRISenders(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetXRPRippleTransactionDetailsByTransactionIDRISenders - a model defined in OpenAPI
