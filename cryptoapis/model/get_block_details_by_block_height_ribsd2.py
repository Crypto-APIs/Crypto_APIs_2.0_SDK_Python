...
class GetBlockDetailsByBlockHeightRIBSD2(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, difficulty, bits, chainwork, merkle_root, nonce, size, version, version_hex, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightRIBSD2 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, difficulty, bits, chainwork, merkle_root, nonce, size, version, version_hex, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightRIBSD2 - a model defined in OpenAPI
