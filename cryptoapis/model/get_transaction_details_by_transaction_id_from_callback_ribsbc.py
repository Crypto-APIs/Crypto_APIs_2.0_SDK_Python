...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBC(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'vout': ([GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInner],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, locktime, size, version, vin, vout, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            vout ([GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInner]): Represents the transaction outputs.
