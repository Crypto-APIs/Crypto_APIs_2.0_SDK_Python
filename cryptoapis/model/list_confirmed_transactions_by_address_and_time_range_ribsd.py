...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSD(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'vin': ([ListConfirmedTransactionsByAddressRIBSDVinInner],),  # noqa: E501
    ...
    def _from_openapi_data(cls, locktime, size, version, vin, vout, *args, **kwargs):  # noqa: E501
        """ListConfirmedTransactionsByAddressAndTimeRangeRIBSD - a model defined in OpenAPI

        Args:
            locktime (int): Represents the locktime on the transaction on the specific blockchain, i.e. the blockheight at which the transaction is valid.
            size (int): Represents the total size of this transaction.
            version (int): Represents the transaction's version number.
            vin ([ListConfirmedTransactionsByAddressRIBSDVinInner]): Represents the transaction inputs.
