...
class ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients(ModelNormal):
    ...
    def __init__(self, address, amount, is_member, *args, **kwargs):  # noqa: E501
        """ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients - a model defined in OpenAPI
