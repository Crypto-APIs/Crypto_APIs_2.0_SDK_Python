...
class DecodeXAddressRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address_tag, classic_address, *args, **kwargs):  # noqa: E501
        """DecodeXAddressRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, address_tag, classic_address, *args, **kwargs):  # noqa: E501
        """DecodeXAddressRI - a model defined in OpenAPI
