...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey(ModelNormal):
    ...
    def _from_openapi_data(cls, addresses, asm, hex, req_sigs, type, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey - a model defined in OpenAPI
