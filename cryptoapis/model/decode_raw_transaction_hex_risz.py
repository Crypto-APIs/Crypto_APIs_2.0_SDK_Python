...
class DecodeRawTransactionHexRISZ(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, expiry_height, locktime, overwintered, saplinged, transaction_hash, value_balance, version, version_group_id, vin, vout, *args, **kwargs):  # noqa: E501
        """DecodeRawTransactionHexRISZ - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, expiry_height, locktime, overwintered, saplinged, transaction_hash, value_balance, version, version_group_id, vin, vout, *args, **kwargs):  # noqa: E501
        """DecodeRawTransactionHexRISZ - a model defined in OpenAPI
