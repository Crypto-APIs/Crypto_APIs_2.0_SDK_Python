...
class TokensForwardingFailDataItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, network, from_address, to_address, trigger_transaction_id, error_code, error_message, *args, **kwargs):  # noqa: E501
        """TokensForwardingFailDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, network, from_address, to_address, trigger_transaction_id, error_code, error_message, *args, **kwargs):  # noqa: E501
        """TokensForwardingFailDataItem - a model defined in OpenAPI
