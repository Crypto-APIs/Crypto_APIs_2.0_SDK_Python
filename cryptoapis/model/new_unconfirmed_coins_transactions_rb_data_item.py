...
class NewUnconfirmedCoinsTransactionsRBDataItem(ModelNormal):
    ...
    def _from_openapi_data(cls, address, callback_url, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            callback_secret_key (str): Represents the Secret Key value provided by the customer. This field is used for security purposes during the callback notification, in order to prove the sender of the callback as Crypto APIs 2.0.. [optional]  # noqa: E501
        """
