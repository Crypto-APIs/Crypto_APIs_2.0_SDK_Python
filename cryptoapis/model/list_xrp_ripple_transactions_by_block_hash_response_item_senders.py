...
class ListXRPRippleTransactionsByBlockHashResponseItemSenders(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """ListXRPRippleTransactionsByBlockHashResponseItemSenders - a model defined in OpenAPI
