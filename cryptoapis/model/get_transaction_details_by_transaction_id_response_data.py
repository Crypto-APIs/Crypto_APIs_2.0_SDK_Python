...
class GetTransactionDetailsByTransactionIDResponseData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'item': (GetTransactionDetailsByTransactionIDResponseItem,),  # noqa: E501
        }
    ...
    def __init__(self, item, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDResponseData - a model defined in OpenAPI

        Args:
            item (GetTransactionDetailsByTransactionIDResponseItem):
