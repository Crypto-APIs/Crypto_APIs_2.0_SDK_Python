...
class CreateCoinsTransactionRequestFromAddressRIRecipientsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """CreateCoinsTransactionRequestFromAddressRIRecipientsInner - a model defined in OpenAPI
