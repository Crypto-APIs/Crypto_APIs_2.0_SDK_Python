...
class GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin(ModelNormal):
    ...
    def __init__(self, difficulty, nonce, size, bits, chainwork, merkle_root, stripped_size, version, weight, *args, **kwargs):  # noqa: E501
        """GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin - a model defined in OpenAPI
