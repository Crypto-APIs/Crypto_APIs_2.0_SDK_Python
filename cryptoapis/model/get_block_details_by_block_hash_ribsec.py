...
class GetBlockDetailsByBlockHashRIBSEC(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, difficulty, nonce, size, extra_data, gas_limit, gas_used, mined_in_seconds, sha3_uncles, total_difficulty, uncles, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHashRIBSEC - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, difficulty, nonce, size, extra_data, gas_limit, gas_used, mined_in_seconds, sha3_uncles, total_difficulty, uncles, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHashRIBSEC - a model defined in OpenAPI
