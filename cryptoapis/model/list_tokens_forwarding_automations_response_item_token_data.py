...
class ListTokensForwardingAutomationsResponseItemTokenData(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ListTokensForwardingAutomationsResponseItemTokenData - a model defined in OpenAPI
