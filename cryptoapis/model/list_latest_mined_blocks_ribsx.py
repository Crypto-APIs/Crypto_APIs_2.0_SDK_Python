...
class ListLatestMinedBlocksRIBSX(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, total_fees, *args, **kwargs):  # noqa: E501
        """ListLatestMinedBlocksRIBSX - a model defined in OpenAPI

        Args:
            total_fees (ListLatestMinedBlocksRIBSXTotalFees):
    ...
    @convert_js_args_to_python_args
    def __init__(self, total_fees, *args, **kwargs):  # noqa: E501
        """ListLatestMinedBlocksRIBSX - a model defined in OpenAPI
