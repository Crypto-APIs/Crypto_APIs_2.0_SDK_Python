...
class ListTransactionsByBlockHeightRIBSLVinInner(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'script_sig': (ListTransactionsByBlockHeightRIBSLVinInnerScriptSig,),  # noqa: E501
    ...
    def _from_openapi_data(cls, addresses, script_sig, sequence, txid, txinwitness, value, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightRIBSLVinInner - a model defined in OpenAPI

        Args:
            addresses ([str]):
            script_sig (ListTransactionsByBlockHeightRIBSLVinInnerScriptSig):
