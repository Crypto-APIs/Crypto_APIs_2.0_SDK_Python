...
class ListDepositAddressesRIFungibleTokensInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, identifier, name, symbol, token_decimals, type, *args, **kwargs):  # noqa: E501
        """ListDepositAddressesRIFungibleTokensInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, identifier, name, symbol, token_decimals, type, *args, **kwargs):  # noqa: E501
        """ListDepositAddressesRIFungibleTokensInner - a model defined in OpenAPI
