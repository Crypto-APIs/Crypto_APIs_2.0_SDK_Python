...
class ListUnconfirmedOmniTransactionsByPropertyIDRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, divisible, mined, property_id, recipients, senders, sent, timestamp, transaction_id, type, type_iint, version, fee, *args, **kwargs):  # noqa: E501
        """ListUnconfirmedOmniTransactionsByPropertyIDRI - a model defined in OpenAPI
