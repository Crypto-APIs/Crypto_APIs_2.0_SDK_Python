...
def lazy_import():
    ...
    globals()['InvalidApiKeyError'] = InvalidApiKeyError


class InvalidApiKey(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'error': (InvalidApiKeyError,),  # noqa: E501
    ...
    def _from_openapi_data(cls, api_version, request_id, error, *args, **kwargs):  # noqa: E501
        """InvalidApiKey - a model defined in OpenAPI
