...
class GetTransactionDetailsByTransactionIDRIBSBCScriptPubKey(ModelNormal):
    ...
    def _from_openapi_data(cls, addresses, asm, hex, req_sigs, type, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDRIBSBCScriptPubKey - a model defined in OpenAPI
