...
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereumClassic(ModelNormal):
    ...
    def __init__(self, contract, gas_limit, gas_price, gas_used, input_data, nonce, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereumClassic - a model defined in OpenAPI

        Args:
            contract (str): Represents the specific transaction contract.
            gas_limit (str): Represents the amount of gas used by this specific transaction alone.
            gas_price (GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereumClassicGasPrice):
