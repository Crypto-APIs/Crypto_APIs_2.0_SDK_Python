...
class GetTransactionDetailsByTransactionIDResponseItemSenders(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDResponseItemSenders - a model defined in OpenAPI
