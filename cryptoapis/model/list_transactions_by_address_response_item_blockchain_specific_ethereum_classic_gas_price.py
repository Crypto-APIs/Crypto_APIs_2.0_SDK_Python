...
class ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassicGasPrice(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassicGasPrice - a model defined in OpenAPI
