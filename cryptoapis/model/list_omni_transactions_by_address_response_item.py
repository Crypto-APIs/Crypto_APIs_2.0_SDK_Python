...
class ListOmniTransactionsByAddressResponseItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'fee': (ListOmniTransactionsByAddressResponseItemFee,),  # noqa: E501
        }
    ...
    def __init__(self, amount, divisible, mined_in_block_hash, mined_in_block_height, property_id, recipients, senders, timestamp, transaction_id, type, type_int, valid, version, fee, *args, **kwargs):  # noqa: E501
        """ListOmniTransactionsByAddressResponseItem - a model defined in OpenAPI
