...
class GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin(ModelNormal):
    ...
    def __init__(self, difficulty, nonce, size, bits, chainwork, merkle_root, stripped_size, version, weight, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin - a model defined in OpenAPI
