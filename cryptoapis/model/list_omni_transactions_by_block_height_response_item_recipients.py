...
class ListOmniTransactionsByBlockHeightResponseItemRecipients(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """ListOmniTransactionsByBlockHeightResponseItemRecipients - a model defined in OpenAPI
