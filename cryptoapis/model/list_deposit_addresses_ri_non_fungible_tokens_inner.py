...
class ListDepositAddressesRINonFungibleTokensInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, identifier, name, symbol, token_id, type, *args, **kwargs):  # noqa: E501
        """ListDepositAddressesRINonFungibleTokensInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, identifier, name, symbol, token_id, type, *args, **kwargs):  # noqa: E501
        """ListDepositAddressesRINonFungibleTokensInner - a model defined in OpenAPI
