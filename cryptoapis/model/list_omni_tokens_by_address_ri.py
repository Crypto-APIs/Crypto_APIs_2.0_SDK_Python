...
class ListOmniTokensByAddressRI(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'frozen': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'property_id': (int,),  # noqa: E501
            'reserved': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balance, frozen, name, property_id, reserved, *args, **kwargs):  # noqa: E501
        """ListOmniTokensByAddressRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, balance, frozen, name, property_id, reserved, *args, **kwargs):  # noqa: E501
        """ListOmniTokensByAddressRI - a model defined in OpenAPI
