...
class EstimateTransactionSmartFee501Response(ModelNormal):
    ...
    def _from_openapi_data(cls, api_version, request_id, error, *args, **kwargs):  # noqa: E501
        """EstimateTransactionSmartFee501Response - a model defined in OpenAPI
