...
def lazy_import():
    ...
    globals()['TransactionRequestRejectData'] = TransactionRequestRejectData


class TransactionRequestReject(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (TransactionRequestRejectData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, api_version, reference_id, idempotency_key, data, *args, **kwargs):  # noqa: E501
        """TransactionRequestReject - a model defined in OpenAPI
        ...
        Args:
            ...
            data (TransactionRequestRejectData):
