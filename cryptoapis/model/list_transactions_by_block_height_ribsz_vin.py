...
def lazy_import():
    ...
    globals()['ListTransactionsByBlockHeightRIBSZScriptSig'] = ListTransactionsByBlockHeightRIBSZScriptSig


class ListTransactionsByBlockHeightRIBSZVin(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'script_sig': (ListTransactionsByBlockHeightRIBSZScriptSig,),  # noqa: E501
    ...
    def _from_openapi_data(cls, addresses, coinbase, script_sig, sequence, txid, txinwitness, value, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHeightRIBSZVin - a model defined in OpenAPI

        Args:
            addresses ([str]):
            coinbase (str): Represents the coinbase hex.
            script_sig (ListTransactionsByBlockHeightRIBSZScriptSig):
