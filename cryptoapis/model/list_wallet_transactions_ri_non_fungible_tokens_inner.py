...
class ListWalletTransactionsRINonFungibleTokensInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, converted_amount, exchange_rate_unit, name, recipient, sender, symbol, token_id, type, *args, **kwargs):  # noqa: E501
        """ListWalletTransactionsRINonFungibleTokensInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, converted_amount, exchange_rate_unit, name, recipient, sender, symbol, token_id, type, *args, **kwargs):  # noqa: E501
        """ListWalletTransactionsRINonFungibleTokensInner - a model defined in OpenAPI
