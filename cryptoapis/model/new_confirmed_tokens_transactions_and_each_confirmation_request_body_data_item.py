...
class NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem(ModelNormal):
    ...
    def __init__(self, address, callback_url, *args, **kwargs):  # noqa: E501
        """NewConfirmedTokensTransactionsAndEachConfirmationRequestBodyDataItem - a model defined in OpenAPI
