...
class ListAllAssetsFromAllWalletsRIFungibleTokensInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, blockchain, identifier, network, symbol, type, *args, **kwargs):  # noqa: E501
        """ListAllAssetsFromAllWalletsRIFungibleTokensInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, blockchain, identifier, network, symbol, type, *args, **kwargs):  # noqa: E501
        """ListAllAssetsFromAllWalletsRIFungibleTokensInner - a model defined in OpenAPI
