...
class GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin(ModelNormal):
    ...
    def __init__(self, difficulty, nonce, size, bits, chainwork, merkle_root, stripped_size, version, version_hex, weight, *args, **kwargs):  # noqa: E501
        """GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin - a model defined in OpenAPI
