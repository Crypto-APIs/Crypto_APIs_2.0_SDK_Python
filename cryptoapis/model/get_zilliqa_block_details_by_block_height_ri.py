...
class GetZilliqaBlockDetailsByBlockHeightRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, block_hash, difficulty, ds_block, ds_difficulty, ds_leader, gas_limit, gas_used, micro_blocks, next_block_hash, previous_block_hash, timestamp, transactions_count, *args, **kwargs):  # noqa: E501
        """GetZilliqaBlockDetailsByBlockHeightRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, block_hash, difficulty, ds_block, ds_difficulty, ds_leader, gas_limit, gas_used, micro_blocks, next_block_hash, previous_block_hash, timestamp, transactions_count, *args, **kwargs):  # noqa: E501
        """GetZilliqaBlockDetailsByBlockHeightRI - a model defined in OpenAPI
