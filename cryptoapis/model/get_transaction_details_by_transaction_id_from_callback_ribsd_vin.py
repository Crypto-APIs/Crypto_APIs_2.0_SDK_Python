...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSDVin(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'script_sig': (GetTransactionDetailsByTransactionIDRIBSD2ScriptSig,),  # noqa: E501
    ...
    def _from_openapi_data(cls, addresses, script_sig, sequence, txinwitness, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDFromCallbackRIBSDVin - a model defined in OpenAPI

        Args:
            addresses ([str]):
            script_sig (GetTransactionDetailsByTransactionIDRIBSD2ScriptSig):
