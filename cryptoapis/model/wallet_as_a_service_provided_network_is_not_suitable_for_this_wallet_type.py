...
class WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType(ModelNormal):
    ...
    def _from_openapi_data(cls, code, message, *args, **kwargs):  # noqa: E501
        """WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType - a model defined in OpenAPI
