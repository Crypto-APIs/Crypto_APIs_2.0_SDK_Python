...
class ListXRPRippleTransactionsByAddressResponseItemReceive(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """ListXRPRippleTransactionsByAddressResponseItemReceive - a model defined in OpenAPI
