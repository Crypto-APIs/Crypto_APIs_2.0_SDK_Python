...
class ListXRPRippleTransactionsByBlockHashResponseItemRecipients(ModelNormal):
    ...
    def __init__(self, address, amount, *args, **kwargs):  # noqa: E501
        """ListXRPRippleTransactionsByBlockHashResponseItemRecipients - a model defined in OpenAPI
