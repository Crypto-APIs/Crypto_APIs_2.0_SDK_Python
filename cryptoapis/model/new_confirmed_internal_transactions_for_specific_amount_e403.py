...
class NewConfirmedInternalTransactionsForSpecificAmountE403(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NewConfirmedInternalTransactionsForSpecificAmountE403 - a model defined in OpenAPI
