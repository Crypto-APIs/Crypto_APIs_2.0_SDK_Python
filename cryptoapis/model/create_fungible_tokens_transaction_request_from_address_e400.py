...
class CreateFungibleTokensTransactionRequestFromAddressE400(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CreateFungibleTokensTransactionRequestFromAddressE400 - a model defined in OpenAPI
