...
class GetBlockDetailsByBlockHeightFromCallbackRIBSL(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bits, chainwork, difficulty, merkle_root, nonce, size, strippedsize, version, version_hex, weight, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightFromCallbackRIBSL - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, bits, chainwork, difficulty, merkle_root, nonce, size, strippedsize, version, version_hex, weight, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightFromCallbackRIBSL - a model defined in OpenAPI
