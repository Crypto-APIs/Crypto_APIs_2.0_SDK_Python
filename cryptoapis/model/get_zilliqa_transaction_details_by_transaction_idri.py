...
class GetZilliqaTransactionDetailsByTransactionIDRI(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fee, gas_limit, gas_price, gas_used, mined_in_block_hash, mined_in_block_height, nonce, recipients, senders, timestamp, transaction_index, transaction_status, *args, **kwargs):  # noqa: E501
        """GetZilliqaTransactionDetailsByTransactionIDRI - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fee, gas_limit, gas_price, gas_used, mined_in_block_hash, mined_in_block_height, nonce, recipients, senders, timestamp, transaction_index, transaction_status, *args, **kwargs):  # noqa: E501
        """GetZilliqaTransactionDetailsByTransactionIDRI - a model defined in OpenAPI
