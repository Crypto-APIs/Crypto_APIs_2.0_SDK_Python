...
class ListTransactionsByAddressRIBSL(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'vin': ([ListTransactionsByAddressRIBSLVin],),  # noqa: E501
    ...
    def _from_openapi_data(cls, locktime, size, v_size, version, vin, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByAddressRIBSL - a model defined in OpenAPI
        ...
        Args:
            ...
            vin ([ListTransactionsByAddressRIBSLVin]): Represents the transaction inputs.
