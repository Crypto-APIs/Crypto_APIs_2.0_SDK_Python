...
class AddressTokensTransactionConfirmedEachConfirmationOmnilayertoken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, property_id, transaction_type, created_by_transaction_id, amount, *args, **kwargs):  # noqa: E501
        """AddressTokensTransactionConfirmedEachConfirmationOmnilayertoken - a model defined in OpenAPI
