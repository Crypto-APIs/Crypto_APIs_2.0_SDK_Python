...
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereumGasPrice(ModelNormal):
    ...
    def __init__(self, amount, unit, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereumGasPrice - a model defined in OpenAPI
