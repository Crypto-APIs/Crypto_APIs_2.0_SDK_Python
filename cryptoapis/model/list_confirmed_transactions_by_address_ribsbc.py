...
class ListConfirmedTransactionsByAddressRIBSBC(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, locktime, size, version, vin, *args, **kwargs):  # noqa: E501
        """ListConfirmedTransactionsByAddressRIBSBC - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, locktime, size, version, vin, *args, **kwargs):  # noqa: E501
        """ListConfirmedTransactionsByAddressRIBSBC - a model defined in OpenAPI
