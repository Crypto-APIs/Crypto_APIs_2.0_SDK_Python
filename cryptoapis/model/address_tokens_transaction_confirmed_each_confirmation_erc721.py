...
class AddressTokensTransactionConfirmedEachConfirmationErc721(ModelNormal):
    ...
    def _from_openapi_data(cls, name, symbol, token_id, contract_address, *args, **kwargs):  # noqa: E501
        """AddressTokensTransactionConfirmedEachConfirmationErc721 - a model defined in OpenAPI
