...
def lazy_import():
    ...
    globals()['ListTransactionsByBlockHashRIBSLVinInnerScriptSig'] = ListTransactionsByBlockHashRIBSLVinInnerScriptSig


class ListTransactionsByBlockHashRIBSLVinInner(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'script_sig': (ListTransactionsByBlockHashRIBSLVinInnerScriptSig,),  # noqa: E501
    ...
    def _from_openapi_data(cls, addresses, script_sig, sequence, txid, txinwitness, value, vout, *args, **kwargs):  # noqa: E501
        """ListTransactionsByBlockHashRIBSLVinInner - a model defined in OpenAPI

        Args:
            addresses ([str]):
            script_sig (ListTransactionsByBlockHashRIBSLVinInnerScriptSig):
