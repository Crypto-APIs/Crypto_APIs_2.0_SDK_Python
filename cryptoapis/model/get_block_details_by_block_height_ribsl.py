...
class GetBlockDetailsByBlockHeightRIBSL(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, difficulty, nonce, size, bits, chainwork, merkle_root, stripped_size, version, version_hex, weight, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightRIBSL - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, difficulty, nonce, size, bits, chainwork, merkle_root, stripped_size, version, version_hex, weight, *args, **kwargs):  # noqa: E501
        """GetBlockDetailsByBlockHeightRIBSL - a model defined in OpenAPI
