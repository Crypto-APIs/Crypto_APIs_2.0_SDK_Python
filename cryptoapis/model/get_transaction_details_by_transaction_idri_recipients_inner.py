...
class GetTransactionDetailsByTransactionIDRIRecipientsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, address, amount, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDRIRecipientsInner - a model defined in OpenAPI
