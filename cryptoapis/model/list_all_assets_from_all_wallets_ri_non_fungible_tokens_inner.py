...
class ListAllAssetsFromAllWalletsRINonFungibleTokensInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, identifier, network, symbol, token_id, type, *args, **kwargs):  # noqa: E501
        """ListAllAssetsFromAllWalletsRINonFungibleTokensInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, identifier, network, symbol, token_id, type, *args, **kwargs):  # noqa: E501
        """ListAllAssetsFromAllWalletsRINonFungibleTokensInner - a model defined in OpenAPI
