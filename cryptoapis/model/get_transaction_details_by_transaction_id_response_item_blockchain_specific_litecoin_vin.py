...
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificLitecoinVin(ModelNormal):
    ...
    def __init__(self, addresses, script_sig, sequence, txinwitness, *args, **kwargs):  # noqa: E501
        """GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificLitecoinVin - a model defined in OpenAPI
