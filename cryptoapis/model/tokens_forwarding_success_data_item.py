...
def lazy_import():
    ...
    globals()['TokensForwardingSuccessToken'] = TokensForwardingSuccessToken


class TokensForwardingSuccessDataItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'token': (TokensForwardingSuccessToken,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, blockchain, network, from_address, to_address, spent_fees_amount, spent_fees_unit, trigger_transaction_id, forwarding_transaction_id, token_type, token, *args, **kwargs):  # noqa: E501
        """TokensForwardingSuccessDataItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, blockchain, network, from_address, to_address, spent_fees_amount, spent_fees_unit, trigger_transaction_id, forwarding_transaction_id, token_type, token, *args, **kwargs):  # noqa: E501
        """TokensForwardingSuccessDataItem - a model defined in OpenAPI
