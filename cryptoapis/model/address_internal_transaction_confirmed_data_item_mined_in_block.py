...
class AddressInternalTransactionConfirmedDataItemMinedInBlock(ModelNormal):
    ...
    def _from_openapi_data(cls, height, hash, timestamp, *args, **kwargs):  # noqa: E501
        """AddressInternalTransactionConfirmedDataItemMinedInBlock - a model defined in OpenAPI
