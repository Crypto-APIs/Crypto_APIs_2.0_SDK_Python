...
class AddressTokensTransactionConfirmedEachConfirmationOmni(ModelNormal):
    ...
    def _from_openapi_data(cls, name, property_id, transaction_type, created_by_transaction_id, amount, *args, **kwargs):  # noqa: E501
        """AddressTokensTransactionConfirmedEachConfirmationOmni - a model defined in OpenAPI
