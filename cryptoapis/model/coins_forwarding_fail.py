...
def lazy_import():
    ...
    globals()['CoinsForwardingFailData'] = CoinsForwardingFailData


class CoinsForwardingFail(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (CoinsForwardingFailData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, api_version, reference_id, idempotency_key, data, *args, **kwargs):  # noqa: E501
        """CoinsForwardingFail - a model defined in OpenAPI
