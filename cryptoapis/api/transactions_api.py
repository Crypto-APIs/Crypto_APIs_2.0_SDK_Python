...
class TransactionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_fungible_token_transaction_request_from_address_without_fee_priority_endpoint = _Endpoint(
            settings={
                'response_type': (CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/wallet-as-a-service/wallets/{walletId}/{blockchain}/{network}/addresses/{senderAddress}/feeless-token-transaction-requests',
                'operation_id': 'create_fungible_token_transaction_request_from_address_without_fee_priority',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'wallet_id': 'path',
                    'context': 'query',
                    'create_fungible_token_transaction_request_from_address_without_fee_priority_rb': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.create_single_transaction_request_from_address_without_fee_priority_endpoint = _Endpoint(
            settings={
                'response_type': (CreateSingleTransactionRequestFromAddressWithoutFeePriorityR,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/wallet-as-a-service/wallets/{walletId}/{blockchain}/{network}/addresses/{address}/feeless-transaction-requests',
                'operation_id': 'create_single_transaction_request_from_address_without_fee_priority',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'wallet_id': 'path',
                    'context': 'query',
                    'create_single_transaction_request_from_address_without_fee_priority_rb': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_fungible_token_transaction_request_from_address_without_fee_priority(
        ...
        **kwargs
        ...
        >>> thread = api.create_fungible_token_transaction_request_from_address_without_fee_priority(network, sender_address, wallet_id, blockchain="tron", async_req=True)
        >>> result = thread.get()
        ...
        Args:
            ...
            blockchain (str): Represents the specific blockchain protocol name, e.g. Ethereum, Bitcoin, etc.. defaults to "tron", must be one of ["tron"]

        Keyword Args:
            context (str): In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.. [optional]
            create_fungible_token_transaction_request_from_address_without_fee_priority_rb (CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['wallet_id'] = \
            wallet_id
        return self.create_fungible_token_transaction_request_from_address_without_fee_priority_endpoint.call_with_http_info(**kwargs)
    ...
    def create_single_transaction_request_from_address_without_fee_priority(
        ...
        **kwargs
        ...
        >>> thread = api.create_single_transaction_request_from_address_without_fee_priority(address, network, wallet_id, blockchain="tron", async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            context (str): In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.. [optional]
            create_single_transaction_request_from_address_without_fee_priority_rb (CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['wallet_id'] = \
            wallet_id
        return self.create_single_transaction_request_from_address_without_fee_priority_endpoint.call_with_http_info(**kwargs)
