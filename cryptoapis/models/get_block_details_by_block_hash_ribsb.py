...
class GetBlockDetailsByBlockHashRIBSB(BaseModel):
    """
    Bitcoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashRIBSB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashRIBSB:
        """Create an instance of GetBlockDetailsByBlockHashRIBSB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashRIBSB.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashRIBSB.parse_obj({
