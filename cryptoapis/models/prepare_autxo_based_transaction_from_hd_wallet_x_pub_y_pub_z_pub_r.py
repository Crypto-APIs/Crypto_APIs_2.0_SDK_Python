...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR(BaseModel):
    """
    ...
    data: PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR:
        """Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR.parse_obj(obj)

        _obj = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
