...
class GetBlockDetailsByBlockHeightFromCallbackRI(BaseModel):
    """
    ...
    blockchain_specific: GetBlockDetailsByBlockHeightFromCallbackRIBS = Field(..., alias="blockchainSpecific")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRI:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRI.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRI.parse_obj({
            "hash": obj.get("hash"),
            "height": obj.get("height"),
            "previous_block_hash": obj.get("previousBlockHash"),
            "timestamp": obj.get("timestamp"),
            "transactions_count": obj.get("transactionsCount"),
            "blockchain_specific": GetBlockDetailsByBlockHeightFromCallbackRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
