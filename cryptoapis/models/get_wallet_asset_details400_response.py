...
class GetWalletAssetDetails400Response(BaseModel):
    """
    ...
    error: GetWalletAssetDetailsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletAssetDetails400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletAssetDetails400Response:
        """Create an instance of GetWalletAssetDetails400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletAssetDetails400Response.parse_obj(obj)

        _obj = GetWalletAssetDetails400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetWalletAssetDetailsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
