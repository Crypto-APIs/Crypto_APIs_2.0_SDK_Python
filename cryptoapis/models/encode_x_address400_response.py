...
class EncodeXAddress400Response(BaseModel):
    """
    ...
    error: EncodeXAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EncodeXAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EncodeXAddress400Response:
        """Create an instance of EncodeXAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EncodeXAddress400Response.parse_obj(obj)

        _obj = EncodeXAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EncodeXAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
