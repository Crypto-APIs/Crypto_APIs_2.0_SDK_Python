...
class GetWalletTransactionDetailsByTransactionIDRIBSD2(BaseModel):
    """
    Dash
    """
    ...
    vin: conlist(GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner) = Field(..., description="Object Array representation of transaction inputs")
    vout: conlist(GetTransactionDetailsByTransactionIDRIBSD2VoutInner) = Field(..., description="Object Array representation of transaction outputs")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSD2:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSD2.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSD2.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [GetTransactionDetailsByTransactionIDRIBSD2VoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
