...
class GetTransactionDetailsByTransactionIDRIBSEGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSEGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSEGasPrice:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSEGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSEGasPrice.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSEGasPrice.parse_obj({
