...
class CreateAutomaticTokensForwardingRITSBOT(BaseModel):
    """
    Bitcoin Omni Token
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAutomaticTokensForwardingRITSBOT:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAutomaticTokensForwardingRITSBOT:
        """Create an instance of CreateAutomaticTokensForwardingRITSBOT from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAutomaticTokensForwardingRITSBOT.parse_obj(obj)

        _obj = CreateAutomaticTokensForwardingRITSBOT.parse_obj({
