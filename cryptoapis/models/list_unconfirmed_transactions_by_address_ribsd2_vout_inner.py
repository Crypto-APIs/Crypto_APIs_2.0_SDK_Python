...
class ListUnconfirmedTransactionsByAddressRIBSD2VoutInner(BaseModel):
    """
    ...
    script_pub_key: ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSD2VoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSD2VoutInner:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSD2VoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSD2VoutInner.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSD2VoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
