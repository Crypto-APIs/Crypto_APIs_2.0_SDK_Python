...
class ListTransactionsByBlockHeightRIBSD2VinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSD2VinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSD2VinInner:
        """Create an instance of ListTransactionsByBlockHeightRIBSD2VinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSD2VinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSD2VinInner.parse_obj({
