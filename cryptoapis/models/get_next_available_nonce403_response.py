...
class GetNextAvailableNonce403Response(BaseModel):
    """
    ...
    error: GetNextAvailableNonceE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNextAvailableNonce403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNextAvailableNonce403Response:
        """Create an instance of GetNextAvailableNonce403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetNextAvailableNonce403Response.parse_obj(obj)

        _obj = GetNextAvailableNonce403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetNextAvailableNonceE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
