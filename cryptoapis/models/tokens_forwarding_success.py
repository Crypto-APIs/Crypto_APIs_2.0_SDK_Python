...
class TokensForwardingSuccess(BaseModel):
    """
    ...
    data: TokensForwardingSuccessData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokensForwardingSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokensForwardingSuccess:
        """Create an instance of TokensForwardingSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokensForwardingSuccess.parse_obj(obj)

        _obj = TokensForwardingSuccess.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": TokensForwardingSuccessData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
