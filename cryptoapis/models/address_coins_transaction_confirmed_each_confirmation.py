...
class AddressCoinsTransactionConfirmedEachConfirmation(BaseModel):
    """
    ...
    data: AddressCoinsTransactionConfirmedEachConfirmationData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressCoinsTransactionConfirmedEachConfirmation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressCoinsTransactionConfirmedEachConfirmation:
        """Create an instance of AddressCoinsTransactionConfirmedEachConfirmation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressCoinsTransactionConfirmedEachConfirmation.parse_obj(obj)

        _obj = AddressCoinsTransactionConfirmedEachConfirmation.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": AddressCoinsTransactionConfirmedEachConfirmationData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
