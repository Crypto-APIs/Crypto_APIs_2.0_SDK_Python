...
class AddTokensToExistingFromAddressR(BaseModel):
    """
    ...
    data: AddTokensToExistingFromAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddTokensToExistingFromAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddTokensToExistingFromAddressR:
        """Create an instance of AddTokensToExistingFromAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddTokensToExistingFromAddressR.parse_obj(obj)

        _obj = AddTokensToExistingFromAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": AddTokensToExistingFromAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
