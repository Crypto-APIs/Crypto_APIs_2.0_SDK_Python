...
class CreateCoinsTransactionRequestFromAddressRB(BaseModel):
    """
    ...
    data: CreateCoinsTransactionRequestFromAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCoinsTransactionRequestFromAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCoinsTransactionRequestFromAddressRB:
        """Create an instance of CreateCoinsTransactionRequestFromAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCoinsTransactionRequestFromAddressRB.parse_obj(obj)

        _obj = CreateCoinsTransactionRequestFromAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": CreateCoinsTransactionRequestFromAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
