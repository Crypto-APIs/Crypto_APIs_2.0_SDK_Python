...
class GetTransactionDetailsByTransactionIDRIBSD2VinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSD2VinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSD2VinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSD2VinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSD2VinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSD2VinInner.parse_obj({
