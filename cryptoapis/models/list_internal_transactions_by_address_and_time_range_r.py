...
class ListInternalTransactionsByAddressAndTimeRangeR(BaseModel):
    """
    ...
    data: ListInternalTransactionsByAddressAndTimeRangeRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddressAndTimeRangeR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddressAndTimeRangeR:
        """Create an instance of ListInternalTransactionsByAddressAndTimeRangeR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddressAndTimeRangeR.parse_obj(obj)

        _obj = ListInternalTransactionsByAddressAndTimeRangeR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListInternalTransactionsByAddressAndTimeRangeRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
