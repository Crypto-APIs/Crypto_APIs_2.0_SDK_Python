...
class GetBlockchainEventSubscriptionDetailsByReferenceIDR(BaseModel):
    """
    ...
    data: GetBlockchainEventSubscriptionDetailsByReferenceIDRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockchainEventSubscriptionDetailsByReferenceIDR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockchainEventSubscriptionDetailsByReferenceIDR:
        """Create an instance of GetBlockchainEventSubscriptionDetailsByReferenceIDR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockchainEventSubscriptionDetailsByReferenceIDR.parse_obj(obj)

        _obj = GetBlockchainEventSubscriptionDetailsByReferenceIDR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetBlockchainEventSubscriptionDetailsByReferenceIDRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
