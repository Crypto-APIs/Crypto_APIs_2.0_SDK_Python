...
class ListDepositAddresses401Response(BaseModel):
    """
    ...
    error: ListDepositAddressesE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDepositAddresses401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDepositAddresses401Response:
        """Create an instance of ListDepositAddresses401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListDepositAddresses401Response.parse_obj(obj)

        _obj = ListDepositAddresses401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListDepositAddressesE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
