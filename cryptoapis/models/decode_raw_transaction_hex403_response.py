...
class DecodeRawTransactionHex403Response(BaseModel):
    """
    ...
    error: DecodeRawTransactionHexE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHex403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHex403Response:
        """Create an instance of DecodeRawTransactionHex403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHex403Response.parse_obj(obj)

        _obj = DecodeRawTransactionHex403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DecodeRawTransactionHexE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
