...
class DecodeRawTransactionHexRISB2VinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISB2VinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISB2VinInner:
        """Create an instance of DecodeRawTransactionHexRISB2VinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISB2VinInner.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISB2VinInner.parse_obj({
