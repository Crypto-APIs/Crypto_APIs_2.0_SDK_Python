...
class GetBlockDetailsByBlockHashRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashRIBSL:
        """Create an instance of GetBlockDetailsByBlockHashRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashRIBSL.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashRIBSL.parse_obj({
