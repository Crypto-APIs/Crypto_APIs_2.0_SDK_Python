...
class GetZilliqaTransactionDetailsByTransactionID400Response(BaseModel):
    """
    ...
    error: GetZilliqaTransactionDetailsByTransactionIDE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaTransactionDetailsByTransactionID400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaTransactionDetailsByTransactionID400Response:
        """Create an instance of GetZilliqaTransactionDetailsByTransactionID400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaTransactionDetailsByTransactionID400Response.parse_obj(obj)

        _obj = GetZilliqaTransactionDetailsByTransactionID400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaTransactionDetailsByTransactionIDE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
