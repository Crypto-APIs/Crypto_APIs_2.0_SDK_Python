...
class GetBlockDetailsByBlockHeightFromCallbackRIBSP(BaseModel):
    """
    Polygon
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSP:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSP:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSP from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSP.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSP.parse_obj({
