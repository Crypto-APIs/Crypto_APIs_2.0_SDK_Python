...
class NewUnconfirmedTokensTransactionsR(BaseModel):
    """
    ...
    data: NewUnconfirmedTokensTransactionsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewUnconfirmedTokensTransactionsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewUnconfirmedTokensTransactionsR:
        """Create an instance of NewUnconfirmedTokensTransactionsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewUnconfirmedTokensTransactionsR.parse_obj(obj)

        _obj = NewUnconfirmedTokensTransactionsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewUnconfirmedTokensTransactionsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
