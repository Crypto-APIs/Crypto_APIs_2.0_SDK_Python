...
class GetTransactionDetailsByTransactionIDRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSBSC:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSBSC.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSBSC.parse_obj({
