...
class GetInternalTransactionByTransactionHashAndOperationId404Response(BaseModel):
    """
    ...
    error: BlockchainDataInternalTransactionNotFound = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInternalTransactionByTransactionHashAndOperationId404Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInternalTransactionByTransactionHashAndOperationId404Response:
        """Create an instance of GetInternalTransactionByTransactionHashAndOperationId404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInternalTransactionByTransactionHashAndOperationId404Response.parse_obj(obj)

        _obj = GetInternalTransactionByTransactionHashAndOperationId404Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": BlockchainDataInternalTransactionNotFound.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
