...
class CreateCoinsTransactionFromAddressForWholeAmountR(BaseModel):
    """
    ...
    data: CreateCoinsTransactionFromAddressForWholeAmountRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCoinsTransactionFromAddressForWholeAmountR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCoinsTransactionFromAddressForWholeAmountR:
        """Create an instance of CreateCoinsTransactionFromAddressForWholeAmountR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCoinsTransactionFromAddressForWholeAmountR.parse_obj(obj)

        _obj = CreateCoinsTransactionFromAddressForWholeAmountR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateCoinsTransactionFromAddressForWholeAmountRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
