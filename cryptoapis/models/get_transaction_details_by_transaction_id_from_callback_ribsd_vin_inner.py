...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner(BaseModel):
    """
    ...
    script_sig: GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig = Field(..., alias="scriptSig")
    sequence: StrictInt = Field(..., description="Represents the script sequence number.")
    txid: Optional[StrictStr] = Field(None, description="String representation of the txid")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
