...
class CreateFungibleTokensTransactionRequestFromAddressR(BaseModel):
    """
    ...
    data: CreateFungibleTokensTransactionRequestFromAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFungibleTokensTransactionRequestFromAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFungibleTokensTransactionRequestFromAddressR:
        """Create an instance of CreateFungibleTokensTransactionRequestFromAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFungibleTokensTransactionRequestFromAddressR.parse_obj(obj)

        _obj = CreateFungibleTokensTransactionRequestFromAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateFungibleTokensTransactionRequestFromAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
