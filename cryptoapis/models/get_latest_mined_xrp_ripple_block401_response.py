...
class GetLatestMinedXRPRippleBlock401Response(BaseModel):
    """
    ...
    error: GetLatestMinedXRPRippleBlockE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedXRPRippleBlock401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedXRPRippleBlock401Response:
        """Create an instance of GetLatestMinedXRPRippleBlock401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedXRPRippleBlock401Response.parse_obj(obj)

        _obj = GetLatestMinedXRPRippleBlock401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLatestMinedXRPRippleBlockE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
