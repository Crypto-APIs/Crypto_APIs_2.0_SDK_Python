...
class AddressTokensTransactionConfirmedEachConfirmationDataItem(BaseModel):
    ...
    token: AddressTokensTransactionConfirmedEachConfirmationToken = Field(...)
    direction: StrictStr = Field(..., description="Defines whether the transaction is \"incoming\" or \"outgoing\".")
    __properties = ["blockchain", "network", "address", "minedInBlock", "transactionId", "currentConfirmations", "targetConfirmations", "tokenType", "token", "direction"]

    @validator('token_type')
    def token_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ERC-20', 'ERC-721', 'OMNI', 'BEP-20', 'TRC-20', 'TRC-721'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedEachConfirmationDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedEachConfirmationDataItem:
        """Create an instance of AddressTokensTransactionConfirmedEachConfirmationDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedEachConfirmationDataItem.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedEachConfirmationDataItem.parse_obj({
            "blockchain": obj.get("blockchain"),
            "network": obj.get("network"),
            "address": obj.get("address"),
            "mined_in_block": AddressTokensTransactionConfirmedDataItemMinedInBlock.from_dict(obj.get("minedInBlock")) if obj.get("minedInBlock") is not None else None,
            ...
            "token": AddressTokensTransactionConfirmedEachConfirmationToken.from_dict(obj.get("token")) if obj.get("token") is not None else None,
