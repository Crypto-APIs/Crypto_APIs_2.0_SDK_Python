...
class ListWalletTransactions400Response(BaseModel):
    """
    ...
    error: ListWalletTransactionsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWalletTransactions400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWalletTransactions400Response:
        """Create an instance of ListWalletTransactions400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWalletTransactions400Response.parse_obj(obj)

        _obj = ListWalletTransactions400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListWalletTransactionsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
