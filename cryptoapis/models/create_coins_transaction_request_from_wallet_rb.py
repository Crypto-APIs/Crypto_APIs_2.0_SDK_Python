...
class CreateCoinsTransactionRequestFromWalletRB(BaseModel):
    """
    ...
    data: CreateCoinsTransactionRequestFromWalletRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCoinsTransactionRequestFromWalletRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCoinsTransactionRequestFromWalletRB:
        """Create an instance of CreateCoinsTransactionRequestFromWalletRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCoinsTransactionRequestFromWalletRB.parse_obj(obj)

        _obj = CreateCoinsTransactionRequestFromWalletRB.parse_obj({
            "context": obj.get("context"),
            "data": CreateCoinsTransactionRequestFromWalletRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
