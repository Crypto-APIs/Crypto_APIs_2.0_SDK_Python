...
class GetBlockDetailsByBlockHeightR(BaseModel):
    """
    ...
    data: GetBlockDetailsByBlockHeightRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightR:
        """Create an instance of GetBlockDetailsByBlockHeightR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightR.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetBlockDetailsByBlockHeightRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
