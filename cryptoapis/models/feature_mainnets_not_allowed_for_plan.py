...
class FeatureMainnetsNotAllowedForPlan(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeatureMainnetsNotAllowedForPlan:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeatureMainnetsNotAllowedForPlan:
        """Create an instance of FeatureMainnetsNotAllowedForPlan from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeatureMainnetsNotAllowedForPlan.parse_obj(obj)

        _obj = FeatureMainnetsNotAllowedForPlan.parse_obj({
            "code": obj.get("code"),
