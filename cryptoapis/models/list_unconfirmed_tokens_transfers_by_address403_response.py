...
class ListUnconfirmedTokensTransfersByAddress403Response(BaseModel):
    """
    ...
    error: ListUnconfirmedTokensTransfersByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTokensTransfersByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTokensTransfersByAddress403Response:
        """Create an instance of ListUnconfirmedTokensTransfersByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTokensTransfersByAddress403Response.parse_obj(obj)

        _obj = ListUnconfirmedTokensTransfersByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListUnconfirmedTokensTransfersByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
