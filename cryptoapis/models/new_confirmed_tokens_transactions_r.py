...
class NewConfirmedTokensTransactionsR(BaseModel):
    """
    ...
    data: NewConfirmedTokensTransactionsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedTokensTransactionsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedTokensTransactionsR:
        """Create an instance of NewConfirmedTokensTransactionsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedTokensTransactionsR.parse_obj(obj)

        _obj = NewConfirmedTokensTransactionsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewConfirmedTokensTransactionsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
