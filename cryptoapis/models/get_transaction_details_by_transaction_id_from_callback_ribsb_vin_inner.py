...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner(BaseModel):
    """
    ...
    script_sig: GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
