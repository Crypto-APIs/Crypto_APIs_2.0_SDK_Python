...
class ListConfirmedTransactionsByAddressRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSZ:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSZ.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSZ.parse_obj({
