...
class ListUnspentTransactionOutputsByAddressR(BaseModel):
    """
    ...
    data: ListUnspentTransactionOutputsByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnspentTransactionOutputsByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnspentTransactionOutputsByAddressR:
        """Create an instance of ListUnspentTransactionOutputsByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnspentTransactionOutputsByAddressR.parse_obj(obj)

        _obj = ListUnspentTransactionOutputsByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListUnspentTransactionOutputsByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
