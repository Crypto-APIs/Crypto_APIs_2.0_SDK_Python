...
class PrepareTransactionFromAddress401Response(BaseModel):
    """
    ...
    error: PrepareTransactionFromAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddress401Response:
        """Create an instance of PrepareTransactionFromAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddress401Response.parse_obj(obj)

        _obj = PrepareTransactionFromAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareTransactionFromAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
