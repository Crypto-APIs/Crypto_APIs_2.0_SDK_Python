...
class ListUnconfirmedTransactionsByAddress403Response(BaseModel):
    """
    ...
    error: ListUnconfirmedTransactionsByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddress403Response:
        """Create an instance of ListUnconfirmedTransactionsByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddress403Response.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListUnconfirmedTransactionsByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
