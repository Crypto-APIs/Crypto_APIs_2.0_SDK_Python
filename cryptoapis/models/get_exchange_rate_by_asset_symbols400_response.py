...
class GetExchangeRateByAssetSymbols400Response(BaseModel):
    """
    ...
    error: GetExchangeRateByAssetSymbolsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetSymbols400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetSymbols400Response:
        """Create an instance of GetExchangeRateByAssetSymbols400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetSymbols400Response.parse_obj(obj)

        _obj = GetExchangeRateByAssetSymbols400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetExchangeRateByAssetSymbolsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
