...
class DeleteAutomaticTokensForwarding400Response(BaseModel):
    """
    ...
    error: DeleteAutomaticTokensForwardingE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticTokensForwarding400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticTokensForwarding400Response:
        """Create an instance of DeleteAutomaticTokensForwarding400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticTokensForwarding400Response.parse_obj(obj)

        _obj = DeleteAutomaticTokensForwarding400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteAutomaticTokensForwardingE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
