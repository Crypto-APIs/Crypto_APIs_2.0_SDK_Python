...
class GenerateDepositAddressRBDataItem(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateDepositAddressRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateDepositAddressRBDataItem:
        """Create an instance of GenerateDepositAddressRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateDepositAddressRBDataItem.parse_obj(obj)

        _obj = GenerateDepositAddressRBDataItem.parse_obj({
            "label": obj.get("label")
        })
        return _obj
