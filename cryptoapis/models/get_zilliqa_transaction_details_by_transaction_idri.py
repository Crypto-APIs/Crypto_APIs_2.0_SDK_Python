...
class GetZilliqaTransactionDetailsByTransactionIDRI(BaseModel):
    """
    ...
    mined_in_block_hash: StrictStr = Field(..., alias="minedInBlockHash", description="Represents the hash of the block, which is its unique identifier. It represents a cryptographic digital fingerprint made by hashing the block header twice through the SHA256 algorithm.")
    ...
    recipients: conlist(GetZilliqaTransactionDetailsByTransactionIDRIRecipientsInner) = Field(..., description="Represents an object of addresses that receive the transactions.")
    senders: conlist(GetZilliqaTransactionDetailsByTransactionIDRISendersInner) = Field(..., description="Represents an object of addresses that provide the funds.")
    ...
    __properties = ["fee", "gasLimit", "gasPrice", "gasUsed", "minedInBlockHash", "minedInBlockHeight", "nonce", "recipients", "senders", "timestamp", "transactionIndex", "transactionStatus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaTransactionDetailsByTransactionIDRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaTransactionDetailsByTransactionIDRI:
        """Create an instance of GetZilliqaTransactionDetailsByTransactionIDRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaTransactionDetailsByTransactionIDRI.parse_obj(obj)

        _obj = GetZilliqaTransactionDetailsByTransactionIDRI.parse_obj({
            ...
            "nonce": obj.get("nonce"),
            "recipients": [GetZilliqaTransactionDetailsByTransactionIDRIRecipientsInner.from_dict(_item) for _item in obj.get("recipients")] if obj.get("recipients") is not None else None,
            "senders": [GetZilliqaTransactionDetailsByTransactionIDRISendersInner.from_dict(_item) for _item in obj.get("senders")] if obj.get("senders") is not None else None,
