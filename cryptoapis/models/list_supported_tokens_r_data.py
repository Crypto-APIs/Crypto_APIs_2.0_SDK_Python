...
class ListSupportedTokensRData(BaseModel):
    """
    ...
    items: conlist(ListSupportedTokensRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedTokensRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedTokensRData:
        """Create an instance of ListSupportedTokensRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedTokensRData.parse_obj(obj)

        _obj = ListSupportedTokensRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListSupportedTokensRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
