...
class GetXRPRippleTransactionDetailsByTransactionIDR(BaseModel):
    """
    ...
    data: GetXRPRippleTransactionDetailsByTransactionIDRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleTransactionDetailsByTransactionIDR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleTransactionDetailsByTransactionIDR:
        """Create an instance of GetXRPRippleTransactionDetailsByTransactionIDR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleTransactionDetailsByTransactionIDR.parse_obj(obj)

        _obj = GetXRPRippleTransactionDetailsByTransactionIDR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetXRPRippleTransactionDetailsByTransactionIDRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
