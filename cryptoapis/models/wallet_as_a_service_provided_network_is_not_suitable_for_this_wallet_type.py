...
class WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType:
        """Create an instance of WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType.parse_obj(obj)

        _obj = WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType.parse_obj({
            "code": obj.get("code"),
