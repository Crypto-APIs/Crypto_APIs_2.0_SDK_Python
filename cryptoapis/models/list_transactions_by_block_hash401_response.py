...
class ListTransactionsByBlockHash401Response(BaseModel):
    """
    ...
    error: ListTransactionsByBlockHashE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHash401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHash401Response:
        """Create an instance of ListTransactionsByBlockHash401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHash401Response.parse_obj(obj)

        _obj = ListTransactionsByBlockHash401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTransactionsByBlockHashE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
