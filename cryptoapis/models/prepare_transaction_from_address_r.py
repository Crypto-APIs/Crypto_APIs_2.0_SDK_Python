...
class PrepareTransactionFromAddressR(BaseModel):
    """
    ...
    data: PrepareTransactionFromAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddressR:
        """Create an instance of PrepareTransactionFromAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddressR.parse_obj(obj)

        _obj = PrepareTransactionFromAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": PrepareTransactionFromAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
