...
class ListSupportedAssetsR(BaseModel):
    """
    ...
    data: ListSupportedAssetsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedAssetsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedAssetsR:
        """Create an instance of ListSupportedAssetsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedAssetsR.parse_obj(obj)

        _obj = ListSupportedAssetsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListSupportedAssetsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
