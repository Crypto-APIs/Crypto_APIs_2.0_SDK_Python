...
class ListUnconfirmedTransactionsByAddressRIBSD(BaseModel):
    """
    Dogecoin
    """
    ...
    version: StrictInt = Field(..., description="Numeric representation of the transaction version")
    vin: conlist(ListUnconfirmedTransactionsByAddressRIBSDVinInner) = Field(..., description="Represents the transaction inputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSD:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSD.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSD.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [ListUnconfirmedTransactionsByAddressRIBSDVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
