...
class GetAddressBalance401Response(BaseModel):
    """
    ...
    error: GetAddressBalanceE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressBalance401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressBalance401Response:
        """Create an instance of GetAddressBalance401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressBalance401Response.parse_obj(obj)

        _obj = GetAddressBalance401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAddressBalanceE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
