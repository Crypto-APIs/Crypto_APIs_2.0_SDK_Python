...
class GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner.parse_obj({
