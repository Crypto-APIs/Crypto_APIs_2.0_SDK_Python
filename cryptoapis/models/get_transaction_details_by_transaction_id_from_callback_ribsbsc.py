...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    gas_price: GetTransactionDetailsByTransactionIDRIBSBSCGasPrice = Field(..., alias="gasPrice")
    gas_used: StrictStr = Field(..., alias="gasUsed", description="Defines the unit of the gas price amount, e.g. BTC, ETH, XRP.")
    ...
    __properties = ["contract", "gasLimit", "gasPrice", "gasUsed", "inputData", "nonce"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC.parse_obj({
            "contract": obj.get("contract"),
            "gas_limit": obj.get("gasLimit"),
            "gas_price": GetTransactionDetailsByTransactionIDRIBSBSCGasPrice.from_dict(obj.get("gasPrice")) if obj.get("gasPrice") is not None else None,
