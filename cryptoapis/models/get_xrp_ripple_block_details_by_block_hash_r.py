...
class GetXRPRippleBlockDetailsByBlockHashR(BaseModel):
    """
    ...
    data: GetXRPRippleBlockDetailsByBlockHashRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleBlockDetailsByBlockHashR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleBlockDetailsByBlockHashR:
        """Create an instance of GetXRPRippleBlockDetailsByBlockHashR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleBlockDetailsByBlockHashR.parse_obj(obj)

        _obj = GetXRPRippleBlockDetailsByBlockHashR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetXRPRippleBlockDetailsByBlockHashRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
