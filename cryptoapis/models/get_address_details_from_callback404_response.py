...
class GetAddressDetailsFromCallback404Response(BaseModel):
    """
    ...
    error: BlockchainDataAddressEventSubscriptionNotFound = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressDetailsFromCallback404Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressDetailsFromCallback404Response:
        """Create an instance of GetAddressDetailsFromCallback404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressDetailsFromCallback404Response.parse_obj(obj)

        _obj = GetAddressDetailsFromCallback404Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": BlockchainDataAddressEventSubscriptionNotFound.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
