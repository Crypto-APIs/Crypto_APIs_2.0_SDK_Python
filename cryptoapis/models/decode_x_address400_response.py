...
class DecodeXAddress400Response(BaseModel):
    """
    ...
    error: DecodeXAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeXAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeXAddress400Response:
        """Create an instance of DecodeXAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeXAddress400Response.parse_obj(obj)

        _obj = DecodeXAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DecodeXAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
