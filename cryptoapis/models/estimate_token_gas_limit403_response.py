...
class EstimateTokenGasLimit403Response(BaseModel):
    """
    ...
    error: EstimateTokenGasLimitE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTokenGasLimit403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTokenGasLimit403Response:
        """Create an instance of EstimateTokenGasLimit403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTokenGasLimit403Response.parse_obj(obj)

        _obj = EstimateTokenGasLimit403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateTokenGasLimitE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
