...
class NewConfirmedInternalTransactionsRBDataItem(BaseModel):
    """
    ...
    allow_duplicates: StrictBool = Field(..., alias="allowDuplicates", description="Flag that permits or denies creation of duplicates")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedInternalTransactionsRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedInternalTransactionsRBDataItem:
        """Create an instance of NewConfirmedInternalTransactionsRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedInternalTransactionsRBDataItem.parse_obj(obj)

        _obj = NewConfirmedInternalTransactionsRBDataItem.parse_obj({
