...
class GetBlockDetailsByBlockHashFromCallback403Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHashFromCallbackE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallback403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallback403Response:
        """Create an instance of GetBlockDetailsByBlockHashFromCallback403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallback403Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallback403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHashFromCallbackE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
