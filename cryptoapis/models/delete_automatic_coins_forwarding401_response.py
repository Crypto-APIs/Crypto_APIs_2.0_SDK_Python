...
class DeleteAutomaticCoinsForwarding401Response(BaseModel):
    """
    ...
    error: DeleteAutomaticCoinsForwardingE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticCoinsForwarding401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticCoinsForwarding401Response:
        """Create an instance of DeleteAutomaticCoinsForwarding401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticCoinsForwarding401Response.parse_obj(obj)

        _obj = DeleteAutomaticCoinsForwarding401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteAutomaticCoinsForwardingE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
