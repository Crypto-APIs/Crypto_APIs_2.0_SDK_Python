...
class GetFeeAddressDetails400Response(BaseModel):
    """
    ...
    error: GetFeeAddressDetailsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeeAddressDetails400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeeAddressDetails400Response:
        """Create an instance of GetFeeAddressDetails400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeeAddressDetails400Response.parse_obj(obj)

        _obj = GetFeeAddressDetails400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetFeeAddressDetailsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
