...
class GetXRPRippleAddressDetails401Response(BaseModel):
    """
    ...
    error: GetXRPRippleAddressDetailsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleAddressDetails401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleAddressDetails401Response:
        """Create an instance of GetXRPRippleAddressDetails401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleAddressDetails401Response.parse_obj(obj)

        _obj = GetXRPRippleAddressDetails401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleAddressDetailsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
