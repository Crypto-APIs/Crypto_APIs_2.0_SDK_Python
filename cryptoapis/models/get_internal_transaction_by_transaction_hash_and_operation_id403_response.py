...
class GetInternalTransactionByTransactionHashAndOperationId403Response(BaseModel):
    """
    ...
    error: GetInternalTransactionByTransactionHashAndOperationIdE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInternalTransactionByTransactionHashAndOperationId403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInternalTransactionByTransactionHashAndOperationId403Response:
        """Create an instance of GetInternalTransactionByTransactionHashAndOperationId403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInternalTransactionByTransactionHashAndOperationId403Response.parse_obj(obj)

        _obj = GetInternalTransactionByTransactionHashAndOperationId403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetInternalTransactionByTransactionHashAndOperationIdE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
