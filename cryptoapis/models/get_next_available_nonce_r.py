...
class GetNextAvailableNonceR(BaseModel):
    """
    ...
    data: GetNextAvailableNonceRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNextAvailableNonceR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNextAvailableNonceR:
        """Create an instance of GetNextAvailableNonceR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetNextAvailableNonceR.parse_obj(obj)

        _obj = GetNextAvailableNonceR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetNextAvailableNonceRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
