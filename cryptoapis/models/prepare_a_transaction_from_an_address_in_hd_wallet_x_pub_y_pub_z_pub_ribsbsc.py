...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    fee: PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSBSCFee = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSBSC:
        """Create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSBSC.parse_obj(obj)

        _obj = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSBSC.parse_obj({
            "data_hex": obj.get("dataHex"),
            "derivation_index": obj.get("derivationIndex"),
            "fee": PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSBSCFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "nonce": obj.get("nonce"),
