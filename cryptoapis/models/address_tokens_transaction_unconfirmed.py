...
class AddressTokensTransactionUnconfirmed(BaseModel):
    """
    ...
    data: AddressTokensTransactionUnconfirmedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionUnconfirmed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionUnconfirmed:
        """Create an instance of AddressTokensTransactionUnconfirmed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionUnconfirmed.parse_obj(obj)

        _obj = AddressTokensTransactionUnconfirmed.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": AddressTokensTransactionUnconfirmedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
