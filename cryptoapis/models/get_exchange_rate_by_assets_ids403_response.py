...
class GetExchangeRateByAssetsIDs403Response(BaseModel):
    """
    ...
    error: GetExchangeRateByAssetsIDsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetsIDs403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetsIDs403Response:
        """Create an instance of GetExchangeRateByAssetsIDs403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetsIDs403Response.parse_obj(obj)

        _obj = GetExchangeRateByAssetsIDs403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetExchangeRateByAssetsIDsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
