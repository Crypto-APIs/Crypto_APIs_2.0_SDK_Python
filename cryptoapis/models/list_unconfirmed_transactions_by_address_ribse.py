...
class ListUnconfirmedTransactionsByAddressRIBSE(BaseModel):
    """
    Ethereum
    """
    fee: ListUnconfirmedTransactionsByAddressRIBSEFee = Field(...)
    ...
    __properties = ["fee", "gasLimit", "gasPrice", "inputData", "nonce", "transactionStatus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSE:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSE.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSE.parse_obj({
            "fee": ListUnconfirmedTransactionsByAddressRIBSEFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
