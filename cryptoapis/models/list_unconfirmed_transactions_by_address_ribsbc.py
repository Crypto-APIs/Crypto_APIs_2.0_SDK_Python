...
class ListUnconfirmedTransactionsByAddressRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    vin: conlist(ListUnconfirmedTransactionsByAddressRIBSBCVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(ListUnconfirmedTransactionsByAddressRIBSBCVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSBC:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSBC.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSBC.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [ListUnconfirmedTransactionsByAddressRIBSBCVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [ListUnconfirmedTransactionsByAddressRIBSBCVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
