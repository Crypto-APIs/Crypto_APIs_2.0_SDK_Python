...
class GetWalletTransactionDetailsByTransactionIDRIBSB(BaseModel):
    """
    Bitcoin
    """
    ...
    vin: conlist(GetWalletTransactionDetailsByTransactionIDRIBSBVinInner) = Field(..., description="Object Array representation of transaction inputs")
    vout: conlist(GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSB:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSB.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSB.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [GetWalletTransactionDetailsByTransactionIDRIBSBVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
