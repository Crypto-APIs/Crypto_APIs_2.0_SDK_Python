...
class CreateAutomaticTokensForwardingRI(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAutomaticTokensForwardingRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAutomaticTokensForwardingRI:
        """Create an instance of CreateAutomaticTokensForwardingRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAutomaticTokensForwardingRI.parse_obj(obj)

        _obj = CreateAutomaticTokensForwardingRI.parse_obj({
            ...
            "token_data": CreateAutomaticTokensForwardingRITS.from_dict(obj.get("tokenData")) if obj.get("tokenData") is not None else None
        })
        return _obj
