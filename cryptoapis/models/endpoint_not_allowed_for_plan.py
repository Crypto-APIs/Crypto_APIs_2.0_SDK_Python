...
class EndpointNotAllowedForPlan(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointNotAllowedForPlan:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointNotAllowedForPlan:
        """Create an instance of EndpointNotAllowedForPlan from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointNotAllowedForPlan.parse_obj(obj)

        _obj = EndpointNotAllowedForPlan.parse_obj({
            "code": obj.get("code"),
