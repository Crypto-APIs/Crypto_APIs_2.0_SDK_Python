...
class ListCoinsForwardingAutomations400Response(BaseModel):
    """
    ...
    error: ListCoinsForwardingAutomationsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCoinsForwardingAutomations400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCoinsForwardingAutomations400Response:
        """Create an instance of ListCoinsForwardingAutomations400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListCoinsForwardingAutomations400Response.parse_obj(obj)

        _obj = ListCoinsForwardingAutomations400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListCoinsForwardingAutomationsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
