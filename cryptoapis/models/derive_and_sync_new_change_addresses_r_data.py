...
class DeriveAndSyncNewChangeAddressesRData(BaseModel):
    """
    ...
    items: conlist(DeriveAndSyncNewChangeAddressesRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewChangeAddressesRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewChangeAddressesRData:
        """Create an instance of DeriveAndSyncNewChangeAddressesRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewChangeAddressesRData.parse_obj(obj)

        _obj = DeriveAndSyncNewChangeAddressesRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [DeriveAndSyncNewChangeAddressesRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
