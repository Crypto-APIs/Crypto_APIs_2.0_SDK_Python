...
class EstimateTokenGasLimitR(BaseModel):
    """
    ...
    data: EstimateTokenGasLimitRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTokenGasLimitR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTokenGasLimitR:
        """Create an instance of EstimateTokenGasLimitR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTokenGasLimitR.parse_obj(obj)

        _obj = EstimateTokenGasLimitR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": EstimateTokenGasLimitRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
