...
class EncodeXAddress401Response(BaseModel):
    """
    ...
    error: EncodeXAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EncodeXAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EncodeXAddress401Response:
        """Create an instance of EncodeXAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EncodeXAddress401Response.parse_obj(obj)

        _obj = EncodeXAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EncodeXAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
