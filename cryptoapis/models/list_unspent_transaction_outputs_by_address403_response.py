...
class ListUnspentTransactionOutputsByAddress403Response(BaseModel):
    """
    ...
    error: ListUnspentTransactionOutputsByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnspentTransactionOutputsByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnspentTransactionOutputsByAddress403Response:
        """Create an instance of ListUnspentTransactionOutputsByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnspentTransactionOutputsByAddress403Response.parse_obj(obj)

        _obj = ListUnspentTransactionOutputsByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListUnspentTransactionOutputsByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
