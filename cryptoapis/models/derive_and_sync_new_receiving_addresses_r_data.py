...
class DeriveAndSyncNewReceivingAddressesRData(BaseModel):
    """
    ...
    items: conlist(DeriveAndSyncNewReceivingAddressesRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewReceivingAddressesRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewReceivingAddressesRData:
        """Create an instance of DeriveAndSyncNewReceivingAddressesRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewReceivingAddressesRData.parse_obj(obj)

        _obj = DeriveAndSyncNewReceivingAddressesRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [DeriveAndSyncNewReceivingAddressesRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
