...
class GetTransactionDetailsByTransactionIDRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSL:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSL.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSL.parse_obj({
