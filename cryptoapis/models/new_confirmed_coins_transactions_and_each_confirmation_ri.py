...
class NewConfirmedCoinsTransactionsAndEachConfirmationRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedCoinsTransactionsAndEachConfirmationRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedCoinsTransactionsAndEachConfirmationRI:
        """Create an instance of NewConfirmedCoinsTransactionsAndEachConfirmationRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedCoinsTransactionsAndEachConfirmationRI.parse_obj(obj)

        _obj = NewConfirmedCoinsTransactionsAndEachConfirmationRI.parse_obj({
