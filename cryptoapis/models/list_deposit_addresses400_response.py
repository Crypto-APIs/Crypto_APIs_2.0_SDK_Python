...
class ListDepositAddresses400Response(BaseModel):
    """
    ...
    error: ListDepositAddressesE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDepositAddresses400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDepositAddresses400Response:
        """Create an instance of ListDepositAddresses400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListDepositAddresses400Response.parse_obj(obj)

        _obj = ListDepositAddresses400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListDepositAddressesE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
