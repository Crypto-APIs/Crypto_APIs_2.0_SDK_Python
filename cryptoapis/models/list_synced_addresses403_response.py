...
class ListSyncedAddresses403Response(BaseModel):
    """
    ...
    error: ListSyncedAddressesE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSyncedAddresses403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSyncedAddresses403Response:
        """Create an instance of ListSyncedAddresses403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSyncedAddresses403Response.parse_obj(obj)

        _obj = ListSyncedAddresses403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSyncedAddressesE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
