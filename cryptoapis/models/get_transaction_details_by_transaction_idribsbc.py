...
class GetTransactionDetailsByTransactionIDRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    vout: conlist(GetTransactionDetailsByTransactionIDRIBSBCVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSBC:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSBC.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSBC.parse_obj({
