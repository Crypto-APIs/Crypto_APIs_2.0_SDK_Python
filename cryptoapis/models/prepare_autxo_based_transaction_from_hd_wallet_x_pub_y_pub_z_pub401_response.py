...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response(BaseModel):
    """
    ...
    error: PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response:
        """Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response.parse_obj(obj)

        _obj = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
