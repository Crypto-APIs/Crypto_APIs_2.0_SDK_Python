...
class ListTransactionsByBlockHeight404Response(BaseModel):
    """
    ...
    error: BlockchainDataBlockNotFound = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeight404Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeight404Response:
        """Create an instance of ListTransactionsByBlockHeight404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeight404Response.parse_obj(obj)

        _obj = ListTransactionsByBlockHeight404Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": BlockchainDataBlockNotFound.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
