...
class GetBlockDetailsByBlockHashFromCallbackRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSL:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSL.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSL.parse_obj({
            "bits": obj.get("bits"),
