...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRB(BaseModel):
    """
    ...
    data: PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRB:
        """Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRB.parse_obj(obj)

        _obj = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRB.parse_obj({
            "context": obj.get("context"),
            "data": PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
