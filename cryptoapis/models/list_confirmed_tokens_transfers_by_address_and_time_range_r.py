...
class ListConfirmedTokensTransfersByAddressAndTimeRangeR(BaseModel):
    """
    ...
    data: ListConfirmedTokensTransfersByAddressAndTimeRangeRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddressAndTimeRangeR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddressAndTimeRangeR:
        """Create an instance of ListConfirmedTokensTransfersByAddressAndTimeRangeR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddressAndTimeRangeR.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddressAndTimeRangeR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListConfirmedTokensTransfersByAddressAndTimeRangeRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
