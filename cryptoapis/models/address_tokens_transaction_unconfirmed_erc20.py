...
class AddressTokensTransactionUnconfirmedErc20(BaseModel):
    """
    ERC-20
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionUnconfirmedErc20:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionUnconfirmedErc20:
        """Create an instance of AddressTokensTransactionUnconfirmedErc20 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionUnconfirmedErc20.parse_obj(obj)

        _obj = AddressTokensTransactionUnconfirmedErc20.parse_obj({
            "name": obj.get("name"),
