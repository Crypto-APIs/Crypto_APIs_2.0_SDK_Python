...
class NewRevertedBlockRBDataItem(BaseModel):
    """
    NewRevertedBlockRBDataItem
    """
    allow_duplicates: Optional[StrictStr] = Field(None, alias="allowDuplicates", description="Specifies a flag that permits or denies the creation of duplicate addresses.")
    ...
    __properties = ["allowDuplicates", "callbackSecretKey", "callbackUrl"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewRevertedBlockRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewRevertedBlockRBDataItem:
        """Create an instance of NewRevertedBlockRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewRevertedBlockRBDataItem.parse_obj(obj)

        _obj = NewRevertedBlockRBDataItem.parse_obj({
