...
class NewConfirmedCoinsTransactionsRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedCoinsTransactionsRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedCoinsTransactionsRI:
        """Create an instance of NewConfirmedCoinsTransactionsRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedCoinsTransactionsRI.parse_obj(obj)

        _obj = NewConfirmedCoinsTransactionsRI.parse_obj({
