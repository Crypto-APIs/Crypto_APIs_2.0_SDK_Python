...
class GetBlockDetailsByBlockHashFromCallbackRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSE:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSE.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSE.parse_obj({
