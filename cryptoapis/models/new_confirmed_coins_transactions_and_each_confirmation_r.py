...
class NewConfirmedCoinsTransactionsAndEachConfirmationR(BaseModel):
    """
    ...
    data: NewConfirmedCoinsTransactionsAndEachConfirmationRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedCoinsTransactionsAndEachConfirmationR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedCoinsTransactionsAndEachConfirmationR:
        """Create an instance of NewConfirmedCoinsTransactionsAndEachConfirmationR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedCoinsTransactionsAndEachConfirmationR.parse_obj(obj)

        _obj = NewConfirmedCoinsTransactionsAndEachConfirmationR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewConfirmedCoinsTransactionsAndEachConfirmationRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
