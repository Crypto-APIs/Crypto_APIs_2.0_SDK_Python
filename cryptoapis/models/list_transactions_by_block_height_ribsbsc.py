...
class ListTransactionsByBlockHeightRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    gas_price: ListTransactionsByBlockHeightRIBSBSCGasPrice = Field(..., alias="gasPrice")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSBSC:
        """Create an instance of ListTransactionsByBlockHeightRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSBSC.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSBSC.parse_obj({
            "contract": obj.get("contract"),
            "gas_limit": obj.get("gasLimit"),
            "gas_price": ListTransactionsByBlockHeightRIBSBSCGasPrice.from_dict(obj.get("gasPrice")) if obj.get("gasPrice") is not None else None,
