...
class ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey:
        """Create an instance of ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey.parse_obj({
