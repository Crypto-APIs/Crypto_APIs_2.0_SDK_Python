...
class ListConfirmedTokensTransfersByAddressAndTimeRange400Response(BaseModel):
    """
    ...
    error: ListConfirmedTokensTransfersByAddressAndTimeRangeE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddressAndTimeRange400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddressAndTimeRange400Response:
        """Create an instance of ListConfirmedTokensTransfersByAddressAndTimeRange400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddressAndTimeRange400Response.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddressAndTimeRange400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTokensTransfersByAddressAndTimeRangeE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
