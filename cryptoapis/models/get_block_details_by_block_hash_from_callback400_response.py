...
class GetBlockDetailsByBlockHashFromCallback400Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHashFromCallbackE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallback400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallback400Response:
        """Create an instance of GetBlockDetailsByBlockHashFromCallback400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallback400Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallback400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHashFromCallbackE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
