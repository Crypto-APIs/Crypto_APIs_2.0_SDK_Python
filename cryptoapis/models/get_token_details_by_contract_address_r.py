...
class GetTokenDetailsByContractAddressR(BaseModel):
    """
    ...
    data: GetTokenDetailsByContractAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTokenDetailsByContractAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTokenDetailsByContractAddressR:
        """Create an instance of GetTokenDetailsByContractAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTokenDetailsByContractAddressR.parse_obj(obj)

        _obj = GetTokenDetailsByContractAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetTokenDetailsByContractAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
