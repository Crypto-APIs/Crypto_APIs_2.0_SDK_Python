...
class ListConfirmedTransactionsByAddressAndTimeRange401Response(BaseModel):
    """
    ...
    error: ListConfirmedTransactionsByAddressAndTimeRangeE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRange401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRange401Response:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRange401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRange401Response.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRange401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTransactionsByAddressAndTimeRangeE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
