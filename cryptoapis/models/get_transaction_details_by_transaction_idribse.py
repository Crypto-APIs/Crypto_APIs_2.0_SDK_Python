...
class GetTransactionDetailsByTransactionIDRIBSE(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSE:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSE.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSE.parse_obj({
