...
class ListInternalTransactionsByAddress403Response(BaseModel):
    """
    ...
    error: ListInternalTransactionsByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddress403Response:
        """Create an instance of ListInternalTransactionsByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddress403Response.parse_obj(obj)

        _obj = ListInternalTransactionsByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionsByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
