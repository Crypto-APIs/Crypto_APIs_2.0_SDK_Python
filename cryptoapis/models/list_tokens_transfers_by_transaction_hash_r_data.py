...
class ListTokensTransfersByTransactionHashRData(BaseModel):
    """
    ...
    items: conlist(ListTokensTransfersByTransactionHashRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensTransfersByTransactionHashRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensTransfersByTransactionHashRData:
        """Create an instance of ListTokensTransfersByTransactionHashRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensTransfersByTransactionHashRData.parse_obj(obj)

        _obj = ListTokensTransfersByTransactionHashRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListTokensTransfersByTransactionHashRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
