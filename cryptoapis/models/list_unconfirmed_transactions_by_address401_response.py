...
class ListUnconfirmedTransactionsByAddress401Response(BaseModel):
    """
    ...
    error: ListUnconfirmedTransactionsByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddress401Response:
        """Create an instance of ListUnconfirmedTransactionsByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddress401Response.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListUnconfirmedTransactionsByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
