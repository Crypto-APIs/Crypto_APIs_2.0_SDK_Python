...
class ListTokensByAddressR(BaseModel):
    """
    ...
    data: ListTokensByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensByAddressR:
        """Create an instance of ListTokensByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensByAddressR.parse_obj(obj)

        _obj = ListTokensByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListTokensByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
