...
class ListXRPRippleTransactionsByBlockHash400Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByBlockHashE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByBlockHash400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByBlockHash400Response:
        """Create an instance of ListXRPRippleTransactionsByBlockHash400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByBlockHash400Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByBlockHash400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByBlockHashE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
