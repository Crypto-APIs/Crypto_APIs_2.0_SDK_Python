...
class PrepareANonFungibleTokenTransferFromAddress403Response(BaseModel):
    """
    ...
    error: PrepareANonFungibleTokenTransferFromAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareANonFungibleTokenTransferFromAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareANonFungibleTokenTransferFromAddress403Response:
        """Create an instance of PrepareANonFungibleTokenTransferFromAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareANonFungibleTokenTransferFromAddress403Response.parse_obj(obj)

        _obj = PrepareANonFungibleTokenTransferFromAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareANonFungibleTokenTransferFromAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
