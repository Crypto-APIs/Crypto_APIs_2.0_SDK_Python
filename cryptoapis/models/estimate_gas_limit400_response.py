...
class EstimateGasLimit400Response(BaseModel):
    """
    ...
    error: EstimateGasLimitE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateGasLimit400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateGasLimit400Response:
        """Create an instance of EstimateGasLimit400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateGasLimit400Response.parse_obj(obj)

        _obj = EstimateGasLimit400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateGasLimitE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
