...
class DecodeRawTransactionHexRB(BaseModel):
    """
    ...
    data: DecodeRawTransactionHexRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRB:
        """Create an instance of DecodeRawTransactionHexRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRB.parse_obj(obj)

        _obj = DecodeRawTransactionHexRB.parse_obj({
            "context": obj.get("context"),
            "data": DecodeRawTransactionHexRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
