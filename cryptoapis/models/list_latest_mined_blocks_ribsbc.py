...
class ListLatestMinedBlocksRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksRIBSBC:
        """Create an instance of ListLatestMinedBlocksRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocksRIBSBC.parse_obj(obj)

        _obj = ListLatestMinedBlocksRIBSBC.parse_obj({
            "bits": obj.get("bits"),
