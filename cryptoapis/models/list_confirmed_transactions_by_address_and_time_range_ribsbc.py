...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    vin: conlist(ListConfirmedTransactionsByAddressRIBSBCVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: Optional[conlist(GetTransactionDetailsByTransactionIDRIBSBCVoutInner)] = Field(None, description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRIBSBC.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [ListConfirmedTransactionsByAddressRIBSBCVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [GetTransactionDetailsByTransactionIDRIBSBCVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
