...
class ListInternalTransactionDetailsByTransactionHash401Response(BaseModel):
    """
    ...
    error: ListInternalTransactionDetailsByTransactionHashE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionDetailsByTransactionHash401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionDetailsByTransactionHash401Response:
        """Create an instance of ListInternalTransactionDetailsByTransactionHash401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionDetailsByTransactionHash401Response.parse_obj(obj)

        _obj = ListInternalTransactionDetailsByTransactionHash401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionDetailsByTransactionHashE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
