...
class EncodeXAddress403Response(BaseModel):
    """
    ...
    error: EncodeXAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EncodeXAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EncodeXAddress403Response:
        """Create an instance of EncodeXAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EncodeXAddress403Response.parse_obj(obj)

        _obj = EncodeXAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EncodeXAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
