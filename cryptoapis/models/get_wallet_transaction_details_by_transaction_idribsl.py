...
class GetWalletTransactionDetailsByTransactionIDRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    vin: conlist(GetWalletTransactionDetailsByTransactionIDRIBSLVinInner) = Field(..., description="Object Array representation of transaction inputs")
    vout: conlist(GetTransactionDetailsByTransactionIDRIBSLVoutInner) = Field(..., description="Object Array representation of transaction outputs")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSL:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSL.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSL.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [GetWalletTransactionDetailsByTransactionIDRIBSLVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
