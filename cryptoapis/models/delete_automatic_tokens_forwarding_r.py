...
class DeleteAutomaticTokensForwardingR(BaseModel):
    """
    ...
    data: DeleteAutomaticTokensForwardingRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticTokensForwardingR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticTokensForwardingR:
        """Create an instance of DeleteAutomaticTokensForwardingR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticTokensForwardingR.parse_obj(obj)

        _obj = DeleteAutomaticTokensForwardingR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": DeleteAutomaticTokensForwardingRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
