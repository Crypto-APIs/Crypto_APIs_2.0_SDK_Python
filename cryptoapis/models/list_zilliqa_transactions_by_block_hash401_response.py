...
class ListZilliqaTransactionsByBlockHash401Response(BaseModel):
    """
    ...
    error: ListZilliqaTransactionsByBlockHashE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHash401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHash401Response:
        """Create an instance of ListZilliqaTransactionsByBlockHash401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHash401Response.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHash401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListZilliqaTransactionsByBlockHashE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
