...
class PrepareAFungibleTokenTransferFromAddressRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    fee: PrepareAFungibleTokenTransferFromAddressRIBSEFee = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAFungibleTokenTransferFromAddressRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAFungibleTokenTransferFromAddressRIBSE:
        """Create an instance of PrepareAFungibleTokenTransferFromAddressRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAFungibleTokenTransferFromAddressRIBSE.parse_obj(obj)

        _obj = PrepareAFungibleTokenTransferFromAddressRIBSE.parse_obj({
            "data_hex": obj.get("dataHex"),
            "sig_hash": obj.get("sigHash"),
            "fee": PrepareAFungibleTokenTransferFromAddressRIBSEFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
