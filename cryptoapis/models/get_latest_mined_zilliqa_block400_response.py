...
class GetLatestMinedZilliqaBlock400Response(BaseModel):
    """
    ...
    error: GetLatestMinedZilliqaBlockE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedZilliqaBlock400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedZilliqaBlock400Response:
        """Create an instance of GetLatestMinedZilliqaBlock400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedZilliqaBlock400Response.parse_obj(obj)

        _obj = GetLatestMinedZilliqaBlock400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLatestMinedZilliqaBlockE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
