...
class ListConfirmedTransactionsByAddressAndTimeRangeRData(BaseModel):
    """
    ...
    items: conlist(ListConfirmedTransactionsByAddressAndTimeRangeRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRData:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRData.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListConfirmedTransactionsByAddressAndTimeRangeRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
