...
class SyncHDWalletXPubYPubZPub403Response(BaseModel):
    ...
    error: SyncHDWalletXPubYPubZPubE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncHDWalletXPubYPubZPub403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncHDWalletXPubYPubZPub403Response:
        """Create an instance of SyncHDWalletXPubYPubZPub403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncHDWalletXPubYPubZPub403Response.parse_obj(obj)

        _obj = SyncHDWalletXPubYPubZPub403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncHDWalletXPubYPubZPubE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
