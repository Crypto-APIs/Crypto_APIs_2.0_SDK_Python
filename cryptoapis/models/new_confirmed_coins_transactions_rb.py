...
class NewConfirmedCoinsTransactionsRB(BaseModel):
    """
    ...
    data: NewConfirmedCoinsTransactionsRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedCoinsTransactionsRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedCoinsTransactionsRB:
        """Create an instance of NewConfirmedCoinsTransactionsRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedCoinsTransactionsRB.parse_obj(obj)

        _obj = NewConfirmedCoinsTransactionsRB.parse_obj({
            "context": obj.get("context"),
            "data": NewConfirmedCoinsTransactionsRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
