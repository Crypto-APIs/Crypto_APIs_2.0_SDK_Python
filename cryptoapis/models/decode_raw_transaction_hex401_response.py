...
class DecodeRawTransactionHex401Response(BaseModel):
    """
    ...
    error: DecodeRawTransactionHexE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHex401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHex401Response:
        """Create an instance of DecodeRawTransactionHex401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHex401Response.parse_obj(obj)

        _obj = DecodeRawTransactionHex401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DecodeRawTransactionHexE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
