...
class GetAssetDetailsByAssetSymbolR(BaseModel):
    """
    ...
    data: GetAssetDetailsByAssetSymbolRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetSymbolR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetSymbolR:
        """Create an instance of GetAssetDetailsByAssetSymbolR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetSymbolR.parse_obj(obj)

        _obj = GetAssetDetailsByAssetSymbolR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetAssetDetailsByAssetSymbolRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
