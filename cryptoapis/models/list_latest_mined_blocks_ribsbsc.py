...
class ListLatestMinedBlocksRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksRIBSBSC:
        """Create an instance of ListLatestMinedBlocksRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocksRIBSBSC.parse_obj(obj)

        _obj = ListLatestMinedBlocksRIBSBSC.parse_obj({
