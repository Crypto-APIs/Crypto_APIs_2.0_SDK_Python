...
class ListConfirmedTransactionsByAddressRIBSEGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSEGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSEGasPrice:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSEGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSEGasPrice.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSEGasPrice.parse_obj({
