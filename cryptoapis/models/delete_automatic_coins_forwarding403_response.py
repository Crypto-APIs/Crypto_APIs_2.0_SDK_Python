...
class DeleteAutomaticCoinsForwarding403Response(BaseModel):
    """
    ...
    error: DeleteAutomaticCoinsForwardingE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticCoinsForwarding403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticCoinsForwarding403Response:
        """Create an instance of DeleteAutomaticCoinsForwarding403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticCoinsForwarding403Response.parse_obj(obj)

        _obj = DeleteAutomaticCoinsForwarding403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteAutomaticCoinsForwardingE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
