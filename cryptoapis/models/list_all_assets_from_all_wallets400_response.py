...
class ListAllAssetsFromAllWallets400Response(BaseModel):
    """
    ...
    error: ListAllAssetsFromAllWalletsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsFromAllWallets400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsFromAllWallets400Response:
        """Create an instance of ListAllAssetsFromAllWallets400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsFromAllWallets400Response.parse_obj(obj)

        _obj = ListAllAssetsFromAllWallets400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListAllAssetsFromAllWalletsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
