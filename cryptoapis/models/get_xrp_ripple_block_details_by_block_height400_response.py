...
class GetXRPRippleBlockDetailsByBlockHeight400Response(BaseModel):
    """
    ...
    error: GetXRPRippleBlockDetailsByBlockHeightE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleBlockDetailsByBlockHeight400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleBlockDetailsByBlockHeight400Response:
        """Create an instance of GetXRPRippleBlockDetailsByBlockHeight400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleBlockDetailsByBlockHeight400Response.parse_obj(obj)

        _obj = GetXRPRippleBlockDetailsByBlockHeight400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleBlockDetailsByBlockHeightE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
