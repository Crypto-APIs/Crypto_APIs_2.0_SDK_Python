...
class GetAssetDetailsByAssetSymbol401Response(BaseModel):
    """
    ...
    error: GetAssetDetailsByAssetSymbolE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetSymbol401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetSymbol401Response:
        """Create an instance of GetAssetDetailsByAssetSymbol401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetSymbol401Response.parse_obj(obj)

        _obj = GetAssetDetailsByAssetSymbol401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAssetDetailsByAssetSymbolE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
