...
class GetExchangeRateByAssetSymbolsR(BaseModel):
    """
    ...
    data: GetExchangeRateByAssetSymbolsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetSymbolsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetSymbolsR:
        """Create an instance of GetExchangeRateByAssetSymbolsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetSymbolsR.parse_obj(obj)

        _obj = GetExchangeRateByAssetSymbolsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetExchangeRateByAssetSymbolsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
