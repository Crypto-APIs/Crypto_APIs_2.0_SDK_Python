...
class ListXRPRippleTransactionsByBlockHeight401Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByBlockHeightE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByBlockHeight401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByBlockHeight401Response:
        """Create an instance of ListXRPRippleTransactionsByBlockHeight401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByBlockHeight401Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByBlockHeight401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByBlockHeightE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
