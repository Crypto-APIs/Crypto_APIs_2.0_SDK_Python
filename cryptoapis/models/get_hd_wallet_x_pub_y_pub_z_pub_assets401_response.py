...
class GetHDWalletXPubYPubZPubAssets401Response(BaseModel):
    """
    ...
    error: GetHDWalletXPubYPubZPubAssetsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubAssets401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubAssets401Response:
        """Create an instance of GetHDWalletXPubYPubZPubAssets401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubAssets401Response.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubAssets401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetHDWalletXPubYPubZPubAssetsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
