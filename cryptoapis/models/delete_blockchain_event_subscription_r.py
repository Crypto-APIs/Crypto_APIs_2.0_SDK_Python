...
class DeleteBlockchainEventSubscriptionR(BaseModel):
    """
    ...
    data: DeleteBlockchainEventSubscriptionRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteBlockchainEventSubscriptionR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteBlockchainEventSubscriptionR:
        """Create an instance of DeleteBlockchainEventSubscriptionR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteBlockchainEventSubscriptionR.parse_obj(obj)

        _obj = DeleteBlockchainEventSubscriptionR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": DeleteBlockchainEventSubscriptionRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
