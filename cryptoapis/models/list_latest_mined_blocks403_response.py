...
class ListLatestMinedBlocks403Response(BaseModel):
    """
    ...
    error: ListLatestMinedBlocksE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocks403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocks403Response:
        """Create an instance of ListLatestMinedBlocks403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocks403Response.parse_obj(obj)

        _obj = ListLatestMinedBlocks403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListLatestMinedBlocksE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
