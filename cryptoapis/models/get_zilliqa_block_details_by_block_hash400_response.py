...
class GetZilliqaBlockDetailsByBlockHash400Response(BaseModel):
    """
    ...
    error: GetZilliqaBlockDetailsByBlockHashE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaBlockDetailsByBlockHash400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaBlockDetailsByBlockHash400Response:
        """Create an instance of GetZilliqaBlockDetailsByBlockHash400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaBlockDetailsByBlockHash400Response.parse_obj(obj)

        _obj = GetZilliqaBlockDetailsByBlockHash400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaBlockDetailsByBlockHashE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
