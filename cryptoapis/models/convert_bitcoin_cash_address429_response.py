...
class ConvertBitcoinCashAddress429Response(BaseModel):
    """
    ...
    error: RequestLimitReached = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress429Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress429Response:
        """Create an instance of ConvertBitcoinCashAddress429Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress429Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress429Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": RequestLimitReached.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
