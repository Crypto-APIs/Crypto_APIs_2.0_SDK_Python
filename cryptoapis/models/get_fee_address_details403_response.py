...
class GetFeeAddressDetails403Response(BaseModel):
    """
    ...
    error: GetFeeAddressDetailsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeeAddressDetails403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeeAddressDetails403Response:
        """Create an instance of GetFeeAddressDetails403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeeAddressDetails403Response.parse_obj(obj)

        _obj = GetFeeAddressDetails403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetFeeAddressDetailsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
