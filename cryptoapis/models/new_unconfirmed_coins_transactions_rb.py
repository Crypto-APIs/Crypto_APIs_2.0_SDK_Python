...
class NewUnconfirmedCoinsTransactionsRB(BaseModel):
    """
    ...
    data: NewUnconfirmedCoinsTransactionsRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewUnconfirmedCoinsTransactionsRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewUnconfirmedCoinsTransactionsRB:
        """Create an instance of NewUnconfirmedCoinsTransactionsRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewUnconfirmedCoinsTransactionsRB.parse_obj(obj)

        _obj = NewUnconfirmedCoinsTransactionsRB.parse_obj({
            "context": obj.get("context"),
            "data": NewUnconfirmedCoinsTransactionsRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
