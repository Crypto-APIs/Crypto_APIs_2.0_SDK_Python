...
class ListTransactionsByBlockHeightRIBSDVinInner(BaseModel):
    """
    ...
    script_sig: ListTransactionsByBlockHeightRIBSDVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSDVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSDVinInner:
        """Create an instance of ListTransactionsByBlockHeightRIBSDVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSDVinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSDVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": ListTransactionsByBlockHeightRIBSDVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
