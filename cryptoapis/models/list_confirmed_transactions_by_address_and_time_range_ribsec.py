...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC.parse_obj({
