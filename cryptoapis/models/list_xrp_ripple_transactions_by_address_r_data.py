...
class ListXRPRippleTransactionsByAddressRData(BaseModel):
    """
    ...
    items: conlist(ListXRPRippleTransactionsByAddressRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddressRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddressRData:
        """Create an instance of ListXRPRippleTransactionsByAddressRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddressRData.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddressRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListXRPRippleTransactionsByAddressRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
