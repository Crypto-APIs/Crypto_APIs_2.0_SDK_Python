...
class GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner(BaseModel):
    """
    ...
    script_sig: GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
