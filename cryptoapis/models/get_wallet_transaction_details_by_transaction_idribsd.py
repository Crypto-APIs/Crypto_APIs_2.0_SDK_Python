...
class GetWalletTransactionDetailsByTransactionIDRIBSD(BaseModel):
    """
    Dogecoin
    """
    ...
    vin: conlist(GetWalletTransactionDetailsByTransactionIDRIBSDVinInner) = Field(..., description="Object Array representation of transaction inputs")
    vout: conlist(GetTransactionDetailsByTransactionIDRIBSDVoutInner) = Field(..., description="Object Array representation of transaction outputs")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSD:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSD.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSD.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [GetWalletTransactionDetailsByTransactionIDRIBSDVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
