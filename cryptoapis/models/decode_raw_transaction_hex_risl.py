...
class DecodeRawTransactionHexRISL(BaseModel):
    ...
    vin: conlist(DecodeRawTransactionHexRISLVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(DecodeRawTransactionHexRISLVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISL:
        """Create an instance of DecodeRawTransactionHexRISL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISL.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISL.parse_obj({
            "locktime": obj.get("locktime"),
            "transaction_hash": obj.get("transactionHash"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [DecodeRawTransactionHexRISLVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [DecodeRawTransactionHexRISLVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None,
