...
class GetTransactionDetailsByTransactionIDRIBSD2VoutInner(BaseModel):
    """
    ...
    script_pub_key: GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSD2VoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSD2VoutInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSD2VoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSD2VoutInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSD2VoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
