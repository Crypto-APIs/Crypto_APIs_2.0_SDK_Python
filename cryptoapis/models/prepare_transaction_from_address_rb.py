...
class PrepareTransactionFromAddressRB(BaseModel):
    """
    ...
    data: PrepareTransactionFromAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddressRB:
        """Create an instance of PrepareTransactionFromAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddressRB.parse_obj(obj)

        _obj = PrepareTransactionFromAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": PrepareTransactionFromAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
