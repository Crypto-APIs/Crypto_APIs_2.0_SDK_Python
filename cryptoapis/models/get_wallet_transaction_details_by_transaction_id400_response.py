...
class GetWalletTransactionDetailsByTransactionID400Response(BaseModel):
    """
    ...
    error: GetWalletTransactionDetailsByTransactionIDE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionID400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionID400Response:
        """Create an instance of GetWalletTransactionDetailsByTransactionID400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionID400Response.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionID400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetWalletTransactionDetailsByTransactionIDE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
