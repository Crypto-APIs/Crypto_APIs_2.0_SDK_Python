...
class ListAllAssetsByWalletID403Response(BaseModel):
    """
    ...
    error: ListAllAssetsByWalletIDE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsByWalletID403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsByWalletID403Response:
        """Create an instance of ListAllAssetsByWalletID403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsByWalletID403Response.parse_obj(obj)

        _obj = ListAllAssetsByWalletID403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListAllAssetsByWalletIDE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
