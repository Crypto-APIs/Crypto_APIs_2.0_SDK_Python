...
class ListInternalTransactionsByAddressAndTimeRange400Response(BaseModel):
    """
    ...
    error: ListInternalTransactionsByAddressAndTimeRangeE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddressAndTimeRange400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddressAndTimeRange400Response:
        """Create an instance of ListInternalTransactionsByAddressAndTimeRange400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddressAndTimeRange400Response.parse_obj(obj)

        _obj = ListInternalTransactionsByAddressAndTimeRange400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionsByAddressAndTimeRangeE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
