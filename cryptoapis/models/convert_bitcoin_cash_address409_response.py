...
class ConvertBitcoinCashAddress409Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress409Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress409Response:
        """Create an instance of ConvertBitcoinCashAddress409Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress409Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress409Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": InvalidData.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
