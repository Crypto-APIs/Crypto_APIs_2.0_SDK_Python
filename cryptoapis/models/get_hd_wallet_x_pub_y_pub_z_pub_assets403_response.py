...
class GetHDWalletXPubYPubZPubAssets403Response(BaseModel):
    """
    ...
    error: GetHDWalletXPubYPubZPubAssetsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubAssets403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubAssets403Response:
        """Create an instance of GetHDWalletXPubYPubZPubAssets403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubAssets403Response.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubAssets403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetHDWalletXPubYPubZPubAssetsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
