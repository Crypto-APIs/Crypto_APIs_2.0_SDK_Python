...
class ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner.parse_obj({
