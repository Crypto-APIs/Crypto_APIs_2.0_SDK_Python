...
class ListTransactionsByBlockHash403Response(BaseModel):
    """
    ...
    error: ListTransactionsByBlockHashE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHash403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHash403Response:
        """Create an instance of ListTransactionsByBlockHash403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHash403Response.parse_obj(obj)

        _obj = ListTransactionsByBlockHash403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTransactionsByBlockHashE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
