...
class ListUnconfirmedTransactionsByAddressRIBSD2(BaseModel):
    """
    Dash
    """
    ...
    vin: conlist(ListUnconfirmedTransactionsByAddressRIBSD2VinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(ListUnconfirmedTransactionsByAddressRIBSD2VoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSD2:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSD2.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSD2.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [ListUnconfirmedTransactionsByAddressRIBSD2VinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [ListUnconfirmedTransactionsByAddressRIBSD2VoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
