...
class NewRevertedBlockR(BaseModel):
    """
    NewRevertedBlockR
    """
    ...
    data: NewRevertedBlockRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewRevertedBlockR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewRevertedBlockR:
        """Create an instance of NewRevertedBlockR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewRevertedBlockR.parse_obj(obj)

        _obj = NewRevertedBlockR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewRevertedBlockRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
