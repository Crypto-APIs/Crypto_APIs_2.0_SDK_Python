...
class CreateNewMasterWalletR(BaseModel):
    """
    ...
    data: CreateNewMasterWalletRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNewMasterWalletR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNewMasterWalletR:
        """Create an instance of CreateNewMasterWalletR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateNewMasterWalletR.parse_obj(obj)

        _obj = CreateNewMasterWalletR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateNewMasterWalletRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
