...
class TransactionRequestFailData(BaseModel):
    """
    ...
    item: TransactionRequestFailDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestFailData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestFailData:
        """Create an instance of TransactionRequestFailData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestFailData.parse_obj(obj)

        _obj = TransactionRequestFailData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": TransactionRequestFailDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
