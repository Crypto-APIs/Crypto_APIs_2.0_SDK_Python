...
class GetTransactionDetailsByTransactionIDRI(BaseModel):
    ...
    fee: GetTransactionDetailsByTransactionIDRIFee = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRI:
        """Create an instance of GetTransactionDetailsByTransactionIDRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRI.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRI.parse_obj({
            ...
            "fee": GetTransactionDetailsByTransactionIDRIFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "blockchain_specific": GetTransactionDetailsByTransactionIDRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
