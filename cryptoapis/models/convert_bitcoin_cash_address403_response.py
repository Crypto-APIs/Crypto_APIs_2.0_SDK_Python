...
class ConvertBitcoinCashAddress403Response(BaseModel):
    """
    ...
    error: ConvertBitcoinCashAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress403Response:
        """Create an instance of ConvertBitcoinCashAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress403Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ConvertBitcoinCashAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
