...
class GetTokenDetailsByContractAddress401Response(BaseModel):
    """
    ...
    error: GetTokenDetailsByContractAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTokenDetailsByContractAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTokenDetailsByContractAddress401Response:
        """Create an instance of GetTokenDetailsByContractAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTokenDetailsByContractAddress401Response.parse_obj(obj)

        _obj = GetTokenDetailsByContractAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTokenDetailsByContractAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
