...
class GetWalletTransactionDetailsByTransactionIDRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    gas_price: GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice = Field(..., alias="gasPrice")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSE:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSE.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSE.parse_obj({
            "contract": obj.get("contract"),
            "gas_limit": obj.get("gasLimit"),
            "gas_price": GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice.from_dict(obj.get("gasPrice")) if obj.get("gasPrice") is not None else None,
