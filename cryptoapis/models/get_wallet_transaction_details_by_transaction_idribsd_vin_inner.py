...
class GetWalletTransactionDetailsByTransactionIDRIBSDVinInner(BaseModel):
    """
    ...
    script_sig: GetWalletTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSDVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSDVinInner:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSDVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSDVinInner.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSDVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": GetWalletTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
