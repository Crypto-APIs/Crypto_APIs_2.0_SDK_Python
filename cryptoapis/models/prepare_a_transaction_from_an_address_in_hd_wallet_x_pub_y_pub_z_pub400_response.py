...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub400Response(BaseModel):
    """
    ...
    error: PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub400Response:
        """Create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub400Response.parse_obj(obj)

        _obj = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
