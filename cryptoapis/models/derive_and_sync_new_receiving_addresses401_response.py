...
class DeriveAndSyncNewReceivingAddresses401Response(BaseModel):
    """
    ...
    error: DeriveAndSyncNewReceivingAddressesE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewReceivingAddresses401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewReceivingAddresses401Response:
        """Create an instance of DeriveAndSyncNewReceivingAddresses401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewReceivingAddresses401Response.parse_obj(obj)

        _obj = DeriveAndSyncNewReceivingAddresses401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveAndSyncNewReceivingAddressesE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
