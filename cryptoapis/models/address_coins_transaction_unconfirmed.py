...
class AddressCoinsTransactionUnconfirmed(BaseModel):
    """
    ...
    data: AddressCoinsTransactionUnconfirmedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressCoinsTransactionUnconfirmed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressCoinsTransactionUnconfirmed:
        """Create an instance of AddressCoinsTransactionUnconfirmed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressCoinsTransactionUnconfirmed.parse_obj(obj)

        _obj = AddressCoinsTransactionUnconfirmed.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": AddressCoinsTransactionUnconfirmedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
