...
class ListHDWalletXPubYPubZPubTransactionsR(BaseModel):
    """
    ...
    data: ListHDWalletXPubYPubZPubTransactionsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubTransactionsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubTransactionsR:
        """Create an instance of ListHDWalletXPubYPubZPubTransactionsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubTransactionsR.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubTransactionsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListHDWalletXPubYPubZPubTransactionsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
