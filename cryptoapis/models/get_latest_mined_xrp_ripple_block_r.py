...
class GetLatestMinedXRPRippleBlockR(BaseModel):
    """
    ...
    data: GetLatestMinedXRPRippleBlockRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedXRPRippleBlockR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedXRPRippleBlockR:
        """Create an instance of GetLatestMinedXRPRippleBlockR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedXRPRippleBlockR.parse_obj(obj)

        _obj = GetLatestMinedXRPRippleBlockR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetLatestMinedXRPRippleBlockRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
