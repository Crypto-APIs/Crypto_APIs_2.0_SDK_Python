...
class ListConfirmedTransactionsByAddressRIBSBVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSBVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSBVinInner:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSBVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSBVinInner.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSBVinInner.parse_obj({
