...
class GetHDWalletXPubYPubZPubDetails401Response(BaseModel):
    """
    ...
    error: GetHDWalletXPubYPubZPubDetailsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubDetails401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubDetails401Response:
        """Create an instance of GetHDWalletXPubYPubZPubDetails401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubDetails401Response.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubDetails401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetHDWalletXPubYPubZPubDetailsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
