...
class ListInternalTransactionsByAddressAndTimeRange403Response(BaseModel):
    """
    ...
    error: ListInternalTransactionsByAddressAndTimeRangeE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddressAndTimeRange403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddressAndTimeRange403Response:
        """Create an instance of ListInternalTransactionsByAddressAndTimeRange403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddressAndTimeRange403Response.parse_obj(obj)

        _obj = ListInternalTransactionsByAddressAndTimeRange403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionsByAddressAndTimeRangeE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
