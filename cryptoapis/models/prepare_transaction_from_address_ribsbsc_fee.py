...
class PrepareTransactionFromAddressRIBSBSCFee(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddressRIBSBSCFee:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddressRIBSBSCFee:
        """Create an instance of PrepareTransactionFromAddressRIBSBSCFee from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddressRIBSBSCFee.parse_obj(obj)

        _obj = PrepareTransactionFromAddressRIBSBSCFee.parse_obj({
