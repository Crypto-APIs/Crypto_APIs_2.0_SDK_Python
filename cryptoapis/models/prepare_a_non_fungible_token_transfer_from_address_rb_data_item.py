...
class PrepareANonFungibleTokenTransferFromAddressRBDataItem(BaseModel):
    ...
    fee: PrepareANonFungibleTokenTransferFromAddressRBDataItemFee = Field(...)
    ...
    __properties = ["contract", "nonce", "recipient", "sender", "tokenId", "fee", "transactionType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareANonFungibleTokenTransferFromAddressRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareANonFungibleTokenTransferFromAddressRBDataItem:
        """Create an instance of PrepareANonFungibleTokenTransferFromAddressRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareANonFungibleTokenTransferFromAddressRBDataItem.parse_obj(obj)

        _obj = PrepareANonFungibleTokenTransferFromAddressRBDataItem.parse_obj({
            "contract": obj.get("contract"),
            "nonce": obj.get("nonce"),
            "recipient": obj.get("recipient"),
            "sender": obj.get("sender"),
            "token_id": obj.get("tokenId"),
            "fee": PrepareANonFungibleTokenTransferFromAddressRBDataItemFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
