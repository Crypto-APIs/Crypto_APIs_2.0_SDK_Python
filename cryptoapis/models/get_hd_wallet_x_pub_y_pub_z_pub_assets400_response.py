...
class GetHDWalletXPubYPubZPubAssets400Response(BaseModel):
    """
    ...
    error: GetHDWalletXPubYPubZPubAssetsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubAssets400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubAssets400Response:
        """Create an instance of GetHDWalletXPubYPubZPubAssets400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubAssets400Response.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubAssets400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetHDWalletXPubYPubZPubAssetsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
