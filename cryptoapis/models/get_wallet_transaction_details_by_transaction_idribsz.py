...
class GetWalletTransactionDetailsByTransactionIDRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    v_join_split: Optional[conlist(GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner)] = Field(None, alias="vJoinSplit", description="Represents a sequence of JoinSplit descriptions using BCTV14 proofs.")
    v_shielded_output: Optional[conlist(GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner)] = Field(None, alias="vShieldedOutput", description="Object Array representation of transaction output descriptions")
    v_shielded_spend: Optional[conlist(GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner)] = Field(None, alias="vShieldedSpend", description="Object Array representation of transaction spend descriptions")
    value_balance: StrictStr = Field(..., alias="valueBalance", description="String representation of the transaction value balance")
    ...
    vin: conlist(GetWalletTransactionDetailsByTransactionIDRIBSZVinInner) = Field(..., description="Object Array representation of transaction inputs")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSZ:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSZ.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSZ.parse_obj({
            ...
            "size": obj.get("size"),
            "v_join_split": [GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner.from_dict(_item) for _item in obj.get("vJoinSplit")] if obj.get("vJoinSplit") is not None else None,
            ...
            "vin": [GetWalletTransactionDetailsByTransactionIDRIBSZVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
