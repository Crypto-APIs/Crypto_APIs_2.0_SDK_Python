...
class GetTransactionDetailsByTransactionID400Response(BaseModel):
    """
    ...
    error: GetTransactionDetailsByTransactionIDE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionID400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionID400Response:
        """Create an instance of GetTransactionDetailsByTransactionID400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionID400Response.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionID400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionDetailsByTransactionIDE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
