...
class PrepareANonFungibleTokenTransferFromAddress400Response(BaseModel):
    """
    ...
    error: PrepareANonFungibleTokenTransferFromAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareANonFungibleTokenTransferFromAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareANonFungibleTokenTransferFromAddress400Response:
        """Create an instance of PrepareANonFungibleTokenTransferFromAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareANonFungibleTokenTransferFromAddress400Response.parse_obj(obj)

        _obj = PrepareANonFungibleTokenTransferFromAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareANonFungibleTokenTransferFromAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
