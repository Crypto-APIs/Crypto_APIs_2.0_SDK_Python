...
class SyncHDWalletXPubYPubZPub401Response(BaseModel):
    """
    ...
    error: SyncHDWalletXPubYPubZPubE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncHDWalletXPubYPubZPub401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncHDWalletXPubYPubZPub401Response:
        """Create an instance of SyncHDWalletXPubYPubZPub401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncHDWalletXPubYPubZPub401Response.parse_obj(obj)

        _obj = SyncHDWalletXPubYPubZPub401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncHDWalletXPubYPubZPubE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
