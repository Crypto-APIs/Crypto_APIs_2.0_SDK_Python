...
class GetAddressDetailsFromCallback401Response(BaseModel):
    """
    ...
    error: GetAddressDetailsFromCallbackE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressDetailsFromCallback401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressDetailsFromCallback401Response:
        """Create an instance of GetAddressDetailsFromCallback401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressDetailsFromCallback401Response.parse_obj(obj)

        _obj = GetAddressDetailsFromCallback401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAddressDetailsFromCallbackE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
