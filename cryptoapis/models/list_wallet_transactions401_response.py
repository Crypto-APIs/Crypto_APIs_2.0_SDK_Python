...
class ListWalletTransactions401Response(BaseModel):
    """
    ...
    error: ListWalletTransactionsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWalletTransactions401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWalletTransactions401Response:
        """Create an instance of ListWalletTransactions401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWalletTransactions401Response.parse_obj(obj)

        _obj = ListWalletTransactions401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListWalletTransactionsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
