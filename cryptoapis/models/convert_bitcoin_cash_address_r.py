...
class ConvertBitcoinCashAddressR(BaseModel):
    """
    ...
    data: ConvertBitcoinCashAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddressR:
        """Create an instance of ConvertBitcoinCashAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddressR.parse_obj(obj)

        _obj = ConvertBitcoinCashAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ConvertBitcoinCashAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
