...
class ListInternalTransactionsByAddressR(BaseModel):
    """
    ...
    data: ListInternalTransactionsByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddressR:
        """Create an instance of ListInternalTransactionsByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddressR.parse_obj(obj)

        _obj = ListInternalTransactionsByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListInternalTransactionsByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
