...
class GetZilliqaBlockDetailsByBlockHash401Response(BaseModel):
    """
    ...
    error: GetZilliqaBlockDetailsByBlockHashE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaBlockDetailsByBlockHash401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaBlockDetailsByBlockHash401Response:
        """Create an instance of GetZilliqaBlockDetailsByBlockHash401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaBlockDetailsByBlockHash401Response.parse_obj(obj)

        _obj = GetZilliqaBlockDetailsByBlockHash401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaBlockDetailsByBlockHashE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
