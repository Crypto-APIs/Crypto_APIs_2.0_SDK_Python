...
class DeleteBlockchainEventSubscription401Response(BaseModel):
    """
    ...
    error: DeleteBlockchainEventSubscriptionE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteBlockchainEventSubscription401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteBlockchainEventSubscription401Response:
        """Create an instance of DeleteBlockchainEventSubscription401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteBlockchainEventSubscription401Response.parse_obj(obj)

        _obj = DeleteBlockchainEventSubscription401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteBlockchainEventSubscriptionE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
