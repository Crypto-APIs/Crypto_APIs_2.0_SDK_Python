...
class ListTokensForwardingAutomations400Response(BaseModel):
    """
    ...
    error: ListTokensForwardingAutomationsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensForwardingAutomations400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensForwardingAutomations400Response:
        """Create an instance of ListTokensForwardingAutomations400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensForwardingAutomations400Response.parse_obj(obj)

        _obj = ListTokensForwardingAutomations400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensForwardingAutomationsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
