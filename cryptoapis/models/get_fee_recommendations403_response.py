...
class GetFeeRecommendations403Response(BaseModel):
    """
    ...
    error: GetFeeRecommendationsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeeRecommendations403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeeRecommendations403Response:
        """Create an instance of GetFeeRecommendations403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeeRecommendations403Response.parse_obj(obj)

        _obj = GetFeeRecommendations403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetFeeRecommendationsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
