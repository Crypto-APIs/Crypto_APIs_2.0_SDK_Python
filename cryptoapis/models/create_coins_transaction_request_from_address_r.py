...
class CreateCoinsTransactionRequestFromAddressR(BaseModel):
    """
    ...
    data: CreateCoinsTransactionRequestFromAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCoinsTransactionRequestFromAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCoinsTransactionRequestFromAddressR:
        """Create an instance of CreateCoinsTransactionRequestFromAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCoinsTransactionRequestFromAddressR.parse_obj(obj)

        _obj = CreateCoinsTransactionRequestFromAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateCoinsTransactionRequestFromAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
