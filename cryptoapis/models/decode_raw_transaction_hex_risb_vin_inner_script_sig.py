...
class DecodeRawTransactionHexRISBVinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISBVinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISBVinInnerScriptSig:
        """Create an instance of DecodeRawTransactionHexRISBVinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISBVinInnerScriptSig.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISBVinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
