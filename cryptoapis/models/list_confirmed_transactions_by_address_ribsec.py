...
class ListConfirmedTransactionsByAddressRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSEC:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSEC.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSEC.parse_obj({
            "contract": obj.get("contract"),
            "gas_limit": obj.get("gasLimit"),
            "gas_price": ListConfirmedTransactionsByAddressRIBSECGasPrice.from_dict(obj.get("gasPrice")) if obj.get("gasPrice") is not None else None,
