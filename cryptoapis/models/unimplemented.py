...
class Unimplemented(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Unimplemented:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Unimplemented:
        """Create an instance of Unimplemented from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Unimplemented.parse_obj(obj)

        _obj = Unimplemented.parse_obj({
            "code": obj.get("code"),
