...
class BroadcastTransactionSuccess(BaseModel):
    """
    ...
    data: BroadcastTransactionSuccessData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastTransactionSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastTransactionSuccess:
        """Create an instance of BroadcastTransactionSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastTransactionSuccess.parse_obj(obj)

        _obj = BroadcastTransactionSuccess.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": BroadcastTransactionSuccessData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
