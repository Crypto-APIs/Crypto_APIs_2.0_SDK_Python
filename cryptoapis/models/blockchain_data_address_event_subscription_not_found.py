...
class BlockchainDataAddressEventSubscriptionNotFound(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockchainDataAddressEventSubscriptionNotFound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockchainDataAddressEventSubscriptionNotFound:
        """Create an instance of BlockchainDataAddressEventSubscriptionNotFound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockchainDataAddressEventSubscriptionNotFound.parse_obj(obj)

        _obj = BlockchainDataAddressEventSubscriptionNotFound.parse_obj({
            "code": obj.get("code"),
