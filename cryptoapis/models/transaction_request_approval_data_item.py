...
class TransactionRequestApprovalDataItem(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestApprovalDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestApprovalDataItem:
        """Create an instance of TransactionRequestApprovalDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestApprovalDataItem.parse_obj(obj)

        _obj = TransactionRequestApprovalDataItem.parse_obj({
