...
class ListXRPRippleTransactionsByAddressRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddressRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddressRI:
        """Create an instance of ListXRPRippleTransactionsByAddressRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddressRI.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddressRI.parse_obj({
