...
class ListBlockchainEventsSubscriptions400Response(BaseModel):
    """
    ...
    error: ListBlockchainEventsSubscriptionsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListBlockchainEventsSubscriptions400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListBlockchainEventsSubscriptions400Response:
        """Create an instance of ListBlockchainEventsSubscriptions400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListBlockchainEventsSubscriptions400Response.parse_obj(obj)

        _obj = ListBlockchainEventsSubscriptions400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListBlockchainEventsSubscriptionsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
