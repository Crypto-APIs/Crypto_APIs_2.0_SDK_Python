...
class GenerateDepositAddressR(BaseModel):
    """
    ...
    data: GenerateDepositAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateDepositAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateDepositAddressR:
        """Create an instance of GenerateDepositAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateDepositAddressR.parse_obj(obj)

        _obj = GenerateDepositAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GenerateDepositAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
