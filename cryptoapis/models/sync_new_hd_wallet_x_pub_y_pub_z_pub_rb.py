...
class SyncNewHDWalletXPubYPubZPubRB(BaseModel):
    """
    ...
    data: SyncHDWalletXPubYPubZPubRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncNewHDWalletXPubYPubZPubRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncNewHDWalletXPubYPubZPubRB:
        """Create an instance of SyncNewHDWalletXPubYPubZPubRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncNewHDWalletXPubYPubZPubRB.parse_obj(obj)

        _obj = SyncNewHDWalletXPubYPubZPubRB.parse_obj({
            "context": obj.get("context"),
            "data": SyncHDWalletXPubYPubZPubRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
