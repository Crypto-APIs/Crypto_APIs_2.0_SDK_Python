...
class WalletAsAServiceDepositAddressesLimitReached(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletAsAServiceDepositAddressesLimitReached:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletAsAServiceDepositAddressesLimitReached:
        """Create an instance of WalletAsAServiceDepositAddressesLimitReached from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletAsAServiceDepositAddressesLimitReached.parse_obj(obj)

        _obj = WalletAsAServiceDepositAddressesLimitReached.parse_obj({
            "code": obj.get("code"),
