...
class GetBlockDetailsByBlockHashRIBSD2(BaseModel):
    """
    Dash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashRIBSD2:
        """Create an instance of GetBlockDetailsByBlockHashRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashRIBSD2.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashRIBSD2.parse_obj({
