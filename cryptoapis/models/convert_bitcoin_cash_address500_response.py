...
class ConvertBitcoinCashAddress500Response(BaseModel):
    """
    ...
    error: UnexpectedServerError = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress500Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress500Response:
        """Create an instance of ConvertBitcoinCashAddress500Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress500Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress500Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": UnexpectedServerError.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
