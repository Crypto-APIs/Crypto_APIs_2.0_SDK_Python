...
class ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey:
        """Create an instance of ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey.parse_obj({
