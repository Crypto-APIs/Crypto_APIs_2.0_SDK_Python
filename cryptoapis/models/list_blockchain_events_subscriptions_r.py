...
class ListBlockchainEventsSubscriptionsR(BaseModel):
    """
    ...
    data: ListBlockchainEventsSubscriptionsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListBlockchainEventsSubscriptionsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListBlockchainEventsSubscriptionsR:
        """Create an instance of ListBlockchainEventsSubscriptionsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListBlockchainEventsSubscriptionsR.parse_obj(obj)

        _obj = ListBlockchainEventsSubscriptionsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListBlockchainEventsSubscriptionsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
