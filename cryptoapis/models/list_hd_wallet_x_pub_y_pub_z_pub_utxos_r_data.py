...
class ListHDWalletXPubYPubZPubUTXOsRData(BaseModel):
    """
    ...
    items: conlist(ListHDWalletXPubYPubZPubUTXOsRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubUTXOsRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubUTXOsRData:
        """Create an instance of ListHDWalletXPubYPubZPubUTXOsRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubUTXOsRData.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubUTXOsRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListHDWalletXPubYPubZPubUTXOsRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
