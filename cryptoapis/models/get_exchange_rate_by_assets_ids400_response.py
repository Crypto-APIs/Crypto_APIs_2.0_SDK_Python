...
class GetExchangeRateByAssetsIDs400Response(BaseModel):
    """
    ...
    error: GetExchangeRateByAssetsIDsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetsIDs400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetsIDs400Response:
        """Create an instance of GetExchangeRateByAssetsIDs400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetsIDs400Response.parse_obj(obj)

        _obj = GetExchangeRateByAssetsIDs400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetExchangeRateByAssetsIDsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
