...
class ListDepositAddressesR(BaseModel):
    """
    ...
    data: ListDepositAddressesRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDepositAddressesR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDepositAddressesR:
        """Create an instance of ListDepositAddressesR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListDepositAddressesR.parse_obj(obj)

        _obj = ListDepositAddressesR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListDepositAddressesRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
