...
class AddressTokensTransactionConfirmedEachConfirmation(BaseModel):
    ...
    data: AddressTokensTransactionConfirmedEachConfirmationData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedEachConfirmation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedEachConfirmation:
        """Create an instance of AddressTokensTransactionConfirmedEachConfirmation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedEachConfirmation.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedEachConfirmation.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": AddressTokensTransactionConfirmedEachConfirmationData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
