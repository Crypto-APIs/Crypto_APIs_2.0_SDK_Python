...
class GetWalletAssetDetails403Response(BaseModel):
    """
    ...
    error: GetWalletAssetDetailsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletAssetDetails403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletAssetDetails403Response:
        """Create an instance of GetWalletAssetDetails403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletAssetDetails403Response.parse_obj(obj)

        _obj = GetWalletAssetDetails403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetWalletAssetDetailsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
