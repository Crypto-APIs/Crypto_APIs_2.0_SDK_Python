...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner(BaseModel):
    """
    ...
    derivation_index: StrictInt = Field(..., alias="derivationIndex", description="Representation of the derivation index of the xpub")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner:
        """Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner.parse_obj(obj)

        _obj = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner.parse_obj({
