...
class GetXRPRippleBlockDetailsByBlockHeight403Response(BaseModel):
    """
    ...
    error: GetXRPRippleBlockDetailsByBlockHeightE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleBlockDetailsByBlockHeight403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleBlockDetailsByBlockHeight403Response:
        """Create an instance of GetXRPRippleBlockDetailsByBlockHeight403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleBlockDetailsByBlockHeight403Response.parse_obj(obj)

        _obj = GetXRPRippleBlockDetailsByBlockHeight403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleBlockDetailsByBlockHeightE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
