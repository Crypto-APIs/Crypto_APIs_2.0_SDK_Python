...
class MinedTransactionR(BaseModel):
    """
    MinedTransactionR
    """
    ...
    data: MinedTransactionRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MinedTransactionR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MinedTransactionR:
        """Create an instance of MinedTransactionR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MinedTransactionR.parse_obj(obj)

        _obj = MinedTransactionR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": MinedTransactionRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
