...
class GetTransactionDetailsByTransactionIDRIBSECGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSECGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSECGasPrice:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSECGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSECGasPrice.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSECGasPrice.parse_obj({
