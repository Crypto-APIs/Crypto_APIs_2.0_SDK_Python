...
class ListZilliqaTransactionsByBlockHashRData(BaseModel):
    """
    ...
    items: conlist(ListZilliqaTransactionsByBlockHashRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHashRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHashRData:
        """Create an instance of ListZilliqaTransactionsByBlockHashRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHashRData.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHashRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListZilliqaTransactionsByBlockHashRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
