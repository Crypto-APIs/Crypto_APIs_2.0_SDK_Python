...
class AddressTokensTransactionConfirmedEachConfirmationTrc20(BaseModel):
    """
    TRC-20
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedEachConfirmationTrc20:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedEachConfirmationTrc20:
        """Create an instance of AddressTokensTransactionConfirmedEachConfirmationTrc20 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedEachConfirmationTrc20.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedEachConfirmationTrc20.parse_obj({
            "name": obj.get("name"),
