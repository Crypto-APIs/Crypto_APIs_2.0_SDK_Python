...
class GetLastMinedBlock400Response(BaseModel):
    """
    ...
    error: GetLastMinedBlockE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlock400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlock400Response:
        """Create an instance of GetLastMinedBlock400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlock400Response.parse_obj(obj)

        _obj = GetLastMinedBlock400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLastMinedBlockE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
