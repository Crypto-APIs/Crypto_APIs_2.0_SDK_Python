...
class DeriveAndSyncNewChangeAddressesRB(BaseModel):
    """
    ...
    data: DeriveAndSyncNewChangeAddressesRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewChangeAddressesRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewChangeAddressesRB:
        """Create an instance of DeriveAndSyncNewChangeAddressesRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewChangeAddressesRB.parse_obj(obj)

        _obj = DeriveAndSyncNewChangeAddressesRB.parse_obj({
            "context": obj.get("context"),
            "data": DeriveAndSyncNewChangeAddressesRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
