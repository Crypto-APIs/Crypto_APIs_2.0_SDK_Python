...
class GetXRPRippleTransactionDetailsByTransactionID404Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleTransactionDetailsByTransactionID404Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleTransactionDetailsByTransactionID404Response:
        """Create an instance of GetXRPRippleTransactionDetailsByTransactionID404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleTransactionDetailsByTransactionID404Response.parse_obj(obj)

        _obj = GetXRPRippleTransactionDetailsByTransactionID404Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ResourceNotFound.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
