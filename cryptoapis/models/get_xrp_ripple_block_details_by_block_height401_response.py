...
class GetXRPRippleBlockDetailsByBlockHeight401Response(BaseModel):
    """
    ...
    error: GetXRPRippleBlockDetailsByBlockHeightE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleBlockDetailsByBlockHeight401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleBlockDetailsByBlockHeight401Response:
        """Create an instance of GetXRPRippleBlockDetailsByBlockHeight401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleBlockDetailsByBlockHeight401Response.parse_obj(obj)

        _obj = GetXRPRippleBlockDetailsByBlockHeight401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleBlockDetailsByBlockHeightE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
