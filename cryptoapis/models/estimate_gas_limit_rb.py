...
class EstimateGasLimitRB(BaseModel):
    """
    EstimateGasLimitRB
    """
    ...
    data: EstimateGasLimitRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateGasLimitRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateGasLimitRB:
        """Create an instance of EstimateGasLimitRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateGasLimitRB.parse_obj(obj)

        _obj = EstimateGasLimitRB.parse_obj({
            "context": obj.get("context"),
            "data": EstimateGasLimitRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
