...
class GetBlockDetailsByBlockHeightFromCallbackRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    mined_in_seconds: StrictInt = Field(..., alias="minedInSeconds", description="Specifies the amount of time required for the block to be mined in second")
    ...
    uncles: Optional[conlist(StrictStr)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSBSC:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSBSC.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSBSC.parse_obj({
