...
class GetExchangeRateByAssetsIDs401Response(BaseModel):
    """
    ...
    error: GetExchangeRateByAssetsIDsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetsIDs401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetsIDs401Response:
        """Create an instance of GetExchangeRateByAssetsIDs401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetsIDs401Response.parse_obj(obj)

        _obj = GetExchangeRateByAssetsIDs401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetExchangeRateByAssetsIDsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
