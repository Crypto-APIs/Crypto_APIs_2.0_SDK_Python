...
class ListSupportedAssets400Response(BaseModel):
    """
    ...
    error: ListSupportedAssetsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedAssets400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedAssets400Response:
        """Create an instance of ListSupportedAssets400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedAssets400Response.parse_obj(obj)

        _obj = ListSupportedAssets400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSupportedAssetsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
