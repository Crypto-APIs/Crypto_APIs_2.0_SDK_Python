...
class ListTransactionsByBlockHashRIBSLVinInner(BaseModel):
    """
    ...
    script_sig: ListTransactionsByBlockHashRIBSLVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSLVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSLVinInner:
        """Create an instance of ListTransactionsByBlockHashRIBSLVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSLVinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSLVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": ListTransactionsByBlockHashRIBSLVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
