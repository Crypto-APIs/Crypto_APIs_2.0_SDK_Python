...
class NewConfirmedCoinsTransactionsRBDataItem(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedCoinsTransactionsRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedCoinsTransactionsRBDataItem:
        """Create an instance of NewConfirmedCoinsTransactionsRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedCoinsTransactionsRBDataItem.parse_obj(obj)

        _obj = NewConfirmedCoinsTransactionsRBDataItem.parse_obj({
