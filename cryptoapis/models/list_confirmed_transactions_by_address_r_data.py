...
class ListConfirmedTransactionsByAddressRData(BaseModel):
    """
    ...
    items: conlist(ListConfirmedTransactionsByAddressRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRData:
        """Create an instance of ListConfirmedTransactionsByAddressRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRData.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListConfirmedTransactionsByAddressRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
