...
class CreateAutomaticTokensForwardingRB(BaseModel):
    """
    ...
    data: CreateAutomaticTokensForwardingRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAutomaticTokensForwardingRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAutomaticTokensForwardingRB:
        """Create an instance of CreateAutomaticTokensForwardingRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAutomaticTokensForwardingRB.parse_obj(obj)

        _obj = CreateAutomaticTokensForwardingRB.parse_obj({
            "context": obj.get("context"),
            "data": CreateAutomaticTokensForwardingRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
