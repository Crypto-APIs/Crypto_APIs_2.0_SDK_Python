...
class ListTokensByAddressRData(BaseModel):
    """
    ...
    items: conlist(ListTokensByAddressRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensByAddressRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensByAddressRData:
        """Create an instance of ListTokensByAddressRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensByAddressRData.parse_obj(obj)

        _obj = ListTokensByAddressRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListTokensByAddressRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
