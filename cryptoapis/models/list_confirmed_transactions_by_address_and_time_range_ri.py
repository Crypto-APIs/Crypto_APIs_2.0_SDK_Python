...
class ListConfirmedTransactionsByAddressAndTimeRangeRI(BaseModel):
    """
    ...
    recipients: conlist(GetTransactionDetailsByTransactionIDRIRecipientsInner) = Field(..., description="Represents a list of recipient addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.")
    senders: conlist(GetTransactionDetailsByTransactionIDRISendersInner) = Field(..., description="Represents a list of sender addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.")
    ...
    fee: ListConfirmedTransactionsByAddressAndTimeRangeRIFee = Field(...)
    blockchain_specific: ListConfirmedTransactionsByAddressAndTimeRangeRIBS = Field(..., alias="blockchainSpecific")
    __properties = ["transactionId", "index", "minedInBlockHash", "minedInBlockHeight", "recipients", "senders", "timestamp", "transactionHash", "fee", "blockchainSpecific"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRI:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRI.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRI.parse_obj({
            "transaction_id": obj.get("transactionId"),
            "index": obj.get("index"),
            "mined_in_block_hash": obj.get("minedInBlockHash"),
            "mined_in_block_height": obj.get("minedInBlockHeight"),
            "recipients": [GetTransactionDetailsByTransactionIDRIRecipientsInner.from_dict(_item) for _item in obj.get("recipients")] if obj.get("recipients") is not None else None,
            "senders": [GetTransactionDetailsByTransactionIDRISendersInner.from_dict(_item) for _item in obj.get("senders")] if obj.get("senders") is not None else None,
            "timestamp": obj.get("timestamp"),
            "transaction_hash": obj.get("transactionHash"),
            "fee": ListConfirmedTransactionsByAddressAndTimeRangeRIFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "blockchain_specific": ListConfirmedTransactionsByAddressAndTimeRangeRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
