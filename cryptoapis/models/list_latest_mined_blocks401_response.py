...
class ListLatestMinedBlocks401Response(BaseModel):
    """
    ...
    error: ListLatestMinedBlocksE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocks401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocks401Response:
        """Create an instance of ListLatestMinedBlocks401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocks401Response.parse_obj(obj)

        _obj = ListLatestMinedBlocks401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListLatestMinedBlocksE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
