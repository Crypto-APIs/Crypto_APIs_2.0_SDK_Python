...
class ListTransactionsByBlockHeightRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    vin: conlist(ListTransactionsByBlockHeightRIBSLVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(ListTransactionsByBlockHashRIBSLVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSL:
        """Create an instance of ListTransactionsByBlockHeightRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSL.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSL.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [ListTransactionsByBlockHeightRIBSLVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [ListTransactionsByBlockHashRIBSLVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
