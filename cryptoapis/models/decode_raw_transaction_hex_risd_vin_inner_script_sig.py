...
class DecodeRawTransactionHexRISDVinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISDVinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISDVinInnerScriptSig:
        """Create an instance of DecodeRawTransactionHexRISDVinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISDVinInnerScriptSig.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISDVinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
