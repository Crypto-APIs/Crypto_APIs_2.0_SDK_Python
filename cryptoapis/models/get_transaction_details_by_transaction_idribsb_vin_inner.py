...
class GetTransactionDetailsByTransactionIDRIBSBVinInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSBVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSBVinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSBVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSBVinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSBVinInner.parse_obj({
