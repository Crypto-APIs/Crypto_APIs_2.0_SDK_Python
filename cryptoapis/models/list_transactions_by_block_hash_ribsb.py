...
class ListTransactionsByBlockHashRIBSB(BaseModel):
    """
    Bitcoin
    """
    ...
    vout: conlist(ListTransactionsByBlockHashRIBSBVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSB:
        """Create an instance of ListTransactionsByBlockHashRIBSB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSB.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSB.parse_obj({
            ...
            "vout": [ListTransactionsByBlockHashRIBSBVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
