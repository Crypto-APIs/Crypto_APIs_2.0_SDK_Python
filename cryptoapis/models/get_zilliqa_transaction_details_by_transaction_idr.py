...
class GetZilliqaTransactionDetailsByTransactionIDR(BaseModel):
    """
    ...
    data: GetZilliqaTransactionDetailsByTransactionIDRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaTransactionDetailsByTransactionIDR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaTransactionDetailsByTransactionIDR:
        """Create an instance of GetZilliqaTransactionDetailsByTransactionIDR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaTransactionDetailsByTransactionIDR.parse_obj(obj)

        _obj = GetZilliqaTransactionDetailsByTransactionIDR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetZilliqaTransactionDetailsByTransactionIDRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
