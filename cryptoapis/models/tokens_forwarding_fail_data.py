...
class TokensForwardingFailData(BaseModel):
    """
    ...
    item: TokensForwardingFailDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokensForwardingFailData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokensForwardingFailData:
        """Create an instance of TokensForwardingFailData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokensForwardingFailData.parse_obj(obj)

        _obj = TokensForwardingFailData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": TokensForwardingFailDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
