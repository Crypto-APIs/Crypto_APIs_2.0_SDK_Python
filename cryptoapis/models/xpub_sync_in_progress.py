...
class XpubSyncInProgress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> XpubSyncInProgress:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> XpubSyncInProgress:
        """Create an instance of XpubSyncInProgress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return XpubSyncInProgress.parse_obj(obj)

        _obj = XpubSyncInProgress.parse_obj({
            "code": obj.get("code"),
