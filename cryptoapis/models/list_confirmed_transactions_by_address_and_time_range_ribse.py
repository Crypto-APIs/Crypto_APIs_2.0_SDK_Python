...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSE:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRIBSE.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRIBSE.parse_obj({
