...
class GetZilliqaAddressDetailsR(BaseModel):
    """
    ...
    data: GetZilliqaAddressDetailsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaAddressDetailsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaAddressDetailsR:
        """Create an instance of GetZilliqaAddressDetailsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaAddressDetailsR.parse_obj(obj)

        _obj = GetZilliqaAddressDetailsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetZilliqaAddressDetailsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
