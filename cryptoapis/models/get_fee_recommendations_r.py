...
class GetFeeRecommendationsR(BaseModel):
    """
    ...
    data: GetFeeRecommendationsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeeRecommendationsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeeRecommendationsR:
        """Create an instance of GetFeeRecommendationsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeeRecommendationsR.parse_obj(obj)

        _obj = GetFeeRecommendationsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetFeeRecommendationsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
