...
class NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem(BaseModel):
    """
    ...
    __properties = ["address", "allowDuplicates", "callbackSecretKey", "callbackUrl", "confirmationsCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem:
        """Create an instance of NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem.parse_obj(obj)

        _obj = NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem.parse_obj({
