...
class ListZilliqaTransactionsByBlockHash400Response(BaseModel):
    """
    ...
    error: ListZilliqaTransactionsByBlockHashE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHash400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHash400Response:
        """Create an instance of ListZilliqaTransactionsByBlockHash400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHash400Response.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHash400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListZilliqaTransactionsByBlockHashE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
