...
class AddressInternalTransactionConfirmed(BaseModel):
    """
    ...
    data: AddressInternalTransactionConfirmedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressInternalTransactionConfirmed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressInternalTransactionConfirmed:
        """Create an instance of AddressInternalTransactionConfirmed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressInternalTransactionConfirmed.parse_obj(obj)

        _obj = AddressInternalTransactionConfirmed.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": AddressInternalTransactionConfirmedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
