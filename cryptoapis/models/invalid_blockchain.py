...
class InvalidBlockchain(BaseModel):
    """
    invalid_blockchain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidBlockchain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidBlockchain:
        """Create an instance of InvalidBlockchain from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidBlockchain.parse_obj(obj)

        _obj = InvalidBlockchain.parse_obj({
            "code": obj.get("code"),
