...
class DecodeXAddressR(BaseModel):
    """
    DecodeXAddressR
    """
    ...
    data: DecodeXAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeXAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeXAddressR:
        """Create an instance of DecodeXAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeXAddressR.parse_obj(obj)

        _obj = DecodeXAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": DecodeXAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
