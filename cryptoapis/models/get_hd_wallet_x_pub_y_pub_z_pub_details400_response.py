...
class GetHDWalletXPubYPubZPubDetails400Response(BaseModel):
    """
    ...
    error: GetHDWalletXPubYPubZPubDetailsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubDetails400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubDetails400Response:
        """Create an instance of GetHDWalletXPubYPubZPubDetails400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubDetails400Response.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubDetails400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetHDWalletXPubYPubZPubDetailsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
