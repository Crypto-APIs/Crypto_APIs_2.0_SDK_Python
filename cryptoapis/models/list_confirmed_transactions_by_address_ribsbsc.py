...
class ListConfirmedTransactionsByAddressRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSBSC:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSBSC.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSBSC.parse_obj({
