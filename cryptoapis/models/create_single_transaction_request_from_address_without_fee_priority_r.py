...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityR(BaseModel):
    """
    ...
    data: CreateSingleTransactionRequestFromAddressWithoutFeePriorityRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSingleTransactionRequestFromAddressWithoutFeePriorityR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSingleTransactionRequestFromAddressWithoutFeePriorityR:
        """Create an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSingleTransactionRequestFromAddressWithoutFeePriorityR.parse_obj(obj)

        _obj = CreateSingleTransactionRequestFromAddressWithoutFeePriorityR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateSingleTransactionRequestFromAddressWithoutFeePriorityRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
