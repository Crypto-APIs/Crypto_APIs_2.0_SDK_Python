...
class ListSupportedAssets401Response(BaseModel):
    """
    ...
    error: ListSupportedAssetsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedAssets401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedAssets401Response:
        """Create an instance of ListSupportedAssets401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedAssets401Response.parse_obj(obj)

        _obj = ListSupportedAssets401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSupportedAssetsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
