...
class NewUnconfirmedTokensTransactionsRBDataItem(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewUnconfirmedTokensTransactionsRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewUnconfirmedTokensTransactionsRBDataItem:
        """Create an instance of NewUnconfirmedTokensTransactionsRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewUnconfirmedTokensTransactionsRBDataItem.parse_obj(obj)

        _obj = NewUnconfirmedTokensTransactionsRBDataItem.parse_obj({
