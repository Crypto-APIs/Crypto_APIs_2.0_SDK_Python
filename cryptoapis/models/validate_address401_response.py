...
class ValidateAddress401Response(BaseModel):
    """
    ...
    error: ValidateAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateAddress401Response:
        """Create an instance of ValidateAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateAddress401Response.parse_obj(obj)

        _obj = ValidateAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ValidateAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
