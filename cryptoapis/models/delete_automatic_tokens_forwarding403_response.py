...
class DeleteAutomaticTokensForwarding403Response(BaseModel):
    """
    ...
    error: DeleteAutomaticTokensForwardingE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticTokensForwarding403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticTokensForwarding403Response:
        """Create an instance of DeleteAutomaticTokensForwarding403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticTokensForwarding403Response.parse_obj(obj)

        _obj = DeleteAutomaticTokensForwarding403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteAutomaticTokensForwardingE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
