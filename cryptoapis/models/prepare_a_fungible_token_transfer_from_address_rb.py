...
class PrepareAFungibleTokenTransferFromAddressRB(BaseModel):
    """
    ...
    data: PrepareAFungibleTokenTransferFromAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAFungibleTokenTransferFromAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAFungibleTokenTransferFromAddressRB:
        """Create an instance of PrepareAFungibleTokenTransferFromAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAFungibleTokenTransferFromAddressRB.parse_obj(obj)

        _obj = PrepareAFungibleTokenTransferFromAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": PrepareAFungibleTokenTransferFromAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
