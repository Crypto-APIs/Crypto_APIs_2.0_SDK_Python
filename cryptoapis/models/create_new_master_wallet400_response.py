...
class CreateNewMasterWallet400Response(BaseModel):
    """
    ...
    error: CreateNewMasterWalletE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNewMasterWallet400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNewMasterWallet400Response:
        """Create an instance of CreateNewMasterWallet400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateNewMasterWallet400Response.parse_obj(obj)

        _obj = CreateNewMasterWallet400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": CreateNewMasterWalletE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
