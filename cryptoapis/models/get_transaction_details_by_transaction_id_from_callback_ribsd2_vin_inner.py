...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner(BaseModel):
    """
    ...
    script_sig: GetTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": GetTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
