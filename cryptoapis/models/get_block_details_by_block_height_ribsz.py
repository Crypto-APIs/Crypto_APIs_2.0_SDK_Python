...
class GetBlockDetailsByBlockHeightRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    version: StrictInt = Field(..., description="Represents the block version number.")
    __properties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightRIBSZ:
        """Create an instance of GetBlockDetailsByBlockHeightRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightRIBSZ.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightRIBSZ.parse_obj({
