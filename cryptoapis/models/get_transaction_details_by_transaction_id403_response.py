...
class GetTransactionDetailsByTransactionID403Response(BaseModel):
    """
    ...
    error: GetTransactionDetailsByTransactionIDE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionID403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionID403Response:
        """Create an instance of GetTransactionDetailsByTransactionID403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionID403Response.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionID403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionDetailsByTransactionIDE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
