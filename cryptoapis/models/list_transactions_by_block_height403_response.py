...
class ListTransactionsByBlockHeight403Response(BaseModel):
    """
    ...
    error: ListTransactionsByBlockHeightE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeight403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeight403Response:
        """Create an instance of ListTransactionsByBlockHeight403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeight403Response.parse_obj(obj)

        _obj = ListTransactionsByBlockHeight403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTransactionsByBlockHeightE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
