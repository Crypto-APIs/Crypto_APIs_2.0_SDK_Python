...
class ListLatestMinedBlocksRIBSEC(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksRIBSEC:
        """Create an instance of ListLatestMinedBlocksRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocksRIBSEC.parse_obj(obj)

        _obj = ListLatestMinedBlocksRIBSEC.parse_obj({
