...
class ListTransactionsByBlockHashRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSEC:
        """Create an instance of ListTransactionsByBlockHashRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSEC.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSEC.parse_obj({
