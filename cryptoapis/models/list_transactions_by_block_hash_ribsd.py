...
class ListTransactionsByBlockHashRIBSD(BaseModel):
    """
    Dogecoin
    """
    ...
    vin: conlist(ListTransactionsByBlockHashRIBSDVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(ListTransactionsByBlockHashRIBSDVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSD:
        """Create an instance of ListTransactionsByBlockHashRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSD.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSD.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [ListTransactionsByBlockHashRIBSDVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [ListTransactionsByBlockHashRIBSDVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
