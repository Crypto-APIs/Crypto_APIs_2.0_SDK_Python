...
class GetLastMinedBlock401Response(BaseModel):
    """
    ...
    error: GetLastMinedBlockE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlock401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlock401Response:
        """Create an instance of GetLastMinedBlock401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlock401Response.parse_obj(obj)

        _obj = GetLastMinedBlock401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLastMinedBlockE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
