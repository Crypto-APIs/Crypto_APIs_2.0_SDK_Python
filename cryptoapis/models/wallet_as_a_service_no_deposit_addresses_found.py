...
class WalletAsAServiceNoDepositAddressesFound(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletAsAServiceNoDepositAddressesFound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletAsAServiceNoDepositAddressesFound:
        """Create an instance of WalletAsAServiceNoDepositAddressesFound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletAsAServiceNoDepositAddressesFound.parse_obj(obj)

        _obj = WalletAsAServiceNoDepositAddressesFound.parse_obj({
            "code": obj.get("code"),
