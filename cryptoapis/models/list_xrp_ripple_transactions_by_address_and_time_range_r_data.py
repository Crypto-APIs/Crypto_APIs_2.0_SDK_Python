...
class ListXRPRippleTransactionsByAddressAndTimeRangeRData(BaseModel):
    """
    ...
    items: conlist(ListXRPRippleTransactionsByAddressAndTimeRangeRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddressAndTimeRangeRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddressAndTimeRangeRData:
        """Create an instance of ListXRPRippleTransactionsByAddressAndTimeRangeRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddressAndTimeRangeRData.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddressAndTimeRangeRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListXRPRippleTransactionsByAddressAndTimeRangeRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
