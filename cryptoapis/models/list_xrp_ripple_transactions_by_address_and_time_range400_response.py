...
class ListXRPRippleTransactionsByAddressAndTimeRange400Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByAddressAndTimeRangeE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddressAndTimeRange400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddressAndTimeRange400Response:
        """Create an instance of ListXRPRippleTransactionsByAddressAndTimeRange400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddressAndTimeRange400Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddressAndTimeRange400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByAddressAndTimeRangeE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
