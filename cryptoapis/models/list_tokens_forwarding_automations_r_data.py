...
class ListTokensForwardingAutomationsRData(BaseModel):
    """
    ...
    items: conlist(ListTokensForwardingAutomationsRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensForwardingAutomationsRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensForwardingAutomationsRData:
        """Create an instance of ListTokensForwardingAutomationsRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensForwardingAutomationsRData.parse_obj(obj)

        _obj = ListTokensForwardingAutomationsRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListTokensForwardingAutomationsRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
