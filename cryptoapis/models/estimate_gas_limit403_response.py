...
class EstimateGasLimit403Response(BaseModel):
    """
    ...
    error: EstimateGasLimitE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateGasLimit403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateGasLimit403Response:
        """Create an instance of EstimateGasLimit403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateGasLimit403Response.parse_obj(obj)

        _obj = EstimateGasLimit403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateGasLimitE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
