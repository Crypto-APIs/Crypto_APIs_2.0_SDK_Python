...
class ListTransactionsByBlockHeightRIBSZVJoinSplitInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSZVJoinSplitInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSZVJoinSplitInner:
        """Create an instance of ListTransactionsByBlockHeightRIBSZVJoinSplitInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSZVJoinSplitInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSZVJoinSplitInner.parse_obj({
