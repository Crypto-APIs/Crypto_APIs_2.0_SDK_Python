...
class GetExchangeRateByAssetSymbols403Response(BaseModel):
    """
    ...
    error: GetExchangeRateByAssetSymbolsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetSymbols403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetSymbols403Response:
        """Create an instance of GetExchangeRateByAssetSymbols403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetSymbols403Response.parse_obj(obj)

        _obj = GetExchangeRateByAssetSymbols403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetExchangeRateByAssetSymbolsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
