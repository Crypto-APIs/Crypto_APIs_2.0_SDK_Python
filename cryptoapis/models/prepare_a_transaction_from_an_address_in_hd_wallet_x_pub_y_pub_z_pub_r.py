...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR(BaseModel):
    """
    ...
    data: PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR:
        """Create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR.parse_obj(obj)

        _obj = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
