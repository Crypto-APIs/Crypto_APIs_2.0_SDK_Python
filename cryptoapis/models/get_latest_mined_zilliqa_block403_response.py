...
class GetLatestMinedZilliqaBlock403Response(BaseModel):
    """
    ...
    error: GetLatestMinedZilliqaBlockE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedZilliqaBlock403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedZilliqaBlock403Response:
        """Create an instance of GetLatestMinedZilliqaBlock403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedZilliqaBlock403Response.parse_obj(obj)

        _obj = GetLatestMinedZilliqaBlock403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLatestMinedZilliqaBlockE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
