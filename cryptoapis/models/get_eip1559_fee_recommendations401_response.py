...
class GetEIP1559FeeRecommendations401Response(BaseModel):
    """
    ...
    error: GetEIP1559FeeRecommendationsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetEIP1559FeeRecommendations401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetEIP1559FeeRecommendations401Response:
        """Create an instance of GetEIP1559FeeRecommendations401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetEIP1559FeeRecommendations401Response.parse_obj(obj)

        _obj = GetEIP1559FeeRecommendations401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetEIP1559FeeRecommendationsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
