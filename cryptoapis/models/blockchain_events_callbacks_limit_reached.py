...
class BlockchainEventsCallbacksLimitReached(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockchainEventsCallbacksLimitReached:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockchainEventsCallbacksLimitReached:
        """Create an instance of BlockchainEventsCallbacksLimitReached from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockchainEventsCallbacksLimitReached.parse_obj(obj)

        _obj = BlockchainEventsCallbacksLimitReached.parse_obj({
            "code": obj.get("code"),
