...
class ListTransactionsByBlockHeightRIBSLVinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSLVinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSLVinInnerScriptSig:
        """Create an instance of ListTransactionsByBlockHeightRIBSLVinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSLVinInnerScriptSig.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSLVinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
