...
class ListTransactionsByBlockHashRIBSBCVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSBCVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSBCVinInner:
        """Create an instance of ListTransactionsByBlockHashRIBSBCVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSBCVinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSBCVinInner.parse_obj({
