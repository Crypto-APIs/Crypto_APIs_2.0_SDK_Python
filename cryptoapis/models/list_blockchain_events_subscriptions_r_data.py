...
class ListBlockchainEventsSubscriptionsRData(BaseModel):
    """
    ...
    items: conlist(ListBlockchainEventsSubscriptionsRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListBlockchainEventsSubscriptionsRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListBlockchainEventsSubscriptionsRData:
        """Create an instance of ListBlockchainEventsSubscriptionsRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListBlockchainEventsSubscriptionsRData.parse_obj(obj)

        _obj = ListBlockchainEventsSubscriptionsRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListBlockchainEventsSubscriptionsRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
