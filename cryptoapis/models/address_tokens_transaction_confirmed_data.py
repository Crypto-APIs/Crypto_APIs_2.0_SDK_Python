...
class AddressTokensTransactionConfirmedData(BaseModel):
    """
    ...
    item: AddressTokensTransactionConfirmedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedData:
        """Create an instance of AddressTokensTransactionConfirmedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedData.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": AddressTokensTransactionConfirmedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
