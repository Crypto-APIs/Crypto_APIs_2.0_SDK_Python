...
class ListHDWalletXPubYPubZPubUTXOs400Response(BaseModel):
    """
    ...
    error: ListHDWalletXPubYPubZPubUTXOsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubUTXOs400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubUTXOs400Response:
        """Create an instance of ListHDWalletXPubYPubZPubUTXOs400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubUTXOs400Response.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubUTXOs400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListHDWalletXPubYPubZPubUTXOsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
