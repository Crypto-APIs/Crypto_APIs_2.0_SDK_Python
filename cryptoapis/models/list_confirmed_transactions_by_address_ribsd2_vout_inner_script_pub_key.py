...
class ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey.parse_obj({
