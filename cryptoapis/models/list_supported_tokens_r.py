...
class ListSupportedTokensR(BaseModel):
    """
    ...
    data: ListSupportedTokensRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedTokensR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedTokensR:
        """Create an instance of ListSupportedTokensR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedTokensR.parse_obj(obj)

        _obj = ListSupportedTokensR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListSupportedTokensRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
