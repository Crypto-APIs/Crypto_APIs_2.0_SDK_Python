...
class GetInternalTransactionByTransactionHashAndOperationIdR(BaseModel):
    """
    ...
    data: GetInternalTransactionByTransactionHashAndOperationIdRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInternalTransactionByTransactionHashAndOperationIdR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInternalTransactionByTransactionHashAndOperationIdR:
        """Create an instance of GetInternalTransactionByTransactionHashAndOperationIdR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInternalTransactionByTransactionHashAndOperationIdR.parse_obj(obj)

        _obj = GetInternalTransactionByTransactionHashAndOperationIdR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetInternalTransactionByTransactionHashAndOperationIdRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
