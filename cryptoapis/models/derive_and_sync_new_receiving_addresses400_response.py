...
class DeriveAndSyncNewReceivingAddresses400Response(BaseModel):
    """
    ...
    error: DeriveAndSyncNewReceivingAddressesE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewReceivingAddresses400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewReceivingAddresses400Response:
        """Create an instance of DeriveAndSyncNewReceivingAddresses400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewReceivingAddresses400Response.parse_obj(obj)

        _obj = DeriveAndSyncNewReceivingAddresses400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveAndSyncNewReceivingAddressesE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
