...
class ListTokensTransfersByTransactionHash403Response(BaseModel):
    """
    ...
    error: ListTokensTransfersByTransactionHashE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensTransfersByTransactionHash403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensTransfersByTransactionHash403Response:
        """Create an instance of ListTokensTransfersByTransactionHash403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensTransfersByTransactionHash403Response.parse_obj(obj)

        _obj = ListTokensTransfersByTransactionHash403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensTransfersByTransactionHashE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
