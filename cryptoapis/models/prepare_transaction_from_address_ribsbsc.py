...
class PrepareTransactionFromAddressRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    fee: PrepareTransactionFromAddressRIBSBSCFee = Field(...)
    transaction_type: StrictStr = Field(..., alias="transactionType", description="Representation of the transaction type")
    unit: StrictStr = Field(..., description="Represents the unit of the amount transacted")
    __properties = ["fee", "transactionType", "unit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddressRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddressRIBSBSC:
        """Create an instance of PrepareTransactionFromAddressRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddressRIBSBSC.parse_obj(obj)

        _obj = PrepareTransactionFromAddressRIBSBSC.parse_obj({
            "fee": PrepareTransactionFromAddressRIBSBSCFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
