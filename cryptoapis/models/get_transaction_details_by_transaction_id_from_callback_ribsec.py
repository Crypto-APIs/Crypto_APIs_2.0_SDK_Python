...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    gas_price: GetTransactionDetailsByTransactionIDRIBSECGasPrice = Field(..., alias="gasPrice")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSEC:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSEC.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSEC.parse_obj({
            "contract": obj.get("contract"),
            "gas_limit": obj.get("gasLimit"),
            "gas_price": GetTransactionDetailsByTransactionIDRIBSECGasPrice.from_dict(obj.get("gasPrice")) if obj.get("gasPrice") is not None else None,
