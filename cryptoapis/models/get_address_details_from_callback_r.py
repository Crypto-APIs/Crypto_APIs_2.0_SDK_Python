...
class GetAddressDetailsFromCallbackR(BaseModel):
    """
    ...
    data: GetAddressDetailsFromCallbackRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressDetailsFromCallbackR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressDetailsFromCallbackR:
        """Create an instance of GetAddressDetailsFromCallbackR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressDetailsFromCallbackR.parse_obj(obj)

        _obj = GetAddressDetailsFromCallbackR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetAddressDetailsFromCallbackRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
