...
class GetTransactionDetailsByTransactionIDRIBSB(BaseModel):
    """
    Bitcoin
    """
    ...
    vin: conlist(GetTransactionDetailsByTransactionIDRIBSBVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(GetTransactionDetailsByTransactionIDRIBSBVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSB:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSB.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSB.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [GetTransactionDetailsByTransactionIDRIBSBVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [GetTransactionDetailsByTransactionIDRIBSBVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
