...
class ListTransactionsByBlockHashRIBSZVinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSZVinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSZVinInnerScriptSig:
        """Create an instance of ListTransactionsByBlockHashRIBSZVinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSZVinInnerScriptSig.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSZVinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
