...
class GetBlockDetailsByBlockHashRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    nonce: StrictStr = Field(..., description="Numeric representation of the block nonce")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashRIBSE:
        """Create an instance of GetBlockDetailsByBlockHashRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashRIBSE.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashRIBSE.parse_obj({
