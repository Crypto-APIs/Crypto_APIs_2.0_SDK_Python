...
class BroadcastTransactionFail(BaseModel):
    """
    ...
    data: BroadcastTransactionFailData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastTransactionFail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastTransactionFail:
        """Create an instance of BroadcastTransactionFail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastTransactionFail.parse_obj(obj)

        _obj = BroadcastTransactionFail.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": BroadcastTransactionFailData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
