...
class GetInternalTransactionByTransactionHashAndOperationId400Response(BaseModel):
    """
    ...
    error: GetInternalTransactionByTransactionHashAndOperationIdE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInternalTransactionByTransactionHashAndOperationId400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInternalTransactionByTransactionHashAndOperationId400Response:
        """Create an instance of GetInternalTransactionByTransactionHashAndOperationId400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInternalTransactionByTransactionHashAndOperationId400Response.parse_obj(obj)

        _obj = GetInternalTransactionByTransactionHashAndOperationId400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetInternalTransactionByTransactionHashAndOperationIdE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
