...
class GetTransactionRequestDetails403Response(BaseModel):
    """
    ...
    error: GetTransactionRequestDetailsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionRequestDetails403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionRequestDetails403Response:
        """Create an instance of GetTransactionRequestDetails403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionRequestDetails403Response.parse_obj(obj)

        _obj = GetTransactionRequestDetails403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionRequestDetailsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
