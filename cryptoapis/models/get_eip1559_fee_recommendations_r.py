...
class GetEIP1559FeeRecommendationsR(BaseModel):
    """
    ...
    data: GetEIP1559FeeRecommendationsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetEIP1559FeeRecommendationsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetEIP1559FeeRecommendationsR:
        """Create an instance of GetEIP1559FeeRecommendationsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetEIP1559FeeRecommendationsR.parse_obj(obj)

        _obj = GetEIP1559FeeRecommendationsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetEIP1559FeeRecommendationsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
