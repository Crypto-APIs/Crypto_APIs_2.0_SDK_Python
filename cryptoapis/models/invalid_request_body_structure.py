...
class InvalidRequestBodyStructure(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidRequestBodyStructure:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidRequestBodyStructure:
        """Create an instance of InvalidRequestBodyStructure from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidRequestBodyStructure.parse_obj(obj)

        _obj = InvalidRequestBodyStructure.parse_obj({
            "code": obj.get("code"),
