...
class ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey(BaseModel):
    """
    ...
    type: StrictStr = Field(..., description="String representation of the type")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.parse_obj({
