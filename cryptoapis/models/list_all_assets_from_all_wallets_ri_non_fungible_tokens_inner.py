...
class ListAllAssetsFromAllWalletsRINonFungibleTokensInner(BaseModel):
    """
    ...
    __properties = ["blockchain", "identifier", "network", "symbol", "tokenId", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsFromAllWalletsRINonFungibleTokensInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsFromAllWalletsRINonFungibleTokensInner:
        """Create an instance of ListAllAssetsFromAllWalletsRINonFungibleTokensInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsFromAllWalletsRINonFungibleTokensInner.parse_obj(obj)

        _obj = ListAllAssetsFromAllWalletsRINonFungibleTokensInner.parse_obj({
