...
class ListTransactionsByBlockHeightRIBSD(BaseModel):
    """
    Dash
    """
    ...
    vin: conlist(ListTransactionsByBlockHeightRIBSDVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(ListTransactionsByBlockHeightRIBSDVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSD:
        """Create an instance of ListTransactionsByBlockHeightRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSD.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSD.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [ListTransactionsByBlockHeightRIBSDVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [ListTransactionsByBlockHeightRIBSDVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
