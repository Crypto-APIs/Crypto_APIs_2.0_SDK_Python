...
class ListConfirmedTransactionsByAddressRIBSBCVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSBCVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSBCVinInner:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSBCVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSBCVinInner.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSBCVinInner.parse_obj({
