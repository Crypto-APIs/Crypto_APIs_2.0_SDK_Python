...
class InvalidTransactionHex(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidTransactionHex:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidTransactionHex:
        """Create an instance of InvalidTransactionHex from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidTransactionHex.parse_obj(obj)

        _obj = InvalidTransactionHex.parse_obj({
            "code": obj.get("code"),
