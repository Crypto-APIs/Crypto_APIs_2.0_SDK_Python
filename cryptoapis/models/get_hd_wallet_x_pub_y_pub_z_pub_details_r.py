...
class GetHDWalletXPubYPubZPubDetailsR(BaseModel):
    """
    ...
    data: GetHDWalletXPubYPubZPubDetailsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubDetailsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubDetailsR:
        """Create an instance of GetHDWalletXPubYPubZPubDetailsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubDetailsR.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubDetailsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetHDWalletXPubYPubZPubDetailsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
