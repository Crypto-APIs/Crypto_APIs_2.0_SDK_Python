...
class GetLastMinedBlockRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlockRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlockRIBSZ:
        """Create an instance of GetLastMinedBlockRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlockRIBSZ.parse_obj(obj)

        _obj = GetLastMinedBlockRIBSZ.parse_obj({
            "bits": obj.get("bits"),
