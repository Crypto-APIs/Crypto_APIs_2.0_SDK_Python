...
class PrepareANonFungibleTokenTransferFromAddressRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareANonFungibleTokenTransferFromAddressRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareANonFungibleTokenTransferFromAddressRIBSBSC:
        """Create an instance of PrepareANonFungibleTokenTransferFromAddressRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareANonFungibleTokenTransferFromAddressRIBSBSC.parse_obj(obj)

        _obj = PrepareANonFungibleTokenTransferFromAddressRIBSBSC.parse_obj({
