...
class DecodeRawTransactionHexRISD2VinInner(BaseModel):
    """
    ...
    script_sig: DecodeRawTransactionHexRISD2VinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISD2VinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISD2VinInner:
        """Create an instance of DecodeRawTransactionHexRISD2VinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISD2VinInner.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISD2VinInner.parse_obj({
            "address": obj.get("address"),
            "input_hash": obj.get("inputHash"),
            "output_index": obj.get("outputIndex"),
            "script_sig": DecodeRawTransactionHexRISD2VinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
