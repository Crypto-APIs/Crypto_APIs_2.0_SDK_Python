...
class GetBlockchainEventSubscriptionDetailsByReferenceID403Response(BaseModel):
    """
    ...
    error: GetBlockchainEventSubscriptionDetailsByReferenceIDE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockchainEventSubscriptionDetailsByReferenceID403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockchainEventSubscriptionDetailsByReferenceID403Response:
        """Create an instance of GetBlockchainEventSubscriptionDetailsByReferenceID403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockchainEventSubscriptionDetailsByReferenceID403Response.parse_obj(obj)

        _obj = GetBlockchainEventSubscriptionDetailsByReferenceID403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockchainEventSubscriptionDetailsByReferenceIDE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
