...
class ListConfirmedTokensTransfersByAddressR(BaseModel):
    """
    ...
    data: ListConfirmedTokensTransfersByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddressR:
        """Create an instance of ListConfirmedTokensTransfersByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddressR.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListConfirmedTokensTransfersByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
