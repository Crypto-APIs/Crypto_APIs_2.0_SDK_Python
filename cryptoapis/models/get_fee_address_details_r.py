...
class GetFeeAddressDetailsR(BaseModel):
    """
    ...
    data: GetFeeAddressDetailsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeeAddressDetailsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeeAddressDetailsR:
        """Create an instance of GetFeeAddressDetailsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeeAddressDetailsR.parse_obj(obj)

        _obj = GetFeeAddressDetailsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetFeeAddressDetailsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
