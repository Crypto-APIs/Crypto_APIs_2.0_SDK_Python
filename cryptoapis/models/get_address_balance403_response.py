...
class GetAddressBalance403Response(BaseModel):
    """
    ...
    error: GetAddressBalanceE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressBalance403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressBalance403Response:
        """Create an instance of GetAddressBalance403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressBalance403Response.parse_obj(obj)

        _obj = GetAddressBalance403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAddressBalanceE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
