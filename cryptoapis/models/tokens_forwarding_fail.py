...
class TokensForwardingFail(BaseModel):
    """
    ...
    data: TokensForwardingFailData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokensForwardingFail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokensForwardingFail:
        """Create an instance of TokensForwardingFail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokensForwardingFail.parse_obj(obj)

        _obj = TokensForwardingFail.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": TokensForwardingFailData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
