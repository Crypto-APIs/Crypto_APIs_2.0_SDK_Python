...
class TransactionRequestMined(BaseModel):
    """
    ...
    data: TransactionRequestMinedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestMined:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestMined:
        """Create an instance of TransactionRequestMined from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestMined.parse_obj(obj)

        _obj = TransactionRequestMined.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": TransactionRequestMinedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
