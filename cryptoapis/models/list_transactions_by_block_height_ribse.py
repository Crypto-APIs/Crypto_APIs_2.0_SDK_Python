...
class ListTransactionsByBlockHeightRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSE:
        """Create an instance of ListTransactionsByBlockHeightRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSE.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSE.parse_obj({
