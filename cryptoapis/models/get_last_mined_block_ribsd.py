...
class GetLastMinedBlockRIBSD(BaseModel):
    """
    Dogecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlockRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlockRIBSD:
        """Create an instance of GetLastMinedBlockRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlockRIBSD.parse_obj(obj)

        _obj = GetLastMinedBlockRIBSD.parse_obj({
            "bits": obj.get("bits"),
