...
class ListTransactionsByBlockHashRIBSDVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSDVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSDVinInner:
        """Create an instance of ListTransactionsByBlockHashRIBSDVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSDVinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSDVinInner.parse_obj({
