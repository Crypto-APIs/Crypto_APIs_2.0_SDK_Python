...
class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR(BaseModel):
    """
    ...
    data: CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR:
        """Create an instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR.parse_obj(obj)

        _obj = CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
