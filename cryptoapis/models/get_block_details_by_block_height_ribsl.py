...
class GetBlockDetailsByBlockHeightRIBSL(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightRIBSL:
        """Create an instance of GetBlockDetailsByBlockHeightRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightRIBSL.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightRIBSL.parse_obj({
