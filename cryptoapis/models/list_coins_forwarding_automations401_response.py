...
class ListCoinsForwardingAutomations401Response(BaseModel):
    """
    ...
    error: ListCoinsForwardingAutomationsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCoinsForwardingAutomations401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCoinsForwardingAutomations401Response:
        """Create an instance of ListCoinsForwardingAutomations401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListCoinsForwardingAutomations401Response.parse_obj(obj)

        _obj = ListCoinsForwardingAutomations401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListCoinsForwardingAutomationsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
