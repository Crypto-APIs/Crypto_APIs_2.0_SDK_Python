...
class ListLatestMinedBlocksRIBSD(BaseModel):
    """
    Dash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksRIBSD:
        """Create an instance of ListLatestMinedBlocksRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocksRIBSD.parse_obj(obj)

        _obj = ListLatestMinedBlocksRIBSD.parse_obj({
            "bits": obj.get("bits"),
