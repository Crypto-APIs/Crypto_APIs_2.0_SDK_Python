...
class GetAssetDetailsByAssetID401Response(BaseModel):
    """
    ...
    error: GetAssetDetailsByAssetIDE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetID401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetID401Response:
        """Create an instance of GetAssetDetailsByAssetID401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetID401Response.parse_obj(obj)

        _obj = GetAssetDetailsByAssetID401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAssetDetailsByAssetIDE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
