...
class CreateAutomaticCoinsForwardingRB(BaseModel):
    """
    ...
    data: CreateAutomaticCoinsForwardingRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAutomaticCoinsForwardingRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAutomaticCoinsForwardingRB:
        """Create an instance of CreateAutomaticCoinsForwardingRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAutomaticCoinsForwardingRB.parse_obj(obj)

        _obj = CreateAutomaticCoinsForwardingRB.parse_obj({
            "context": obj.get("context"),
            "data": CreateAutomaticCoinsForwardingRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
