...
class GetBlockDetailsByBlockHeightFromCallbackRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSBC:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSBC.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSBC.parse_obj({
            "bits": obj.get("bits"),
