...
class GetBlockDetailsByBlockHeightRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    __properties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "version", "versionHex"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightRIBSBC:
        """Create an instance of GetBlockDetailsByBlockHeightRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightRIBSBC.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightRIBSBC.parse_obj({
