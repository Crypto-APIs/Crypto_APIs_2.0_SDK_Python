...
class GetBlockDetailsByBlockHeightFromCallbackRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSEC:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSEC.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSEC.parse_obj({
