...
class ListXRPRippleTransactionsByAddress400Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddress400Response:
        """Create an instance of ListXRPRippleTransactionsByAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddress400Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
