...
class ListTransactionsByBlockHashRIBSLVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSLVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSLVoutInnerScriptPubKey:
        """Create an instance of ListTransactionsByBlockHashRIBSLVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSLVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSLVoutInnerScriptPubKey.parse_obj({
