...
class DecodeRawTransactionHexRISBVoutInner(BaseModel):
    """
    DecodeRawTransactionHexRISBVoutInner
    """
    script_pub_key: DecodeRawTransactionHexRISBVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISBVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISBVoutInner:
        """Create an instance of DecodeRawTransactionHexRISBVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISBVoutInner.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISBVoutInner.parse_obj({
            "script_pub_key": DecodeRawTransactionHexRISBVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
