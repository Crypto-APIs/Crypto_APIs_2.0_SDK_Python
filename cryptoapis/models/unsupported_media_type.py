...
class UnsupportedMediaType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnsupportedMediaType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnsupportedMediaType:
        """Create an instance of UnsupportedMediaType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnsupportedMediaType.parse_obj(obj)

        _obj = UnsupportedMediaType.parse_obj({
            "code": obj.get("code"),
