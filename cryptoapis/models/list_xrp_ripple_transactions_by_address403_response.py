...
class ListXRPRippleTransactionsByAddress403Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddress403Response:
        """Create an instance of ListXRPRippleTransactionsByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddress403Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
