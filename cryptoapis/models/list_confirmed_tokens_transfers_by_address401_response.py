...
class ListConfirmedTokensTransfersByAddress401Response(BaseModel):
    """
    ...
    error: ListConfirmedTokensTransfersByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddress401Response:
        """Create an instance of ListConfirmedTokensTransfersByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddress401Response.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTokensTransfersByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
