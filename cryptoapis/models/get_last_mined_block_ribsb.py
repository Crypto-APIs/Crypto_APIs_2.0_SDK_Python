...
class GetLastMinedBlockRIBSB(BaseModel):
    """
    Bitcoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlockRIBSB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlockRIBSB:
        """Create an instance of GetLastMinedBlockRIBSB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlockRIBSB.parse_obj(obj)

        _obj = GetLastMinedBlockRIBSB.parse_obj({
            "bits": obj.get("bits"),
