...
class SyncNewHDWalletXPubYPubZPubR(BaseModel):
    """
    ...
    data: SyncNewHDWalletXPubYPubZPubRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncNewHDWalletXPubYPubZPubR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncNewHDWalletXPubYPubZPubR:
        """Create an instance of SyncNewHDWalletXPubYPubZPubR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncNewHDWalletXPubYPubZPubR.parse_obj(obj)

        _obj = SyncNewHDWalletXPubYPubZPubR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": SyncNewHDWalletXPubYPubZPubRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
