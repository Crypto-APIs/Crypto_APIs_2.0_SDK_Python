...
class CoinsForwardingFail(BaseModel):
    """
    CoinsForwardingFail
    """
    ...
    data: CoinsForwardingFailData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CoinsForwardingFail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CoinsForwardingFail:
        """Create an instance of CoinsForwardingFail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CoinsForwardingFail.parse_obj(obj)

        _obj = CoinsForwardingFail.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": CoinsForwardingFailData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
