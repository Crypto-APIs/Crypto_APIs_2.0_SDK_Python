...
class NewBlockRB(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewBlockRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewBlockRB:
        """Create an instance of NewBlockRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewBlockRB.parse_obj(obj)

        _obj = NewBlockRB.parse_obj({
            "context": obj.get("context"),
            "data": NewBlockRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
