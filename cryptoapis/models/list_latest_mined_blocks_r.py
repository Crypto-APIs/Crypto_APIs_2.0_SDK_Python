...
class ListLatestMinedBlocksR(BaseModel):
    """
    ...
    data: ListLatestMinedBlocksRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksR:
        """Create an instance of ListLatestMinedBlocksR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocksR.parse_obj(obj)

        _obj = ListLatestMinedBlocksR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListLatestMinedBlocksRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
