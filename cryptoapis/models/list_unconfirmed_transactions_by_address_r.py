...
class ListUnconfirmedTransactionsByAddressR(BaseModel):
    """
    ...
    data: ListUnconfirmedTransactionsByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressR:
        """Create an instance of ListUnconfirmedTransactionsByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressR.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListUnconfirmedTransactionsByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
