...
class ListConfirmedTransactionsByAddress403Response(BaseModel):
    """
    ...
    error: ListConfirmedTransactionsByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddress403Response:
        """Create an instance of ListConfirmedTransactionsByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddress403Response.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTransactionsByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
