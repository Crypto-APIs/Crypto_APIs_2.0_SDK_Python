...
class EstimateTokenGasLimit401Response(BaseModel):
    """
    ...
    error: EstimateTokenGasLimitE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTokenGasLimit401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTokenGasLimit401Response:
        """Create an instance of EstimateTokenGasLimit401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTokenGasLimit401Response.parse_obj(obj)

        _obj = EstimateTokenGasLimit401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateTokenGasLimitE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
