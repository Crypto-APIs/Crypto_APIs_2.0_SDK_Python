...
class DeleteAutomaticTokensForwarding401Response(BaseModel):
    """
    ...
    error: DeleteAutomaticTokensForwardingE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticTokensForwarding401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticTokensForwarding401Response:
        """Create an instance of DeleteAutomaticTokensForwarding401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticTokensForwarding401Response.parse_obj(obj)

        _obj = DeleteAutomaticTokensForwarding401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteAutomaticTokensForwardingE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
