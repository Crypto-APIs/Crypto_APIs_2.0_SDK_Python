...
class GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSDVoutInnerScriptPubKey.parse_obj({
