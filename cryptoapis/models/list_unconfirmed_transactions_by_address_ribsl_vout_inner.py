...
class ListUnconfirmedTransactionsByAddressRIBSLVoutInner(BaseModel):
    """
    ...
    script_pub_key: GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSLVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSLVoutInner:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSLVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSLVoutInner.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSLVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
