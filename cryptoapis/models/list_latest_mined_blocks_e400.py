...
class ListLatestMinedBlocksE400(BaseModel):
    ...
    actual_instance: Any
    one_of_schemas: List[str] = Field(LISTLATESTMINEDBLOCKSE400_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ListLatestMinedBlocksE400.construct()
        error_messages = []
        match = 0
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksE400:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksE400:
