...
class GetTokenDetailsByContractAddress400Response(BaseModel):
    """
    ...
    error: GetTokenDetailsByContractAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTokenDetailsByContractAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTokenDetailsByContractAddress400Response:
        """Create an instance of GetTokenDetailsByContractAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTokenDetailsByContractAddress400Response.parse_obj(obj)

        _obj = GetTokenDetailsByContractAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTokenDetailsByContractAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
