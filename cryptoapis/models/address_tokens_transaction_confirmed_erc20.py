...
class AddressTokensTransactionConfirmedErc20(BaseModel):
    """
    ERC-20
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedErc20:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedErc20:
        """Create an instance of AddressTokensTransactionConfirmedErc20 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedErc20.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedErc20.parse_obj({
            "name": obj.get("name"),
