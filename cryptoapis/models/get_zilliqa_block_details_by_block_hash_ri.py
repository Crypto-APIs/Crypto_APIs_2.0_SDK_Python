...
class GetZilliqaBlockDetailsByBlockHashRI(BaseModel):
    """
    ...
    __properties = ["blockHeight", "difficulty", "dsBlock", "dsDifficulty", "dsLeader", "gasLimit", "gasUsed", "microBlocks", "nextBlockHash", "previousBlockHash", "timestamp", "transactionsCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaBlockDetailsByBlockHashRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaBlockDetailsByBlockHashRI:
        """Create an instance of GetZilliqaBlockDetailsByBlockHashRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaBlockDetailsByBlockHashRI.parse_obj(obj)

        _obj = GetZilliqaBlockDetailsByBlockHashRI.parse_obj({
