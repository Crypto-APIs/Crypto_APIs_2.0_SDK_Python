...
class ListSyncedAddressesR(BaseModel):
    """
    ...
    data: ListSyncedAddressesRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSyncedAddressesR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSyncedAddressesR:
        """Create an instance of ListSyncedAddressesR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSyncedAddressesR.parse_obj(obj)

        _obj = ListSyncedAddressesR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListSyncedAddressesRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
