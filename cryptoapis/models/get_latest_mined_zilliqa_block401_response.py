...
class GetLatestMinedZilliqaBlock401Response(BaseModel):
    """
    ...
    error: GetLatestMinedZilliqaBlockE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedZilliqaBlock401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedZilliqaBlock401Response:
        """Create an instance of GetLatestMinedZilliqaBlock401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedZilliqaBlock401Response.parse_obj(obj)

        _obj = GetLatestMinedZilliqaBlock401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLatestMinedZilliqaBlockE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
