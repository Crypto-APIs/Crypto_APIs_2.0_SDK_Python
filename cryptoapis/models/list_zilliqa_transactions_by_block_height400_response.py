...
class ListZilliqaTransactionsByBlockHeight400Response(BaseModel):
    """
    ...
    error: ListZilliqaTransactionsByBlockHeightE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHeight400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHeight400Response:
        """Create an instance of ListZilliqaTransactionsByBlockHeight400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHeight400Response.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHeight400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListZilliqaTransactionsByBlockHeightE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
