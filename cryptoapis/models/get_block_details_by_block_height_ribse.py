...
class GetBlockDetailsByBlockHeightRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightRIBSE:
        """Create an instance of GetBlockDetailsByBlockHeightRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightRIBSE.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightRIBSE.parse_obj({
