...
class ValidateAddressRB(BaseModel):
    """
    ValidateAddressRB
    """
    ...
    data: ValidateAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateAddressRB:
        """Create an instance of ValidateAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateAddressRB.parse_obj(obj)

        _obj = ValidateAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": ValidateAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
