...
class AddressCoinsTransactionConfirmed(BaseModel):
    """
    ...
    data: AddressCoinsTransactionConfirmedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressCoinsTransactionConfirmed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressCoinsTransactionConfirmed:
        """Create an instance of AddressCoinsTransactionConfirmed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressCoinsTransactionConfirmed.parse_obj(obj)

        _obj = AddressCoinsTransactionConfirmed.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": AddressCoinsTransactionConfirmedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
