...
class NewConfirmedCoinsTransactionsAndEachConfirmationRB(BaseModel):
    """
    ...
    data: NewConfirmedCoinsTransactionsAndEachConfirmationRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedCoinsTransactionsAndEachConfirmationRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedCoinsTransactionsAndEachConfirmationRB:
        """Create an instance of NewConfirmedCoinsTransactionsAndEachConfirmationRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedCoinsTransactionsAndEachConfirmationRB.parse_obj(obj)

        _obj = NewConfirmedCoinsTransactionsAndEachConfirmationRB.parse_obj({
            "context": obj.get("context"),
            "data": NewConfirmedCoinsTransactionsAndEachConfirmationRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
