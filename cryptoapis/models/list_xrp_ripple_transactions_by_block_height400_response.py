...
class ListXRPRippleTransactionsByBlockHeight400Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByBlockHeightE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByBlockHeight400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByBlockHeight400Response:
        """Create an instance of ListXRPRippleTransactionsByBlockHeight400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByBlockHeight400Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByBlockHeight400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByBlockHeightE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
