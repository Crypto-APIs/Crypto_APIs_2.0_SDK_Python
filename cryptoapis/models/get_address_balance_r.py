...
class GetAddressBalanceR(BaseModel):
    """
    GetAddressBalanceR
    """
    ...
    data: GetAddressBalanceRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressBalanceR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressBalanceR:
        """Create an instance of GetAddressBalanceR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressBalanceR.parse_obj(obj)

        _obj = GetAddressBalanceR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetAddressBalanceRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
