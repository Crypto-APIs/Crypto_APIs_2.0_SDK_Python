...
class GetTransactionDetailsByTransactionIDRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSZ:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSZ.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSZ.parse_obj({
