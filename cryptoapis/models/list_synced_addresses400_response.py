...
class ListSyncedAddresses400Response(BaseModel):
    """
    ...
    error: ListSyncedAddressesE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSyncedAddresses400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSyncedAddresses400Response:
        """Create an instance of ListSyncedAddresses400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSyncedAddresses400Response.parse_obj(obj)

        _obj = ListSyncedAddresses400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSyncedAddressesE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
