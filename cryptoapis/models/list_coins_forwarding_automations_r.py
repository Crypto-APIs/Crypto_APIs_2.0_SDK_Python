...
class ListCoinsForwardingAutomationsR(BaseModel):
    """
    ...
    data: ListCoinsForwardingAutomationsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCoinsForwardingAutomationsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCoinsForwardingAutomationsR:
        """Create an instance of ListCoinsForwardingAutomationsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListCoinsForwardingAutomationsR.parse_obj(obj)

        _obj = ListCoinsForwardingAutomationsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListCoinsForwardingAutomationsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
