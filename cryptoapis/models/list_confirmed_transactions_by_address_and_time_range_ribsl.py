...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSL:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRIBSL.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRIBSL.parse_obj({
