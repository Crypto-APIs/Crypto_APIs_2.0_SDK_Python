...
class ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey:
        """Create an instance of ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey.parse_obj({
