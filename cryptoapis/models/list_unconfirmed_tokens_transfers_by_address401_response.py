...
class ListUnconfirmedTokensTransfersByAddress401Response(BaseModel):
    """
    ...
    error: ListUnconfirmedTokensTransfersByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTokensTransfersByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTokensTransfersByAddress401Response:
        """Create an instance of ListUnconfirmedTokensTransfersByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTokensTransfersByAddress401Response.parse_obj(obj)

        _obj = ListUnconfirmedTokensTransfersByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListUnconfirmedTokensTransfersByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
