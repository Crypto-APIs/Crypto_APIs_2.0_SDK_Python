...
class ListHDWalletXPubYPubZPubUTXOs422Response(BaseModel):
    """
    ...
    error: ListHDWalletXPubYPubZPubUTXOsE422 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubUTXOs422Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubUTXOs422Response:
        """Create an instance of ListHDWalletXPubYPubZPubUTXOs422Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubUTXOs422Response.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubUTXOs422Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListHDWalletXPubYPubZPubUTXOsE422.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
