...
class ListConfirmedTransactionsByAddressRI(BaseModel):
    """
    ...
    recipients: conlist(ListConfirmedTransactionsByAddressRIRecipientsInner) = Field(..., description="Represents a list of recipient addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.")
    senders: conlist(ListConfirmedTransactionsByAddressRISendersInner) = Field(..., description="Represents a list of sender addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.")
    ...
    fee: ListConfirmedTransactionsByAddressRIFee = Field(...)
    blockchain_specific: ListConfirmedTransactionsByAddressRIBS = Field(..., alias="blockchainSpecific")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRI:
        """Create an instance of ListConfirmedTransactionsByAddressRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRI.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRI.parse_obj({
            "transaction_id": obj.get("transactionId"),
            "index": obj.get("index"),
            "mined_in_block_hash": obj.get("minedInBlockHash"),
            "mined_in_block_height": obj.get("minedInBlockHeight"),
            "recipients": [ListConfirmedTransactionsByAddressRIRecipientsInner.from_dict(_item) for _item in obj.get("recipients")] if obj.get("recipients") is not None else None,
            "senders": [ListConfirmedTransactionsByAddressRISendersInner.from_dict(_item) for _item in obj.get("senders")] if obj.get("senders") is not None else None,
            "timestamp": obj.get("timestamp"),
            "transaction_hash": obj.get("transactionHash"),
            "fee": ListConfirmedTransactionsByAddressRIFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "blockchain_specific": ListConfirmedTransactionsByAddressRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
