...
class GetAssetDetailsByAssetIDR(BaseModel):
    """
    ...
    data: GetAssetDetailsByAssetIDRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetIDR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetIDR:
        """Create an instance of GetAssetDetailsByAssetIDR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetIDR.parse_obj(obj)

        _obj = GetAssetDetailsByAssetIDR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetAssetDetailsByAssetIDRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
