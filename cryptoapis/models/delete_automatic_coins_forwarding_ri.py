...
class DeleteAutomaticCoinsForwardingRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticCoinsForwardingRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticCoinsForwardingRI:
        """Create an instance of DeleteAutomaticCoinsForwardingRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticCoinsForwardingRI.parse_obj(obj)

        _obj = DeleteAutomaticCoinsForwardingRI.parse_obj({
