...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response(BaseModel):
    """
    ...
    error: PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response:
        """Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response.parse_obj(obj)

        _obj = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
