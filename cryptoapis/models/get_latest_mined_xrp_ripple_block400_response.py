...
class GetLatestMinedXRPRippleBlock400Response(BaseModel):
    """
    ...
    error: GetLatestMinedXRPRippleBlockE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedXRPRippleBlock400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedXRPRippleBlock400Response:
        """Create an instance of GetLatestMinedXRPRippleBlock400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedXRPRippleBlock400Response.parse_obj(obj)

        _obj = GetLatestMinedXRPRippleBlock400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLatestMinedXRPRippleBlockE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
