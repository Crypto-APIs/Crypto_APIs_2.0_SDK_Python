...
class DeleteBlockchainEventSubscriptionRI(BaseModel):
    """
    ...
    __properties = ["callbackSecretKey", "callbackUrl", "createdTimestamp", "eventType", "referenceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteBlockchainEventSubscriptionRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteBlockchainEventSubscriptionRI:
        """Create an instance of DeleteBlockchainEventSubscriptionRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteBlockchainEventSubscriptionRI.parse_obj(obj)

        _obj = DeleteBlockchainEventSubscriptionRI.parse_obj({
