...
class DeriveAndSyncNewReceivingAddresses403Response(BaseModel):
    """
    ...
    error: DeriveAndSyncNewReceivingAddressesE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewReceivingAddresses403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewReceivingAddresses403Response:
        """Create an instance of DeriveAndSyncNewReceivingAddresses403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewReceivingAddresses403Response.parse_obj(obj)

        _obj = DeriveAndSyncNewReceivingAddresses403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveAndSyncNewReceivingAddressesE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
