...
class ListBlockchainEventsSubscriptions401Response(BaseModel):
    """
    ...
    error: ListBlockchainEventsSubscriptionsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListBlockchainEventsSubscriptions401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListBlockchainEventsSubscriptions401Response:
        """Create an instance of ListBlockchainEventsSubscriptions401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListBlockchainEventsSubscriptions401Response.parse_obj(obj)

        _obj = ListBlockchainEventsSubscriptions401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListBlockchainEventsSubscriptionsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
