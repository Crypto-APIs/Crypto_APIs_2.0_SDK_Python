...
class GetLastMinedBlockRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlockRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlockRIBSBC:
        """Create an instance of GetLastMinedBlockRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlockRIBSBC.parse_obj(obj)

        _obj = GetLastMinedBlockRIBSBC.parse_obj({
            "bits": obj.get("bits"),
