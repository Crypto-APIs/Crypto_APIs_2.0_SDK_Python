...
class AddressTokensTransactionConfirmedDataItem(BaseModel):
    """
    ...
    token: AddressTokensTransactionConfirmedToken = Field(...)
    direction: StrictStr = Field(..., description="Defines whether the transaction is \"incoming\" or \"outgoing\".")
    __properties = ["blockchain", "network", "address", "minedInBlock", "transactionId", "tokenType", "token", "direction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedDataItem:
        """Create an instance of AddressTokensTransactionConfirmedDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedDataItem.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedDataItem.parse_obj({
            ...
            "token": AddressTokensTransactionConfirmedToken.from_dict(obj.get("token")) if obj.get("token") is not None else None,
