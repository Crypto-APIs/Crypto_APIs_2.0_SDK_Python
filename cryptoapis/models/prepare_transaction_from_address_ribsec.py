...
class PrepareTransactionFromAddressRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddressRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddressRIBSEC:
        """Create an instance of PrepareTransactionFromAddressRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddressRIBSEC.parse_obj(obj)

        _obj = PrepareTransactionFromAddressRIBSEC.parse_obj({
