...
class DecodeRawTransactionHexRISD2VinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISD2VinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISD2VinInnerScriptSig:
        """Create an instance of DecodeRawTransactionHexRISD2VinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISD2VinInnerScriptSig.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISD2VinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
