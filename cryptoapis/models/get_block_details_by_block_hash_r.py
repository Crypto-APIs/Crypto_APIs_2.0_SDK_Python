...
class GetBlockDetailsByBlockHashR(BaseModel):
    """
    ...
    data: GetBlockDetailsByBlockHashRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashR:
        """Create an instance of GetBlockDetailsByBlockHashR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashR.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetBlockDetailsByBlockHashRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
