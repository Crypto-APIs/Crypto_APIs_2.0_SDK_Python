...
class AddressInternalTransactionConfirmedData(BaseModel):
    """
    ...
    item: AddressInternalTransactionConfirmedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressInternalTransactionConfirmedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressInternalTransactionConfirmedData:
        """Create an instance of AddressInternalTransactionConfirmedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressInternalTransactionConfirmedData.parse_obj(obj)

        _obj = AddressInternalTransactionConfirmedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": AddressInternalTransactionConfirmedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
