...
class ListWalletTransactionsRData(BaseModel):
    """
    ...
    items: conlist(ListWalletTransactionsRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWalletTransactionsRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWalletTransactionsRData:
        """Create an instance of ListWalletTransactionsRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWalletTransactionsRData.parse_obj(obj)

        _obj = ListWalletTransactionsRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListWalletTransactionsRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
