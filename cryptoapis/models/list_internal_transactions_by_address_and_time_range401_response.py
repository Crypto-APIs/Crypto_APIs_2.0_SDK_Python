...
class ListInternalTransactionsByAddressAndTimeRange401Response(BaseModel):
    """
    ...
    error: ListInternalTransactionsByAddressAndTimeRangeE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddressAndTimeRange401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddressAndTimeRange401Response:
        """Create an instance of ListInternalTransactionsByAddressAndTimeRange401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddressAndTimeRange401Response.parse_obj(obj)

        _obj = ListInternalTransactionsByAddressAndTimeRange401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionsByAddressAndTimeRangeE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
