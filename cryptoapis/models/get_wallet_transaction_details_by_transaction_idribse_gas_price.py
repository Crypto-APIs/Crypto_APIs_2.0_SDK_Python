...
class GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice.parse_obj({
