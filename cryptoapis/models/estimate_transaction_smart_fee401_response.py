...
class EstimateTransactionSmartFee401Response(BaseModel):
    """
    ...
    error: EstimateTransactionSmartFeeE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTransactionSmartFee401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTransactionSmartFee401Response:
        """Create an instance of EstimateTransactionSmartFee401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTransactionSmartFee401Response.parse_obj(obj)

        _obj = EstimateTransactionSmartFee401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateTransactionSmartFeeE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
