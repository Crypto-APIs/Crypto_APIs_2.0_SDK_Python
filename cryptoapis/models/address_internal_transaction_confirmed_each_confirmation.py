...
class AddressInternalTransactionConfirmedEachConfirmation(BaseModel):
    """
    ...
    data: AddressInternalTransactionConfirmedEachConfirmationData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressInternalTransactionConfirmedEachConfirmation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressInternalTransactionConfirmedEachConfirmation:
        """Create an instance of AddressInternalTransactionConfirmedEachConfirmation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressInternalTransactionConfirmedEachConfirmation.parse_obj(obj)

        _obj = AddressInternalTransactionConfirmedEachConfirmation.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": AddressInternalTransactionConfirmedEachConfirmationData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
