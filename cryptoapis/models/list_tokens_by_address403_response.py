...
class ListTokensByAddress403Response(BaseModel):
    """
    ...
    error: ListTokensByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensByAddress403Response:
        """Create an instance of ListTokensByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensByAddress403Response.parse_obj(obj)

        _obj = ListTokensByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
