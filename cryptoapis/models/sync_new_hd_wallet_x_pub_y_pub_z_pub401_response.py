...
class SyncNewHDWalletXPubYPubZPub401Response(BaseModel):
    """
    ...
    error: SyncNewHDWalletXPubYPubZPubE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncNewHDWalletXPubYPubZPub401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncNewHDWalletXPubYPubZPub401Response:
        """Create an instance of SyncNewHDWalletXPubYPubZPub401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncNewHDWalletXPubYPubZPub401Response.parse_obj(obj)

        _obj = SyncNewHDWalletXPubYPubZPub401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncNewHDWalletXPubYPubZPubE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
