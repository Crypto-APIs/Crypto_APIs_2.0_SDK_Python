...
class DecodeXAddress401Response(BaseModel):
    """
    ...
    error: DecodeXAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeXAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeXAddress401Response:
        """Create an instance of DecodeXAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeXAddress401Response.parse_obj(obj)

        _obj = DecodeXAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DecodeXAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
