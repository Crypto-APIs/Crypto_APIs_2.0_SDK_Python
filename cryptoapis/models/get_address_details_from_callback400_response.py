...
class GetAddressDetailsFromCallback400Response(BaseModel):
    """
    ...
    error: GetAddressDetailsFromCallbackE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressDetailsFromCallback400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressDetailsFromCallback400Response:
        """Create an instance of GetAddressDetailsFromCallback400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressDetailsFromCallback400Response.parse_obj(obj)

        _obj = GetAddressDetailsFromCallback400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAddressDetailsFromCallbackE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
