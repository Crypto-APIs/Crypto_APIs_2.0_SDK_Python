...
class GetTransactionDetailsByTransactionID404Response(BaseModel):
    """
    ...
    error: BlockchainDataTransactionNotFound = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionID404Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionID404Response:
        """Create an instance of GetTransactionDetailsByTransactionID404Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionID404Response.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionID404Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": BlockchainDataTransactionNotFound.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
