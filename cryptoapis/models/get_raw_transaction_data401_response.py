...
class GetRawTransactionData401Response(BaseModel):
    """
    ...
    error: GetRawTransactionDataE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRawTransactionData401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRawTransactionData401Response:
        """Create an instance of GetRawTransactionData401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRawTransactionData401Response.parse_obj(obj)

        _obj = GetRawTransactionData401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetRawTransactionDataE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
