...
class GetTransactionDetailsByTransactionIDFromCallback400Response(BaseModel):
    """
    ...
    error: GetTransactionDetailsByTransactionIDFromCallbackE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallback400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallback400Response:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallback400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallback400Response.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallback400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionDetailsByTransactionIDFromCallbackE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
