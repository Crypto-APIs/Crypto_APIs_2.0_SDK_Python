...
class BlockchainDataTransactionNotFound(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockchainDataTransactionNotFound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockchainDataTransactionNotFound:
        """Create an instance of BlockchainDataTransactionNotFound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockchainDataTransactionNotFound.parse_obj(obj)

        _obj = BlockchainDataTransactionNotFound.parse_obj({
            "code": obj.get("code"),
