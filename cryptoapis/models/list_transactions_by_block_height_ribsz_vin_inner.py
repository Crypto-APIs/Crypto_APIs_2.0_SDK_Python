...
class ListTransactionsByBlockHeightRIBSZVinInner(BaseModel):
    """
    ...
    script_sig: ListTransactionsByBlockHeightRIBSZVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSZVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSZVinInner:
        """Create an instance of ListTransactionsByBlockHeightRIBSZVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSZVinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSZVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": ListTransactionsByBlockHeightRIBSZVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
