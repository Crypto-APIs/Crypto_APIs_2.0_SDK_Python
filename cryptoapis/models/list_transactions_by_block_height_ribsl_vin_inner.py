...
class ListTransactionsByBlockHeightRIBSLVinInner(BaseModel):
    """
    ...
    script_sig: ListTransactionsByBlockHeightRIBSLVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSLVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSLVinInner:
        """Create an instance of ListTransactionsByBlockHeightRIBSLVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSLVinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSLVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": ListTransactionsByBlockHeightRIBSLVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
