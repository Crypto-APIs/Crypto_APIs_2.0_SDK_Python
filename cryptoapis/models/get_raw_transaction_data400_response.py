...
class GetRawTransactionData400Response(BaseModel):
    """
    ...
    error: GetRawTransactionDataE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRawTransactionData400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRawTransactionData400Response:
        """Create an instance of GetRawTransactionData400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRawTransactionData400Response.parse_obj(obj)

        _obj = GetRawTransactionData400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetRawTransactionDataE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
