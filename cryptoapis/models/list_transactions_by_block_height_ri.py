...
class ListTransactionsByBlockHeightRI(BaseModel):
    """
    ...
    fee: ListTransactionsByBlockHeightRIFee = Field(...)
    blockchain_specific: ListTransactionsByBlockHeightRIBS = Field(..., alias="blockchainSpecific")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRI:
        """Create an instance of ListTransactionsByBlockHeightRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRI.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRI.parse_obj({
            ...
            "fee": ListTransactionsByBlockHeightRIFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "blockchain_specific": ListTransactionsByBlockHeightRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
