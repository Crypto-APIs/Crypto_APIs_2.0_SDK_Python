...
class ListTokensForwardingAutomations401Response(BaseModel):
    """
    ...
    error: ListTokensForwardingAutomationsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensForwardingAutomations401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensForwardingAutomations401Response:
        """Create an instance of ListTokensForwardingAutomations401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensForwardingAutomations401Response.parse_obj(obj)

        _obj = ListTokensForwardingAutomations401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensForwardingAutomationsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
