...
class GetAddressDetailsFromCallback403Response(BaseModel):
    """
    ...
    error: GetAddressDetailsFromCallbackE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressDetailsFromCallback403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressDetailsFromCallback403Response:
        """Create an instance of GetAddressDetailsFromCallback403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressDetailsFromCallback403Response.parse_obj(obj)

        _obj = GetAddressDetailsFromCallback403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAddressDetailsFromCallbackE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
