...
class GetLatestMinedZilliqaBlockR(BaseModel):
    """
    ...
    data: GetLatestMinedZilliqaBlockRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedZilliqaBlockR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedZilliqaBlockR:
        """Create an instance of GetLatestMinedZilliqaBlockR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedZilliqaBlockR.parse_obj(obj)

        _obj = GetLatestMinedZilliqaBlockR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetLatestMinedZilliqaBlockRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
