...
class ListWalletTransactionsRISendersInner(BaseModel):
    """
    ...
    label: Optional[StrictStr] = Field(None, description="Defines a plain text string as a label for the sender.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWalletTransactionsRISendersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWalletTransactionsRISendersInner:
        """Create an instance of ListWalletTransactionsRISendersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWalletTransactionsRISendersInner.parse_obj(obj)

        _obj = ListWalletTransactionsRISendersInner.parse_obj({
