...
class ListInternalTransactionsByAddressAndTimeRangeRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddressAndTimeRangeRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddressAndTimeRangeRI:
        """Create an instance of ListInternalTransactionsByAddressAndTimeRangeRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddressAndTimeRangeRI.parse_obj(obj)

        _obj = ListInternalTransactionsByAddressAndTimeRangeRI.parse_obj({
