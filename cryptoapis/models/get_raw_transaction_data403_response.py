...
class GetRawTransactionData403Response(BaseModel):
    """
    ...
    error: GetRawTransactionDataE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRawTransactionData403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRawTransactionData403Response:
        """Create an instance of GetRawTransactionData403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRawTransactionData403Response.parse_obj(obj)

        _obj = GetRawTransactionData403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetRawTransactionDataE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
