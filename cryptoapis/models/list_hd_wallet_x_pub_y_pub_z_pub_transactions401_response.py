...
class ListHDWalletXPubYPubZPubTransactions401Response(BaseModel):
    """
    ...
    error: ListHDWalletXPubYPubZPubTransactionsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubTransactions401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubTransactions401Response:
        """Create an instance of ListHDWalletXPubYPubZPubTransactions401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubTransactions401Response.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubTransactions401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListHDWalletXPubYPubZPubTransactionsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
