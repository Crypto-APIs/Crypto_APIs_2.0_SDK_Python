...
class GetTransactionDetailsByTransactionIDRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSEC:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSEC.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSEC.parse_obj({
