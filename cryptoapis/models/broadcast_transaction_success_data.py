...
class BroadcastTransactionSuccessData(BaseModel):
    """
    ...
    item: BroadcastTransactionSuccessDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastTransactionSuccessData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastTransactionSuccessData:
        """Create an instance of BroadcastTransactionSuccessData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastTransactionSuccessData.parse_obj(obj)

        _obj = BroadcastTransactionSuccessData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": BroadcastTransactionSuccessDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
