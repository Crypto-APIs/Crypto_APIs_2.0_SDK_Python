...
class BannedIpAddress(BaseModel):
    """
    banned_ip_address
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BannedIpAddress:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BannedIpAddress:
        """Create an instance of BannedIpAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BannedIpAddress.parse_obj(obj)

        _obj = BannedIpAddress.parse_obj({
            "code": obj.get("code"),
