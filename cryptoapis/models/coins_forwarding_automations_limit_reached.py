...
class CoinsForwardingAutomationsLimitReached(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CoinsForwardingAutomationsLimitReached:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CoinsForwardingAutomationsLimitReached:
        """Create an instance of CoinsForwardingAutomationsLimitReached from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CoinsForwardingAutomationsLimitReached.parse_obj(obj)

        _obj = CoinsForwardingAutomationsLimitReached.parse_obj({
            "code": obj.get("code"),
