...
class GetBlockDetailsByBlockHeightFromCallbackRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    __properties = ["bits", "chainwork", "merkleRoot", "nonce", "size", "version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSZ:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSZ.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSZ.parse_obj({
            "bits": obj.get("bits"),
