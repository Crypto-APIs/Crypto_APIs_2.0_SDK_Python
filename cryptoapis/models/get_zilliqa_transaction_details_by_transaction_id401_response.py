...
class GetZilliqaTransactionDetailsByTransactionID401Response(BaseModel):
    """
    ...
    error: GetZilliqaTransactionDetailsByTransactionIDE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaTransactionDetailsByTransactionID401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaTransactionDetailsByTransactionID401Response:
        """Create an instance of GetZilliqaTransactionDetailsByTransactionID401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaTransactionDetailsByTransactionID401Response.parse_obj(obj)

        _obj = GetZilliqaTransactionDetailsByTransactionID401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaTransactionDetailsByTransactionIDE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
