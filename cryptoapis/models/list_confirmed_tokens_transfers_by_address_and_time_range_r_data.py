...
class ListConfirmedTokensTransfersByAddressAndTimeRangeRData(BaseModel):
    """
    ...
    items: conlist(ListConfirmedTokensTransfersByAddressAndTimeRangeRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddressAndTimeRangeRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddressAndTimeRangeRData:
        """Create an instance of ListConfirmedTokensTransfersByAddressAndTimeRangeRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddressAndTimeRangeRData.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddressAndTimeRangeRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListConfirmedTokensTransfersByAddressAndTimeRangeRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
