...
class ListConfirmedTokensTransfersByAddressAndTimeRange403Response(BaseModel):
    """
    ...
    error: ListConfirmedTokensTransfersByAddressAndTimeRangeE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddressAndTimeRange403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddressAndTimeRange403Response:
        """Create an instance of ListConfirmedTokensTransfersByAddressAndTimeRange403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddressAndTimeRange403Response.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddressAndTimeRange403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTokensTransfersByAddressAndTimeRangeE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
