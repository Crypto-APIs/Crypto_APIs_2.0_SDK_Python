...
class ListZilliqaTransactionsByBlockHeight403Response(BaseModel):
    """
    ...
    error: ListZilliqaTransactionsByBlockHeightE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHeight403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHeight403Response:
        """Create an instance of ListZilliqaTransactionsByBlockHeight403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHeight403Response.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHeight403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListZilliqaTransactionsByBlockHeightE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
