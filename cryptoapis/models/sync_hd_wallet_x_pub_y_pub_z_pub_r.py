...
class SyncHDWalletXPubYPubZPubR(BaseModel):
    """
    ...
    data: SyncHDWalletXPubYPubZPubRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncHDWalletXPubYPubZPubR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncHDWalletXPubYPubZPubR:
        """Create an instance of SyncHDWalletXPubYPubZPubR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncHDWalletXPubYPubZPubR.parse_obj(obj)

        _obj = SyncHDWalletXPubYPubZPubR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": SyncHDWalletXPubYPubZPubRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
