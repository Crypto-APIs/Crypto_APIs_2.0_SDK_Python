...
class ListZilliqaTransactionsByAddress401Response(BaseModel):
    """
    ...
    error: ListZilliqaTransactionsByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByAddress401Response:
        """Create an instance of ListZilliqaTransactionsByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByAddress401Response.parse_obj(obj)

        _obj = ListZilliqaTransactionsByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListZilliqaTransactionsByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
