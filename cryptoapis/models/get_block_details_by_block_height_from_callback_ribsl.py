...
class GetBlockDetailsByBlockHeightFromCallbackRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    strippedsize: StrictInt = Field(..., description="Defines the numeric representation of the block size excluding the witness data.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSL:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSL.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSL.parse_obj({
            "bits": obj.get("bits"),
