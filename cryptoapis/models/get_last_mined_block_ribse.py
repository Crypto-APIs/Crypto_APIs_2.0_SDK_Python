...
class GetLastMinedBlockRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlockRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlockRIBSE:
        """Create an instance of GetLastMinedBlockRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlockRIBSE.parse_obj(obj)

        _obj = GetLastMinedBlockRIBSE.parse_obj({
