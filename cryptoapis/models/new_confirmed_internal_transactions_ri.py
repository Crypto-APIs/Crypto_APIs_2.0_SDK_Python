...
class NewConfirmedInternalTransactionsRI(BaseModel):
    """
    ...
    receive_callback_on: StrictInt = Field(..., alias="receiveCallbackOn", description="Represents the exact confirmation, on which the user wants to receive callback.")
    ...
    __properties = ["address", "callbackSecretKey", "callbackUrl", "createdTimestamp", "eventType", "isActive", "receiveCallbackOn", "referenceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedInternalTransactionsRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedInternalTransactionsRI:
        """Create an instance of NewConfirmedInternalTransactionsRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedInternalTransactionsRI.parse_obj(obj)

        _obj = NewConfirmedInternalTransactionsRI.parse_obj({
