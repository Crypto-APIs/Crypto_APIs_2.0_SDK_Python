...
class GetTransactionDetailsByTransactionIDRIBSLVinInner(BaseModel):
    """
    ...
    script_sig: GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSLVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSLVinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSLVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSLVinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSLVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
