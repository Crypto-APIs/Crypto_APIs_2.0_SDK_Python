...
class CreateAutomaticCoinsForwardingRI(BaseModel):
    """
    ...
    __properties = ["callbackUrl", "confirmationsCount", "createdTimestamp", "feePriority", "fromAddress", "minimumTransferAmount", "referenceId", "toAddress"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAutomaticCoinsForwardingRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAutomaticCoinsForwardingRI:
        """Create an instance of CreateAutomaticCoinsForwardingRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAutomaticCoinsForwardingRI.parse_obj(obj)

        _obj = CreateAutomaticCoinsForwardingRI.parse_obj({
