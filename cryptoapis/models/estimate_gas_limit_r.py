...
class EstimateGasLimitR(BaseModel):
    """
    EstimateGasLimitR
    """
    ...
    data: EstimateGasLimitRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateGasLimitR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateGasLimitR:
        """Create an instance of EstimateGasLimitR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateGasLimitR.parse_obj(obj)

        _obj = EstimateGasLimitR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": EstimateGasLimitRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
