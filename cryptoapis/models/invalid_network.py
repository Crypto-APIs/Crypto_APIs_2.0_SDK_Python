...
class InvalidNetwork(BaseModel):
    """
    invalid_network
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidNetwork:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidNetwork:
        """Create an instance of InvalidNetwork from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidNetwork.parse_obj(obj)

        _obj = InvalidNetwork.parse_obj({
            "code": obj.get("code"),
