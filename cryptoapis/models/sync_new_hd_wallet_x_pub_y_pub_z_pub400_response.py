...
class SyncNewHDWalletXPubYPubZPub400Response(BaseModel):
    """
    ...
    error: SyncNewHDWalletXPubYPubZPubE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncNewHDWalletXPubYPubZPub400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncNewHDWalletXPubYPubZPub400Response:
        """Create an instance of SyncNewHDWalletXPubYPubZPub400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncNewHDWalletXPubYPubZPub400Response.parse_obj(obj)

        _obj = SyncNewHDWalletXPubYPubZPub400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncNewHDWalletXPubYPubZPubE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
