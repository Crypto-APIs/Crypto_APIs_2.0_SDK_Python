...
class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response(BaseModel):
    """
    ...
    error: DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response:
        """Create an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response.parse_obj(obj)

        _obj = DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
