...
class NewConfirmedTokensTransactionsRB(BaseModel):
    """
    ...
    data: NewConfirmedTokensTransactionsRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedTokensTransactionsRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedTokensTransactionsRB:
        """Create an instance of NewConfirmedTokensTransactionsRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedTokensTransactionsRB.parse_obj(obj)

        _obj = NewConfirmedTokensTransactionsRB.parse_obj({
            "context": obj.get("context"),
            "data": NewConfirmedTokensTransactionsRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
