...
class PrepareTransactionFromAddress400Response(BaseModel):
    """
    ...
    error: PrepareTransactionFromAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddress400Response:
        """Create an instance of PrepareTransactionFromAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddress400Response.parse_obj(obj)

        _obj = PrepareTransactionFromAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareTransactionFromAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
