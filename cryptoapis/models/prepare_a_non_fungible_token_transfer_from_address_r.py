...
class PrepareANonFungibleTokenTransferFromAddressR(BaseModel):
    """
    ...
    data: PrepareANonFungibleTokenTransferFromAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareANonFungibleTokenTransferFromAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareANonFungibleTokenTransferFromAddressR:
        """Create an instance of PrepareANonFungibleTokenTransferFromAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareANonFungibleTokenTransferFromAddressR.parse_obj(obj)

        _obj = PrepareANonFungibleTokenTransferFromAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": PrepareANonFungibleTokenTransferFromAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
