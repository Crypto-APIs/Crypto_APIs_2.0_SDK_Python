...
class GetZilliqaAddressDetails400Response(BaseModel):
    """
    ...
    error: GetZilliqaAddressDetailsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaAddressDetails400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaAddressDetails400Response:
        """Create an instance of GetZilliqaAddressDetails400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaAddressDetails400Response.parse_obj(obj)

        _obj = GetZilliqaAddressDetails400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaAddressDetailsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
