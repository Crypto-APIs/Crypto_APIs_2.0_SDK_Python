...
class ListAllAssetsFromAllWallets403Response(BaseModel):
    """
    ...
    error: ListAllAssetsFromAllWalletsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsFromAllWallets403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsFromAllWallets403Response:
        """Create an instance of ListAllAssetsFromAllWallets403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsFromAllWallets403Response.parse_obj(obj)

        _obj = ListAllAssetsFromAllWallets403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListAllAssetsFromAllWalletsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
