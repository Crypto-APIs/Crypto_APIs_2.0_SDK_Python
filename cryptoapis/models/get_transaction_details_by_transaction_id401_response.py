...
class GetTransactionDetailsByTransactionID401Response(BaseModel):
    """
    ...
    error: GetTransactionDetailsByTransactionIDE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionID401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionID401Response:
        """Create an instance of GetTransactionDetailsByTransactionID401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionID401Response.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionID401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionDetailsByTransactionIDE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
