...
class XpubNotSynced(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> XpubNotSynced:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> XpubNotSynced:
        """Create an instance of XpubNotSynced from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return XpubNotSynced.parse_obj(obj)

        _obj = XpubNotSynced.parse_obj({
            "code": obj.get("code"),
