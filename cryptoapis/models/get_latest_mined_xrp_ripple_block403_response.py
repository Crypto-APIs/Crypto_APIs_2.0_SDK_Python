...
class GetLatestMinedXRPRippleBlock403Response(BaseModel):
    """
    ...
    error: GetLatestMinedXRPRippleBlockE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedXRPRippleBlock403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedXRPRippleBlock403Response:
        """Create an instance of GetLatestMinedXRPRippleBlock403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedXRPRippleBlock403Response.parse_obj(obj)

        _obj = GetLatestMinedXRPRippleBlock403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLatestMinedXRPRippleBlockE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
