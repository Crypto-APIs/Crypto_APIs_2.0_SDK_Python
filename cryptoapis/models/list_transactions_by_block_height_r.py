...
class ListTransactionsByBlockHeightR(BaseModel):
    """
    ...
    data: ListTransactionsByBlockHeightRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightR:
        """Create an instance of ListTransactionsByBlockHeightR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightR.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListTransactionsByBlockHeightRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
