...
class DeleteBlockchainEventSubscription400Response(BaseModel):
    """
    ...
    error: DeleteBlockchainEventSubscriptionE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteBlockchainEventSubscription400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteBlockchainEventSubscription400Response:
        """Create an instance of DeleteBlockchainEventSubscription400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteBlockchainEventSubscription400Response.parse_obj(obj)

        _obj = DeleteBlockchainEventSubscription400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteBlockchainEventSubscriptionE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
