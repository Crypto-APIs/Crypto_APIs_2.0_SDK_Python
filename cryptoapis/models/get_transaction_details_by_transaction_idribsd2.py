...
class GetTransactionDetailsByTransactionIDRIBSD2(BaseModel):
    """
    Dash
    """
    ...
    vin: conlist(GetTransactionDetailsByTransactionIDRIBSD2VinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(GetTransactionDetailsByTransactionIDRIBSD2VoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSD2:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSD2.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSD2.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [GetTransactionDetailsByTransactionIDRIBSD2VinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
