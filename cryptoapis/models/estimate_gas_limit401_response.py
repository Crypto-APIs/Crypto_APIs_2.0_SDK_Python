...
class EstimateGasLimit401Response(BaseModel):
    """
    ...
    error: EstimateGasLimitE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateGasLimit401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateGasLimit401Response:
        """Create an instance of EstimateGasLimit401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateGasLimit401Response.parse_obj(obj)

        _obj = EstimateGasLimit401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateGasLimitE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
