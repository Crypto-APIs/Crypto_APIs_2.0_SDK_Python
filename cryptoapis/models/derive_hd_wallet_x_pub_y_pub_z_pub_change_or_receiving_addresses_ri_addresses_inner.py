...
class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRIAddressesInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRIAddressesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRIAddressesInner:
        """Create an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRIAddressesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRIAddressesInner.parse_obj(obj)

        _obj = DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRIAddressesInner.parse_obj({
