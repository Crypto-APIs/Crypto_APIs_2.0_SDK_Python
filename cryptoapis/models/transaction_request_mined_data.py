...
class TransactionRequestMinedData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestMinedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestMinedData:
        """Create an instance of TransactionRequestMinedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestMinedData.parse_obj(obj)

        _obj = TransactionRequestMinedData.parse_obj({
