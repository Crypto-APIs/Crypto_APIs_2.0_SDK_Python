...
class ListUnconfirmedTransactionsByAddressRIBSDVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSDVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSDVinInner:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSDVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSDVinInner.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSDVinInner.parse_obj({
