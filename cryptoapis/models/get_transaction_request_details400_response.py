...
class GetTransactionRequestDetails400Response(BaseModel):
    """
    ...
    error: GetTransactionRequestDetailsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionRequestDetails400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionRequestDetails400Response:
        """Create an instance of GetTransactionRequestDetails400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionRequestDetails400Response.parse_obj(obj)

        _obj = GetTransactionRequestDetails400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionRequestDetailsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
