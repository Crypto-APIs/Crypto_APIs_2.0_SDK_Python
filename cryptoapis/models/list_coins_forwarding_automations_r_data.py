...
class ListCoinsForwardingAutomationsRData(BaseModel):
    """
    ...
    items: conlist(ListCoinsForwardingAutomationsRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCoinsForwardingAutomationsRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCoinsForwardingAutomationsRData:
        """Create an instance of ListCoinsForwardingAutomationsRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListCoinsForwardingAutomationsRData.parse_obj(obj)

        _obj = ListCoinsForwardingAutomationsRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListCoinsForwardingAutomationsRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
