...
class ListTransactionsByBlockHashRIBSLVinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSLVinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSLVinInnerScriptSig:
        """Create an instance of ListTransactionsByBlockHashRIBSLVinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSLVinInnerScriptSig.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSLVinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
