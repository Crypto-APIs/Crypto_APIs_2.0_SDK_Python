...
class ActivateBlockchainEventSubscription403Response(BaseModel):
    """
    ...
    error: ActivateBlockchainEventSubscriptionE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivateBlockchainEventSubscription403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivateBlockchainEventSubscription403Response:
        """Create an instance of ActivateBlockchainEventSubscription403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivateBlockchainEventSubscription403Response.parse_obj(obj)

        _obj = ActivateBlockchainEventSubscription403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ActivateBlockchainEventSubscriptionE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
