...
class GetBlockDetailsByBlockHashRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashRIBSZ:
        """Create an instance of GetBlockDetailsByBlockHashRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashRIBSZ.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashRIBSZ.parse_obj({
