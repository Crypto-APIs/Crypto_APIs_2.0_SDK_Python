...
class ActivateBlockchainEventSubscription401Response(BaseModel):
    """
    ...
    error: ActivateBlockchainEventSubscriptionE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivateBlockchainEventSubscription401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivateBlockchainEventSubscription401Response:
        """Create an instance of ActivateBlockchainEventSubscription401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivateBlockchainEventSubscription401Response.parse_obj(obj)

        _obj = ActivateBlockchainEventSubscription401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ActivateBlockchainEventSubscriptionE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
