...
class ListTransactionsByBlockHashRIBSE(BaseModel):
    """
    Ethereum
    """
    contract: StrictStr = Field(..., description="Represents the specific transaction contract.")
    gas_limit: StrictStr = Field(..., alias="gasLimit", description="String representation of the transaction Represents the amount of gas used by this specific transaction alone.")
    gas_price: ListTransactionsByBlockHashRIBSEGasPrice = Field(..., alias="gasPrice")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSE:
        """Create an instance of ListTransactionsByBlockHashRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSE.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSE.parse_obj({
            "contract": obj.get("contract"),
            "gas_limit": obj.get("gasLimit"),
            "gas_price": ListTransactionsByBlockHashRIBSEGasPrice.from_dict(obj.get("gasPrice")) if obj.get("gasPrice") is not None else None,
