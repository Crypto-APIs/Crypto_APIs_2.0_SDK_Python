...
class AddTokensToExistingFromAddressRBDataItem(BaseModel):
    """
    ...
    token_data: AddTokensToExistingFromAddressRBTokenData = Field(..., alias="tokenData")
    __properties = ["callbackSecretKey", "callbackUrl", "confirmationsCount", "feePriority", "fromAddress", "minimumTransferAmount", "toAddress", "tokenData"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddTokensToExistingFromAddressRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddTokensToExistingFromAddressRBDataItem:
        """Create an instance of AddTokensToExistingFromAddressRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddTokensToExistingFromAddressRBDataItem.parse_obj(obj)

        _obj = AddTokensToExistingFromAddressRBDataItem.parse_obj({
            ...
            "token_data": AddTokensToExistingFromAddressRBTokenData.from_dict(obj.get("tokenData")) if obj.get("tokenData") is not None else None
        })
        return _obj
