...
class ListXRPRippleTransactionsByAddressR(BaseModel):
    """
    ...
    data: ListXRPRippleTransactionsByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddressR:
        """Create an instance of ListXRPRippleTransactionsByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddressR.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListXRPRippleTransactionsByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
