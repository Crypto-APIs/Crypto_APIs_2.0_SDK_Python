...
class GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.parse_obj({
