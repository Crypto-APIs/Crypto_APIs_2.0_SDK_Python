...
class CouldNotCalculateRateForPair(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CouldNotCalculateRateForPair:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CouldNotCalculateRateForPair:
        """Create an instance of CouldNotCalculateRateForPair from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CouldNotCalculateRateForPair.parse_obj(obj)

        _obj = CouldNotCalculateRateForPair.parse_obj({
            "code": obj.get("code"),
