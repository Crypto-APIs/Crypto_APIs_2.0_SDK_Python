...
class ListUnconfirmedTokensTransfersByAddressR(BaseModel):
    """
    ...
    data: ListUnconfirmedTokensTransfersByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTokensTransfersByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTokensTransfersByAddressR:
        """Create an instance of ListUnconfirmedTokensTransfersByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTokensTransfersByAddressR.parse_obj(obj)

        _obj = ListUnconfirmedTokensTransfersByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListUnconfirmedTokensTransfersByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
