...
class ListTransactionsByBlockHashRIBSZVinInner(BaseModel):
    """
    ...
    script_sig: ListTransactionsByBlockHashRIBSZVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSZVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSZVinInner:
        """Create an instance of ListTransactionsByBlockHashRIBSZVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSZVinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSZVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": ListTransactionsByBlockHashRIBSZVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
