...
class ListConfirmedTransactionsByAddressR(BaseModel):
    """
    ...
    data: ListConfirmedTransactionsByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressR:
        """Create an instance of ListConfirmedTransactionsByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressR.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListConfirmedTransactionsByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
