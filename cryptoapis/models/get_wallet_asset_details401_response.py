...
class GetWalletAssetDetails401Response(BaseModel):
    """
    ...
    error: GetWalletAssetDetailsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletAssetDetails401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletAssetDetails401Response:
        """Create an instance of GetWalletAssetDetails401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletAssetDetails401Response.parse_obj(obj)

        _obj = GetWalletAssetDetails401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetWalletAssetDetailsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
