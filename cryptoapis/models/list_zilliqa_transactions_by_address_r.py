...
class ListZilliqaTransactionsByAddressR(BaseModel):
    """
    ...
    data: ListZilliqaTransactionsByAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByAddressR:
        """Create an instance of ListZilliqaTransactionsByAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByAddressR.parse_obj(obj)

        _obj = ListZilliqaTransactionsByAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListZilliqaTransactionsByAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
