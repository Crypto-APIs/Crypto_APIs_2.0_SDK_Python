...
class ValidateAddress403Response(BaseModel):
    """
    ...
    error: ValidateAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateAddress403Response:
        """Create an instance of ValidateAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateAddress403Response.parse_obj(obj)

        _obj = ValidateAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ValidateAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
