...
class ListTokensTransfersByTransactionHash400Response(BaseModel):
    """
    ...
    error: ListTokensTransfersByTransactionHashE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensTransfersByTransactionHash400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensTransfersByTransactionHash400Response:
        """Create an instance of ListTokensTransfersByTransactionHash400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensTransfersByTransactionHash400Response.parse_obj(obj)

        _obj = ListTokensTransfersByTransactionHash400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensTransfersByTransactionHashE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
