...
class CreateNewMasterWallet401Response(BaseModel):
    """
    ...
    error: CreateNewMasterWalletE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNewMasterWallet401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNewMasterWallet401Response:
        """Create an instance of CreateNewMasterWallet401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateNewMasterWallet401Response.parse_obj(obj)

        _obj = CreateNewMasterWallet401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": CreateNewMasterWalletE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
