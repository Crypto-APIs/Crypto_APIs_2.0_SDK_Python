...
class ListTransactionsByBlockHashRI(BaseModel):
    """
    ...
    recipients: conlist(ListTransactionsByBlockHashRIRecipientsInner) = Field(..., description="Represents a list of recipient addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.")
    senders: conlist(ListTransactionsByBlockHashRISendersInner) = Field(..., description="Represents a list of sender addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.")
    ...
    fee: ListTransactionsByBlockHashRIFee = Field(...)
    blockchain_specific: ListTransactionsByBlockHashRIBS = Field(..., alias="blockchainSpecific")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRI:
        """Create an instance of ListTransactionsByBlockHashRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRI.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRI.parse_obj({
            "transaction_id": obj.get("transactionId"),
            "index": obj.get("index"),
            "mined_in_block_hash": obj.get("minedInBlockHash"),
            "mined_in_block_height": obj.get("minedInBlockHeight"),
            "recipients": [ListTransactionsByBlockHashRIRecipientsInner.from_dict(_item) for _item in obj.get("recipients")] if obj.get("recipients") is not None else None,
            "senders": [ListTransactionsByBlockHashRISendersInner.from_dict(_item) for _item in obj.get("senders")] if obj.get("senders") is not None else None,
            "timestamp": obj.get("timestamp"),
            "transaction_hash": obj.get("transactionHash"),
            "fee": ListTransactionsByBlockHashRIFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "blockchain_specific": ListTransactionsByBlockHashRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
