...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInnerScriptPubKey:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInnerScriptPubKey.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInnerScriptPubKey.parse_obj({
