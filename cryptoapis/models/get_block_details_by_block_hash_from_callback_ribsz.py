...
class GetBlockDetailsByBlockHashFromCallbackRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSZ:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSZ.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSZ.parse_obj({
            "bits": obj.get("bits"),
