...
class ListXRPRippleTransactionsByAddressAndTimeRange403Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByAddressAndTimeRangeE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddressAndTimeRange403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddressAndTimeRange403Response:
        """Create an instance of ListXRPRippleTransactionsByAddressAndTimeRange403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddressAndTimeRange403Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddressAndTimeRange403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByAddressAndTimeRangeE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
