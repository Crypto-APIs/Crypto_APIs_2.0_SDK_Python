...
class ListWalletTransactionsR(BaseModel):
    """
    ...
    data: ListWalletTransactionsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWalletTransactionsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWalletTransactionsR:
        """Create an instance of ListWalletTransactionsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWalletTransactionsR.parse_obj(obj)

        _obj = ListWalletTransactionsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListWalletTransactionsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
