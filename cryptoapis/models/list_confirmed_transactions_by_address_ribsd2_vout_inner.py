...
class ListConfirmedTransactionsByAddressRIBSD2VoutInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSD2VoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSD2VoutInner:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSD2VoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSD2VoutInner.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSD2VoutInner.parse_obj({
