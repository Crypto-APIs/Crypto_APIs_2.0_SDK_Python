...
class EndpointNotAllowedForApiKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointNotAllowedForApiKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointNotAllowedForApiKey:
        """Create an instance of EndpointNotAllowedForApiKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointNotAllowedForApiKey.parse_obj(obj)

        _obj = EndpointNotAllowedForApiKey.parse_obj({
            "code": obj.get("code"),
