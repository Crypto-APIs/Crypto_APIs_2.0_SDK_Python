...
class ConvertBitcoinCashAddressRBDataItem(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddressRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddressRBDataItem:
        """Create an instance of ConvertBitcoinCashAddressRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddressRBDataItem.parse_obj(obj)

        _obj = ConvertBitcoinCashAddressRBDataItem.parse_obj({
