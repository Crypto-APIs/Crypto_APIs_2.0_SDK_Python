...
class ListConfirmedTokensTransfersByAddress403Response(BaseModel):
    """
    ...
    error: ListConfirmedTokensTransfersByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddress403Response:
        """Create an instance of ListConfirmedTokensTransfersByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddress403Response.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTokensTransfersByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
