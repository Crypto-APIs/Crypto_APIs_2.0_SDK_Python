...
class ListTokensTransfersByTransactionHash401Response(BaseModel):
    """
    ...
    error: ListTokensTransfersByTransactionHashE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensTransfersByTransactionHash401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensTransfersByTransactionHash401Response:
        """Create an instance of ListTokensTransfersByTransactionHash401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensTransfersByTransactionHash401Response.parse_obj(obj)

        _obj = ListTokensTransfersByTransactionHash401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensTransfersByTransactionHashE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
