...
class DecodeRawTransactionHexRISD2(BaseModel):
    """
    Dogecoin
    """
    ...
    vin: conlist(DecodeRawTransactionHexRISD2VinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(DecodeRawTransactionHexRISD2VoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISD2:
        """Create an instance of DecodeRawTransactionHexRISD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISD2.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISD2.parse_obj({
            "locktime": obj.get("locktime"),
            "transaction_hash": obj.get("transactionHash"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [DecodeRawTransactionHexRISD2VinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [DecodeRawTransactionHexRISD2VoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None,
