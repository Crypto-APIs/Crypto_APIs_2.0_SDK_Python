...
class DeriveAndSyncNewChangeAddresses401Response(BaseModel):
    """
    ...
    error: DeriveAndSyncNewChangeAddressesE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewChangeAddresses401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewChangeAddresses401Response:
        """Create an instance of DeriveAndSyncNewChangeAddresses401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewChangeAddresses401Response.parse_obj(obj)

        _obj = DeriveAndSyncNewChangeAddresses401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveAndSyncNewChangeAddressesE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
