...
class ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey:
        """Create an instance of ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey.parse_obj({
