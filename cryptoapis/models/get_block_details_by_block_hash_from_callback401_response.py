...
class GetBlockDetailsByBlockHashFromCallback401Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHashFromCallbackE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallback401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallback401Response:
        """Create an instance of GetBlockDetailsByBlockHashFromCallback401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallback401Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallback401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHashFromCallbackE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
