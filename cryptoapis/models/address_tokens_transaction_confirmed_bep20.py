...
class AddressTokensTransactionConfirmedBep20(BaseModel):
    """
    BEP-20
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedBep20:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedBep20:
        """Create an instance of AddressTokensTransactionConfirmedBep20 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedBep20.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedBep20.parse_obj({
            "name": obj.get("name"),
