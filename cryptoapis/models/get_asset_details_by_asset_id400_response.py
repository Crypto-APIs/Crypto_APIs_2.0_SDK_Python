...
class GetAssetDetailsByAssetID400Response(BaseModel):
    """
    ...
    error: GetAssetDetailsByAssetIDE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetID400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetID400Response:
        """Create an instance of GetAssetDetailsByAssetID400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetID400Response.parse_obj(obj)

        _obj = GetAssetDetailsByAssetID400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAssetDetailsByAssetIDE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
