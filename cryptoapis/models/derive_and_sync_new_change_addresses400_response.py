...
class DeriveAndSyncNewChangeAddresses400Response(BaseModel):
    """
    ...
    error: DeriveAndSyncNewChangeAddressesE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewChangeAddresses400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewChangeAddresses400Response:
        """Create an instance of DeriveAndSyncNewChangeAddresses400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewChangeAddresses400Response.parse_obj(obj)

        _obj = DeriveAndSyncNewChangeAddresses400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveAndSyncNewChangeAddressesE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
