...
class TransactionRequestApproval(BaseModel):
    """
    ...
    data: TransactionRequestApprovalData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestApproval:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestApproval:
        """Create an instance of TransactionRequestApproval from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestApproval.parse_obj(obj)

        _obj = TransactionRequestApproval.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": TransactionRequestApprovalData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
