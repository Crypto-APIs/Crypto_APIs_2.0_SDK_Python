...
class ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.parse_obj({
