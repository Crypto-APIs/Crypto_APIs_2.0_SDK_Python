...
class ListUnspentTransactionOutputsByAddressRData(BaseModel):
    """
    ...
    items: conlist(ListUnspentTransactionOutputsByAddressRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnspentTransactionOutputsByAddressRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnspentTransactionOutputsByAddressRData:
        """Create an instance of ListUnspentTransactionOutputsByAddressRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnspentTransactionOutputsByAddressRData.parse_obj(obj)

        _obj = ListUnspentTransactionOutputsByAddressRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListUnspentTransactionOutputsByAddressRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
