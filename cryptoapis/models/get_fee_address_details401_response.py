...
class GetFeeAddressDetails401Response(BaseModel):
    """
    ...
    error: GetFeeAddressDetailsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeeAddressDetails401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeeAddressDetails401Response:
        """Create an instance of GetFeeAddressDetails401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeeAddressDetails401Response.parse_obj(obj)

        _obj = GetFeeAddressDetails401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetFeeAddressDetailsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
