...
class ListZilliqaTransactionsByAddressRData(BaseModel):
    """
    ...
    items: conlist(ListZilliqaTransactionsByAddressRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByAddressRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByAddressRData:
        """Create an instance of ListZilliqaTransactionsByAddressRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByAddressRData.parse_obj(obj)

        _obj = ListZilliqaTransactionsByAddressRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListZilliqaTransactionsByAddressRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
