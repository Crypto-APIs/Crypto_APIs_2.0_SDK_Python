...
class GetNextAvailableNonce401Response(BaseModel):
    """
    ...
    error: GetNextAvailableNonceE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNextAvailableNonce401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNextAvailableNonce401Response:
        """Create an instance of GetNextAvailableNonce401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetNextAvailableNonce401Response.parse_obj(obj)

        _obj = GetNextAvailableNonce401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetNextAvailableNonceE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
