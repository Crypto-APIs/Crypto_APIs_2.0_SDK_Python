...
class CreateFungibleTokensTransactionRequestFromAddressRB(BaseModel):
    """
    ...
    data: CreateFungibleTokensTransactionRequestFromAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFungibleTokensTransactionRequestFromAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFungibleTokensTransactionRequestFromAddressRB:
        """Create an instance of CreateFungibleTokensTransactionRequestFromAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFungibleTokensTransactionRequestFromAddressRB.parse_obj(obj)

        _obj = CreateFungibleTokensTransactionRequestFromAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": CreateFungibleTokensTransactionRequestFromAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
