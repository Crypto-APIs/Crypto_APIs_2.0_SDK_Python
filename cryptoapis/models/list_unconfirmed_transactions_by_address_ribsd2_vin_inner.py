...
class ListUnconfirmedTransactionsByAddressRIBSD2VinInner(BaseModel):
    """
    ListUnconfirmedTransactionsByAddressRIBSD2VinInner
    """
    addresses: conlist(StrictStr) = Field(...)
    script_sig: ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    value: Optional[StrictStr] = Field(None, description="String representation of the amount")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSD2VinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSD2VinInner:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSD2VinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSD2VinInner.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSD2VinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "script_sig": ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
