...
class ListHDWalletXPubYPubZPubTransactionsRData(BaseModel):
    """
    ...
    items: conlist(ListHDWalletXPubYPubZPubTransactionsRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubTransactionsRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubTransactionsRData:
        """Create an instance of ListHDWalletXPubYPubZPubTransactionsRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubTransactionsRData.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubTransactionsRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListHDWalletXPubYPubZPubTransactionsRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
