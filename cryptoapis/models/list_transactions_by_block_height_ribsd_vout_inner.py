...
class ListTransactionsByBlockHeightRIBSDVoutInner(BaseModel):
    """
    ...
    script_pub_key: ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSDVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSDVoutInner:
        """Create an instance of ListTransactionsByBlockHeightRIBSDVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSDVoutInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSDVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
