...
class GetZilliqaBlockDetailsByBlockHeight400Response(BaseModel):
    """
    ...
    error: GetZilliqaBlockDetailsByBlockHeightE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaBlockDetailsByBlockHeight400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaBlockDetailsByBlockHeight400Response:
        """Create an instance of GetZilliqaBlockDetailsByBlockHeight400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaBlockDetailsByBlockHeight400Response.parse_obj(obj)

        _obj = GetZilliqaBlockDetailsByBlockHeight400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaBlockDetailsByBlockHeightE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
