...
class GetBlockDetailsByBlockHashFromCallbackRIBSB(BaseModel):
    """
    Bitcoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSB:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSB.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSB.parse_obj({
            "bits": obj.get("bits"),
