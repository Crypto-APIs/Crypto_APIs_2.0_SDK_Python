...
class GetWalletTransactionDetailsByTransactionIDRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSBSC:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSBSC.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSBSC.parse_obj({
