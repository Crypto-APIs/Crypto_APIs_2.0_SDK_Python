...
class GetZilliqaBlockDetailsByBlockHeightR(BaseModel):
    """
    ...
    data: GetZilliqaBlockDetailsByBlockHeightRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaBlockDetailsByBlockHeightR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaBlockDetailsByBlockHeightR:
        """Create an instance of GetZilliqaBlockDetailsByBlockHeightR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaBlockDetailsByBlockHeightR.parse_obj(obj)

        _obj = GetZilliqaBlockDetailsByBlockHeightR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetZilliqaBlockDetailsByBlockHeightRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
