...
class SyncHDWalletXPubYPubZPub400Response(BaseModel):
    """
    ...
    error: SyncHDWalletXPubYPubZPubE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncHDWalletXPubYPubZPub400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncHDWalletXPubYPubZPub400Response:
        """Create an instance of SyncHDWalletXPubYPubZPub400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncHDWalletXPubYPubZPub400Response.parse_obj(obj)

        _obj = SyncHDWalletXPubYPubZPub400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncHDWalletXPubYPubZPubE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
