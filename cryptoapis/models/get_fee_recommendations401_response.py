...
class GetFeeRecommendations401Response(BaseModel):
    """
    ...
    error: GetFeeRecommendationsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFeeRecommendations401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFeeRecommendations401Response:
        """Create an instance of GetFeeRecommendations401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFeeRecommendations401Response.parse_obj(obj)

        _obj = GetFeeRecommendations401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetFeeRecommendationsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
