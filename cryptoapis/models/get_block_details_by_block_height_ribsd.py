...
class GetBlockDetailsByBlockHeightRIBSD(BaseModel):
    """
    Dogecoin
    """
    ...
    weight: StrictInt = Field(..., description="Represents a measurement to compare the size of different transactions to each other in proportion to the block size limi")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightRIBSD:
        """Create an instance of GetBlockDetailsByBlockHeightRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightRIBSD.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightRIBSD.parse_obj({
