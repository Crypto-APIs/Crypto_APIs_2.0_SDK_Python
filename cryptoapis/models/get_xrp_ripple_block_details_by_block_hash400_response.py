...
class GetXRPRippleBlockDetailsByBlockHash400Response(BaseModel):
    """
    ...
    error: GetXRPRippleBlockDetailsByBlockHashE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleBlockDetailsByBlockHash400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleBlockDetailsByBlockHash400Response:
        """Create an instance of GetXRPRippleBlockDetailsByBlockHash400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleBlockDetailsByBlockHash400Response.parse_obj(obj)

        _obj = GetXRPRippleBlockDetailsByBlockHash400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleBlockDetailsByBlockHashE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
