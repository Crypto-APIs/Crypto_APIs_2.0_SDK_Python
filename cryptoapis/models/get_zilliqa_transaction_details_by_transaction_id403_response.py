...
class GetZilliqaTransactionDetailsByTransactionID403Response(BaseModel):
    """
    ...
    error: GetZilliqaTransactionDetailsByTransactionIDE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaTransactionDetailsByTransactionID403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaTransactionDetailsByTransactionID403Response:
        """Create an instance of GetZilliqaTransactionDetailsByTransactionID403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaTransactionDetailsByTransactionID403Response.parse_obj(obj)

        _obj = GetZilliqaTransactionDetailsByTransactionID403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaTransactionDetailsByTransactionIDE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
