...
class TransactionRequestFailDataItem(BaseModel):
    """
    ...
    error_message: StrictStr = Field(..., alias="errorMessage", description="Represents the error message received for the transaction.")
    __properties = ["blockchain", "network", "requiredApprovals", "requiredRejections", "currentApprovals", "currentRejections", "errorMessage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestFailDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestFailDataItem:
        """Create an instance of TransactionRequestFailDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestFailDataItem.parse_obj(obj)

        _obj = TransactionRequestFailDataItem.parse_obj({
