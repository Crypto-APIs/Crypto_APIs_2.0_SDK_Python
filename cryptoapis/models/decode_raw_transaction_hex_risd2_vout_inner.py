...
class DecodeRawTransactionHexRISD2VoutInner(BaseModel):
    """
    DecodeRawTransactionHexRISD2VoutInner
    """
    script_pub_key: DecodeRawTransactionHexRISD2VoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISD2VoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISD2VoutInner:
        """Create an instance of DecodeRawTransactionHexRISD2VoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISD2VoutInner.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISD2VoutInner.parse_obj({
            "script_pub_key": DecodeRawTransactionHexRISD2VoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
