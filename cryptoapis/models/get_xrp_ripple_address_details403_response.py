...
class GetXRPRippleAddressDetails403Response(BaseModel):
    """
    ...
    error: GetXRPRippleAddressDetailsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleAddressDetails403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleAddressDetails403Response:
        """Create an instance of GetXRPRippleAddressDetails403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleAddressDetails403Response.parse_obj(obj)

        _obj = GetXRPRippleAddressDetails403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleAddressDetailsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
