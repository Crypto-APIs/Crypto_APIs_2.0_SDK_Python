...
class CreateCoinsTransactionFromAddressForWholeAmountRIRecipientsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCoinsTransactionFromAddressForWholeAmountRIRecipientsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCoinsTransactionFromAddressForWholeAmountRIRecipientsInner:
        """Create an instance of CreateCoinsTransactionFromAddressForWholeAmountRIRecipientsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCoinsTransactionFromAddressForWholeAmountRIRecipientsInner.parse_obj(obj)

        _obj = CreateCoinsTransactionFromAddressForWholeAmountRIRecipientsInner.parse_obj({
