...
class TokensForwardingAutomationsLimitReached(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokensForwardingAutomationsLimitReached:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokensForwardingAutomationsLimitReached:
        """Create an instance of TokensForwardingAutomationsLimitReached from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokensForwardingAutomationsLimitReached.parse_obj(obj)

        _obj = TokensForwardingAutomationsLimitReached.parse_obj({
            "code": obj.get("code"),
