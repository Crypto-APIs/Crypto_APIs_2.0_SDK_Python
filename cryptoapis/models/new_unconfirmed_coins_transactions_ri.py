...
class NewUnconfirmedCoinsTransactionsRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewUnconfirmedCoinsTransactionsRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewUnconfirmedCoinsTransactionsRI:
        """Create an instance of NewUnconfirmedCoinsTransactionsRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewUnconfirmedCoinsTransactionsRI.parse_obj(obj)

        _obj = NewUnconfirmedCoinsTransactionsRI.parse_obj({
