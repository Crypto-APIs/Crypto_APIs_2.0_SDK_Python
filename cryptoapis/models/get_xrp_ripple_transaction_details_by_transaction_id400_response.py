...
class GetXRPRippleTransactionDetailsByTransactionID400Response(BaseModel):
    """
    ...
    error: GetXRPRippleTransactionDetailsByTransactionIDE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleTransactionDetailsByTransactionID400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleTransactionDetailsByTransactionID400Response:
        """Create an instance of GetXRPRippleTransactionDetailsByTransactionID400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleTransactionDetailsByTransactionID400Response.parse_obj(obj)

        _obj = GetXRPRippleTransactionDetailsByTransactionID400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleTransactionDetailsByTransactionIDE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
