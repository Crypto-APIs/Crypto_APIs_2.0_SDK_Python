...
class NewRevertedBlockRB(BaseModel):
    """
    NewRevertedBlockRB
    """
    ...
    data: NewRevertedBlockRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewRevertedBlockRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewRevertedBlockRB:
        """Create an instance of NewRevertedBlockRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewRevertedBlockRB.parse_obj(obj)

        _obj = NewRevertedBlockRB.parse_obj({
            "context": obj.get("context"),
            "data": NewRevertedBlockRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
