...
class GetAddressBalance400Response(BaseModel):
    """
    ...
    error: GetAddressBalanceE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressBalance400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressBalance400Response:
        """Create an instance of GetAddressBalance400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressBalance400Response.parse_obj(obj)

        _obj = GetAddressBalance400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAddressBalanceE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
