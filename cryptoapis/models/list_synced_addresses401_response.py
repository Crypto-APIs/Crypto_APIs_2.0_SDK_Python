...
class ListSyncedAddresses401Response(BaseModel):
    """
    ...
    error: ListSyncedAddressesE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSyncedAddresses401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSyncedAddresses401Response:
        """Create an instance of ListSyncedAddresses401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSyncedAddresses401Response.parse_obj(obj)

        _obj = ListSyncedAddresses401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSyncedAddressesE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
