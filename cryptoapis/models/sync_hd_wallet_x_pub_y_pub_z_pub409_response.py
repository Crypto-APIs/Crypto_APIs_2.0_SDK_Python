...
class SyncHDWalletXPubYPubZPub409Response(BaseModel):
    """
    ...
    error: SyncHDWalletXPubYPubZPubE409 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncHDWalletXPubYPubZPub409Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncHDWalletXPubYPubZPub409Response:
        """Create an instance of SyncHDWalletXPubYPubZPub409Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncHDWalletXPubYPubZPub409Response.parse_obj(obj)

        _obj = SyncHDWalletXPubYPubZPub409Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncHDWalletXPubYPubZPubE409.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
