...
class GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey.parse_obj({
