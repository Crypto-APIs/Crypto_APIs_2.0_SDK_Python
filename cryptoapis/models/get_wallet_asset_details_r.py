...
class GetWalletAssetDetailsR(BaseModel):
    """
    ...
    data: GetWalletAssetDetailsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletAssetDetailsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletAssetDetailsR:
        """Create an instance of GetWalletAssetDetailsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletAssetDetailsR.parse_obj(obj)

        _obj = GetWalletAssetDetailsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetWalletAssetDetailsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
