...
class SyncHDWalletXPubYPubZPubRB(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncHDWalletXPubYPubZPubRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncHDWalletXPubYPubZPubRB:
        """Create an instance of SyncHDWalletXPubYPubZPubRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncHDWalletXPubYPubZPubRB.parse_obj(obj)

        _obj = SyncHDWalletXPubYPubZPubRB.parse_obj({
