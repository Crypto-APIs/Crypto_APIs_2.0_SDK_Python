...
class ListTransactionsByBlockHeightRIBSZVinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSZVinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSZVinInnerScriptSig:
        """Create an instance of ListTransactionsByBlockHeightRIBSZVinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSZVinInnerScriptSig.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSZVinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
