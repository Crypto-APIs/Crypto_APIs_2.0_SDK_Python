...
class ListTransactionsByBlockHashRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    vin: conlist(ListTransactionsByBlockHashRIBSLVinInner) = Field(..., description="Represents the transaction inputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSL:
        """Create an instance of ListTransactionsByBlockHashRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSL.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSL.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [ListTransactionsByBlockHashRIBSLVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
