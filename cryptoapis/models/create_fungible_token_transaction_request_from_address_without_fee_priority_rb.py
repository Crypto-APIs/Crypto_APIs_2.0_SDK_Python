...
class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB(BaseModel):
    """
    ...
    data: CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRBData = Field(...)
    __properties = ["context", "data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB:
        """Create an instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB.parse_obj(obj)

        _obj = CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB.parse_obj({
            "context": obj.get("context"),
            "data": CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
