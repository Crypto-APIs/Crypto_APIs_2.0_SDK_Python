...
class ListTransactionsByBlockHashRIBSEGasPrice(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSEGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSEGasPrice:
        """Create an instance of ListTransactionsByBlockHashRIBSEGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSEGasPrice.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSEGasPrice.parse_obj({
