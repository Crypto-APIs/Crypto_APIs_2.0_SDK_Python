...
class DecodeRawTransactionHexRISB2VoutInner(BaseModel):
    """
    DecodeRawTransactionHexRISB2VoutInner
    """
    script_pub_key: DecodeRawTransactionHexRISB2VoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISB2VoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISB2VoutInner:
        """Create an instance of DecodeRawTransactionHexRISB2VoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISB2VoutInner.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISB2VoutInner.parse_obj({
            "script_pub_key": DecodeRawTransactionHexRISB2VoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
