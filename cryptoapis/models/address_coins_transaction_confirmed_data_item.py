...
class AddressCoinsTransactionConfirmedDataItem(BaseModel):
    """
    ...
    address: StrictStr = Field(..., description="Defines the specific address to which the coin transaction has been sent and is confirmed.")
    mined_in_block: AddressCoinsTransactionConfirmedDataItemMinedInBlock = Field(..., alias="minedInBlock")
    ...
    __properties = ["blockchain", "network", "address", "minedInBlock", "transactionId", "amount", "unit", "direction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressCoinsTransactionConfirmedDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressCoinsTransactionConfirmedDataItem:
        """Create an instance of AddressCoinsTransactionConfirmedDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressCoinsTransactionConfirmedDataItem.parse_obj(obj)

        _obj = AddressCoinsTransactionConfirmedDataItem.parse_obj({
            "blockchain": obj.get("blockchain"),
            "network": obj.get("network"),
            "address": obj.get("address"),
            "mined_in_block": AddressCoinsTransactionConfirmedDataItemMinedInBlock.from_dict(obj.get("minedInBlock")) if obj.get("minedInBlock") is not None else None,
