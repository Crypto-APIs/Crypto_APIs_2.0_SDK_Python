...
class GetBlockDetailsByBlockHashFromCallbackRIBSD2(BaseModel):
    """
    Dogecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSD2:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSD2.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSD2.parse_obj({
            "bits": obj.get("bits"),
