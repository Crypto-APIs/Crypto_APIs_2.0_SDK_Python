...
class GetXRPRippleAddressDetailsR(BaseModel):
    """
    ...
    data: GetXRPRippleAddressDetailsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleAddressDetailsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleAddressDetailsR:
        """Create an instance of GetXRPRippleAddressDetailsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleAddressDetailsR.parse_obj(obj)

        _obj = GetXRPRippleAddressDetailsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetXRPRippleAddressDetailsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
