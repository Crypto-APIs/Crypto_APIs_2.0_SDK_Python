...
class AddressCoinsTransactionUnconfirmedData(BaseModel):
    """
    ...
    item: AddressCoinsTransactionUnconfirmedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressCoinsTransactionUnconfirmedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressCoinsTransactionUnconfirmedData:
        """Create an instance of AddressCoinsTransactionUnconfirmedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressCoinsTransactionUnconfirmedData.parse_obj(obj)

        _obj = AddressCoinsTransactionUnconfirmedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": AddressCoinsTransactionUnconfirmedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
