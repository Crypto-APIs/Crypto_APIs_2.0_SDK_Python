...
class ConvertBitcoinCashAddress415Response(BaseModel):
    """
    ...
    error: UnsupportedMediaType = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress415Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress415Response:
        """Create an instance of ConvertBitcoinCashAddress415Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress415Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress415Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": UnsupportedMediaType.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
