...
class ListConfirmedTransactionsByAddress400Response(BaseModel):
    """
    ...
    error: ListConfirmedTransactionsByAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddress400Response:
        """Create an instance of ListConfirmedTransactionsByAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddress400Response.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTransactionsByAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
