...
class SyncNewHDWalletXPubYPubZPub403Response(BaseModel):
    """
    ...
    error: SyncNewHDWalletXPubYPubZPubE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncNewHDWalletXPubYPubZPub403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncNewHDWalletXPubYPubZPub403Response:
        """Create an instance of SyncNewHDWalletXPubYPubZPub403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncNewHDWalletXPubYPubZPub403Response.parse_obj(obj)

        _obj = SyncNewHDWalletXPubYPubZPub403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncNewHDWalletXPubYPubZPubE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
