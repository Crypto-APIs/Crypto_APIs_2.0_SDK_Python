...
class ConvertBitcoinCashAddress402Response(BaseModel):
    """
    ...
    error: InsufficientCredits = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress402Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress402Response:
        """Create an instance of ConvertBitcoinCashAddress402Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress402Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress402Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": InsufficientCredits.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
