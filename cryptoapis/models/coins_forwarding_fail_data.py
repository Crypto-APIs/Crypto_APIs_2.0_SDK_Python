...
class CoinsForwardingFailData(BaseModel):
    """
    ...
    item: CoinsForwardingFailDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CoinsForwardingFailData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CoinsForwardingFailData:
        """Create an instance of CoinsForwardingFailData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CoinsForwardingFailData.parse_obj(obj)

        _obj = CoinsForwardingFailData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": CoinsForwardingFailDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
