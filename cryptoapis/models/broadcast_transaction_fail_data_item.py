...
class BroadcastTransactionFailDataItem(BaseModel):
    """
    ...
    __properties = ["blockchain", "network", "transactionId", "errorMessage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastTransactionFailDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastTransactionFailDataItem:
        """Create an instance of BroadcastTransactionFailDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastTransactionFailDataItem.parse_obj(obj)

        _obj = BroadcastTransactionFailDataItem.parse_obj({
