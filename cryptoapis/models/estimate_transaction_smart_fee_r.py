...
class EstimateTransactionSmartFeeR(BaseModel):
    """
    ...
    data: EstimateTransactionSmartFeeRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTransactionSmartFeeR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTransactionSmartFeeR:
        """Create an instance of EstimateTransactionSmartFeeR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTransactionSmartFeeR.parse_obj(obj)

        _obj = EstimateTransactionSmartFeeR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": EstimateTransactionSmartFeeRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
