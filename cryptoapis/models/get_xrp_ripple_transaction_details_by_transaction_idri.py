...
class GetXRPRippleTransactionDetailsByTransactionIDRI(BaseModel):
    """
    ...
    index: StrictStr = Field(..., description="Defines the index of the transaction, i.e. the consecutive place it takes in the blockchain.")
    ...
    mined_in_block_height: StrictStr = Field(..., alias="minedInBlockHeight", description="Represents the hight of the block where this transaction was mined/confirmed for first time. The height is defined as the number of blocks in the blockchain preceding this specific block.")
    ...
    status: Optional[StrictStr] = Field(None, description="Defines the status of the transaction.")
    ...
    fee: GetXRPRippleTransactionDetailsByTransactionIDRIFee = Field(...)
    value: GetXRPRippleTransactionDetailsByTransactionIDRIValue = Field(...)
    __properties = ["additionalData", "destinationTag", "index", "minedInBlockHash", "minedInBlockHeight", "offer", "receive", "recipients", "senders", "sequence", "status", "timestamp", "transactionHash", "type", "fee", "value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleTransactionDetailsByTransactionIDRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleTransactionDetailsByTransactionIDRI:
        """Create an instance of GetXRPRippleTransactionDetailsByTransactionIDRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleTransactionDetailsByTransactionIDRI.parse_obj(obj)

        _obj = GetXRPRippleTransactionDetailsByTransactionIDRI.parse_obj({
            ...
            "type": obj.get("type"),
            "fee": GetXRPRippleTransactionDetailsByTransactionIDRIFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "value": GetXRPRippleTransactionDetailsByTransactionIDRIValue.from_dict(obj.get("value")) if obj.get("value") is not None else None
        })
        return _obj
