...
class GetLatestMinedZilliqaBlockRI(BaseModel):
    """
    ...
    __properties = ["blockHash", "blockHeight", "difficulty", "dsBlock", "dsDifficulty", "dsLeader", "gasLimit", "gasUsed", "microBlocks", "previousBlockHash", "timestamp", "transactionsCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestMinedZilliqaBlockRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestMinedZilliqaBlockRI:
        """Create an instance of GetLatestMinedZilliqaBlockRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestMinedZilliqaBlockRI.parse_obj(obj)

        _obj = GetLatestMinedZilliqaBlockRI.parse_obj({
