...
class InvalidXpub(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidXpub:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidXpub:
        """Create an instance of InvalidXpub from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidXpub.parse_obj(obj)

        _obj = InvalidXpub.parse_obj({
            "code": obj.get("code"),
