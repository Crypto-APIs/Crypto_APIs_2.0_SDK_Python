...
class ListCoinsForwardingAutomations403Response(BaseModel):
    """
    ...
    error: ListCoinsForwardingAutomationsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCoinsForwardingAutomations403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCoinsForwardingAutomations403Response:
        """Create an instance of ListCoinsForwardingAutomations403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListCoinsForwardingAutomations403Response.parse_obj(obj)

        _obj = ListCoinsForwardingAutomations403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListCoinsForwardingAutomationsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
