...
class BlockHeightReachedData(BaseModel):
    """
    ...
    item: BlockHeightReachedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockHeightReachedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockHeightReachedData:
        """Create an instance of BlockHeightReachedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockHeightReachedData.parse_obj(obj)

        _obj = BlockHeightReachedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": BlockHeightReachedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
