...
class ValidateAddress400Response(BaseModel):
    """
    ...
    error: ValidateAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateAddress400Response:
        """Create an instance of ValidateAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateAddress400Response.parse_obj(obj)

        _obj = ValidateAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ValidateAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
