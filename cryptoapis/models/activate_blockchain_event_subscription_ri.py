...
class ActivateBlockchainEventSubscriptionRI(BaseModel):
    """
    ...
    __properties = ["address", "blockchain", "callbackSecretKey", "callbackUrl", "confirmationsCount", "createdTimestamp", "eventType", "isActive", "network", "referenceId", "transactionId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivateBlockchainEventSubscriptionRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivateBlockchainEventSubscriptionRI:
        """Create an instance of ActivateBlockchainEventSubscriptionRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivateBlockchainEventSubscriptionRI.parse_obj(obj)

        _obj = ActivateBlockchainEventSubscriptionRI.parse_obj({
