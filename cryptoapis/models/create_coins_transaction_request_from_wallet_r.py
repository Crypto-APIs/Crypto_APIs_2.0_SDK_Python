...
class CreateCoinsTransactionRequestFromWalletR(BaseModel):
    """
    ...
    data: CreateCoinsTransactionRequestFromWalletRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCoinsTransactionRequestFromWalletR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCoinsTransactionRequestFromWalletR:
        """Create an instance of CreateCoinsTransactionRequestFromWalletR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCoinsTransactionRequestFromWalletR.parse_obj(obj)

        _obj = CreateCoinsTransactionRequestFromWalletR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateCoinsTransactionRequestFromWalletRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
