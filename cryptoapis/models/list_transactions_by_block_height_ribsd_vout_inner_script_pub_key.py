...
class ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey:
        """Create an instance of ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSDVoutInnerScriptPubKey.parse_obj({
