...
class EstimateTokenGasLimit400Response(BaseModel):
    """
    ...
    error: EstimateTokenGasLimitE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTokenGasLimit400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTokenGasLimit400Response:
        """Create an instance of EstimateTokenGasLimit400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTokenGasLimit400Response.parse_obj(obj)

        _obj = EstimateTokenGasLimit400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateTokenGasLimitE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
