...
class UnexpectedServerError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnexpectedServerError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnexpectedServerError:
        """Create an instance of UnexpectedServerError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnexpectedServerError.parse_obj(obj)

        _obj = UnexpectedServerError.parse_obj({
            "code": obj.get("code"),
