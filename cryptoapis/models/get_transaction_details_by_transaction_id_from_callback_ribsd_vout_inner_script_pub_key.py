...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey.parse_obj({
