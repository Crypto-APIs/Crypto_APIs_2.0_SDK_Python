...
class WalletAsAServiceWalletsLimitReached(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletAsAServiceWalletsLimitReached:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletAsAServiceWalletsLimitReached:
        """Create an instance of WalletAsAServiceWalletsLimitReached from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletAsAServiceWalletsLimitReached.parse_obj(obj)

        _obj = WalletAsAServiceWalletsLimitReached.parse_obj({
            "code": obj.get("code"),
