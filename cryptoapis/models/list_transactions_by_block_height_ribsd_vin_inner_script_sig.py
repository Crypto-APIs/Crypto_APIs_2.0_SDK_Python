...
class ListTransactionsByBlockHeightRIBSDVinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSDVinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSDVinInnerScriptSig:
        """Create an instance of ListTransactionsByBlockHeightRIBSDVinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSDVinInnerScriptSig.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSDVinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
