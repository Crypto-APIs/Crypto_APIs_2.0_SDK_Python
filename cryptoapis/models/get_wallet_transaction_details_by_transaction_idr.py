...
class GetWalletTransactionDetailsByTransactionIDR(BaseModel):
    """
    ...
    data: GetWalletTransactionDetailsByTransactionIDRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDR:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDR.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetWalletTransactionDetailsByTransactionIDRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
