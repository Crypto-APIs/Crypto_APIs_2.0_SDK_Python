...
class EstimateGasLimitRI(BaseModel):
    """
    EstimateGasLimitRI
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateGasLimitRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateGasLimitRI:
        """Create an instance of EstimateGasLimitRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateGasLimitRI.parse_obj(obj)

        _obj = EstimateGasLimitRI.parse_obj({
