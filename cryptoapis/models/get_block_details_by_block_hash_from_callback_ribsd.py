...
class GetBlockDetailsByBlockHashFromCallbackRIBSD(BaseModel):
    """
    Dash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSD:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSD.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSD.parse_obj({
            "bits": obj.get("bits"),
