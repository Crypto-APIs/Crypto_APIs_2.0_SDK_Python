...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub401Response(BaseModel):
    """
    ...
    error: PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub401Response:
        """Create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub401Response.parse_obj(obj)

        _obj = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
