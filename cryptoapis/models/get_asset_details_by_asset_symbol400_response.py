...
class GetAssetDetailsByAssetSymbol400Response(BaseModel):
    """
    ...
    error: GetAssetDetailsByAssetSymbolE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetSymbol400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetSymbol400Response:
        """Create an instance of GetAssetDetailsByAssetSymbol400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetSymbol400Response.parse_obj(obj)

        _obj = GetAssetDetailsByAssetSymbol400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAssetDetailsByAssetSymbolE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
