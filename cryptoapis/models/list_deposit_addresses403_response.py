...
class ListDepositAddresses403Response(BaseModel):
    """
    ...
    error: ListDepositAddressesE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDepositAddresses403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDepositAddresses403Response:
        """Create an instance of ListDepositAddresses403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListDepositAddresses403Response.parse_obj(obj)

        _obj = ListDepositAddresses403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListDepositAddressesE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
