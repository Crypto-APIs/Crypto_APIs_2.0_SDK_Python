...
class ListTransactionsByBlockHashRIBSD2(BaseModel):
    """
    Dash
    """
    ...
    vin: conlist(ListTransactionsByBlockHashRIBSD2VinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(ListTransactionsByBlockHashRIBSD2VoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSD2:
        """Create an instance of ListTransactionsByBlockHashRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSD2.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSD2.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [ListTransactionsByBlockHashRIBSD2VinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [ListTransactionsByBlockHashRIBSD2VoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
