...
class ListTransactionsByBlockHashRIBSBVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSBVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSBVinInner:
        """Create an instance of ListTransactionsByBlockHashRIBSBVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSBVinInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSBVinInner.parse_obj({
