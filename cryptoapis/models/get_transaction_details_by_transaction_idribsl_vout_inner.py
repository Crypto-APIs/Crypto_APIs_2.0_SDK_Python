...
class GetTransactionDetailsByTransactionIDRIBSLVoutInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSLVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSLVoutInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSLVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSLVoutInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSLVoutInner.parse_obj({
