...
class PrepareAFungibleTokenTransferFromAddress403Response(BaseModel):
    """
    ...
    error: PrepareAFungibleTokenTransferFromAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAFungibleTokenTransferFromAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAFungibleTokenTransferFromAddress403Response:
        """Create an instance of PrepareAFungibleTokenTransferFromAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAFungibleTokenTransferFromAddress403Response.parse_obj(obj)

        _obj = PrepareAFungibleTokenTransferFromAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareAFungibleTokenTransferFromAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
