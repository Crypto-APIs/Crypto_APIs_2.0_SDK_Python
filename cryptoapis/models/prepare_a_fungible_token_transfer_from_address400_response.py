...
class PrepareAFungibleTokenTransferFromAddress400Response(BaseModel):
    """
    ...
    error: PrepareAFungibleTokenTransferFromAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAFungibleTokenTransferFromAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAFungibleTokenTransferFromAddress400Response:
        """Create an instance of PrepareAFungibleTokenTransferFromAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAFungibleTokenTransferFromAddress400Response.parse_obj(obj)

        _obj = PrepareAFungibleTokenTransferFromAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareAFungibleTokenTransferFromAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
