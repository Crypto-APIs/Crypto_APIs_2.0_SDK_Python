...
class BroadcastTransactionFailData(BaseModel):
    """
    ...
    item: BroadcastTransactionFailDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastTransactionFailData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastTransactionFailData:
        """Create an instance of BroadcastTransactionFailData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastTransactionFailData.parse_obj(obj)

        _obj = BroadcastTransactionFailData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": BroadcastTransactionFailDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
