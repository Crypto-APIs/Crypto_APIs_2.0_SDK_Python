...
class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response(BaseModel):
    """
    ...
    error: DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response:
        """Create an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response.parse_obj(obj)

        _obj = DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
