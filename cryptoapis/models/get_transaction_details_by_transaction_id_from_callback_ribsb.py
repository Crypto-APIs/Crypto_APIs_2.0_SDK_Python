...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSB(BaseModel):
    """
    Bitcoin
    """
    ...
    vin: conlist(GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSB:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSB.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSB.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
