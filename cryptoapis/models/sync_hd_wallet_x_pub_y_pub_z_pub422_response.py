...
class SyncHDWalletXPubYPubZPub422Response(BaseModel):
    """
    ...
    error: SyncHDWalletXPubYPubZPubE422 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncHDWalletXPubYPubZPub422Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncHDWalletXPubYPubZPub422Response:
        """Create an instance of SyncHDWalletXPubYPubZPub422Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncHDWalletXPubYPubZPub422Response.parse_obj(obj)

        _obj = SyncHDWalletXPubYPubZPub422Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncHDWalletXPubYPubZPubE422.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
