...
class ListConfirmedTransactionsByAddressAndTimeRange403Response(BaseModel):
    """
    ...
    error: ListConfirmedTransactionsByAddressAndTimeRangeE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRange403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRange403Response:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRange403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRange403Response.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRange403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTransactionsByAddressAndTimeRangeE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
