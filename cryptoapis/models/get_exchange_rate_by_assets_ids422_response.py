...
class GetExchangeRateByAssetsIDs422Response(BaseModel):
    """
    ...
    error: GetExchangeRateByAssetsIDsE422 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetsIDs422Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetsIDs422Response:
        """Create an instance of GetExchangeRateByAssetsIDs422Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetsIDs422Response.parse_obj(obj)

        _obj = GetExchangeRateByAssetsIDs422Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetExchangeRateByAssetsIDsE422.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
