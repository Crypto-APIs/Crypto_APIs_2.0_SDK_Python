...
class GetLastMinedBlock403Response(BaseModel):
    """
    ...
    error: GetLastMinedBlockE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlock403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlock403Response:
        """Create an instance of GetLastMinedBlock403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlock403Response.parse_obj(obj)

        _obj = GetLastMinedBlock403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetLastMinedBlockE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
