...
class DeleteAutomaticTokensForwardingRI(BaseModel):
    """
    ...
    token_data: DeleteAutomaticTokensForwardingRITS = Field(..., alias="tokenData")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticTokensForwardingRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticTokensForwardingRI:
        """Create an instance of DeleteAutomaticTokensForwardingRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticTokensForwardingRI.parse_obj(obj)

        _obj = DeleteAutomaticTokensForwardingRI.parse_obj({
            ...
            "token_data": DeleteAutomaticTokensForwardingRITS.from_dict(obj.get("tokenData")) if obj.get("tokenData") is not None else None
        })
        return _obj
