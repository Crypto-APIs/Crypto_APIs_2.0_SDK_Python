...
class ListXRPRippleTransactionsByAddress401Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddress401Response:
        """Create an instance of ListXRPRippleTransactionsByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddress401Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
