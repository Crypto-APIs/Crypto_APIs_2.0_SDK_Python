...
class DeleteBlockchainEventSubscription403Response(BaseModel):
    """
    ...
    error: DeleteBlockchainEventSubscriptionE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteBlockchainEventSubscription403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteBlockchainEventSubscription403Response:
        """Create an instance of DeleteBlockchainEventSubscription403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteBlockchainEventSubscription403Response.parse_obj(obj)

        _obj = DeleteBlockchainEventSubscription403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteBlockchainEventSubscriptionE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
