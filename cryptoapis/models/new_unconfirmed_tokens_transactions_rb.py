...
class NewUnconfirmedTokensTransactionsRB(BaseModel):
    """
    ...
    data: NewUnconfirmedTokensTransactionsRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewUnconfirmedTokensTransactionsRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewUnconfirmedTokensTransactionsRB:
        """Create an instance of NewUnconfirmedTokensTransactionsRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewUnconfirmedTokensTransactionsRB.parse_obj(obj)

        _obj = NewUnconfirmedTokensTransactionsRB.parse_obj({
            "context": obj.get("context"),
            "data": NewUnconfirmedTokensTransactionsRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
