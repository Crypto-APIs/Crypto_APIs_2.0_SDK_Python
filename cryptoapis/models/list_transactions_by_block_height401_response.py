...
class ListTransactionsByBlockHeight401Response(BaseModel):
    """
    ...
    error: ListTransactionsByBlockHeightE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeight401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeight401Response:
        """Create an instance of ListTransactionsByBlockHeight401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeight401Response.parse_obj(obj)

        _obj = ListTransactionsByBlockHeight401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTransactionsByBlockHeightE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
