...
class GetBlockDetailsByBlockHashFromCallbackRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSEC:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSEC.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSEC.parse_obj({
