...
class AddTokensToExistingFromAddressRITSBOT(BaseModel):
    """
    Bitcoin Omni Token
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddTokensToExistingFromAddressRITSBOT:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddTokensToExistingFromAddressRITSBOT:
        """Create an instance of AddTokensToExistingFromAddressRITSBOT from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddTokensToExistingFromAddressRITSBOT.parse_obj(obj)

        _obj = AddTokensToExistingFromAddressRITSBOT.parse_obj({
