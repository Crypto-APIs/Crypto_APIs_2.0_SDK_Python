...
class DeriveAndSyncNewChangeAddressesR(BaseModel):
    """
    ...
    data: DeriveAndSyncNewChangeAddressesRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewChangeAddressesR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewChangeAddressesR:
        """Create an instance of DeriveAndSyncNewChangeAddressesR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewChangeAddressesR.parse_obj(obj)

        _obj = DeriveAndSyncNewChangeAddressesR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": DeriveAndSyncNewChangeAddressesRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
