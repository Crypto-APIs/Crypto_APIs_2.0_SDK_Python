...
class ListUnspentTransactionOutputsByAddress400Response(BaseModel):
    """
    ...
    error: ListUnspentTransactionOutputsByAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnspentTransactionOutputsByAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnspentTransactionOutputsByAddress400Response:
        """Create an instance of ListUnspentTransactionOutputsByAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnspentTransactionOutputsByAddress400Response.parse_obj(obj)

        _obj = ListUnspentTransactionOutputsByAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListUnspentTransactionOutputsByAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
