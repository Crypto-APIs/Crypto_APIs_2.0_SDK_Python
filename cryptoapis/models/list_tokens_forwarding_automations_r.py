...
class ListTokensForwardingAutomationsR(BaseModel):
    """
    ...
    data: ListTokensForwardingAutomationsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensForwardingAutomationsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensForwardingAutomationsR:
        """Create an instance of ListTokensForwardingAutomationsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensForwardingAutomationsR.parse_obj(obj)

        _obj = ListTokensForwardingAutomationsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListTokensForwardingAutomationsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
