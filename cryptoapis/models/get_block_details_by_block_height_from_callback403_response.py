...
class GetBlockDetailsByBlockHeightFromCallback403Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHeightFromCallbackE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallback403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallback403Response:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallback403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallback403Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallback403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHeightFromCallbackE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
