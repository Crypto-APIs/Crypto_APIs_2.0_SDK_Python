...
class EncodeXAddressR(BaseModel):
    """
    EncodeXAddressR
    """
    ...
    data: EncodeXAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EncodeXAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EncodeXAddressR:
        """Create an instance of EncodeXAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EncodeXAddressR.parse_obj(obj)

        _obj = EncodeXAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": EncodeXAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
