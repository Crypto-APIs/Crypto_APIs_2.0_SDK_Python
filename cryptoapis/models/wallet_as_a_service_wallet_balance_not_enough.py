...
class WalletAsAServiceWalletBalanceNotEnough(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletAsAServiceWalletBalanceNotEnough:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletAsAServiceWalletBalanceNotEnough:
        """Create an instance of WalletAsAServiceWalletBalanceNotEnough from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletAsAServiceWalletBalanceNotEnough.parse_obj(obj)

        _obj = WalletAsAServiceWalletBalanceNotEnough.parse_obj({
            "code": obj.get("code"),
