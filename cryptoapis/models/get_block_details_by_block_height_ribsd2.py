...
class GetBlockDetailsByBlockHeightRIBSD2(BaseModel):
    """
    Dash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightRIBSD2:
        """Create an instance of GetBlockDetailsByBlockHeightRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightRIBSD2.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightRIBSD2.parse_obj({
