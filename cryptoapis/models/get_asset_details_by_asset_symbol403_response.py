...
class GetAssetDetailsByAssetSymbol403Response(BaseModel):
    """
    ...
    error: GetAssetDetailsByAssetSymbolE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetSymbol403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetSymbol403Response:
        """Create an instance of GetAssetDetailsByAssetSymbol403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetSymbol403Response.parse_obj(obj)

        _obj = GetAssetDetailsByAssetSymbol403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAssetDetailsByAssetSymbolE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
