...
class ListTransactionsByBlockHashRIBSBCVoutInner(BaseModel):
    """
    ...
    script_pub_key: ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSBCVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSBCVoutInner:
        """Create an instance of ListTransactionsByBlockHashRIBSBCVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSBCVoutInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSBCVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
