...
class ListTransactionsByBlockHeightRIBSBSCGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSBSCGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSBSCGasPrice:
        """Create an instance of ListTransactionsByBlockHeightRIBSBSCGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSBSCGasPrice.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSBSCGasPrice.parse_obj({
