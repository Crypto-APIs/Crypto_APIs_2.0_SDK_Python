...
class AddressTokensTransactionConfirmedEachConfirmationOmni(BaseModel):
    """
    OMNI
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedEachConfirmationOmni:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedEachConfirmationOmni:
        """Create an instance of AddressTokensTransactionConfirmedEachConfirmationOmni from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedEachConfirmationOmni.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedEachConfirmationOmni.parse_obj({
            "name": obj.get("name"),
