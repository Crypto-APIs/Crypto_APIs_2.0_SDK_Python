...
class GetZilliqaBlockDetailsByBlockHashR(BaseModel):
    """
    ...
    data: GetZilliqaBlockDetailsByBlockHashRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaBlockDetailsByBlockHashR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaBlockDetailsByBlockHashR:
        """Create an instance of GetZilliqaBlockDetailsByBlockHashR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaBlockDetailsByBlockHashR.parse_obj(obj)

        _obj = GetZilliqaBlockDetailsByBlockHashR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetZilliqaBlockDetailsByBlockHashRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
