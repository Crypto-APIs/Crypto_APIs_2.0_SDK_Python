...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    fee: PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSECFee = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC:
        """Create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC.parse_obj(obj)

        _obj = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC.parse_obj({
            "data_hex": obj.get("dataHex"),
            "derivation_index": obj.get("derivationIndex"),
            "fee": PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSECFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "nonce": obj.get("nonce"),
