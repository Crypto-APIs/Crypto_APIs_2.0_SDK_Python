...
class ListUnconfirmedTransactionsByAddressRIBSBVoutInner(BaseModel):
    """
    ...
    script_pub_key: ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSBVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSBVoutInner:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSBVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSBVoutInner.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSBVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
