...
class ListTransactionsByBlockHeightRIBSECGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSECGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSECGasPrice:
        """Create an instance of ListTransactionsByBlockHeightRIBSECGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSECGasPrice.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSECGasPrice.parse_obj({
