...
class CoinsForwardingSuccessData(BaseModel):
    """
    ...
    item: CoinsForwardingSuccessDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CoinsForwardingSuccessData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CoinsForwardingSuccessData:
        """Create an instance of CoinsForwardingSuccessData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CoinsForwardingSuccessData.parse_obj(obj)

        _obj = CoinsForwardingSuccessData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": CoinsForwardingSuccessDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
