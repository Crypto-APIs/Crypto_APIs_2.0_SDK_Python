...
class ListDepositAddressesRData(BaseModel):
    """
    ...
    items: conlist(ListDepositAddressesRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDepositAddressesRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDepositAddressesRData:
        """Create an instance of ListDepositAddressesRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListDepositAddressesRData.parse_obj(obj)

        _obj = ListDepositAddressesRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListDepositAddressesRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
