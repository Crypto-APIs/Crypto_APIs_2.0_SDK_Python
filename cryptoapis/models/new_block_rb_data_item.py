...
class NewBlockRBDataItem(BaseModel):
    """
    NewBlockRBDataItem
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewBlockRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewBlockRBDataItem:
        """Create an instance of NewBlockRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewBlockRBDataItem.parse_obj(obj)

        _obj = NewBlockRBDataItem.parse_obj({
