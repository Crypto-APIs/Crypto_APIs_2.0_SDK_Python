...
class GetBlockDetailsByBlockHashRI(BaseModel):
    """
    ...
    blockchain_specific: GetBlockDetailsByBlockHashRIBS = Field(..., alias="blockchainSpecific")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashRI:
        """Create an instance of GetBlockDetailsByBlockHashRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashRI.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashRI.parse_obj({
            "hash": obj.get("hash"),
            ...
            "blockchain_specific": GetBlockDetailsByBlockHashRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
