...
class ListXRPRippleTransactionsByAddressAndTimeRange401Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByAddressAndTimeRangeE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddressAndTimeRange401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddressAndTimeRange401Response:
        """Create an instance of ListXRPRippleTransactionsByAddressAndTimeRange401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddressAndTimeRange401Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddressAndTimeRange401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByAddressAndTimeRangeE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
