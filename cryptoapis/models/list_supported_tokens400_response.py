...
class ListSupportedTokens400Response(BaseModel):
    """
    ...
    error: ListSupportedTokensE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedTokens400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedTokens400Response:
        """Create an instance of ListSupportedTokens400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedTokens400Response.parse_obj(obj)

        _obj = ListSupportedTokens400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSupportedTokensE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
