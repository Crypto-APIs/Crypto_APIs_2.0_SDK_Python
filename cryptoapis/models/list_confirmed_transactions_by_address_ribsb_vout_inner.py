...
class ListConfirmedTransactionsByAddressRIBSBVoutInner(BaseModel):
    """
    ...
    script_pub_key: ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSBVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSBVoutInner:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSBVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSBVoutInner.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSBVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
