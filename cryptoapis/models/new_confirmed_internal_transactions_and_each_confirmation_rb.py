...
class NewConfirmedInternalTransactionsAndEachConfirmationRB(BaseModel):
    """
    ...
    data: NewConfirmedInternalTransactionsAndEachConfirmationRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedInternalTransactionsAndEachConfirmationRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedInternalTransactionsAndEachConfirmationRB:
        """Create an instance of NewConfirmedInternalTransactionsAndEachConfirmationRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedInternalTransactionsAndEachConfirmationRB.parse_obj(obj)

        _obj = NewConfirmedInternalTransactionsAndEachConfirmationRB.parse_obj({
            "context": obj.get("context"),
            "data": NewConfirmedInternalTransactionsAndEachConfirmationRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
