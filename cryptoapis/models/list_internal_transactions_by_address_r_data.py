...
class ListInternalTransactionsByAddressRData(BaseModel):
    """
    ...
    items: conlist(ListInternalTransactionsByAddressRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddressRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddressRData:
        """Create an instance of ListInternalTransactionsByAddressRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddressRData.parse_obj(obj)

        _obj = ListInternalTransactionsByAddressRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListInternalTransactionsByAddressRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
