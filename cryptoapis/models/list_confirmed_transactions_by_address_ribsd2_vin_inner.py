...
class ListConfirmedTransactionsByAddressRIBSD2VinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSD2VinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSD2VinInner:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSD2VinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSD2VinInner.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSD2VinInner.parse_obj({
