...
class ListAllAssetsFromAllWalletsR(BaseModel):
    """
    ...
    data: ListAllAssetsFromAllWalletsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsFromAllWalletsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsFromAllWalletsR:
        """Create an instance of ListAllAssetsFromAllWalletsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsFromAllWalletsR.parse_obj(obj)

        _obj = ListAllAssetsFromAllWalletsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListAllAssetsFromAllWalletsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
