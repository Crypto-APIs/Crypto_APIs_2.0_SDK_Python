...
class GetBlockDetailsByBlockHash403Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHashE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHash403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHash403Response:
        """Create an instance of GetBlockDetailsByBlockHash403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHash403Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHash403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHashE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
