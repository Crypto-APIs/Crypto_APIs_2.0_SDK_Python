...
class GetLastMinedBlockRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlockRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlockRIBSBSC:
        """Create an instance of GetLastMinedBlockRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlockRIBSBSC.parse_obj(obj)

        _obj = GetLastMinedBlockRIBSBSC.parse_obj({
