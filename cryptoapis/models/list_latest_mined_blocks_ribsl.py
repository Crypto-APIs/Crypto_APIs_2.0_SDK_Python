...
class ListLatestMinedBlocksRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksRIBSL:
        """Create an instance of ListLatestMinedBlocksRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocksRIBSL.parse_obj(obj)

        _obj = ListLatestMinedBlocksRIBSL.parse_obj({
            "bits": obj.get("bits"),
