...
class NewUnconfirmedCoinsTransactionsR(BaseModel):
    """
    ...
    data: NewUnconfirmedCoinsTransactionsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewUnconfirmedCoinsTransactionsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewUnconfirmedCoinsTransactionsR:
        """Create an instance of NewUnconfirmedCoinsTransactionsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewUnconfirmedCoinsTransactionsR.parse_obj(obj)

        _obj = NewUnconfirmedCoinsTransactionsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewUnconfirmedCoinsTransactionsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
