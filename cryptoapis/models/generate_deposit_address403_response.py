...
class GenerateDepositAddress403Response(BaseModel):
    """
    ...
    error: GenerateDepositAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateDepositAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateDepositAddress403Response:
        """Create an instance of GenerateDepositAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateDepositAddress403Response.parse_obj(obj)

        _obj = GenerateDepositAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GenerateDepositAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
