...
class ConvertBitcoinCashAddressRB(BaseModel):
    """
    ...
    data: ConvertBitcoinCashAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddressRB:
        """Create an instance of ConvertBitcoinCashAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddressRB.parse_obj(obj)

        _obj = ConvertBitcoinCashAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": ConvertBitcoinCashAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
