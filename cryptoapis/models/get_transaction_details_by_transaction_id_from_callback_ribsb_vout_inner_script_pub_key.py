...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey.parse_obj({
