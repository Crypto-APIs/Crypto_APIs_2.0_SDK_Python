...
class GetHDWalletXPubYPubZPubAssets422Response(BaseModel):
    """
    ...
    error: GetHDWalletXPubYPubZPubAssetsE422 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubAssets422Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubAssets422Response:
        """Create an instance of GetHDWalletXPubYPubZPubAssets422Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubAssets422Response.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubAssets422Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetHDWalletXPubYPubZPubAssetsE422.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
