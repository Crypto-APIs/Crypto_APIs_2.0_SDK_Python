...
class ListUnspentTransactionOutputsByAddress401Response(BaseModel):
    """
    ...
    error: ListUnspentTransactionOutputsByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnspentTransactionOutputsByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnspentTransactionOutputsByAddress401Response:
        """Create an instance of ListUnspentTransactionOutputsByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnspentTransactionOutputsByAddress401Response.parse_obj(obj)

        _obj = ListUnspentTransactionOutputsByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListUnspentTransactionOutputsByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
