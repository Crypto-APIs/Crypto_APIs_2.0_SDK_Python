...
class BlockchainDataInternalTransactionNotFound(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockchainDataInternalTransactionNotFound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockchainDataInternalTransactionNotFound:
        """Create an instance of BlockchainDataInternalTransactionNotFound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockchainDataInternalTransactionNotFound.parse_obj(obj)

        _obj = BlockchainDataInternalTransactionNotFound.parse_obj({
            "code": obj.get("code"),
