...
class EstimateTransactionSmartFee400Response(BaseModel):
    """
    ...
    error: EstimateTransactionSmartFeeE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTransactionSmartFee400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTransactionSmartFee400Response:
        """Create an instance of EstimateTransactionSmartFee400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTransactionSmartFee400Response.parse_obj(obj)

        _obj = EstimateTransactionSmartFee400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateTransactionSmartFeeE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
