...
class ListUnconfirmedTransactionsByAddressRIBSECGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSECGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSECGasPrice:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSECGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSECGasPrice.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSECGasPrice.parse_obj({
