...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub403Response(BaseModel):
    """
    ...
    error: PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub403Response:
        """Create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub403Response.parse_obj(obj)

        _obj = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPub403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
