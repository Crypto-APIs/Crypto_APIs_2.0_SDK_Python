...
class NewConfirmedCoinsTransactionsAndEachConfirmationRBDataItem(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedCoinsTransactionsAndEachConfirmationRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedCoinsTransactionsAndEachConfirmationRBDataItem:
        """Create an instance of NewConfirmedCoinsTransactionsAndEachConfirmationRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedCoinsTransactionsAndEachConfirmationRBDataItem.parse_obj(obj)

        _obj = NewConfirmedCoinsTransactionsAndEachConfirmationRBDataItem.parse_obj({
