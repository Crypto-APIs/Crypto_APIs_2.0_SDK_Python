...
class GetWalletTransactionDetailsByTransactionID401Response(BaseModel):
    """
    ...
    error: GetWalletTransactionDetailsByTransactionIDE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionID401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionID401Response:
        """Create an instance of GetWalletTransactionDetailsByTransactionID401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionID401Response.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionID401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetWalletTransactionDetailsByTransactionIDE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
