...
class GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.parse_obj({
