...
class GetHDWalletXPubYPubZPubAssetsR(BaseModel):
    """
    ...
    data: GetHDWalletXPubYPubZPubAssetsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubAssetsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubAssetsR:
        """Create an instance of GetHDWalletXPubYPubZPubAssetsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubAssetsR.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubAssetsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetHDWalletXPubYPubZPubAssetsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
