...
class ListTransactionsByBlockHashR(BaseModel):
    """
    ...
    data: ListTransactionsByBlockHashRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashR:
        """Create an instance of ListTransactionsByBlockHashR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashR.parse_obj(obj)

        _obj = ListTransactionsByBlockHashR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListTransactionsByBlockHashRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
