...
class WalletAsAServiceTokenNotSupported(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletAsAServiceTokenNotSupported:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletAsAServiceTokenNotSupported:
        """Create an instance of WalletAsAServiceTokenNotSupported from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletAsAServiceTokenNotSupported.parse_obj(obj)

        _obj = WalletAsAServiceTokenNotSupported.parse_obj({
            "code": obj.get("code"),
