...
class GetTransactionDetailsByTransactionIDRIBSZVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSZVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSZVinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSZVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSZVinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSZVinInner.parse_obj({
