...
class CoinsForwardingSuccess(BaseModel):
    """
    ...
    data: CoinsForwardingSuccessData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CoinsForwardingSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CoinsForwardingSuccess:
        """Create an instance of CoinsForwardingSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CoinsForwardingSuccess.parse_obj(obj)

        _obj = CoinsForwardingSuccess.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": CoinsForwardingSuccessData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
