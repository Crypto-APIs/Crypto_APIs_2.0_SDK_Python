...
class AddressCoinsTransactionConfirmedData(BaseModel):
    """
    ...
    item: AddressCoinsTransactionConfirmedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressCoinsTransactionConfirmedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressCoinsTransactionConfirmedData:
        """Create an instance of AddressCoinsTransactionConfirmedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressCoinsTransactionConfirmedData.parse_obj(obj)

        _obj = AddressCoinsTransactionConfirmedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": AddressCoinsTransactionConfirmedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
