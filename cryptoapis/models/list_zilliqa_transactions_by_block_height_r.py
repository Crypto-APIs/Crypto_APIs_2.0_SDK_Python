...
class ListZilliqaTransactionsByBlockHeightR(BaseModel):
    """
    ...
    data: ListZilliqaTransactionsByBlockHeightRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHeightR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHeightR:
        """Create an instance of ListZilliqaTransactionsByBlockHeightR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHeightR.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHeightR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListZilliqaTransactionsByBlockHeightRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
