...
class ListZilliqaTransactionsByAddress400Response(BaseModel):
    """
    ...
    error: ListZilliqaTransactionsByAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByAddress400Response:
        """Create an instance of ListZilliqaTransactionsByAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByAddress400Response.parse_obj(obj)

        _obj = ListZilliqaTransactionsByAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListZilliqaTransactionsByAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
