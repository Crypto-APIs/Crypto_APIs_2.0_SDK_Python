...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSD(BaseModel):
    """
    Dogecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSD:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRIBSD.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRIBSD.parse_obj({
