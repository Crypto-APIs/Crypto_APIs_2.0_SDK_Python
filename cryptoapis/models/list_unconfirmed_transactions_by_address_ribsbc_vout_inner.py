...
class ListUnconfirmedTransactionsByAddressRIBSBCVoutInner(BaseModel):
    """
    ...
    script_pub_key: ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSBCVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSBCVoutInner:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSBCVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSBCVoutInner.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSBCVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
