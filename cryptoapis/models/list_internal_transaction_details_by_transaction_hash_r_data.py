...
class ListInternalTransactionDetailsByTransactionHashRData(BaseModel):
    """
    ...
    items: conlist(ListInternalTransactionDetailsByTransactionHashRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionDetailsByTransactionHashRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionDetailsByTransactionHashRData:
        """Create an instance of ListInternalTransactionDetailsByTransactionHashRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionDetailsByTransactionHashRData.parse_obj(obj)

        _obj = ListInternalTransactionDetailsByTransactionHashRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListInternalTransactionDetailsByTransactionHashRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
