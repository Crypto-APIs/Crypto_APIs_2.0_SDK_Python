...
class ListTransactionsByBlockHashRData(BaseModel):
    """
    ...
    items: conlist(ListTransactionsByBlockHashRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRData:
        """Create an instance of ListTransactionsByBlockHashRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRData.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListTransactionsByBlockHashRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
