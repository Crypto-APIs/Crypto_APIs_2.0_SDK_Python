...
class ListConfirmedTransactionsByAddressRIBSZVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSZVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSZVinInner:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSZVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSZVinInner.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSZVinInner.parse_obj({
