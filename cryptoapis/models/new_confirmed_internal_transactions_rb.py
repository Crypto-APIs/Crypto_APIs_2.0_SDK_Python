...
class NewConfirmedInternalTransactionsRB(BaseModel):
    """
    ...
    data: NewConfirmedInternalTransactionsRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedInternalTransactionsRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedInternalTransactionsRB:
        """Create an instance of NewConfirmedInternalTransactionsRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedInternalTransactionsRB.parse_obj(obj)

        _obj = NewConfirmedInternalTransactionsRB.parse_obj({
            "context": obj.get("context"),
            "data": NewConfirmedInternalTransactionsRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
