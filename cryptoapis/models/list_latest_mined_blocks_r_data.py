...
class ListLatestMinedBlocksRData(BaseModel):
    """
    ...
    items: conlist(ListLatestMinedBlocksRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksRData:
        """Create an instance of ListLatestMinedBlocksRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocksRData.parse_obj(obj)

        _obj = ListLatestMinedBlocksRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListLatestMinedBlocksRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
