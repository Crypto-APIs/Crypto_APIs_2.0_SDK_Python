...
class ConvertBitcoinCashAddress401Response(BaseModel):
    """
    ...
    error: ConvertBitcoinCashAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress401Response:
        """Create an instance of ConvertBitcoinCashAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress401Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ConvertBitcoinCashAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
