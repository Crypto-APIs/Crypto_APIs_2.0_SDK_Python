...
class ListConfirmedTransactionsByAddressAndTimeRangeR(BaseModel):
    """
    ...
    data: ListConfirmedTransactionsByAddressAndTimeRangeRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeR:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeR.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListConfirmedTransactionsByAddressAndTimeRangeRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
