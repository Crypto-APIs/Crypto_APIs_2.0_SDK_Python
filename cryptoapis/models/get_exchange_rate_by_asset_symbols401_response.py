...
class GetExchangeRateByAssetSymbols401Response(BaseModel):
    """
    ...
    error: GetExchangeRateByAssetSymbolsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetSymbols401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetSymbols401Response:
        """Create an instance of GetExchangeRateByAssetSymbols401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetSymbols401Response.parse_obj(obj)

        _obj = GetExchangeRateByAssetSymbols401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetExchangeRateByAssetSymbolsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
