...
class UriNotFound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UriNotFound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UriNotFound:
        """Create an instance of UriNotFound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UriNotFound.parse_obj(obj)

        _obj = UriNotFound.parse_obj({
            "code": obj.get("code"),
