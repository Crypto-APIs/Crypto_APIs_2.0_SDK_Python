...
class ListXRPRippleTransactionsByBlockHashRData(BaseModel):
    """
    ...
    items: conlist(ListXRPRippleTransactionsByBlockHashRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByBlockHashRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByBlockHashRData:
        """Create an instance of ListXRPRippleTransactionsByBlockHashRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByBlockHashRData.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByBlockHashRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListXRPRippleTransactionsByBlockHashRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
