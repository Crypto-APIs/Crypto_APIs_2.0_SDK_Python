...
class ListHDWalletXPubYPubZPubTransactions422Response(BaseModel):
    """
    ...
    error: ListHDWalletXPubYPubZPubTransactionsE422 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubTransactions422Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubTransactions422Response:
        """Create an instance of ListHDWalletXPubYPubZPubTransactions422Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubTransactions422Response.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubTransactions422Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListHDWalletXPubYPubZPubTransactionsE422.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
