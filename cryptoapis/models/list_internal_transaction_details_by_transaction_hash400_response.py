...
class ListInternalTransactionDetailsByTransactionHash400Response(BaseModel):
    """
    ...
    error: ListInternalTransactionDetailsByTransactionHashE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionDetailsByTransactionHash400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionDetailsByTransactionHash400Response:
        """Create an instance of ListInternalTransactionDetailsByTransactionHash400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionDetailsByTransactionHash400Response.parse_obj(obj)

        _obj = ListInternalTransactionDetailsByTransactionHash400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionDetailsByTransactionHashE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
