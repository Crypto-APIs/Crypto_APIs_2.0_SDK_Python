...
class GetZilliqaBlockDetailsByBlockHeight401Response(BaseModel):
    """
    ...
    error: GetZilliqaBlockDetailsByBlockHeightE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaBlockDetailsByBlockHeight401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaBlockDetailsByBlockHeight401Response:
        """Create an instance of GetZilliqaBlockDetailsByBlockHeight401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaBlockDetailsByBlockHeight401Response.parse_obj(obj)

        _obj = GetZilliqaBlockDetailsByBlockHeight401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaBlockDetailsByBlockHeightE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
