...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    vin: conlist(ListConfirmedTransactionsByAddressRIBSZVinInner) = Field(..., description="Object Array representation of transaction inputs")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ.parse_obj({
            ...
            "vin": [ListConfirmedTransactionsByAddressRIBSZVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
