...
class GetTransactionRequestDetails401Response(BaseModel):
    """
    ...
    error: GetTransactionRequestDetailsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionRequestDetails401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionRequestDetails401Response:
        """Create an instance of GetTransactionRequestDetails401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionRequestDetails401Response.parse_obj(obj)

        _obj = GetTransactionRequestDetails401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionRequestDetailsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
