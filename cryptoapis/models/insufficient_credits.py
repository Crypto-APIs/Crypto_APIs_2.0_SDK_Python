...
class InsufficientCredits(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsufficientCredits:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsufficientCredits:
        """Create an instance of InsufficientCredits from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsufficientCredits.parse_obj(obj)

        _obj = InsufficientCredits.parse_obj({
            "code": obj.get("code"),
