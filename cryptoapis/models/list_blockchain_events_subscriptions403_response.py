...
class ListBlockchainEventsSubscriptions403Response(BaseModel):
    """
    ...
    error: ListBlockchainEventsSubscriptionsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListBlockchainEventsSubscriptions403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListBlockchainEventsSubscriptions403Response:
        """Create an instance of ListBlockchainEventsSubscriptions403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListBlockchainEventsSubscriptions403Response.parse_obj(obj)

        _obj = ListBlockchainEventsSubscriptions403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListBlockchainEventsSubscriptionsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
