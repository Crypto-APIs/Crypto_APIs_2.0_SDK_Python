...
class NewConfirmedInternalTransactionsAndEachConfirmationRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedInternalTransactionsAndEachConfirmationRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedInternalTransactionsAndEachConfirmationRI:
        """Create an instance of NewConfirmedInternalTransactionsAndEachConfirmationRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedInternalTransactionsAndEachConfirmationRI.parse_obj(obj)

        _obj = NewConfirmedInternalTransactionsAndEachConfirmationRI.parse_obj({
