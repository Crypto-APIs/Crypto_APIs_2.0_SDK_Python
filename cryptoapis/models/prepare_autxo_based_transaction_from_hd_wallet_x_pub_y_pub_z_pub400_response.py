...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub400Response(BaseModel):
    """
    ...
    error: PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub400Response:
        """Create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub400Response.parse_obj(obj)

        _obj = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
