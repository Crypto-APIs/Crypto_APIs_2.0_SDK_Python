...
class TransactionMined(BaseModel):
    """
    TransactionMined
    """
    ...
    data: TransactionMinedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionMined:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionMined:
        """Create an instance of TransactionMined from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionMined.parse_obj(obj)

        _obj = TransactionMined.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": TransactionMinedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
