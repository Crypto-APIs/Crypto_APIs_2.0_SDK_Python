...
class DeleteAutomaticCoinsForwarding400Response(BaseModel):
    """
    ...
    error: DeleteAutomaticCoinsForwardingE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticCoinsForwarding400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticCoinsForwarding400Response:
        """Create an instance of DeleteAutomaticCoinsForwarding400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticCoinsForwarding400Response.parse_obj(obj)

        _obj = DeleteAutomaticCoinsForwarding400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeleteAutomaticCoinsForwardingE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
