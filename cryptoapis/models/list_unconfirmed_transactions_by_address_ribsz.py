...
class ListUnconfirmedTransactionsByAddressRIBSZ(BaseModel):
    """
    Zcash
    """
    ...
    v_join_split: conlist(ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner) = Field(..., alias="vJoinSplit", description="Represents a sequence of JoinSplit descriptions using BCTV14 proofs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSZ:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSZ:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSZ from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSZ.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSZ.parse_obj({
            ...
            "size": obj.get("size"),
            "v_join_split": [ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner.from_dict(_item) for _item in obj.get("vJoinSplit")] if obj.get("vJoinSplit") is not None else None,
