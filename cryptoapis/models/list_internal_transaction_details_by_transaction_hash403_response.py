...
class ListInternalTransactionDetailsByTransactionHash403Response(BaseModel):
    """
    ...
    error: ListInternalTransactionDetailsByTransactionHashE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionDetailsByTransactionHash403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionDetailsByTransactionHash403Response:
        """Create an instance of ListInternalTransactionDetailsByTransactionHash403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionDetailsByTransactionHash403Response.parse_obj(obj)

        _obj = ListInternalTransactionDetailsByTransactionHash403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionDetailsByTransactionHashE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
