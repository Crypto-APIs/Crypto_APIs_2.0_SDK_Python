...
class BroadcastLocallySignedTransactionRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastLocallySignedTransactionRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastLocallySignedTransactionRI:
        """Create an instance of BroadcastLocallySignedTransactionRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastLocallySignedTransactionRI.parse_obj(obj)

        _obj = BroadcastLocallySignedTransactionRI.parse_obj({
