...
class GetRawTransactionDataR(BaseModel):
    """
    ...
    data: GetRawTransactionDataRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRawTransactionDataR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRawTransactionDataR:
        """Create an instance of GetRawTransactionDataR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRawTransactionDataR.parse_obj(obj)

        _obj = GetRawTransactionDataR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetRawTransactionDataRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
