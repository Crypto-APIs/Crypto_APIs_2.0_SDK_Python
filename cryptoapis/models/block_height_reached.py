...
class BlockHeightReached(BaseModel):
    """
    BlockHeightReached
    """
    ...
    data: BlockHeightReachedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockHeightReached:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockHeightReached:
        """Create an instance of BlockHeightReached from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockHeightReached.parse_obj(obj)

        _obj = BlockHeightReached.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": BlockHeightReachedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
