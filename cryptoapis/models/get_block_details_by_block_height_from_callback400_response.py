...
class GetBlockDetailsByBlockHeightFromCallback400Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHeightFromCallbackE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallback400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallback400Response:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallback400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallback400Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallback400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHeightFromCallbackE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
