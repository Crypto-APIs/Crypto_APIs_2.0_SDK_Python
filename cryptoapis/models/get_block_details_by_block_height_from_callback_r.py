...
class GetBlockDetailsByBlockHeightFromCallbackR(BaseModel):
    """
    ...
    data: GetBlockDetailsByBlockHeightFromCallbackRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackR:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackR.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetBlockDetailsByBlockHeightFromCallbackRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
