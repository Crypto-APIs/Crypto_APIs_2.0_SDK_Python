...
class BlockchainDataBlockNotFound(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockchainDataBlockNotFound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockchainDataBlockNotFound:
        """Create an instance of BlockchainDataBlockNotFound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockchainDataBlockNotFound.parse_obj(obj)

        _obj = BlockchainDataBlockNotFound.parse_obj({
            "code": obj.get("code"),
