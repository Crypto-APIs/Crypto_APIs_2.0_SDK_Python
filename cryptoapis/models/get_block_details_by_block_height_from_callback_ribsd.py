...
class GetBlockDetailsByBlockHeightFromCallbackRIBSD(BaseModel):
    """
    Dash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSD:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSD.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSD.parse_obj({
            "bits": obj.get("bits"),
