...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSD2(BaseModel):
    """
    Dogecoin
    """
    ...
    vin: conlist(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSD2:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSD2.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSD2.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None
        })
        return _obj
