...
class ListSupportedTokens403Response(BaseModel):
    """
    ...
    error: ListSupportedTokensE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedTokens403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedTokens403Response:
        """Create an instance of ListSupportedTokens403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedTokens403Response.parse_obj(obj)

        _obj = ListSupportedTokens403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSupportedTokensE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
