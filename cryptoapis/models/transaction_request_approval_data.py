...
class TransactionRequestApprovalData(BaseModel):
    """
    ...
    item: TransactionRequestApprovalDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestApprovalData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestApprovalData:
        """Create an instance of TransactionRequestApprovalData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestApprovalData.parse_obj(obj)

        _obj = TransactionRequestApprovalData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": TransactionRequestApprovalDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
