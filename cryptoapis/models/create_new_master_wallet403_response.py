...
class CreateNewMasterWallet403Response(BaseModel):
    """
    ...
    error: CreateNewMasterWalletE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNewMasterWallet403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNewMasterWallet403Response:
        """Create an instance of CreateNewMasterWallet403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateNewMasterWallet403Response.parse_obj(obj)

        _obj = CreateNewMasterWallet403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": CreateNewMasterWalletE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
