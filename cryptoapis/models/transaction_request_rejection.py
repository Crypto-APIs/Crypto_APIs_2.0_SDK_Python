...
class TransactionRequestRejection(BaseModel):
    """
    ...
    data: TransactionRequestRejectionData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestRejection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestRejection:
        """Create an instance of TransactionRequestRejection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestRejection.parse_obj(obj)

        _obj = TransactionRequestRejection.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": TransactionRequestRejectionData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
