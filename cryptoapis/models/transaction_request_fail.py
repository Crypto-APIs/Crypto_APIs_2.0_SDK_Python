...
class TransactionRequestFail(BaseModel):
    """
    ...
    data: TransactionRequestFailData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestFail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestFail:
        """Create an instance of TransactionRequestFail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestFail.parse_obj(obj)

        _obj = TransactionRequestFail.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": TransactionRequestFailData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
