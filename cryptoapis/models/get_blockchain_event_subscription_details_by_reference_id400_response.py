...
class GetBlockchainEventSubscriptionDetailsByReferenceID400Response(BaseModel):
    """
    ...
    error: GetBlockchainEventSubscriptionDetailsByReferenceIDE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockchainEventSubscriptionDetailsByReferenceID400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockchainEventSubscriptionDetailsByReferenceID400Response:
        """Create an instance of GetBlockchainEventSubscriptionDetailsByReferenceID400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockchainEventSubscriptionDetailsByReferenceID400Response.parse_obj(obj)

        _obj = GetBlockchainEventSubscriptionDetailsByReferenceID400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockchainEventSubscriptionDetailsByReferenceIDE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
