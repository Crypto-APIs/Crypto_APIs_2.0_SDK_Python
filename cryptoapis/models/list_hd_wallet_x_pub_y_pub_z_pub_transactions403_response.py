...
class ListHDWalletXPubYPubZPubTransactions403Response(BaseModel):
    """
    ...
    error: ListHDWalletXPubYPubZPubTransactionsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubTransactions403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubTransactions403Response:
        """Create an instance of ListHDWalletXPubYPubZPubTransactions403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubTransactions403Response.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubTransactions403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListHDWalletXPubYPubZPubTransactionsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
