...
class GetBlockDetailsByBlockHashFromCallbackR(BaseModel):
    """
    ...
    data: GetBlockDetailsByBlockHashFromCallbackRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackR:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackR.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetBlockDetailsByBlockHashFromCallbackRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
