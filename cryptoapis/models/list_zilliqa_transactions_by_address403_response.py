...
class ListZilliqaTransactionsByAddress403Response(BaseModel):
    """
    ...
    error: ListZilliqaTransactionsByAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByAddress403Response:
        """Create an instance of ListZilliqaTransactionsByAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByAddress403Response.parse_obj(obj)

        _obj = ListZilliqaTransactionsByAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListZilliqaTransactionsByAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
