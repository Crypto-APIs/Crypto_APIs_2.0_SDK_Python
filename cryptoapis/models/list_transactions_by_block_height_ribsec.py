...
class ListTransactionsByBlockHeightRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    gas_price: ListTransactionsByBlockHeightRIBSECGasPrice = Field(..., alias="gasPrice")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSEC:
        """Create an instance of ListTransactionsByBlockHeightRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSEC.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSEC.parse_obj({
            "contract": obj.get("contract"),
            "gas_limit": obj.get("gasLimit"),
            "gas_price": ListTransactionsByBlockHeightRIBSECGasPrice.from_dict(obj.get("gasPrice")) if obj.get("gasPrice") is not None else None,
