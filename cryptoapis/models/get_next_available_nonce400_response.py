...
class GetNextAvailableNonce400Response(BaseModel):
    """
    ...
    error: GetNextAvailableNonceE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNextAvailableNonce400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNextAvailableNonce400Response:
        """Create an instance of GetNextAvailableNonce400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetNextAvailableNonce400Response.parse_obj(obj)

        _obj = GetNextAvailableNonce400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetNextAvailableNonceE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
