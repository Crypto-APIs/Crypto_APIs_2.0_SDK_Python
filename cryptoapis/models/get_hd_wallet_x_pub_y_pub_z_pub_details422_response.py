...
class GetHDWalletXPubYPubZPubDetails422Response(BaseModel):
    """
    ...
    error: GetHDWalletXPubYPubZPubDetailsE422 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubDetails422Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubDetails422Response:
        """Create an instance of GetHDWalletXPubYPubZPubDetails422Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubDetails422Response.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubDetails422Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetHDWalletXPubYPubZPubDetailsE422.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
