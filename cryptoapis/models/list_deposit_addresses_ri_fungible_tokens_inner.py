...
class ListDepositAddressesRIFungibleTokensInner(BaseModel):
    """
    ...
    __properties = ["amount", "identifier", "name", "symbol", "tokenDecimals", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListDepositAddressesRIFungibleTokensInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListDepositAddressesRIFungibleTokensInner:
        """Create an instance of ListDepositAddressesRIFungibleTokensInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListDepositAddressesRIFungibleTokensInner.parse_obj(obj)

        _obj = ListDepositAddressesRIFungibleTokensInner.parse_obj({
