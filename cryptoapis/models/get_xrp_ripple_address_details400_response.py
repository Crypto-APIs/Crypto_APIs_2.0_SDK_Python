...
class GetXRPRippleAddressDetails400Response(BaseModel):
    """
    ...
    error: GetXRPRippleAddressDetailsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleAddressDetails400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleAddressDetails400Response:
        """Create an instance of GetXRPRippleAddressDetails400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleAddressDetails400Response.parse_obj(obj)

        _obj = GetXRPRippleAddressDetails400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleAddressDetailsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
