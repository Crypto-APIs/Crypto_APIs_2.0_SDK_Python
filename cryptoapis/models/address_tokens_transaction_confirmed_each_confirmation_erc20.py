...
class AddressTokensTransactionConfirmedEachConfirmationErc20(BaseModel):
    """
    ERC-20
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmedEachConfirmationErc20:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmedEachConfirmationErc20:
        """Create an instance of AddressTokensTransactionConfirmedEachConfirmationErc20 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmedEachConfirmationErc20.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmedEachConfirmationErc20.parse_obj({
            "name": obj.get("name"),
