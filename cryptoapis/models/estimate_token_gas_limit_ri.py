...
class EstimateTokenGasLimitRI(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTokenGasLimitRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTokenGasLimitRI:
        """Create an instance of EstimateTokenGasLimitRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTokenGasLimitRI.parse_obj(obj)

        _obj = EstimateTokenGasLimitRI.parse_obj({
