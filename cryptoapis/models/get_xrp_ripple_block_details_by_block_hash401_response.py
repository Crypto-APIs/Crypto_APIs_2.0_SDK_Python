...
class GetXRPRippleBlockDetailsByBlockHash401Response(BaseModel):
    """
    ...
    error: GetXRPRippleBlockDetailsByBlockHashE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleBlockDetailsByBlockHash401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleBlockDetailsByBlockHash401Response:
        """Create an instance of GetXRPRippleBlockDetailsByBlockHash401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleBlockDetailsByBlockHash401Response.parse_obj(obj)

        _obj = GetXRPRippleBlockDetailsByBlockHash401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleBlockDetailsByBlockHashE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
