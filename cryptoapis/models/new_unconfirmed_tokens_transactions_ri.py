...
class NewUnconfirmedTokensTransactionsRI(BaseModel):
    """
    NewUnconfirmedTokensTransactionsRI
    """
    address: StrictStr = Field(..., description="Defines the type of the specific event available for the customer to subscribe to for callback notification.")
    ...
    __properties = ["address", "callbackSecretKey", "callbackUrl", "createdTimestamp", "eventType", "isActive", "referenceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewUnconfirmedTokensTransactionsRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewUnconfirmedTokensTransactionsRI:
        """Create an instance of NewUnconfirmedTokensTransactionsRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewUnconfirmedTokensTransactionsRI.parse_obj(obj)

        _obj = NewUnconfirmedTokensTransactionsRI.parse_obj({
