...
class GetTokenDetailsByContractAddress403Response(BaseModel):
    """
    ...
    error: GetTokenDetailsByContractAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTokenDetailsByContractAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTokenDetailsByContractAddress403Response:
        """Create an instance of GetTokenDetailsByContractAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTokenDetailsByContractAddress403Response.parse_obj(obj)

        _obj = GetTokenDetailsByContractAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTokenDetailsByContractAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
