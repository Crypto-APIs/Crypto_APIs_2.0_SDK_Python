...
class DecodeRawTransactionHexRISDVinInner(BaseModel):
    """
    ...
    script_sig: DecodeRawTransactionHexRISDVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISDVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISDVinInner:
        """Create an instance of DecodeRawTransactionHexRISDVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISDVinInner.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISDVinInner.parse_obj({
            "address": obj.get("address"),
            "input_hash": obj.get("inputHash"),
            "output_index": obj.get("outputIndex"),
            "script_sig": DecodeRawTransactionHexRISDVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
