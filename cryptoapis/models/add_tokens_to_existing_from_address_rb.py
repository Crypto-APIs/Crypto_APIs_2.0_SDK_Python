...
class AddTokensToExistingFromAddressRB(BaseModel):
    """
    ...
    data: AddTokensToExistingFromAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddTokensToExistingFromAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddTokensToExistingFromAddressRB:
        """Create an instance of AddTokensToExistingFromAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddTokensToExistingFromAddressRB.parse_obj(obj)

        _obj = AddTokensToExistingFromAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": AddTokensToExistingFromAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
