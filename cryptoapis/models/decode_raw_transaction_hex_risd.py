...
class DecodeRawTransactionHexRISD(BaseModel):
    """
    Dash
    """
    ...
    vin: conlist(DecodeRawTransactionHexRISDVinInner) = Field(..., description="Represents the transaction inputs.")
    vout: conlist(DecodeRawTransactionHexRISDVoutInner) = Field(..., description="Represents the transaction outputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISD:
        """Create an instance of DecodeRawTransactionHexRISD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISD.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISD.parse_obj({
            "locktime": obj.get("locktime"),
            "transaction_hash": obj.get("transactionHash"),
            "v_size": obj.get("vSize"),
            "version": obj.get("version"),
            "vin": [DecodeRawTransactionHexRISDVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
            "vout": [DecodeRawTransactionHexRISDVoutInner.from_dict(_item) for _item in obj.get("vout")] if obj.get("vout") is not None else None,
