...
class ListXRPRippleTransactionsByAddressAndTimeRangeR(BaseModel):
    """
    ...
    data: ListXRPRippleTransactionsByAddressAndTimeRangeRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByAddressAndTimeRangeR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByAddressAndTimeRangeR:
        """Create an instance of ListXRPRippleTransactionsByAddressAndTimeRangeR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByAddressAndTimeRangeR.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByAddressAndTimeRangeR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListXRPRippleTransactionsByAddressAndTimeRangeRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
