...
class BlockHeightReachedRBDataItem(BaseModel):
    """
    ...
    __properties = ["allowDuplicates", "blockHeightReached", "callbackSecretKey", "callbackUrl"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockHeightReachedRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockHeightReachedRBDataItem:
        """Create an instance of BlockHeightReachedRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockHeightReachedRBDataItem.parse_obj(obj)

        _obj = BlockHeightReachedRBDataItem.parse_obj({
