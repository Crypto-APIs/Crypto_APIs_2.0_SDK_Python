...
class GetZilliqaBlockDetailsByBlockHeight403Response(BaseModel):
    """
    ...
    error: GetZilliqaBlockDetailsByBlockHeightE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaBlockDetailsByBlockHeight403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaBlockDetailsByBlockHeight403Response:
        """Create an instance of GetZilliqaBlockDetailsByBlockHeight403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaBlockDetailsByBlockHeight403Response.parse_obj(obj)

        _obj = GetZilliqaBlockDetailsByBlockHeight403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaBlockDetailsByBlockHeightE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
