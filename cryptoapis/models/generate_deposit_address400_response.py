...
class GenerateDepositAddress400Response(BaseModel):
    """
    ...
    error: GenerateDepositAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateDepositAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateDepositAddress400Response:
        """Create an instance of GenerateDepositAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateDepositAddress400Response.parse_obj(obj)

        _obj = GenerateDepositAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GenerateDepositAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
