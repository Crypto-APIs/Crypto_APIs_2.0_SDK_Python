...
class DeriveAndSyncNewChangeAddresses403Response(BaseModel):
    """
    ...
    error: DeriveAndSyncNewChangeAddressesE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewChangeAddresses403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewChangeAddresses403Response:
        """Create an instance of DeriveAndSyncNewChangeAddresses403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewChangeAddresses403Response.parse_obj(obj)

        _obj = DeriveAndSyncNewChangeAddresses403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveAndSyncNewChangeAddressesE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
