...
class GetHDWalletXPubYPubZPubDetails403Response(BaseModel):
    """
    ...
    error: GetHDWalletXPubYPubZPubDetailsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHDWalletXPubYPubZPubDetails403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHDWalletXPubYPubZPubDetails403Response:
        """Create an instance of GetHDWalletXPubYPubZPubDetails403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHDWalletXPubYPubZPubDetails403Response.parse_obj(obj)

        _obj = GetHDWalletXPubYPubZPubDetails403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetHDWalletXPubYPubZPubDetailsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
