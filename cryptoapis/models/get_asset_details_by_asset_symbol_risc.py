...
class GetAssetDetailsByAssetSymbolRISC(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetSymbolRISC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetSymbolRISC:
        """Create an instance of GetAssetDetailsByAssetSymbolRISC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetSymbolRISC.parse_obj(obj)

        _obj = GetAssetDetailsByAssetSymbolRISC.parse_obj({
