...
class ListTokensTransfersByTransactionHashR(BaseModel):
    """
    ...
    data: ListTokensTransfersByTransactionHashRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensTransfersByTransactionHashR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensTransfersByTransactionHashR:
        """Create an instance of ListTokensTransfersByTransactionHashR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensTransfersByTransactionHashR.parse_obj(obj)

        _obj = ListTokensTransfersByTransactionHashR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListTokensTransfersByTransactionHashRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
