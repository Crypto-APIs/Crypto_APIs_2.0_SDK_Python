...
class AddressTokensTransactionConfirmed(BaseModel):
    """
    ...
    data: AddressTokensTransactionConfirmedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionConfirmed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionConfirmed:
        """Create an instance of AddressTokensTransactionConfirmed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionConfirmed.parse_obj(obj)

        _obj = AddressTokensTransactionConfirmed.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": AddressTokensTransactionConfirmedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
