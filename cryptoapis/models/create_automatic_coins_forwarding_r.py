...
class CreateAutomaticCoinsForwardingR(BaseModel):
    """
    ...
    data: CreateAutomaticCoinsForwardingRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAutomaticCoinsForwardingR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAutomaticCoinsForwardingR:
        """Create an instance of CreateAutomaticCoinsForwardingR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAutomaticCoinsForwardingR.parse_obj(obj)

        _obj = CreateAutomaticCoinsForwardingR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateAutomaticCoinsForwardingRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
