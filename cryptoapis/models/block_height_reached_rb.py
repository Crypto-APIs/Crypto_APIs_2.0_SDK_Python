...
class BlockHeightReachedRB(BaseModel):
    """
    ...
    data: BlockHeightReachedRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockHeightReachedRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockHeightReachedRB:
        """Create an instance of BlockHeightReachedRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockHeightReachedRB.parse_obj(obj)

        _obj = BlockHeightReachedRB.parse_obj({
            "context": obj.get("context"),
            "data": BlockHeightReachedRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
