...
class GetBlockDetailsByBlockHeightFromCallbackRIBSD2(BaseModel):
    """
    Dogecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSD2:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSD2.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSD2.parse_obj({
            "bits": obj.get("bits"),
