...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB(BaseModel):
    """
    ...
    data: CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB:
        """Create an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB.parse_obj(obj)

        _obj = CreateSingleTransactionRequestFromAddressWithoutFeePriorityRB.parse_obj({
            "context": obj.get("context"),
            "data": CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
