...
class GetBlockDetailsByBlockHeight400Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHeightE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeight400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeight400Response:
        """Create an instance of GetBlockDetailsByBlockHeight400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeight400Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeight400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHeightE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
