...
class GetZilliqaAddressDetails401Response(BaseModel):
    """
    ...
    error: GetZilliqaAddressDetailsE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaAddressDetails401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaAddressDetails401Response:
        """Create an instance of GetZilliqaAddressDetails401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaAddressDetails401Response.parse_obj(obj)

        _obj = GetZilliqaAddressDetails401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaAddressDetailsE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
