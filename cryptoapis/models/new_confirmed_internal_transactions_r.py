...
class NewConfirmedInternalTransactionsR(BaseModel):
    """
    ...
    data: NewConfirmedInternalTransactionsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedInternalTransactionsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedInternalTransactionsR:
        """Create an instance of NewConfirmedInternalTransactionsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedInternalTransactionsR.parse_obj(obj)

        _obj = NewConfirmedInternalTransactionsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewConfirmedInternalTransactionsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
