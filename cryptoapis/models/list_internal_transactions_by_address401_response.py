...
class ListInternalTransactionsByAddress401Response(BaseModel):
    """
    ...
    error: ListInternalTransactionsByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddress401Response:
        """Create an instance of ListInternalTransactionsByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddress401Response.parse_obj(obj)

        _obj = ListInternalTransactionsByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionsByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
