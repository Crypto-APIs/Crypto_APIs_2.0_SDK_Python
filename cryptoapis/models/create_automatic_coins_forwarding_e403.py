...
CREATEAUTOMATICCOINSFORWARDINGE403_ONE_OF_SCHEMAS = ["BannedIpAddress", "CoinsForwardingAutomationsLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"]

class CreateAutomaticCoinsForwardingE403(BaseModel):
    """
    ...
    # data type: CoinsForwardingAutomationsLimitReached
    oneof_schema_5_validator: Optional[CoinsForwardingAutomationsLimitReached] = None
    actual_instance: Any
    one_of_schemas: List[str] = Field(CREATEAUTOMATICCOINSFORWARDINGE403_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateAutomaticCoinsForwardingE403.construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, FeatureMainnetsNotAllowedForPlan):
            ...
            match += 1
        # validate data type: CoinsForwardingAutomationsLimitReached
        if not isinstance(v, CoinsForwardingAutomationsLimitReached):
            error_messages.append(f"Error! Input type `{type(v)}` is not `CoinsForwardingAutomationsLimitReached`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in CreateAutomaticCoinsForwardingE403 with oneOf schemas: BannedIpAddress, CoinsForwardingAutomationsLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in CreateAutomaticCoinsForwardingE403 with oneOf schemas: BannedIpAddress, CoinsForwardingAutomationsLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> CreateAutomaticCoinsForwardingE403:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> CreateAutomaticCoinsForwardingE403:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into CoinsForwardingAutomationsLimitReached
        try:
            instance.actual_instance = CoinsForwardingAutomationsLimitReached.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into CreateAutomaticCoinsForwardingE403 with oneOf schemas: BannedIpAddress, CoinsForwardingAutomationsLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CreateAutomaticCoinsForwardingE403 with oneOf schemas: BannedIpAddress, CoinsForwardingAutomationsLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + ", ".join(error_messages))
        else:
            return instance
