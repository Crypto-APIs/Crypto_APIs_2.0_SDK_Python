...
class ListTransactionsByBlockHashRIBSLVoutInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSLVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSLVoutInner:
        """Create an instance of ListTransactionsByBlockHashRIBSLVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSLVoutInner.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSLVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": ListTransactionsByBlockHashRIBSLVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
