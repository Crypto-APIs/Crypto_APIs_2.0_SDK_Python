...
class NewBlockRI(BaseModel):
    ...
    __properties = ["callbackSecretKey", "callbackUrl", "createdTimestamp", "isActive", "referenceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewBlockRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewBlockRI:
        """Create an instance of NewBlockRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewBlockRI.parse_obj(obj)

        _obj = NewBlockRI.parse_obj({
