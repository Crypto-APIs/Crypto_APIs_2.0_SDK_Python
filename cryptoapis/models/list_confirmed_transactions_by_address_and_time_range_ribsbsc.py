...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC.parse_obj({
