...
class PrepareANonFungibleTokenTransferFromAddressRB(BaseModel):
    """
    ...
    data: PrepareANonFungibleTokenTransferFromAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareANonFungibleTokenTransferFromAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareANonFungibleTokenTransferFromAddressRB:
        """Create an instance of PrepareANonFungibleTokenTransferFromAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareANonFungibleTokenTransferFromAddressRB.parse_obj(obj)

        _obj = PrepareANonFungibleTokenTransferFromAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": PrepareANonFungibleTokenTransferFromAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
