...
class GetTransactionDetailsByTransactionIDRISendersInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRISendersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRISendersInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRISendersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRISendersInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRISendersInner.parse_obj({
