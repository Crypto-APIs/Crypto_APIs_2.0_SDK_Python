...
class ListZilliqaTransactionsByBlockHashR(BaseModel):
    """
    ...
    data: ListZilliqaTransactionsByBlockHashRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHashR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHashR:
        """Create an instance of ListZilliqaTransactionsByBlockHashR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHashR.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHashR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListZilliqaTransactionsByBlockHashRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
