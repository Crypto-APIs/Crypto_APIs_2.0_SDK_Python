...
class DecodeRawTransactionHexR(BaseModel):
    """
    ...
    data: DecodeRawTransactionHexRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexR:
        """Create an instance of DecodeRawTransactionHexR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexR.parse_obj(obj)

        _obj = DecodeRawTransactionHexR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": DecodeRawTransactionHexRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
