...
class ListTokensForwardingAutomations403Response(BaseModel):
    """
    ...
    error: ListTokensForwardingAutomationsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensForwardingAutomations403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensForwardingAutomations403Response:
        """Create an instance of ListTokensForwardingAutomations403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensForwardingAutomations403Response.parse_obj(obj)

        _obj = ListTokensForwardingAutomations403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensForwardingAutomationsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
