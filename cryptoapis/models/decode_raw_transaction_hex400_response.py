...
class DecodeRawTransactionHex400Response(BaseModel):
    """
    ...
    error: DecodeRawTransactionHexE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHex400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHex400Response:
        """Create an instance of DecodeRawTransactionHex400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHex400Response.parse_obj(obj)

        _obj = DecodeRawTransactionHex400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DecodeRawTransactionHexE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
