...
class PrepareAFungibleTokenTransferFromAddressR(BaseModel):
    """
    ...
    data: PrepareAFungibleTokenTransferFromAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAFungibleTokenTransferFromAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAFungibleTokenTransferFromAddressR:
        """Create an instance of PrepareAFungibleTokenTransferFromAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAFungibleTokenTransferFromAddressR.parse_obj(obj)

        _obj = PrepareAFungibleTokenTransferFromAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": PrepareAFungibleTokenTransferFromAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
