...
class GetInternalTransactionByTransactionHashAndOperationId401Response(BaseModel):
    """
    ...
    error: GetInternalTransactionByTransactionHashAndOperationIdE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInternalTransactionByTransactionHashAndOperationId401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInternalTransactionByTransactionHashAndOperationId401Response:
        """Create an instance of GetInternalTransactionByTransactionHashAndOperationId401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInternalTransactionByTransactionHashAndOperationId401Response.parse_obj(obj)

        _obj = GetInternalTransactionByTransactionHashAndOperationId401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetInternalTransactionByTransactionHashAndOperationIdE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
