...
class GetTransactionDetailsByTransactionIDRIBSD(BaseModel):
    """
    Dogecoin
    """
    ...
    vin: conlist(GetTransactionDetailsByTransactionIDRIBSDVinInner) = Field(..., description="Represents the transaction inputs.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSD:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSD.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSD.parse_obj({
            "locktime": obj.get("locktime"),
            "size": obj.get("size"),
            "version": obj.get("version"),
            "vin": [GetTransactionDetailsByTransactionIDRIBSDVinInner.from_dict(_item) for _item in obj.get("vin")] if obj.get("vin") is not None else None,
