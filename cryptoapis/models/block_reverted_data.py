...
class BlockRevertedData(BaseModel):
    """
    ...
    item: BlockRevertedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockRevertedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockRevertedData:
        """Create an instance of BlockRevertedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockRevertedData.parse_obj(obj)

        _obj = BlockRevertedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": BlockRevertedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
