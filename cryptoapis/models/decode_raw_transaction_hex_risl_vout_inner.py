...
class DecodeRawTransactionHexRISLVoutInner(BaseModel):
    """
    DecodeRawTransactionHexRISLVoutInner
    """
    script_pub_key: DecodeRawTransactionHexRISLVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISLVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISLVoutInner:
        """Create an instance of DecodeRawTransactionHexRISLVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISLVoutInner.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISLVoutInner.parse_obj({
            "script_pub_key": DecodeRawTransactionHexRISLVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
