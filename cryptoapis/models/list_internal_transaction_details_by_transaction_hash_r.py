...
class ListInternalTransactionDetailsByTransactionHashR(BaseModel):
    """
    ...
    data: ListInternalTransactionDetailsByTransactionHashRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionDetailsByTransactionHashR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionDetailsByTransactionHashR:
        """Create an instance of ListInternalTransactionDetailsByTransactionHashR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionDetailsByTransactionHashR.parse_obj(obj)

        _obj = ListInternalTransactionDetailsByTransactionHashR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListInternalTransactionDetailsByTransactionHashRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
