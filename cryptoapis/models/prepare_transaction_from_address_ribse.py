...
class PrepareTransactionFromAddressRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddressRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddressRIBSE:
        """Create an instance of PrepareTransactionFromAddressRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddressRIBSE.parse_obj(obj)

        _obj = PrepareTransactionFromAddressRIBSE.parse_obj({
