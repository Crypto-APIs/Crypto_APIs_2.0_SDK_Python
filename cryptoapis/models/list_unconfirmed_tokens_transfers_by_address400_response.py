...
class ListUnconfirmedTokensTransfersByAddress400Response(BaseModel):
    """
    ...
    error: ListUnconfirmedTokensTransfersByAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTokensTransfersByAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTokensTransfersByAddress400Response:
        """Create an instance of ListUnconfirmedTokensTransfersByAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTokensTransfersByAddress400Response.parse_obj(obj)

        _obj = ListUnconfirmedTokensTransfersByAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListUnconfirmedTokensTransfersByAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
