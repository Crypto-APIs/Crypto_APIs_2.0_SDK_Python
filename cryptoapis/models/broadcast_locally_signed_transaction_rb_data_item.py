...
class BroadcastLocallySignedTransactionRBDataItem(BaseModel):
    """
    ...
    signed_transaction_hex: StrictStr = Field(..., alias="signedTransactionHex", description="Represents the signed transaction's specific hex.")
    __properties = ["callbackSecretKey", "callbackUrl", "signedTransactionHex"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastLocallySignedTransactionRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastLocallySignedTransactionRBDataItem:
        """Create an instance of BroadcastLocallySignedTransactionRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastLocallySignedTransactionRBDataItem.parse_obj(obj)

        _obj = BroadcastLocallySignedTransactionRBDataItem.parse_obj({
            "callback_secret_key": obj.get("callbackSecretKey"),
            "callback_url": obj.get("callbackUrl"),
            "signed_transaction_hex": obj.get("signedTransactionHex")
        })
        return _obj
