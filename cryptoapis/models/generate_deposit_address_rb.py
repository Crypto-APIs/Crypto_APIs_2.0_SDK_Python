...
class GenerateDepositAddressRB(BaseModel):
    """
    ...
    data: GenerateDepositAddressRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateDepositAddressRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateDepositAddressRB:
        """Create an instance of GenerateDepositAddressRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateDepositAddressRB.parse_obj(obj)

        _obj = GenerateDepositAddressRB.parse_obj({
            "context": obj.get("context"),
            "data": GenerateDepositAddressRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
