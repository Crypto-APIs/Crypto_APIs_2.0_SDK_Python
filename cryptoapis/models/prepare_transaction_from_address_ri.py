...
class PrepareTransactionFromAddressRI(BaseModel):
    """
    ...
    blockchain_specific: PrepareTransactionFromAddressRIBS = Field(..., alias="blockchainSpecific")
    __properties = ["amount", "dataHex", "nonce", "recipient", "sender", "sighash", "blockchainSpecific"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddressRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddressRI:
        """Create an instance of PrepareTransactionFromAddressRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddressRI.parse_obj(obj)

        _obj = PrepareTransactionFromAddressRI.parse_obj({
            ...
            "blockchain_specific": PrepareTransactionFromAddressRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
