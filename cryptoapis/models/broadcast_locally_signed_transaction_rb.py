...
class BroadcastLocallySignedTransactionRB(BaseModel):
    """
    ...
    data: BroadcastLocallySignedTransactionRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastLocallySignedTransactionRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastLocallySignedTransactionRB:
        """Create an instance of BroadcastLocallySignedTransactionRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastLocallySignedTransactionRB.parse_obj(obj)

        _obj = BroadcastLocallySignedTransactionRB.parse_obj({
            "context": obj.get("context"),
            "data": BroadcastLocallySignedTransactionRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
