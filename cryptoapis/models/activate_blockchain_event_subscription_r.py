...
class ActivateBlockchainEventSubscriptionR(BaseModel):
    """
    ...
    data: ActivateBlockchainEventSubscriptionRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivateBlockchainEventSubscriptionR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivateBlockchainEventSubscriptionR:
        """Create an instance of ActivateBlockchainEventSubscriptionR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivateBlockchainEventSubscriptionR.parse_obj(obj)

        _obj = ActivateBlockchainEventSubscriptionR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ActivateBlockchainEventSubscriptionRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
