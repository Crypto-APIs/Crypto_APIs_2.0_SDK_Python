...
class InvalidPagination(BaseModel):
    """
    invalid_pagination
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidPagination:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidPagination:
        """Create an instance of InvalidPagination from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidPagination.parse_obj(obj)

        _obj = InvalidPagination.parse_obj({
            "code": obj.get("code"),
