...
class ListInternalTransactionsByAddress400Response(BaseModel):
    """
    ...
    error: ListInternalTransactionsByAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddress400Response:
        """Create an instance of ListInternalTransactionsByAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddress400Response.parse_obj(obj)

        _obj = ListInternalTransactionsByAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListInternalTransactionsByAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
