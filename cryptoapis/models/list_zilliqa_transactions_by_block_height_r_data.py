...
class ListZilliqaTransactionsByBlockHeightRData(BaseModel):
    """
    ...
    items: conlist(ListZilliqaTransactionsByBlockHeightRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHeightRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHeightRData:
        """Create an instance of ListZilliqaTransactionsByBlockHeightRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHeightRData.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHeightRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListZilliqaTransactionsByBlockHeightRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
