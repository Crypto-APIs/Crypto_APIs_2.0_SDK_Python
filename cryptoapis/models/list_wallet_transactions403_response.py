...
class ListWalletTransactions403Response(BaseModel):
    """
    ...
    error: ListWalletTransactionsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWalletTransactions403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWalletTransactions403Response:
        """Create an instance of ListWalletTransactions403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWalletTransactions403Response.parse_obj(obj)

        _obj = ListWalletTransactions403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListWalletTransactionsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
