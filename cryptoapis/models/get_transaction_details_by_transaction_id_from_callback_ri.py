...
class GetTransactionDetailsByTransactionIDFromCallbackRI(BaseModel):
    """
    ...
    fee: GetTransactionDetailsByTransactionIDFromCallbackRIFee = Field(...)
    transaction_id: StrictStr = Field(..., alias="transactionId", description="String representation of the transaction hash")
    blockchain_specific: GetTransactionDetailsByTransactionIDFromCallbackRIBS = Field(..., alias="blockchainSpecific")
    __properties = ["index", "isConfirmed", "minedInBlockHash", "minedInBlockHeight", "recipients", "senders", "timestamp", "transactionHash", "fee", "transactionId", "blockchainSpecific"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRI:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRI.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRI.parse_obj({
            "index": obj.get("index"),
            ...
            "fee": GetTransactionDetailsByTransactionIDFromCallbackRIFee.from_dict(obj.get("fee")) if obj.get("fee") is not None else None,
            "transaction_id": obj.get("transactionId"),
            "blockchain_specific": GetTransactionDetailsByTransactionIDFromCallbackRIBS.from_dict(obj.get("blockchainSpecific")) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
