...
class ListXRPRippleTransactionsByBlockHeightRData(BaseModel):
    """
    ...
    items: conlist(ListXRPRippleTransactionsByBlockHeightRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByBlockHeightRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByBlockHeightRData:
        """Create an instance of ListXRPRippleTransactionsByBlockHeightRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByBlockHeightRData.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByBlockHeightRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListXRPRippleTransactionsByBlockHeightRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
