...
class CreateNewMasterWalletRB(BaseModel):
    """
    ...
    data: CreateNewMasterWalletRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNewMasterWalletRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNewMasterWalletRB:
        """Create an instance of CreateNewMasterWalletRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateNewMasterWalletRB.parse_obj(obj)

        _obj = CreateNewMasterWalletRB.parse_obj({
            "context": obj.get("context"),
            "data": CreateNewMasterWalletRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
