...
class ListAllAssetsByWalletID401Response(BaseModel):
    """
    ...
    error: ListAllAssetsByWalletIDE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsByWalletID401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsByWalletID401Response:
        """Create an instance of ListAllAssetsByWalletID401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsByWalletID401Response.parse_obj(obj)

        _obj = ListAllAssetsByWalletID401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListAllAssetsByWalletIDE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
