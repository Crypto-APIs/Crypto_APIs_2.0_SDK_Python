...
class CreateCoinsTransactionFromAddressForWholeAmountRBDataItem(BaseModel):
    """
    ...
    __properties = ["callbackSecretKey", "callbackUrl", "feePriority", "note", "recipientAddress"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCoinsTransactionFromAddressForWholeAmountRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCoinsTransactionFromAddressForWholeAmountRBDataItem:
        """Create an instance of CreateCoinsTransactionFromAddressForWholeAmountRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCoinsTransactionFromAddressForWholeAmountRBDataItem.parse_obj(obj)

        _obj = CreateCoinsTransactionFromAddressForWholeAmountRBDataItem.parse_obj({
