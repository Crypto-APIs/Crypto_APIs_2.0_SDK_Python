...
class MinedTransactionRB(BaseModel):
    """
    MinedTransactionRB
    """
    ...
    data: MinedTransactionRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MinedTransactionRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MinedTransactionRB:
        """Create an instance of MinedTransactionRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MinedTransactionRB.parse_obj(obj)

        _obj = MinedTransactionRB.parse_obj({
            "context": obj.get("context"),
            "data": MinedTransactionRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
