...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey.parse_obj({
