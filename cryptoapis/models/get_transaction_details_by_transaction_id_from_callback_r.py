...
class GetTransactionDetailsByTransactionIDFromCallbackR(BaseModel):
    """
    ...
    data: GetTransactionDetailsByTransactionIDFromCallbackRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackR:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackR.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetTransactionDetailsByTransactionIDFromCallbackRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
