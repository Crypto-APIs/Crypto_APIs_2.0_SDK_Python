...
class ListConfirmedTransactionsByAddressRIBSECGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSECGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSECGasPrice:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSECGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSECGasPrice.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSECGasPrice.parse_obj({
