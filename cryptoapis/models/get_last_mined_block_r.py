...
class GetLastMinedBlockR(BaseModel):
    """
    GetLastMinedBlockR
    """
    ...
    data: GetLastMinedBlockRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlockR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlockR:
        """Create an instance of GetLastMinedBlockR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlockR.parse_obj(obj)

        _obj = GetLastMinedBlockR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetLastMinedBlockRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
