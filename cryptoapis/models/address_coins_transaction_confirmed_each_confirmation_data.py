...
class AddressCoinsTransactionConfirmedEachConfirmationData(BaseModel):
    """
    ...
    item: AddressCoinsTransactionConfirmedEachConfirmationDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressCoinsTransactionConfirmedEachConfirmationData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressCoinsTransactionConfirmedEachConfirmationData:
        """Create an instance of AddressCoinsTransactionConfirmedEachConfirmationData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressCoinsTransactionConfirmedEachConfirmationData.parse_obj(obj)

        _obj = AddressCoinsTransactionConfirmedEachConfirmationData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": AddressCoinsTransactionConfirmedEachConfirmationDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
