...
class ValidateAddressR(BaseModel):
    """
    ValidateAddressR
    """
    ...
    data: ValidateAddressRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateAddressR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateAddressR:
        """Create an instance of ValidateAddressR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateAddressR.parse_obj(obj)

        _obj = ValidateAddressR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ValidateAddressRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
