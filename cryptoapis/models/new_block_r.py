...
class NewBlockR(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewBlockR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewBlockR:
        """Create an instance of NewBlockR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewBlockR.parse_obj(obj)

        _obj = NewBlockR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewBlockRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
