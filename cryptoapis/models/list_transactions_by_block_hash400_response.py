...
class ListTransactionsByBlockHash400Response(BaseModel):
    """
    ...
    error: ListTransactionsByBlockHashE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHash400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHash400Response:
        """Create an instance of ListTransactionsByBlockHash400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHash400Response.parse_obj(obj)

        _obj = ListTransactionsByBlockHash400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTransactionsByBlockHashE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
