...
class GetTransactionRequestDetailsR(BaseModel):
    """
    ...
    data: GetTransactionRequestDetailsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionRequestDetailsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionRequestDetailsR:
        """Create an instance of GetTransactionRequestDetailsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionRequestDetailsR.parse_obj(obj)

        _obj = GetTransactionRequestDetailsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetTransactionRequestDetailsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
