...
class GetTransactionDetailsByTransactionIDRIBSBVoutInner(BaseModel):
    """
    ...
    script_pub_key: GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSBVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSBVoutInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSBVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSBVoutInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSBVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
