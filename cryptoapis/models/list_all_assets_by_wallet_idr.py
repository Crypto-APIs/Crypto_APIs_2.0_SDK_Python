...
class ListAllAssetsByWalletIDR(BaseModel):
    """
    ...
    data: ListAllAssetsByWalletIDRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsByWalletIDR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsByWalletIDR:
        """Create an instance of ListAllAssetsByWalletIDR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsByWalletIDR.parse_obj(obj)

        _obj = ListAllAssetsByWalletIDR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListAllAssetsByWalletIDRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
