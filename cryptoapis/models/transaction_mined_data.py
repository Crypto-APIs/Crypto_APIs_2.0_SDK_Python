...
class TransactionMinedData(BaseModel):
    """
    ...
    item: TransactionMinedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionMinedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionMinedData:
        """Create an instance of TransactionMinedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionMinedData.parse_obj(obj)

        _obj = TransactionMinedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": TransactionMinedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
