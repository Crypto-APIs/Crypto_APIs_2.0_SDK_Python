...
class GetXRPRippleBlockDetailsByBlockHashRI(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleBlockDetailsByBlockHashRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleBlockDetailsByBlockHashRI:
        """Create an instance of GetXRPRippleBlockDetailsByBlockHashRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleBlockDetailsByBlockHashRI.parse_obj(obj)

        _obj = GetXRPRippleBlockDetailsByBlockHashRI.parse_obj({
            ...
            "total_coins": GetXRPRippleBlockDetailsByBlockHashRITotalCoins.from_dict(obj.get("totalCoins")) if obj.get("totalCoins") is not None else None,
