...
class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses400Response(BaseModel):
    """
    ...
    error: DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses400Response:
        """Create an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses400Response.parse_obj(obj)

        _obj = DeriveHDWalletXPubYPubZPubChangeOrReceivingAddresses400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
