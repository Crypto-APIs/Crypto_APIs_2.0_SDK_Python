...
class ListSupportedAssetsRData(BaseModel):
    """
    ...
    items: conlist(ListSupportedAssetsRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedAssetsRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedAssetsRData:
        """Create an instance of ListSupportedAssetsRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedAssetsRData.parse_obj(obj)

        _obj = ListSupportedAssetsRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListSupportedAssetsRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
