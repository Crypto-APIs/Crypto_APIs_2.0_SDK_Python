...
class GetXRPRippleBlockDetailsByBlockHeightR(BaseModel):
    """
    ...
    data: GetXRPRippleBlockDetailsByBlockHeightRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleBlockDetailsByBlockHeightR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleBlockDetailsByBlockHeightR:
        """Create an instance of GetXRPRippleBlockDetailsByBlockHeightR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleBlockDetailsByBlockHeightR.parse_obj(obj)

        _obj = GetXRPRippleBlockDetailsByBlockHeightR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetXRPRippleBlockDetailsByBlockHeightRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
