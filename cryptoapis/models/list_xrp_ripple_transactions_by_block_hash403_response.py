...
class ListXRPRippleTransactionsByBlockHash403Response(BaseModel):
    """
    ...
    error: ListXRPRippleTransactionsByBlockHashE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByBlockHash403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByBlockHash403Response:
        """Create an instance of ListXRPRippleTransactionsByBlockHash403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByBlockHash403Response.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByBlockHash403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListXRPRippleTransactionsByBlockHashE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
