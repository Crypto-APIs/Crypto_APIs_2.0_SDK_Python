...
class GetBlockDetailsByBlockHeightFromCallbackRIBSB(BaseModel):
    """
    Bitcoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallbackRIBSB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallbackRIBSB:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallbackRIBSB.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallbackRIBSB.parse_obj({
            "bits": obj.get("bits"),
