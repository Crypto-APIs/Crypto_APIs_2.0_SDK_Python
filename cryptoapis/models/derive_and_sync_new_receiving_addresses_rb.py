...
class DeriveAndSyncNewReceivingAddressesRB(BaseModel):
    """
    ...
    data: DeriveAndSyncNewReceivingAddressesRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveAndSyncNewReceivingAddressesRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveAndSyncNewReceivingAddressesRB:
        """Create an instance of DeriveAndSyncNewReceivingAddressesRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveAndSyncNewReceivingAddressesRB.parse_obj(obj)

        _obj = DeriveAndSyncNewReceivingAddressesRB.parse_obj({
            "context": obj.get("context"),
            "data": DeriveAndSyncNewReceivingAddressesRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
