...
class DeleteAutomaticCoinsForwardingR(BaseModel):
    """
    ...
    data: DeleteAutomaticCoinsForwardingRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAutomaticCoinsForwardingR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAutomaticCoinsForwardingR:
        """Create an instance of DeleteAutomaticCoinsForwardingR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAutomaticCoinsForwardingR.parse_obj(obj)

        _obj = DeleteAutomaticCoinsForwardingR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": DeleteAutomaticCoinsForwardingRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
