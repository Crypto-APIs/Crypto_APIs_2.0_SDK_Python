...
class ConvertBitcoinCashAddress400Response(BaseModel):
    """
    ...
    error: ConvertBitcoinCashAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress400Response:
        """Create an instance of ConvertBitcoinCashAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress400Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ConvertBitcoinCashAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
