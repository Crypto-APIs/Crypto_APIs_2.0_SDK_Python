...
class NewConfirmedTokensTransactionsAndEachConfirmationRB(BaseModel):
    """
    ...
    data: NewConfirmedTokensTransactionsAndEachConfirmationRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedTokensTransactionsAndEachConfirmationRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedTokensTransactionsAndEachConfirmationRB:
        """Create an instance of NewConfirmedTokensTransactionsAndEachConfirmationRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedTokensTransactionsAndEachConfirmationRB.parse_obj(obj)

        _obj = NewConfirmedTokensTransactionsAndEachConfirmationRB.parse_obj({
            "context": obj.get("context"),
            "data": NewConfirmedTokensTransactionsAndEachConfirmationRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
