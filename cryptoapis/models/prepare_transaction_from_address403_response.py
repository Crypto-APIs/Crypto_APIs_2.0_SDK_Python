...
class PrepareTransactionFromAddress403Response(BaseModel):
    """
    ...
    error: PrepareTransactionFromAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareTransactionFromAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareTransactionFromAddress403Response:
        """Create an instance of PrepareTransactionFromAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareTransactionFromAddress403Response.parse_obj(obj)

        _obj = PrepareTransactionFromAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareTransactionFromAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
