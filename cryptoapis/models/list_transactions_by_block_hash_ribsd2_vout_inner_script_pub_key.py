...
class ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey:
        """Create an instance of ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey.parse_obj({
