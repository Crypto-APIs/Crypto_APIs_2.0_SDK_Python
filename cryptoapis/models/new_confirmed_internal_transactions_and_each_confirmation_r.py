...
class NewConfirmedInternalTransactionsAndEachConfirmationR(BaseModel):
    """
    ...
    data: NewConfirmedInternalTransactionsAndEachConfirmationRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedInternalTransactionsAndEachConfirmationR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedInternalTransactionsAndEachConfirmationR:
        """Create an instance of NewConfirmedInternalTransactionsAndEachConfirmationR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedInternalTransactionsAndEachConfirmationR.parse_obj(obj)

        _obj = NewConfirmedInternalTransactionsAndEachConfirmationR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewConfirmedInternalTransactionsAndEachConfirmationRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
