...
class GetTransactionDetailsByTransactionIDRIBSBCVoutInner(BaseModel):
    """
    ...
    script_pub_key: GetTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey = Field(..., alias="scriptPubKey")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSBCVoutInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSBCVoutInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSBCVoutInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSBCVoutInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSBCVoutInner.parse_obj({
            "is_spent": obj.get("isSpent"),
            "script_pub_key": GetTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey.from_dict(obj.get("scriptPubKey")) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
