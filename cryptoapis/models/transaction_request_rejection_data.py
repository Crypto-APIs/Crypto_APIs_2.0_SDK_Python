...
class TransactionRequestRejectionData(BaseModel):
    """
    ...
    item: TransactionRequestRejectionDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestRejectionData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestRejectionData:
        """Create an instance of TransactionRequestRejectionData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestRejectionData.parse_obj(obj)

        _obj = TransactionRequestRejectionData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": TransactionRequestRejectionDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
