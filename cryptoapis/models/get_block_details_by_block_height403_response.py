...
class GetBlockDetailsByBlockHeight403Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHeightE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeight403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeight403Response:
        """Create an instance of GetBlockDetailsByBlockHeight403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeight403Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeight403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHeightE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
