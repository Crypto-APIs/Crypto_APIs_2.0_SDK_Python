...
class ListXRPRippleTransactionsByBlockHashR(BaseModel):
    """
    ...
    data: ListXRPRippleTransactionsByBlockHashRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListXRPRippleTransactionsByBlockHashR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListXRPRippleTransactionsByBlockHashR:
        """Create an instance of ListXRPRippleTransactionsByBlockHashR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListXRPRippleTransactionsByBlockHashR.parse_obj(obj)

        _obj = ListXRPRippleTransactionsByBlockHashR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListXRPRippleTransactionsByBlockHashRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
