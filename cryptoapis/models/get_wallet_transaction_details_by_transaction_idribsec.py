...
class GetWalletTransactionDetailsByTransactionIDRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSEC:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSEC.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSEC.parse_obj({
