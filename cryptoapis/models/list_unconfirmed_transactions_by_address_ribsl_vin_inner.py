...
class ListUnconfirmedTransactionsByAddressRIBSLVinInner(BaseModel):
    """
    ListUnconfirmedTransactionsByAddressRIBSLVinInner
    """
    addresses: conlist(StrictStr) = Field(...)
    script_sig: ListUnconfirmedTransactionsByAddressRIBSLVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSLVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSLVinInner:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSLVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSLVinInner.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSLVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "script_sig": ListUnconfirmedTransactionsByAddressRIBSLVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
