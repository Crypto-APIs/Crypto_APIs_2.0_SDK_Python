...
class ActivateBlockchainEventSubscription400Response(BaseModel):
    """
    ...
    error: ActivateBlockchainEventSubscriptionE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivateBlockchainEventSubscription400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivateBlockchainEventSubscription400Response:
        """Create an instance of ActivateBlockchainEventSubscription400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivateBlockchainEventSubscription400Response.parse_obj(obj)

        _obj = ActivateBlockchainEventSubscription400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ActivateBlockchainEventSubscriptionE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
