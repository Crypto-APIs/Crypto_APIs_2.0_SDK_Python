...
class ListLatestMinedBlocksRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocksRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocksRIBSE:
        """Create an instance of ListLatestMinedBlocksRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocksRIBSE.parse_obj(obj)

        _obj = ListLatestMinedBlocksRIBSE.parse_obj({
