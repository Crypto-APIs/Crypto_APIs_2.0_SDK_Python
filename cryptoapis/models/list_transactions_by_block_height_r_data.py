...
class ListTransactionsByBlockHeightRData(BaseModel):
    """
    ...
    items: conlist(ListTransactionsByBlockHeightRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRData:
        """Create an instance of ListTransactionsByBlockHeightRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRData.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListTransactionsByBlockHeightRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
