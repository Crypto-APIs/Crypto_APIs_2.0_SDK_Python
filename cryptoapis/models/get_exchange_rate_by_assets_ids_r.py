...
class GetExchangeRateByAssetsIDsR(BaseModel):
    """
    ...
    data: GetExchangeRateByAssetsIDsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetsIDsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetsIDsR:
        """Create an instance of GetExchangeRateByAssetsIDsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetsIDsR.parse_obj(obj)

        _obj = GetExchangeRateByAssetsIDsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetExchangeRateByAssetsIDsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
