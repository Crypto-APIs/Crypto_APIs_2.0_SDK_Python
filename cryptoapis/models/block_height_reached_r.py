...
class BlockHeightReachedR(BaseModel):
    """
    BlockHeightReachedR
    """
    ...
    data: BlockHeightReachedRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BlockHeightReachedR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BlockHeightReachedR:
        """Create an instance of BlockHeightReachedR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BlockHeightReachedR.parse_obj(obj)

        _obj = BlockHeightReachedR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": BlockHeightReachedRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
