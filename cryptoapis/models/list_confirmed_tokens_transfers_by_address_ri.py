...
class ListConfirmedTokensTransfersByAddressRI(BaseModel):
    ...
    token_name: StrictStr = Field(..., alias="tokenName", description="Defines the token's name as a string.")
    token_symbol: StrictStr = Field(..., alias="tokenSymbol", description="Defines the token symbol by which the token contract is known. It is usually 3-4 characters in length.")
    ...
    __properties = ["contractAddress", "minedInBlockHeight", "recipientAddress", "senderAddress", "tokenDecimals", "tokenId", "tokenName", "tokenSymbol", "tokenType", "tokensAmount", "transactionHash", "transactionTimestamp", "transactionFee"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddressRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddressRI:
        """Create an instance of ListConfirmedTokensTransfersByAddressRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddressRI.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddressRI.parse_obj({
