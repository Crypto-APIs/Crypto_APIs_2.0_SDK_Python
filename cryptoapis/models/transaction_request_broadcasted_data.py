...
class TransactionRequestBroadcastedData(BaseModel):
    """
    ...
    item: TransactionRequestBroadcastedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestBroadcastedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestBroadcastedData:
        """Create an instance of TransactionRequestBroadcastedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestBroadcastedData.parse_obj(obj)

        _obj = TransactionRequestBroadcastedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": TransactionRequestBroadcastedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
