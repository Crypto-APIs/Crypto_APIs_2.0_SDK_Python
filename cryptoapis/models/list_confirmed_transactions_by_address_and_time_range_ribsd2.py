...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2(BaseModel):
    """
    Dash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2.parse_obj({
