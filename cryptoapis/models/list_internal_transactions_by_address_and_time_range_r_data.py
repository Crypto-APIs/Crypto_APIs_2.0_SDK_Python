...
class ListInternalTransactionsByAddressAndTimeRangeRData(BaseModel):
    """
    ...
    items: conlist(ListInternalTransactionsByAddressAndTimeRangeRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListInternalTransactionsByAddressAndTimeRangeRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListInternalTransactionsByAddressAndTimeRangeRData:
        """Create an instance of ListInternalTransactionsByAddressAndTimeRangeRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListInternalTransactionsByAddressAndTimeRangeRData.parse_obj(obj)

        _obj = ListInternalTransactionsByAddressAndTimeRangeRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListInternalTransactionsByAddressAndTimeRangeRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
