...
class EstimateTransactionSmartFee501Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTransactionSmartFee501Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTransactionSmartFee501Response:
        """Create an instance of EstimateTransactionSmartFee501Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTransactionSmartFee501Response.parse_obj(obj)

        _obj = EstimateTransactionSmartFee501Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": Unimplemented.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
