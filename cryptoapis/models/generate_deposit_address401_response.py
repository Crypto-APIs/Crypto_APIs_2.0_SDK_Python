...
class GenerateDepositAddress401Response(BaseModel):
    """
    ...
    error: GenerateDepositAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateDepositAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateDepositAddress401Response:
        """Create an instance of GenerateDepositAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateDepositAddress401Response.parse_obj(obj)

        _obj = GenerateDepositAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GenerateDepositAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
