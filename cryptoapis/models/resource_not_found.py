...
class ResourceNotFound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceNotFound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceNotFound:
        """Create an instance of ResourceNotFound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceNotFound.parse_obj(obj)

        _obj = ResourceNotFound.parse_obj({
            "code": obj.get("code"),
