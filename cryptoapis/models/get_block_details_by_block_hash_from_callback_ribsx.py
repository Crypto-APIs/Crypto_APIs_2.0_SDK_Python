...
class GetBlockDetailsByBlockHashFromCallbackRIBSX(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSX:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSX:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSX from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSX.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSX.parse_obj({
