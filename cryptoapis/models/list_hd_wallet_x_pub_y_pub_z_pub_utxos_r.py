...
class ListHDWalletXPubYPubZPubUTXOsR(BaseModel):
    """
    ...
    data: ListHDWalletXPubYPubZPubUTXOsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubUTXOsR:
        """Create an instance of ListHDWalletXPubYPubZPubUTXOsR from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubUTXOsR:
        """Create an instance of ListHDWalletXPubYPubZPubUTXOsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubUTXOsR.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubUTXOsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": ListHDWalletXPubYPubZPubUTXOsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
