...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem(BaseModel):
    """
    CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem
    """
    amount: StrictStr = Field(..., description="Represents the specific amount of the transaction's destination.")
    ...
    recipient_address: StrictStr = Field(..., alias="recipientAddress", description="Defines the specific recipient/destination address.")
    __properties = ["amount", "callbackSecretKey", "callbackUrl", "note", "recipientAddress"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem:
        """Create an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem.parse_obj(obj)

        _obj = CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem.parse_obj({
