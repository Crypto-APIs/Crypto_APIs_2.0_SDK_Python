...
class ListConfirmedTransactionsByAddressAndTimeRange400Response(BaseModel):
    """
    ...
    error: ListConfirmedTransactionsByAddressAndTimeRangeE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressAndTimeRange400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressAndTimeRange400Response:
        """Create an instance of ListConfirmedTransactionsByAddressAndTimeRange400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressAndTimeRange400Response.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressAndTimeRange400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTransactionsByAddressAndTimeRangeE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
