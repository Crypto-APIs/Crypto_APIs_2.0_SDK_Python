...
class BroadcastTransactionSuccessDataItem(BaseModel):
    """
    ...
    __properties = ["blockchain", "network", "transactionId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastTransactionSuccessDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastTransactionSuccessDataItem:
        """Create an instance of BroadcastTransactionSuccessDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastTransactionSuccessDataItem.parse_obj(obj)

        _obj = BroadcastTransactionSuccessDataItem.parse_obj({
