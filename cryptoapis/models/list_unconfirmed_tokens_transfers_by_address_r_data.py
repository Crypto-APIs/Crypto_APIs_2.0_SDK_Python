...
class ListUnconfirmedTokensTransfersByAddressRData(BaseModel):
    """
    ...
    items: conlist(ListUnconfirmedTokensTransfersByAddressRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTokensTransfersByAddressRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTokensTransfersByAddressRData:
        """Create an instance of ListUnconfirmedTokensTransfersByAddressRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTokensTransfersByAddressRData.parse_obj(obj)

        _obj = ListUnconfirmedTokensTransfersByAddressRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListUnconfirmedTokensTransfersByAddressRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
