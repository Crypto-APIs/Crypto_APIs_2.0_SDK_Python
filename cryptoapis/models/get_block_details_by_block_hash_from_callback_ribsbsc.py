...
class GetBlockDetailsByBlockHashFromCallbackRIBSBSC(BaseModel):
    """
    Binance Smart Chain
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSBSC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSBSC:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSBSC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSBSC.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSBSC.parse_obj({
