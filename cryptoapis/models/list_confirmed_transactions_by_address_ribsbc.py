...
class ListConfirmedTransactionsByAddressRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSBC:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSBC.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSBC.parse_obj({
