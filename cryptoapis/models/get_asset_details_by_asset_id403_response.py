...
class GetAssetDetailsByAssetID403Response(BaseModel):
    """
    ...
    error: GetAssetDetailsByAssetIDE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetDetailsByAssetID403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetDetailsByAssetID403Response:
        """Create an instance of GetAssetDetailsByAssetID403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAssetDetailsByAssetID403Response.parse_obj(obj)

        _obj = GetAssetDetailsByAssetID403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetAssetDetailsByAssetIDE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
