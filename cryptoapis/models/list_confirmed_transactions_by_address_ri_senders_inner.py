...
class ListConfirmedTransactionsByAddressRISendersInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRISendersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRISendersInner:
        """Create an instance of ListConfirmedTransactionsByAddressRISendersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRISendersInner.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRISendersInner.parse_obj({
