...
class NewConfirmedTokensTransactionsAndEachConfirmationRI(BaseModel):
    """
    ...
    __properties = ["address", "callbackSecretKey", "callbackUrl", "confirmationsCount", "createdTimestamp", "eventType", "isActive", "referenceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedTokensTransactionsAndEachConfirmationRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedTokensTransactionsAndEachConfirmationRI:
        """Create an instance of NewConfirmedTokensTransactionsAndEachConfirmationRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedTokensTransactionsAndEachConfirmationRI.parse_obj(obj)

        _obj = NewConfirmedTokensTransactionsAndEachConfirmationRI.parse_obj({
