...
class ListConfirmedTransactionsByAddressRIBSBSCGasPrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddressRIBSBSCGasPrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddressRIBSBSCGasPrice:
        """Create an instance of ListConfirmedTransactionsByAddressRIBSBSCGasPrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddressRIBSBSCGasPrice.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddressRIBSBSCGasPrice.parse_obj({
