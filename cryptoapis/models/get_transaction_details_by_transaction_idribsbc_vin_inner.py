...
class GetTransactionDetailsByTransactionIDRIBSBCVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSBCVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSBCVinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSBCVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSBCVinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSBCVinInner.parse_obj({
