...
class NewRevertedBlockRI(BaseModel):
    """
    NewRevertedBlockRI
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewRevertedBlockRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewRevertedBlockRI:
        """Create an instance of NewRevertedBlockRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewRevertedBlockRI.parse_obj(obj)

        _obj = NewRevertedBlockRI.parse_obj({
