...
class GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner.parse_obj({
