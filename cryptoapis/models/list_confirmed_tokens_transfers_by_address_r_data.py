...
class ListConfirmedTokensTransfersByAddressRData(BaseModel):
    ...
    items: conlist(ListConfirmedTokensTransfersByAddressRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddressRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddressRData:
        """Create an instance of ListConfirmedTokensTransfersByAddressRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddressRData.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddressRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListConfirmedTokensTransfersByAddressRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
