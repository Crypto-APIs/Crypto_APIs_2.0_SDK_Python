...
class PrepareANonFungibleTokenTransferFromAddress401Response(BaseModel):
    """
    ...
    error: PrepareANonFungibleTokenTransferFromAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareANonFungibleTokenTransferFromAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareANonFungibleTokenTransferFromAddress401Response:
        """Create an instance of PrepareANonFungibleTokenTransferFromAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareANonFungibleTokenTransferFromAddress401Response.parse_obj(obj)

        _obj = PrepareANonFungibleTokenTransferFromAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareANonFungibleTokenTransferFromAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
