...
class GetTransactionDetailsByTransactionIDFromCallback403Response(BaseModel):
    """
    ...
    error: GetTransactionDetailsByTransactionIDFromCallbackE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallback403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallback403Response:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallback403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallback403Response.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallback403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionDetailsByTransactionIDFromCallbackE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
