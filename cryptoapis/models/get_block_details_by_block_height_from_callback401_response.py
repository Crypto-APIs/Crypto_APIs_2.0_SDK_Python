...
class GetBlockDetailsByBlockHeightFromCallback401Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHeightFromCallbackE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightFromCallback401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightFromCallback401Response:
        """Create an instance of GetBlockDetailsByBlockHeightFromCallback401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightFromCallback401Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightFromCallback401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHeightFromCallbackE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
