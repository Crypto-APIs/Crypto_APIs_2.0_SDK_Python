...
class PrepareAFungibleTokenTransferFromAddress401Response(BaseModel):
    """
    ...
    error: PrepareAFungibleTokenTransferFromAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareAFungibleTokenTransferFromAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareAFungibleTokenTransferFromAddress401Response:
        """Create an instance of PrepareAFungibleTokenTransferFromAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareAFungibleTokenTransferFromAddress401Response.parse_obj(obj)

        _obj = PrepareAFungibleTokenTransferFromAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": PrepareAFungibleTokenTransferFromAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
