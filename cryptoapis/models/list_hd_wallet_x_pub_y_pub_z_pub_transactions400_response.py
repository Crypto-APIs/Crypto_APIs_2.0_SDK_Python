...
class ListHDWalletXPubYPubZPubTransactions400Response(BaseModel):
    """
    ...
    error: ListHDWalletXPubYPubZPubTransactionsE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListHDWalletXPubYPubZPubTransactions400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListHDWalletXPubYPubZPubTransactions400Response:
        """Create an instance of ListHDWalletXPubYPubZPubTransactions400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListHDWalletXPubYPubZPubTransactions400Response.parse_obj(obj)

        _obj = ListHDWalletXPubYPubZPubTransactions400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListHDWalletXPubYPubZPubTransactionsE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
