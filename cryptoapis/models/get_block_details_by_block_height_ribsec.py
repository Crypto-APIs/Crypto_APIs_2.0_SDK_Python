...
class GetBlockDetailsByBlockHeightRIBSEC(BaseModel):
    """
    Ethereum Classic
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeightRIBSEC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeightRIBSEC:
        """Create an instance of GetBlockDetailsByBlockHeightRIBSEC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeightRIBSEC.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeightRIBSEC.parse_obj({
