...
class ListSupportedAssets403Response(BaseModel):
    """
    ...
    error: ListSupportedAssetsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedAssets403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedAssets403Response:
        """Create an instance of ListSupportedAssets403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedAssets403Response.parse_obj(obj)

        _obj = ListSupportedAssets403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSupportedAssetsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
