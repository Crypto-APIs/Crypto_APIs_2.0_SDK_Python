...
class GetZilliqaAddressDetails403Response(BaseModel):
    """
    ...
    error: GetZilliqaAddressDetailsE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZilliqaAddressDetails403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZilliqaAddressDetails403Response:
        """Create an instance of GetZilliqaAddressDetails403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZilliqaAddressDetails403Response.parse_obj(obj)

        _obj = GetZilliqaAddressDetails403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetZilliqaAddressDetailsE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
