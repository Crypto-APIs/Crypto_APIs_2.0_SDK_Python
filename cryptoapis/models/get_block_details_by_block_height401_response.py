...
class GetBlockDetailsByBlockHeight401Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHeightE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHeight401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHeight401Response:
        """Create an instance of GetBlockDetailsByBlockHeight401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHeight401Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHeight401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHeightE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
