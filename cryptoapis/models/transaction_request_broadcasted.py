...
class TransactionRequestBroadcasted(BaseModel):
    """
    ...
    data: TransactionRequestBroadcastedData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestBroadcasted:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestBroadcasted:
        """Create an instance of TransactionRequestBroadcasted from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionRequestBroadcasted.parse_obj(obj)

        _obj = TransactionRequestBroadcasted.parse_obj({
            "api_version": obj.get("apiVersion"),
            "reference_id": obj.get("referenceId"),
            "idempotency_key": obj.get("idempotencyKey"),
            "data": TransactionRequestBroadcastedData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
