...
class CreateAutomaticTokensForwardingR(BaseModel):
    """
    ...
    data: CreateAutomaticTokensForwardingRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAutomaticTokensForwardingR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAutomaticTokensForwardingR:
        """Create an instance of CreateAutomaticTokensForwardingR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAutomaticTokensForwardingR.parse_obj(obj)

        _obj = CreateAutomaticTokensForwardingR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": CreateAutomaticTokensForwardingRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
