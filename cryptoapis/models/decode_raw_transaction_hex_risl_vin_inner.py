...
class DecodeRawTransactionHexRISLVinInner(BaseModel):
    """
    ...
    script_sig: DecodeRawTransactionHexRISLVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISLVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISLVinInner:
        """Create an instance of DecodeRawTransactionHexRISLVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISLVinInner.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISLVinInner.parse_obj({
            "address": obj.get("address"),
            "input_hash": obj.get("inputHash"),
            "output_index": obj.get("outputIndex"),
            "script_sig": DecodeRawTransactionHexRISLVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
