...
class GetBlockDetailsByBlockHash401Response(BaseModel):
    """
    ...
    error: GetBlockDetailsByBlockHashE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHash401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHash401Response:
        """Create an instance of GetBlockDetailsByBlockHash401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHash401Response.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHash401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockDetailsByBlockHashE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
