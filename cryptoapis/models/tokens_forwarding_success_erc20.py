...
class TokensForwardingSuccessErc20(BaseModel):
    """
    ERC-20
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokensForwardingSuccessErc20:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokensForwardingSuccessErc20:
        """Create an instance of TokensForwardingSuccessErc20 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokensForwardingSuccessErc20.parse_obj(obj)

        _obj = TokensForwardingSuccessErc20.parse_obj({
            "name": obj.get("name"),
