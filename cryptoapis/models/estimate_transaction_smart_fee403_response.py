...
class EstimateTransactionSmartFee403Response(BaseModel):
    """
    ...
    error: EstimateTransactionSmartFeeE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTransactionSmartFee403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTransactionSmartFee403Response:
        """Create an instance of EstimateTransactionSmartFee403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTransactionSmartFee403Response.parse_obj(obj)

        _obj = EstimateTransactionSmartFee403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": EstimateTransactionSmartFeeE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
