...
class GetExchangeRateByAssetSymbols422Response(BaseModel):
    """
    ...
    error: GetExchangeRateByAssetSymbolsE422 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetExchangeRateByAssetSymbols422Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetExchangeRateByAssetSymbols422Response:
        """Create an instance of GetExchangeRateByAssetSymbols422Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetExchangeRateByAssetSymbols422Response.parse_obj(obj)

        _obj = GetExchangeRateByAssetSymbols422Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetExchangeRateByAssetSymbolsE422.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
