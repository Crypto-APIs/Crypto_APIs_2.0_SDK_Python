...
class SyncNewHDWalletXPubYPubZPub409Response(BaseModel):
    """
    ...
    error: SyncNewHDWalletXPubYPubZPubE409 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SyncNewHDWalletXPubYPubZPub409Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SyncNewHDWalletXPubYPubZPub409Response:
        """Create an instance of SyncNewHDWalletXPubYPubZPub409Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SyncNewHDWalletXPubYPubZPub409Response.parse_obj(obj)

        _obj = SyncNewHDWalletXPubYPubZPub409Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": SyncNewHDWalletXPubYPubZPubE409.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
