...
class ListAllAssetsByWalletID400Response(BaseModel):
    """
    ...
    error: ListAllAssetsByWalletIDE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsByWalletID400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsByWalletID400Response:
        """Create an instance of ListAllAssetsByWalletID400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsByWalletID400Response.parse_obj(obj)

        _obj = ListAllAssetsByWalletID400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListAllAssetsByWalletIDE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
