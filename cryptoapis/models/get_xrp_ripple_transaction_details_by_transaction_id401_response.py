...
class GetXRPRippleTransactionDetailsByTransactionID401Response(BaseModel):
    """
    ...
    error: GetXRPRippleTransactionDetailsByTransactionIDE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleTransactionDetailsByTransactionID401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleTransactionDetailsByTransactionID401Response:
        """Create an instance of GetXRPRippleTransactionDetailsByTransactionID401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleTransactionDetailsByTransactionID401Response.parse_obj(obj)

        _obj = GetXRPRippleTransactionDetailsByTransactionID401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleTransactionDetailsByTransactionIDE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
