...
class GetLastMinedBlockRIBSL(BaseModel):
    """
    Litecoin
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLastMinedBlockRIBSL:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLastMinedBlockRIBSL:
        """Create an instance of GetLastMinedBlockRIBSL from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLastMinedBlockRIBSL.parse_obj(obj)

        _obj = GetLastMinedBlockRIBSL.parse_obj({
            "bits": obj.get("bits"),
