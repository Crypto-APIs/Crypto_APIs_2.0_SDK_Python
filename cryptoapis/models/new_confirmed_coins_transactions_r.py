...
class NewConfirmedCoinsTransactionsR(BaseModel):
    """
    ...
    data: NewConfirmedCoinsTransactionsRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedCoinsTransactionsR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedCoinsTransactionsR:
        """Create an instance of NewConfirmedCoinsTransactionsR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedCoinsTransactionsR.parse_obj(obj)

        _obj = NewConfirmedCoinsTransactionsR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewConfirmedCoinsTransactionsRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
