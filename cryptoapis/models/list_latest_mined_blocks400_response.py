...
class ListLatestMinedBlocks400Response(BaseModel):
    """
    ...
    error: ListLatestMinedBlocksE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListLatestMinedBlocks400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListLatestMinedBlocks400Response:
        """Create an instance of ListLatestMinedBlocks400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListLatestMinedBlocks400Response.parse_obj(obj)

        _obj = ListLatestMinedBlocks400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListLatestMinedBlocksE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
