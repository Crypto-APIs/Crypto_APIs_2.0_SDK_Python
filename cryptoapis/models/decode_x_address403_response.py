...
class DecodeXAddress403Response(BaseModel):
    """
    ...
    error: DecodeXAddressE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeXAddress403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeXAddress403Response:
        """Create an instance of DecodeXAddress403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeXAddress403Response.parse_obj(obj)

        _obj = DecodeXAddress403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": DecodeXAddressE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
