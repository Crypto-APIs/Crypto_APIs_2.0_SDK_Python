...
class CreateCoinsTransactionRequestFromWalletRI(BaseModel):
    """
    ...
    recipients: conlist(CreateCoinsTransactionRequestFromWalletRIRecipientsInner) = Field(..., description="Defines the destination of the transaction, whether it is incoming or outgoing.")
    total_transaction_amount: StrictStr = Field(..., alias="totalTransactionAmount", description="Represents the specific amount of the transaction.")
    ...
    __properties = ["callbackSecretKey", "callbackUrl", "feePriority", "note", "recipients", "totalTransactionAmount", "transactionRequestId", "transactionRequestStatus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCoinsTransactionRequestFromWalletRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCoinsTransactionRequestFromWalletRI:
        """Create an instance of CreateCoinsTransactionRequestFromWalletRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCoinsTransactionRequestFromWalletRI.parse_obj(obj)

        _obj = CreateCoinsTransactionRequestFromWalletRI.parse_obj({
            "callback_secret_key": obj.get("callbackSecretKey"),
            "callback_url": obj.get("callbackUrl"),
            "fee_priority": obj.get("feePriority"),
            "note": obj.get("note"),
            "recipients": [CreateCoinsTransactionRequestFromWalletRIRecipientsInner.from_dict(_item) for _item in obj.get("recipients")] if obj.get("recipients") is not None else None,
