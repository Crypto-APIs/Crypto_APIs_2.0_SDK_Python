...
class ListAllAssetsFromAllWalletsRData(BaseModel):
    """
    ...
    items: conlist(ListAllAssetsFromAllWalletsRI) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAllAssetsFromAllWalletsRData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAllAssetsFromAllWalletsRData:
        """Create an instance of ListAllAssetsFromAllWalletsRData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAllAssetsFromAllWalletsRData.parse_obj(obj)

        _obj = ListAllAssetsFromAllWalletsRData.parse_obj({
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "total": obj.get("total"),
            "items": [ListAllAssetsFromAllWalletsRI.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
