...
class GetWalletTransactionDetailsByTransactionIDRIBSZVinInner(BaseModel):
    """
    GetWalletTransactionDetailsByTransactionIDRIBSZVinInner
    """
    addresses: conlist(StrictStr) = Field(...)
    script_sig: GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    value: StrictStr = Field(..., description="Defines the specific amount.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSZVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSZVinInner:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSZVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSZVinInner.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSZVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "script_sig": GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
