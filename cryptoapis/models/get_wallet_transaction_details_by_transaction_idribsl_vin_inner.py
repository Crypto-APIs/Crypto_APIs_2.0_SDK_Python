...
class GetWalletTransactionDetailsByTransactionIDRIBSLVinInner(BaseModel):
    """
    ...
    script_sig: GetWalletTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionIDRIBSLVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionIDRIBSLVinInner:
        """Create an instance of GetWalletTransactionDetailsByTransactionIDRIBSLVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionIDRIBSLVinInner.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionIDRIBSLVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "coinbase": obj.get("coinbase"),
            "script_sig": GetWalletTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
