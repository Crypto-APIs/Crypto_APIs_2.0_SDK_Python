...
class GetTransactionDetailsByTransactionIDR(BaseModel):
    """
    ...
    data: GetTransactionDetailsByTransactionIDRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDR:
        """Create an instance of GetTransactionDetailsByTransactionIDR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDR.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": GetTransactionDetailsByTransactionIDRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
