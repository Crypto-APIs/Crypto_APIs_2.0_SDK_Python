...
class GetBlockDetailsByBlockHashFromCallbackRIBSBC(BaseModel):
    """
    Bitcoin Cash
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockDetailsByBlockHashFromCallbackRIBSBC:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockDetailsByBlockHashFromCallbackRIBSBC:
        """Create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSBC from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockDetailsByBlockHashFromCallbackRIBSBC.parse_obj(obj)

        _obj = GetBlockDetailsByBlockHashFromCallbackRIBSBC.parse_obj({
            "bits": obj.get("bits"),
