...
class GetTransactionDetailsByTransactionIDFromCallback401Response(BaseModel):
    """
    ...
    error: GetTransactionDetailsByTransactionIDFromCallbackE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallback401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallback401Response:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallback401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallback401Response.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallback401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetTransactionDetailsByTransactionIDFromCallbackE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
