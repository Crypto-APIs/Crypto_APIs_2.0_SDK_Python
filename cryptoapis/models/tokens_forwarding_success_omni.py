...
class TokensForwardingSuccessOmni(BaseModel):
    """
    OMNI
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokensForwardingSuccessOmni:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokensForwardingSuccessOmni:
        """Create an instance of TokensForwardingSuccessOmni from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokensForwardingSuccessOmni.parse_obj(obj)

        _obj = TokensForwardingSuccessOmni.parse_obj({
            "name": obj.get("name"),
