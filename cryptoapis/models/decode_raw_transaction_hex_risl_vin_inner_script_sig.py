...
class DecodeRawTransactionHexRISLVinInnerScriptSig(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DecodeRawTransactionHexRISLVinInnerScriptSig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DecodeRawTransactionHexRISLVinInnerScriptSig:
        """Create an instance of DecodeRawTransactionHexRISLVinInnerScriptSig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DecodeRawTransactionHexRISLVinInnerScriptSig.parse_obj(obj)

        _obj = DecodeRawTransactionHexRISLVinInnerScriptSig.parse_obj({
            "asm": obj.get("asm"),
            "hex": obj.get("hex"),
            "type": obj.get("type")
        })
