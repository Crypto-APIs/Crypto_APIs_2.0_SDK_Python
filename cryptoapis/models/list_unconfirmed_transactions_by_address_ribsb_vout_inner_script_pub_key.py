...
class ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.parse_obj({
