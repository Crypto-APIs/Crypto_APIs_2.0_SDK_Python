...
class ListTokensByAddress400Response(BaseModel):
    """
    ...
    error: ListTokensByAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensByAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensByAddress400Response:
        """Create an instance of ListTokensByAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensByAddress400Response.parse_obj(obj)

        _obj = ListTokensByAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensByAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
