...
class ActivateBlockchainEventSubscriptionRB(BaseModel):
    """
    ...
    data: ActivateBlockchainEventSubscriptionRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivateBlockchainEventSubscriptionRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivateBlockchainEventSubscriptionRB:
        """Create an instance of ActivateBlockchainEventSubscriptionRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivateBlockchainEventSubscriptionRB.parse_obj(obj)

        _obj = ActivateBlockchainEventSubscriptionRB.parse_obj({
            "context": obj.get("context"),
            "data": ActivateBlockchainEventSubscriptionRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
