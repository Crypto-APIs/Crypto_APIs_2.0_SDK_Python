...
class NewConfirmedTokensTransactionsAndEachConfirmationR(BaseModel):
    """
    ...
    data: NewConfirmedTokensTransactionsAndEachConfirmationRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewConfirmedTokensTransactionsAndEachConfirmationR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewConfirmedTokensTransactionsAndEachConfirmationR:
        """Create an instance of NewConfirmedTokensTransactionsAndEachConfirmationR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewConfirmedTokensTransactionsAndEachConfirmationR.parse_obj(obj)

        _obj = NewConfirmedTokensTransactionsAndEachConfirmationR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": NewConfirmedTokensTransactionsAndEachConfirmationRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
