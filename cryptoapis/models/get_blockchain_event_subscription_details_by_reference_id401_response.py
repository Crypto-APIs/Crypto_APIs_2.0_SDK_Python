...
class GetBlockchainEventSubscriptionDetailsByReferenceID401Response(BaseModel):
    """
    ...
    error: GetBlockchainEventSubscriptionDetailsByReferenceIDE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBlockchainEventSubscriptionDetailsByReferenceID401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBlockchainEventSubscriptionDetailsByReferenceID401Response:
        """Create an instance of GetBlockchainEventSubscriptionDetailsByReferenceID401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBlockchainEventSubscriptionDetailsByReferenceID401Response.parse_obj(obj)

        _obj = GetBlockchainEventSubscriptionDetailsByReferenceID401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetBlockchainEventSubscriptionDetailsByReferenceIDE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
