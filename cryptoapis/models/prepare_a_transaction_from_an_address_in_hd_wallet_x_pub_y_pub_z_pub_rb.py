...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB(BaseModel):
    """
    ...
    data: PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB:
        """Create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB.parse_obj(obj)

        _obj = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB.parse_obj({
            "context": obj.get("context"),
            "data": PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
