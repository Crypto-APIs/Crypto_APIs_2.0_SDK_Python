...
class ListTokensByAddress401Response(BaseModel):
    """
    ...
    error: ListTokensByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTokensByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTokensByAddress401Response:
        """Create an instance of ListTokensByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTokensByAddress401Response.parse_obj(obj)

        _obj = ListTokensByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListTokensByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
