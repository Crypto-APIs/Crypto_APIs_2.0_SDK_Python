...
class ListConfirmedTransactionsByAddress401Response(BaseModel):
    """
    ...
    error: ListConfirmedTransactionsByAddressE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTransactionsByAddress401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTransactionsByAddress401Response:
        """Create an instance of ListConfirmedTransactionsByAddress401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTransactionsByAddress401Response.parse_obj(obj)

        _obj = ListConfirmedTransactionsByAddress401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTransactionsByAddressE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
