...
class AddressTokensTransactionUnconfirmedData(BaseModel):
    """
    ...
    item: AddressTokensTransactionUnconfirmedDataItem = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressTokensTransactionUnconfirmedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressTokensTransactionUnconfirmedData:
        """Create an instance of AddressTokensTransactionUnconfirmedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressTokensTransactionUnconfirmedData.parse_obj(obj)

        _obj = AddressTokensTransactionUnconfirmedData.parse_obj({
            "product": obj.get("product"),
            "event": obj.get("event"),
            "item": AddressTokensTransactionUnconfirmedDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None
        })
        return _obj
