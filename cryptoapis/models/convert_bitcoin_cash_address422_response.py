...
class ConvertBitcoinCashAddress422Response(BaseModel):
    """
    ...
    error: InvalidRequestBodyStructure = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertBitcoinCashAddress422Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertBitcoinCashAddress422Response:
        """Create an instance of ConvertBitcoinCashAddress422Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConvertBitcoinCashAddress422Response.parse_obj(obj)

        _obj = ConvertBitcoinCashAddress422Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": InvalidRequestBodyStructure.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
