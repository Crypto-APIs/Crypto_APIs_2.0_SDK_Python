...
class EstimateTokenGasLimitRB(BaseModel):
    """
    ...
    data: EstimateTokenGasLimitRBData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateTokenGasLimitRB:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateTokenGasLimitRB:
        """Create an instance of EstimateTokenGasLimitRB from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EstimateTokenGasLimitRB.parse_obj(obj)

        _obj = EstimateTokenGasLimitRB.parse_obj({
            "context": obj.get("context"),
            "data": EstimateTokenGasLimitRBData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
