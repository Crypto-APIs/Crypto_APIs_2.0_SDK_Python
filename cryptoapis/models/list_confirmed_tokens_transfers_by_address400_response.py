...
class ListConfirmedTokensTransfersByAddress400Response(BaseModel):
    """
    ...
    error: ListConfirmedTokensTransfersByAddressE400 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddress400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddress400Response:
        """Create an instance of ListConfirmedTokensTransfersByAddress400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddress400Response.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddress400Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTokensTransfersByAddressE400.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
