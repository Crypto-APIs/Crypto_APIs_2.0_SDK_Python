...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner(BaseModel):
    """
    ...
    unit: StrictStr = Field(..., description="Defines the unit of the recieved amount for the address.")
    __properties = ["address", "amount", "classicAddress", "unit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner:
        """Create an instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner.parse_obj(obj)

        _obj = CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner.parse_obj({
