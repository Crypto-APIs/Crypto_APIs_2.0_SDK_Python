...
class BroadcastLocallySignedTransactionR(BaseModel):
    """
    ...
    data: BroadcastLocallySignedTransactionRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastLocallySignedTransactionR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastLocallySignedTransactionR:
        """Create an instance of BroadcastLocallySignedTransactionR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastLocallySignedTransactionR.parse_obj(obj)

        _obj = BroadcastLocallySignedTransactionR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": BroadcastLocallySignedTransactionRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
