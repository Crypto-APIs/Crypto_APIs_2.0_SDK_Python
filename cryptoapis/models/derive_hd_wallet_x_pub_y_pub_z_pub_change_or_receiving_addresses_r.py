...
class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesR(BaseModel):
    """
    ...
    data: DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesR:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesR:
        """Create an instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesR from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesR.parse_obj(obj)

        _obj = DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesR.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "data": DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
