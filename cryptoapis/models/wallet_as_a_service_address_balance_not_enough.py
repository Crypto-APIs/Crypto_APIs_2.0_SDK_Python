...
class WalletAsAServiceAddressBalanceNotEnough(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletAsAServiceAddressBalanceNotEnough:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletAsAServiceAddressBalanceNotEnough:
        """Create an instance of WalletAsAServiceAddressBalanceNotEnough from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletAsAServiceAddressBalanceNotEnough.parse_obj(obj)

        _obj = WalletAsAServiceAddressBalanceNotEnough.parse_obj({
            "code": obj.get("code"),
