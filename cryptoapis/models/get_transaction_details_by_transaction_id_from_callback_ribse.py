...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSE(BaseModel):
    """
    Ethereum
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSE:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSE:
        """Create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSE from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSE.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDFromCallbackRIBSE.parse_obj({
            "contract": obj.get("contract"),
            "gas_limit": obj.get("gasLimit"),
            "gas_price": GetTransactionDetailsByTransactionIDRIBSEGasPrice.from_dict(obj.get("gasPrice")) if obj.get("gasPrice") is not None else None,
