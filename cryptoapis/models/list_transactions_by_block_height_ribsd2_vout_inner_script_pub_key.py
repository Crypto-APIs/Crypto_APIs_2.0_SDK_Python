...
class ListTransactionsByBlockHeightRIBSD2VoutInnerScriptPubKey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTransactionsByBlockHeightRIBSD2VoutInnerScriptPubKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTransactionsByBlockHeightRIBSD2VoutInnerScriptPubKey:
        """Create an instance of ListTransactionsByBlockHeightRIBSD2VoutInnerScriptPubKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTransactionsByBlockHeightRIBSD2VoutInnerScriptPubKey.parse_obj(obj)

        _obj = ListTransactionsByBlockHeightRIBSD2VoutInnerScriptPubKey.parse_obj({
