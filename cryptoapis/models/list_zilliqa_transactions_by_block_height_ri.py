...
class ListZilliqaTransactionsByBlockHeightRI(BaseModel):
    """
    ...
    __properties = ["fee", "gasLimit", "gasPrice", "gasUsed", "minedInBlockHash", "nonce", "recipients", "senders", "timestamp", "transactionHash", "transactionIndex", "transactionStatus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListZilliqaTransactionsByBlockHeightRI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListZilliqaTransactionsByBlockHeightRI:
        """Create an instance of ListZilliqaTransactionsByBlockHeightRI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListZilliqaTransactionsByBlockHeightRI.parse_obj(obj)

        _obj = ListZilliqaTransactionsByBlockHeightRI.parse_obj({
