...
class GetXRPRippleTransactionDetailsByTransactionID403Response(BaseModel):
    """
    ...
    error: GetXRPRippleTransactionDetailsByTransactionIDE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetXRPRippleTransactionDetailsByTransactionID403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetXRPRippleTransactionDetailsByTransactionID403Response:
        """Create an instance of GetXRPRippleTransactionDetailsByTransactionID403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetXRPRippleTransactionDetailsByTransactionID403Response.parse_obj(obj)

        _obj = GetXRPRippleTransactionDetailsByTransactionID403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetXRPRippleTransactionDetailsByTransactionIDE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
