...
class GetWalletTransactionDetailsByTransactionID403Response(BaseModel):
    """
    ...
    error: GetWalletTransactionDetailsByTransactionIDE403 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWalletTransactionDetailsByTransactionID403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWalletTransactionDetailsByTransactionID403Response:
        """Create an instance of GetWalletTransactionDetailsByTransactionID403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWalletTransactionDetailsByTransactionID403Response.parse_obj(obj)

        _obj = GetWalletTransactionDetailsByTransactionID403Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": GetWalletTransactionDetailsByTransactionIDE403.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
