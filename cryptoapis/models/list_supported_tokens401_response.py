...
class ListSupportedTokens401Response(BaseModel):
    """
    ...
    error: ListSupportedTokensE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSupportedTokens401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSupportedTokens401Response:
        """Create an instance of ListSupportedTokens401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSupportedTokens401Response.parse_obj(obj)

        _obj = ListSupportedTokens401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListSupportedTokensE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
