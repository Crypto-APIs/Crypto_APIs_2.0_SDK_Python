...
class GetTransactionDetailsByTransactionIDRIBSDVinInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionDetailsByTransactionIDRIBSDVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionDetailsByTransactionIDRIBSDVinInner:
        """Create an instance of GetTransactionDetailsByTransactionIDRIBSDVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionDetailsByTransactionIDRIBSDVinInner.parse_obj(obj)

        _obj = GetTransactionDetailsByTransactionIDRIBSDVinInner.parse_obj({
