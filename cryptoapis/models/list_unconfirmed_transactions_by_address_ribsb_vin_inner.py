...
class ListUnconfirmedTransactionsByAddressRIBSBVinInner(BaseModel):
    """
    ListUnconfirmedTransactionsByAddressRIBSBVinInner
    """
    addresses: conlist(StrictStr) = Field(...)
    script_sig: ListUnconfirmedTransactionsByAddressRIBSBVinInnerScriptSig = Field(..., alias="scriptSig")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUnconfirmedTransactionsByAddressRIBSBVinInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUnconfirmedTransactionsByAddressRIBSBVinInner:
        """Create an instance of ListUnconfirmedTransactionsByAddressRIBSBVinInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListUnconfirmedTransactionsByAddressRIBSBVinInner.parse_obj(obj)

        _obj = ListUnconfirmedTransactionsByAddressRIBSBVinInner.parse_obj({
            "addresses": obj.get("addresses"),
            "script_sig": ListUnconfirmedTransactionsByAddressRIBSBVinInnerScriptSig.from_dict(obj.get("scriptSig")) if obj.get("scriptSig") is not None else None,
