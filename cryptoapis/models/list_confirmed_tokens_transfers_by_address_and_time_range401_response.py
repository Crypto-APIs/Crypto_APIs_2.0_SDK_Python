...
class ListConfirmedTokensTransfersByAddressAndTimeRange401Response(BaseModel):
    """
    ...
    error: ListConfirmedTokensTransfersByAddressAndTimeRangeE401 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConfirmedTokensTransfersByAddressAndTimeRange401Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConfirmedTokensTransfersByAddressAndTimeRange401Response:
        """Create an instance of ListConfirmedTokensTransfersByAddressAndTimeRange401Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConfirmedTokensTransfersByAddressAndTimeRange401Response.parse_obj(obj)

        _obj = ListConfirmedTokensTransfersByAddressAndTimeRange401Response.parse_obj({
            "api_version": obj.get("apiVersion"),
            "request_id": obj.get("requestId"),
            "context": obj.get("context"),
            "error": ListConfirmedTokensTransfersByAddressAndTimeRangeE401.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
