...
get_asset_details_by_asset_symbol_risc_instance = GetAssetDetailsByAssetSymbolRISC.from_json(json)
# print the JSON string representation of the object
print GetAssetDetailsByAssetSymbolRISC.to_json()

# convert the object into a dict
get_asset_details_by_asset_symbol_risc_dict = get_asset_details_by_asset_symbol_risc_instance.to_dict()
# create an instance of GetAssetDetailsByAssetSymbolRISC from a dict
get_asset_details_by_asset_symbol_risc_form_dict = get_asset_details_by_asset_symbol_risc.from_dict(get_asset_details_by_asset_symbol_risc_dict)
```
