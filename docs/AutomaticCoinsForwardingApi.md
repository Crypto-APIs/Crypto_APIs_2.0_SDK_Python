...
> CreateAutomaticCoinsForwardingR create_automatic_coins_forwarding(blockchain, network, context=context, create_automatic_coins_forwarding_rb=create_automatic_coins_forwarding_rb)
...
with cryptoapis.ApiClient(configuration) as api_client:
    ...
    api_instance = cryptoapis.AutomaticCoinsForwardingApi(api_client)
    ...
    create_automatic_coins_forwarding_rb = cryptoapis.CreateAutomaticCoinsForwardingRB() # CreateAutomaticCoinsForwardingRB |  (optional)
    ...
    try:
        ...
        print("The response of AutomaticCoinsForwardingApi->create_automatic_coins_forwarding:\n")
        pprint(api_response)
...
> DeleteAutomaticCoinsForwardingR delete_automatic_coins_forwarding(blockchain, network, reference_id, context=context)
...
with cryptoapis.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutomaticCoinsForwardingApi->delete_automatic_coins_forwarding:\n")
        pprint(api_response)
    except Exception as e:
...
> ListCoinsForwardingAutomationsR list_coins_forwarding_automations(blockchain, network, context=context, limit=limit, offset=offset)
...
with cryptoapis.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AutomaticCoinsForwardingApi->list_coins_forwarding_automations:\n")
        pprint(api_response)
    except Exception as e:
