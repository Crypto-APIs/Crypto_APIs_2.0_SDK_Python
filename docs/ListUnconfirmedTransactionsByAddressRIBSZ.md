...
json = "{}"
# create an instance of ListUnconfirmedTransactionsByAddressRIBSZ from a JSON string
list_unconfirmed_transactions_by_address_ribsz_instance = ListUnconfirmedTransactionsByAddressRIBSZ.from_json(json)
# print the JSON string representation of the object
print ListUnconfirmedTransactionsByAddressRIBSZ.to_json()

# convert the object into a dict
list_unconfirmed_transactions_by_address_ribsz_dict = list_unconfirmed_transactions_by_address_ribsz_instance.to_dict()
# create an instance of ListUnconfirmedTransactionsByAddressRIBSZ from a dict
list_unconfirmed_transactions_by_address_ribsz_form_dict = list_unconfirmed_transactions_by_address_ribsz.from_dict(list_unconfirmed_transactions_by_address_ribsz_dict)
```
