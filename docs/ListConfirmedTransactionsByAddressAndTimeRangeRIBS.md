...
list_confirmed_transactions_by_address_and_time_range_ribs_instance = ListConfirmedTransactionsByAddressAndTimeRangeRIBS.from_json(json)
# print the JSON string representation of the object
print ListConfirmedTransactionsByAddressAndTimeRangeRIBS.to_json()

# convert the object into a dict
list_confirmed_transactions_by_address_and_time_range_ribs_dict = list_confirmed_transactions_by_address_and_time_range_ribs_instance.to_dict()
# create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBS from a dict
list_confirmed_transactions_by_address_and_time_range_ribs_form_dict = list_confirmed_transactions_by_address_and_time_range_ribs.from_dict(list_confirmed_transactions_by_address_and_time_range_ribs_dict)
```
