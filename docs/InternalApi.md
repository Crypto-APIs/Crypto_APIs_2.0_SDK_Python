...
> GetInternalTransactionByTransactionHashAndOperationIdR get_internal_transaction_by_transaction_hash_and_operation_id(operation_id, transaction_hash)
...
with cryptoapis.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Internal Transaction by Transaction Hash and Operation Id
        api_response = api_instance.get_internal_transaction_by_transaction_hash_and_operation_id(operation_id, transaction_hash)
        pprint(api_response)
    ...
    try:
        # Get Internal Transaction by Transaction Hash and Operation Id
        api_response = api_instance.get_internal_transaction_by_transaction_hash_and_operation_id(operation_id, transaction_hash, context=context)
        pprint(api_response)
    except cryptoapis.ApiException as e:
        print("Exception when calling InternalApi->get_internal_transaction_by_transaction_hash_and_operation_id: %s\n" % e)
```
 ...
 **network** | **str**| Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot;, \&quot;rinkeby\&quot; are test networks. | defaults to "ropsten"
...
> ListInternalTransactionDetailsByTransactionHashR list_internal_transaction_details_by_transaction_hash(transaction_hash)
...
with cryptoapis.ApiClient(configuration) as api_client:
    ...
    try:
        # List Internal Transaction Details by Transaction Hash
        api_response = api_instance.list_internal_transaction_details_by_transaction_hash(transaction_hash)
        pprint(api_response)
    except cryptoapis.ApiException as e:
    ...
    try:
        # List Internal Transaction Details by Transaction Hash
        api_response = api_instance.list_internal_transaction_details_by_transaction_hash(transaction_hash, context=context, limit=limit, offset=offset)
        pprint(api_response)
    except cryptoapis.ApiException as e:
        print("Exception when calling InternalApi->list_internal_transaction_details_by_transaction_hash: %s\n" % e)
```
