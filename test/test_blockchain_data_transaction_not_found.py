...
import cryptoapis
from cryptoapis.models.blockchain_data_transaction_not_found import BlockchainDataTransactionNotFound  # noqa: E501
...
class TestBlockchainDataTransactionNotFound(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `BlockchainDataTransactionNotFound`
        """
        model = cryptoapis.models.blockchain_data_transaction_not_found.BlockchainDataTransactionNotFound()  # noqa: E501
        if include_optional :
