...
import cryptoapis
from cryptoapis.models.address_tokens_transaction_confirmed_token import AddressTokensTransactionConfirmedToken  # noqa: E501
...
class TestAddressTokensTransactionConfirmedToken(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `AddressTokensTransactionConfirmedToken`
        """
        model = cryptoapis.models.address_tokens_transaction_confirmed_token.AddressTokensTransactionConfirmedToken()  # noqa: E501
        if include_optional :
