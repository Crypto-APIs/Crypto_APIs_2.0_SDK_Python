...
class TestListTransactionsByAddressResponseItemBlockchainSpecificDash(unittest.TestCase):
    """ListTransactionsByAddressResponseItemBlockchainSpecificDash unit test stubs"""
    ...
    def testListTransactionsByAddressResponseItemBlockchainSpecificDash(self):
        """Test ListTransactionsByAddressResponseItemBlockchainSpecificDash"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ListTransactionsByAddressResponseItemBlockchainSpecificDash()  # noqa: E501
        pass
