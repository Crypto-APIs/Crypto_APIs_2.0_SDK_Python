...
import cryptoapis
from cryptoapis.models.limit_greater_than_allowed import LimitGreaterThanAllowed  # noqa: E501
...
class TestLimitGreaterThanAllowed(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `LimitGreaterThanAllowed`
        """
        model = cryptoapis.models.limit_greater_than_allowed.LimitGreaterThanAllowed()  # noqa: E501
        if include_optional :
