...
import cryptoapis
from cryptoapis.api.xrp_ripple_api import XRPRippleApi  # noqa: E501
...
class TestXRPRippleApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = cryptoapis.api.xrp_ripple_api.XRPRippleApi()  # noqa: E501
    ...
    def test_list_xrp__ripple_transactions_by_address_and_time_range(self):
